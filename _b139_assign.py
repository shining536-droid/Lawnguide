...
TIER = {  # 도메인별 사용할 판례 tier (pool 가용성 기준)
    ...
    # ⚠️ b139: defamation supreme 완전 소진(b137 97도133 이 마지막) → lower 고정.
...
#   다음 배치(b139)부터 defamation 은 TIER 를 "lower" 로 고정하면 된다.
# b139 적용 완료: defamation supreme 0 → TIER 에서 "lower" 고정. TIER_SEQ 는 비움(분기 불필요).
TIER_SEQ = {}
_tier_cur = {}

...
### 💡 Tip 3. 영장의 수색 범위를 가능한 한 확인하세요 — 범위 밖은 거부할 수 있어요
...
⚠️ 영장이 없는 상태에서 "동의 수색" 서류에 서명하면 영장 없는 수색도 합법이 돼요. 서명 전에 가능한 한 신중하게 판단하세요.
...
혐의를 받고 있다면 변호사 연락 → 압수 목록 확보 → 영장 범위 확인, 이 세 가지를 가능한 한 챙기세요. 압수수색 단계에서의 대응이 이후 재판 결과를 크게 좌우할 수 있어요. 당황하지 말고 차분하게 권리를 행사하세요.

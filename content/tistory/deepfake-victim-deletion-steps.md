...
"영상을 퍼뜨리겠다"는 메시지를 받았다면 어떤 상황에서도 대화 내용을 삭제해서는 안 됩니다. 카카오톡, 문자, DM 등 모든 협박 내용을 날짜와 시간이 보이는 상태로 캡처하세요. 금전을 요구하는 경우 해당 내용도 가능한 한 보존해야 합니다. 돈을 보내면 해결될 것이라는 기대는 환상에 불과하며, 한 번 응하면 요구가 반복될 뿐입니다. 즉각 경찰에 신고하는 것만이 확실한 해결책입니다.

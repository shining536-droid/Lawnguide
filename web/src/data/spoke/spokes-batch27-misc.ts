...
export const spokesBatch27Misc: SpokePage[] = [
...

  {
    ...
    cases: [{ title: '판례 — 과거 양육비 청구권 인정', summary: '대법원 2018므724 사건(대법원, 2024.07.18 선고)에서 법원은 이혼한 부부 사이에서 일방이 미성년 자녀를 양육하면서 상대에게 양육비 환급을 청구하는 경우, 과거 양육비의 분담 비율은 쌍방의 경제적 능력과 기여도를 고려하여 정한다고 판시했습니다.', takeaway: '비슷한 상황이라면 자녀가 성인이 돼도 과거 양육비를 청구하세요. 소급 청구가 인정됩니다.' }],
    faq: [
...

  {
    ...
    sections: [
      {
        title: '사실혼 관계의 법적 보호',
        content: '<p><strong style="color:#1e3a5f">혼인신고를 하지 않았더라도 실질적 혼인 생활이 있었다면 사실혼 관계로 인정됩니다.</strong></p>\n<ul>\n<li><strong>사실혼 인정 요건</strong> — ①혼인 의사의 합치 ②공동생활의 실체가 있어야 합니다.</li>\n<li><strong>보호 범위</strong> — 재산분할 청구권, 위자료 청구권이 인정됩니다. 다만 상속권은 인정되지 않습니다.</li>\n<li><strong>입증 자료</strong> — 동일 주소지 등록, 가족 소개, 경조사 참석, 공동 명의 재산, 자녀 존재 등</li>\n</ul>',
      },
      {
        title: '재산분할 청구 방법',
...

  {
    ...
    faq: [
      { question: '건강보험료 체납도 면책이 안 되나요?', answer: '<p>국민건강보험료, 국민연금 등 사회보험료는 비면책채권에 해당합니다.</p>' },
...

  {
    ...
    cases: [{ title: '판례 — 간접흡연 손해배상 인정', summary: '법원은 공동주택에서의 간접흡연이 수인한도를 넘는 경우 불법행위로 인정하고 위자료를 인정한 사례가 있습니다. 특히 미성년 자녀나 호흡기 질환이 있는 가족이 있는 경우 피해가 가중되어 인정됩니다.', takeaway: '비슷한 상황이라면 아이나 호흡기 환자가 있다면 병원 진료 기록을 반드시 확보하세요. 법적 대응 시 유리한 증거가 됩니다.' }],
    faq: [

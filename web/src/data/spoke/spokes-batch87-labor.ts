...
export const spokesBatch87Labor: SpokePage[] = [
  // ─── 1. dismissal-probation-evaluation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '수습·시용 해고 다툼', href: '/guide/dismissal/dismissal-probation-trial-track' },
      { label: '이력서 허위기재 해고', href: '/guide/dismissal/dismissal-resume-falsification-track' },
  ...
  // ─── 2. dismissal-disciplinary-procedure-track ───
  {
    ...
    internalLinks: [
      { label: '부당해고 구제 절차', href: '/guide/dismissal/unfair-dismissal-relief-procedure' },
      { label: '징계 절차 하자 다툼', href: '/guide/dismissal/dismissal-disciplinary-procedure-defect' },
      { label: '해고 입증책임 정리', href: '/guide/dismissal/dismissal-burden-of-proof-track' },
      { label: '해고 서면통지 요건', href: '/guide/dismissal/dismissal-written-notice-requirement' },
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
    ],
  },
  ...
  // ─── 3. dismissal-pregnancy-maternity-track ───
  {
    ...
    internalLinks: [
      { label: '부당해고 구제 절차', href: '/guide/dismissal/unfair-dismissal-relief-procedure' },
      { label: '경영상 해고 요건', href: '/guide/dismissal/dismissal-managerial-requirement-track' },
      { label: '일부 사업 폐지 해고', href: '/guide/dismissal/dismissal-partial-closure-track' },
      { label: '해고 서면통지 요건', href: '/guide/dismissal/dismissal-written-notice-requirement' },
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
    ],
  },
  ...
  // ─── 4. wage-night-holiday-premium-track ───
  {
    ...
    internalLinks: [
      { label: '야간·휴일 가산수당 청구', href: '/guide/wage/wage-night-holiday-premium-claim' },
      { label: '포괄임금 성립 범위 다툼', href: '/guide/wage/wage-comprehensive-scope-track' },
  ...
  // ─── 5. wage-annual-leave-allowance-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '연차 사용촉진 다툼', href: '/guide/wage/wage-leave-use-promotion-track' },
  ...
  // ─── 6. unemployment-harassment-resignation-track ───
  {
    ...
    internalLinks: [
      { label: '괴롭힘 자진퇴사 수급', href: '/guide/unemployment/harassment-resignation-track' },
  ...
  // ─── 7. unemployment-pregnancy-childcare-resignation-track ───
  {
    ...
    cta: { text: '실업급여 받을 수 있는지 AI로 점검하기', link: '/chat?domain=unemployment' },
    internalLinks: [
      { label: '임신·육아 자진퇴사 수급', href: '/guide/unemployment/pregnancy-childcare-resignation-track' },
      { label: '정당한 이직 사유 정리', href: '/guide/unemployment/justifiable-separation-reason-track' },
      { label: '실업급여 신청 절차', href: '/guide/unemployment/benefit-application-procedure' },
      { label: '육아휴직급여 신청기간', href: '/guide/unemployment/parental-leave-benefit-deadline-track' },
      { label: '피보험단위기간 확인', href: '/guide/unemployment/insured-period-check-track' },
    ],
  },
  ...
  // ─── 8. retirement-part-time-worker-track ───
  {
    ...
    internalLinks: [
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
      { label: '단시간근로자 퇴직금 다툼', href: '/guide/retirement/retirement-part-time-track' },
  ...
  // ─── 9. retirement-bonus-average-wage-track ───
  {
    ...
    internalLinks: [
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
      { label: '상여금 평균임금 산입 다툼', href: '/guide/retirement/retirement-bonus-inclusion-track' },
      { label: '평균임금 산정 기준', href: '/guide/retirement/retirement-average-wage-standard-track' },
      { label: '퇴직금 재산정 차액', href: '/guide/retirement/retirement-recalculation-difference' },
      { label: '퇴직금 체불 진정', href: '/guide/retirement/retirement-pay-unpaid-report-track' },
    ],
  },
  ...
  // ─── 10. industrial-accident-commuting-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '출퇴근 재해 산재 다툼', href: '/guide/industrial-accident/industrial-accident-commuting-disaster-track' },
      { label: '업무상 재해 인과관계', href: '/guide/industrial-accident/industrial-accident-disease-causation-track' },

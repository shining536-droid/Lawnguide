...
export const spokesBatch62WageUnempRetire: SpokePage[] = [
  // ─── 1. wage-meal-allowance-ordinary-wage-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 임금·퇴직금 규정 변경과 근로자 동의',
        summary:
          '대법원 2000다65239(대법원, 2001.06.26 선고)에서 법원은 퇴직금 관련 규정을 근로자에게 불리하게 바꿀 때에는 근로자의 집단적 동의가 필요하고, 앞서 동의 없이 이루어져 효력이 없던 개정 부분까지 포함해 노동조합이 동의했다면 그 동의는 규정 전체에 대한 것으로 볼 수 있다고 판시했습니다. 임금·수당의 지급 기준은 취업규칙·단체협약 등으로 정해지는데, 근로자에게 불이익한 변경에는 엄격한 동의 요건이 적용된다는 취지입니다. 식대가 통상임금에 포함되는지는 그 지급이 정기·일률·고정적인지와 관련 규정을 함께 살펴 정리해볼 수 있습니다.',
        takeaway: '식대가 정기·일률·고정적으로 지급되면 통상임금 포함 여부를 검토해볼 수 있음. 임금 기준을 불리하게 바꾸려면 근로자 동의가 필요. 급여명세서·취업규칙을 모아 확인해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      { label: '정기상여금 통상임금 산입 차액', href: '/guide/wage/wage-customary-bonus-ordinary-wage-inclusion-track' },
      { label: '이사 정관 퇴직금 하한 청구', href: '/guide/wage/wage-director-articles-minimum-retirement-pay-claim-track' },
      { label: '공정수당 지급액 계산', href: '/guide/wage/fair-allowance-amount-calculation' },
      { label: '체불임금 소멸시효 3년 — 기한 전 반드시 할 일', href: '/guide/wage/unpaid-wage-statute-of-limitations' },
      { label: '근로감독관 신고 전 증거 준비', href: '/guide/wage/labor-inspector-complaint-evidence-prep' },
    ],
  },
  ...
  // ─── 2. wage-holiday-allowance-saturday-sunday-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 미달 지급 임금과 퇴직금 산정',
        summary:
          '대법원 2012다70388(대법원, 2014.10.27 선고)에서 법원은 최저임금법 제6조 제5항 시행 이후 퇴직한 택시운전 근로자가 그 기준에 미달하는 임금을 받아온 경우, 실제 지급된 임금뿐 아니라 법에 따라 당연히 지급되었어야 할 미지급 임금까지 포함한 평균임금을 기초로 퇴직금을 산정해야 하고 이를 함부로 감액할 수 없다고 판시했습니다. 법정 기준에 못 미치게 지급된 임금은 사후에 산정에 반영될 수 있다는 취지입니다. 휴일근로 가산수당처럼 법정 가산분이 누락된 경우에도 그 미지급분을 정리해 청구를 검토해볼 수 있습니다.',
        takeaway: '법정 기준에 못 미쳐 지급된 임금·가산수당은 사후 청구를 검토해볼 수 있음. 토요일·일요일 근로가 휴일인지 휴무일인지에 따라 가산율이 달라지니 근무기록을 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '주휴일 공휴일 중복 수당', href: '/guide/wage/wage-weekly-holiday-public-holiday-overlap' },
  ...
  // ─── 3. unemployment-recommended-resignation-eligibility-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '임신 육아 자진퇴사 실업급여', href: '/guide/unemployment/unemployment-maternity-voluntary-quit' },
      ...
      { label: '실업급여 신청 필요 서류 6가지 체크리스트', href: '/guide/unemployment/application-required-documents-checklist' },
    ],
  },
  ...
  // ─── 4. retirement-db-investment-loss-responsibility-track ───
  {
    ...
    cases: [
      {
        ...
        takeaway: '퇴직연금 지급 분쟁은 유형에 따라 다투는 절차가 달라짐. DB형 운용손실·부족분은 제도 구조와 약정·규정을 확인해 대응 방법을 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '퇴직금 미지급 내용증명 전 준비 사항', href: '/guide/retirement/before-demand-letter-retirement-pay' },
      { label: 'DB DC 강제 전환 손해', href: '/guide/retirement/retirement-db-to-dc-pension-conversion-loss-track' },
  ...
  // ─── 5. retirement-self-employed-transition-payout-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 퇴직금 청구권 발생 시점과 소멸시효',
        summary:
          '대법원 2006다20542(대법원, 2008.02.01 선고)에서 법원은 근로기간 중 일부에 대해 퇴직금 중간정산이 이루어진 경우 그 부분은 중간정산 시점에 청구권이 발생하지만, 중간정산 합의가 없었던 나머지 근로기간에 대해서는 최종 퇴직 시에 비로소 퇴직금 청구권이 발생하고 소멸시효도 그때부터 진행한다고 판시했습니다. 자영업 전환을 위해 퇴사하는 경우에도 최종 퇴직일을 기준으로 청구권과 3년 시효를 검토해볼 수 있습니다.',
        takeaway: '퇴직금 청구권은 최종 퇴직 시 발생해 그때부터 3년 안에 청구할 수 있고, 지급은 퇴직일로부터 14일 이내가 원칙입니다. 자영업 전환자는 IRP로 받으면 과세이연을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    cta: { text: '퇴직금 계산과 청구 절차, AI로 정리하기', link: '/chat?domain=retirement' },
    internalLinks: [
      { label: '퇴직금 지급 기한 14일 규정 상세', href: '/guide/retirement/retirement-pay-14day-rule-detail' },

...
export const spokesBatch24_1to7: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>개인사업자든 법인이든 진정 절차는 동일합니다.</strong> 다만 개인사업자는 대표 개인 재산으로 체불금을 변제해야 하고, 법인은 법인 자산에서 지급합니다. 대지급금 신청 시에도 사업 형태에 관계없이 요건을 충족하면 지급받을 수 있습니다.',
      },
    ],
    cta: {
  ...
  // ───────────────────────────────────────────
  {
    ...
    cases: [
      {
        title: '판례 — 근로자성 판단과 4대보험 적용',
        summary:
          '대구지방법원 2018가단139279(대구지방법원, 2019.11.08 선고)에서는 업무위탁계약을 맺고 대리점에서 휴대전화 판매업무를 한 사람이 근로기준법상 근로자인지 다툰 사안에서, 기본급·고정급 없이 판매실적에 따라 수수료를 받고 근무시간을 스스로 조정할 수 있었던 점 등을 들어 근로자로 보기 어렵다고 판단한 사례가 있습니다. 이처럼 근로자성은 계약의 형식보다 지휘·감독과 종속관계의 실질로 판단되고, 근로자로 인정되어야 사용자에게 4대보험 가입 의무가 발생합니다. 다만 하급심 사례라 구체적 사정에 따라 결론이 달라질 수 있으니, 본인의 근무 실태 자료를 정리해 가입 대상 여부부터 확인해볼 수 있습니다.',
        takeaway:
          '4대보험 가입 의무는 근로자성 인정을 전제로 함. 계약 형식이 아니라 실제 근무 실태로 판단되니 출퇴근·업무지시·급여 자료를 모아 미가입 신고 전 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {

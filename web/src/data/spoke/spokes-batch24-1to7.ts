...
export const spokesBatch24_1to7: SpokePage[] = [
    ...
    faq: [
      {
        ...
        answer:
          '<strong>무주택자가 전세보증금을 부담하는 경우 중간정산 사유에 해당합니다.</strong> 다만 보증금 부담액이 연 임금총액의 50% 이상이어야 하고, 임대차계약서와 무주택 확인 서류를 함께 제출해야 합니다. 기존 전세 연장 시 인상분이 50%를 넘으면 가능합니다.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    intro:
      '<p>월급날이 한 달째 지나도록 사장님은 "다음 달에 준다"만 반복합니다. 노동청에 진정을 넣겠다고 마음먹었지만 막상 뭘 어떻게 준비해야 할지 막막합니다. 증거가 부족하면 진정이 기각될 수 있고, 잘못된 정보로 신고하면 오히려 사업주에게 불리하게 작용할 수도 있습니다. 진정서를 제출하기 전에 반드시 확인해야 할 8가지를 정리해보세요.</p>',
    sections: [
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>고용 형태와 관계없이 근로기준법상 근로자라면 모두 진정 대상입니다.</strong> 일용직, 아르바이트, 프리랜서 명목이라도 실질적으로 사용자의 지휘·감독을 받았다면 근로자로 인정됩니다. 근무 일자와 시간, 지급받은 금액을 기록한 자료를 제출하세요.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    meta: {
      ...
      description:
        '갑자기 해고 통보를 받아서 당장 뭘 해야 할지 모르겠다면 24시간 내 반드시 해야 할 5가지를 지금 확인하세요',
    },
    intro:
    ...
    faq: [
      {
        ...
        answer:
          '<strong>구두 통보도 해고에 해당합니다.</strong> 근로기준법은 해고 사유와 시기를 서면으로 통지하도록 규정하고 있어 구두 해고는 절차적으로 부당해고가 됩니다. 통보 즉시 녹음하거나 메모를 남기고 해고 사유서를 서면으로 요구하세요.',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '<strong>이직확인서에 "권고사직"으로 기재되면 비자발적 이직으로 인정되어 실업급여를 받을 수 있습니다.</strong> 핵심은 사직서 작성 여부가 아니라 이직확인서 기재 내용입니다. 반드시 회사에 "권고사직"으로 기재한다는 서면 확인을 받으세요.',
      },
      {

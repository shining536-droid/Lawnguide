...
export const spokesBatch82Labor: SpokePage[] = [
  // ─── 1. dismissal-probation-period-low-evaluation-termination-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '수습기간 평가 부적격 본채용 거부 정당성 판단', href: '/guide/dismissal/dismissal-probation-period-evaluation-nonhire-termination-track' },
  ...
  // ─── 6. unemployment-workplace-harassment-voluntary-resignation-track ───
  {
    ...
    internalLinks: [
      { label: '임금체불 자진퇴사 구직급여 정당한 사유 절차', href: '/guide/unemployment/unemployment-wage-arrears-resignation-eligibility-track' },
      { label: '실업급여 퇴사 전 준비 체크리스트', href: '/guide/unemployment/pre-resignation-benefit-prep' },
  ...
  // ─── 7. unemployment-family-care-commute-difficulty-resignation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '임기제 공무원 고용보험 가입신청 기간 구직급여 절차', href: '/guide/unemployment/unemployment-fixed-term-public-official-insurance-enrollment-period-track' },
      { label: '실업급여 거절 사유 5가지', href: '/guide/unemployment/benefit-application-rejection-5-reasons' },
      { label: '실업급여 종합 가이드', href: '/guide/unemployment' },
      { label: '실업급여 질병 부상 치료 수급기간 연장', href: '/guide/unemployment/unemployment-illness-medical-treatment-extended-period-track' },
    ],
  },
  ...
  // ─── 8. retirement-average-wage-bonus-inclusion-recalculation-track ───
  {
    ...
    internalLinks: [
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
      { label: '평균임금 산정 기초 퇴직금', href: '/guide/retirement/retirement-average-wage-exclusion-period-track' },
  ...
  // ─── 10. industrial-accident-work-stress-mental-illness-recognition-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '과로 뇌심혈관 질병 업무상 재해 인정 절차', href: '/guide/industrial-accident/industrial-accident-overwork-cerebral-cardiac-disease-recognition-track' },

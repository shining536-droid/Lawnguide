...
export const spokesBatch31Misc: SpokePage[] = [
  // ── 회생 1. 채권자 이의 대응 방법 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>가능한 한 늘어나지는 않습니다. 채권액 이의가 인정되면 총 변제액이 늘어날 수 있지만, 가용소득 범위 내에서 조정됩니다. 법원은 채무자의 최저생계비를 보장하므로 무리한 변제를 강요하지 않습니다.</p>',
      },
      {
  ...
  // ── 회생 2. 보증채무 개인회생 포함 여부 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>네, 조건부 채무도 개인회생채권에 해당할 소지가 있습니다. 주채무자가 아직 상환 중이라 보증이 현실화되지 않더라도 채권자목록에 기재할 수 있습니다.</p>',
      },
      {
  ...
  // ── 상가 1. 특례기간 연체 차임과 계약갱신 ──
  {
    ...
    faq: [
      ...
      {
        question: '3기분(3개월분) 이상 연체하면 원칙적으로 해지되나요?',
        answer:
    ...
    faq: [
      {
        ...
        answer:
          '<p>임대인이 실제로 직접 영업을 하려는 진정한 의사가 없다면 방해 행위에 해당할 소지가 있습니다. 거절 후 상당 기간 빈 상가로 방치하거나 제3자에게 임대하는 경우가 대표적입니다.</p>',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>네, 소멸시효 3년이 경과하면 임대인이 시효 항변을 할 수 있어 사실상 청구가 불가능합니다. 종료일로부터 3년 이내에 가능한 한 소송을 제기하거나 조정을 신청하세요.</p>',
      },
    ],
    ...
    faq: [
      {
        ...
        answer:
          '<p>전입신고 다음 날 0시에 대항력이 발생하므로, 그날 설정된 근저당과는 같은 날 기준이 됩니다. 같은 날이면 등기가 먼저이므로 후순위가 됩니다. 전입신고 하루 전에 등기부를 가능한 한 확인하세요.</p>',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>확정일자 없이는 대항력은 있지만 우선변제권이 없습니다. 경매 시 다른 담보권자보다 우선 배당을 받으려면 가능한 한 확정일자를 받아야 합니다. 비용은 600원입니다.</p>',
      },
      {

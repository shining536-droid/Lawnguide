...
export const spokesBatch65AssaultCsDui: SpokePage[] = [
    ...
    cases: [
      {
        ...
        summary:
          '창원지방법원 2024노3452(창원지방법원, 2025.07.15 선고)에서는 시비·분쟁 과정에서의 폭행 행위에 대해 피해자 측의 일부 선행 행위가 있더라도 폭행 자체의 위법성과 책임은 별도로 평가될 여지가 있고, 가중 사정이 인정될 수 있다고 본 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하며, 유사 상황이라면 이런 기준을 검토해볼 수 있습니다.',
  ...
  // ─── 3. assault-cyber-bullying-school-online-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '청소년 사이버 학교폭력 + 폭행', href: '/guide/assault/assault-cyber-bullying-school-online-track' },
  ...
  // ─── 4. child-support-cohabitation-paternity-recognition-claim-track ───
  {
    ...
    internalLinks: [
      { label: '혼외자 인지 과거 양육비', href: '/guide/child-support/child-support-paternity-recognition-back-claim-track' },
      { label: '양육비 직접지급명령 사용자', href: '/guide/child-support/child-support-direct-payment-third-party-employer' },
  ...
  // ─── 6. dui-electric-scooter-personal-mobility-impaired-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '음주운전 자진신고 자수 대응', href: '/guide/dui/dui-voluntary-surrender-self-report-criminal-admin-track' },
    ],
  },
];

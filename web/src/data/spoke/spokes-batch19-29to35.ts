...
export const spokesBatch19_29to35: SpokePage[] = [
  {
    ...
    questionKeyword: '부동산 매매계약서에 넣어야 할 필수 특약은 무엇인가요?',
    ctaKeyword: '매매계약서 특약 체크',
    type: '체크리스트형',
    perspective: 'buyer',
    meta: {
      title: '부동산 매매계약서 필수 특약 8가지 체크리스트 | 로앤가이드',
      description: '매매계약서 특약을 빠뜨려 나중에 분쟁이 생길까 불안하다면, 반드시 넣어야 할 필수 특약 8가지를 지금 확인하세요.',
    },
    intro:
      '중개사 사무실에 앉아 매매계약서를 펼쳤습니다. "특약사항" 란이 비어 있는데, 무엇을 적어야 할지 막막합니다. 부동산 매매에서 특약은 분쟁이 생겼을 때 가장 강력한 보호장치입니다. 계약서에 한 줄을 빠뜨렸다가 수천만 원의 손해를 보는 사례가 해마다 반복됩니다. 계약서에 서명하기 전에 반드시 아래 8가지 항목을 점검하세요.',
    sections: [
      {
        title: '첫째, 잔금 전 하자 발견 시 계약 해제 조건을 명시하세요',
        content:
          '<p><strong style="color:#1e3a5f">민법 제580조에 따라 매매 목적물에 하자가 있으면 매수인은 계약을 해제하거나 손해배상을 청구할 수 있습니다</strong></p>\n<p>잔금 지급 전까지 <strong>누수, 균열, 불법 증축</strong> 등 숨겨진 하자가 발견되면 매수인이 별도 위약금 없이 계약을 해제할 수 있다는 조항을 반드시 넣으세요. "매도인은 잔금일 전까지 발견된 하자에 대해 보수 완료 또는 매수인의 해제권 행사를 인정한다"라는 문구가 핵심입니다.</p>\n<p>특약 없이 계약하면 잔금 지급 후 하자를 발견해도 <strong>계약 해제가 아닌 손해배상 절차</strong>로만 해결해야 하며, 입증 부담이 매수인에게 넘어갑니다. 사전에 특약으로 보호 범위를 넓혀두세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">체크: 하자 범위 특정 + 발견 시 해제 가능 명시 + 보수 책임 소재 기재</blockquote>',
      },
      {
        title: '둘째, 근저당·가압류 말소 시점과 책임을 확정하세요',
        content:
          '<p><strong style="color:#1e3a5f">등기부등본상 근저당권이 잔금일까지 말소되지 않으면 소유권 이전에 중대한 장애가 됩니다</strong></p>\n<p>"매도인은 잔금일까지 등기부등본상 근저당권, 가압류, 압류, 가처분 등 <strong>일체의 제한물권과 부담을 말소</strong>한다"는 문구를 특약에 포함하세요. 말소 시점을 "잔금일 전일 17시까지"처럼 구체적으로 지정하면 더 안전합니다.</p>\n<p>근저당 말소가 이루어지지 않을 경우 <strong>매수인의 계약 해제권</strong>과 위약금 조항을 함께 넣어두면, 매도인의 말소 이행을 강제하는 효과가 있습니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">체크: 말소 대상 목록 + 말소 기한 + 미이행 시 해제권 + 위약금 조항</blockquote>\n<div style="margin-top:16px;padding:14px 18px;background:linear-gradient(135deg,#fff8e1,#fff3cd);border-left:4px solid #f9a825;border-radius:8px">\n<strong style="color:#e65100">지금 바로 확인하세요</strong><br/>\n<a href="/chat?domain=real-estate-sale" style="color:#1565c0;font-weight:600">내 매매계약서 특약 사항 AI로 점검받기 &rarr;</a>\n</div>',
      },
      {
        title: '셋째, 실측 면적 차이 시 정산 조건을 정하세요',
        content:
          '<p><strong style="color:#1e3a5f">공부상 면적과 실측 면적이 다른 경우 매매대금을 정산하는 기준을 미리 합의해야 합니다</strong></p>\n<p>"실측 결과 공부상 면적과 차이가 있을 경우 <strong>평당 단가 기준으로 매매대금을 증감 정산</strong>한다"는 조항을 넣어야 합니다. 토지 매매에서 특히 중요한데, 면적 차이가 3% 이상이면 계약 해제까지 가능하도록 설정하는 것이 일반적입니다.</p>\n<p>아파트의 경우에도 <strong>전용면적과 공급면적의 혼동</strong>으로 분쟁이 생기는 경우가 있으므로, 계약서에 전용면적을 기준으로 매매대금을 산정한다는 점을 명확히 해두세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">체크: 면적 기준 명시 + 차이 정산 방법 + 일정 이상 차이 시 해제 조건</blockquote>',
      },
      {
        title: '넷째, 세입자 퇴거 완료 시점과 인도 조건을 확인하세요',
        content:
          '<p><strong style="color:#1e3a5f">세입자가 있는 매물은 잔금일까지 퇴거 완료를 보장하는 특약이 필수입니다</strong></p>\n<p>"매도인은 잔금일까지 현 세입자의 <strong>전입세대 전원의 퇴거 및 전입신고 말소</strong>를 완료한다"는 문구를 반드시 넣으세요. 세입자가 퇴거하지 않으면 매수인이 이사조차 할 수 없는 상황이 발생합니다.</p>\n<p>특히 <strong>대항력을 갖춘 임차인</strong>이 남아 있으면 매수인에게 보증금 반환 의무가 승계됩니다. 임차인 현황(보증금액, 전입일, 확정일자)을 특약에 구체적으로 기재하고, 인도일에 빈 집 상태로 넘겨받는 조건을 확정하세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">체크: 세입자 목록 + 보증금액 + 퇴거 기한 + 미퇴거 시 위약금</blockquote>',
      },
    ],
    cases: [
      {
        title: '매매계약 특약 불이행 시 계약 해제 가능성을 판시한 사례',
        summary:
          '대법원 2022다203804 사건(2022.06.16 선고)에서 법원은 분양계약서에 수기로 명시한 특약사항(고압선 지중화 의무)이 계약의 주된 채무에 해당하는지가 쟁점이 되었고, 특약 불이행이 계약 목적 달성에 필수적이라면 계약 해제 사유가 될 수 있다고 판시했습니다.',
        takeaway:
          '매매계약서에 특약을 넣을 때는 해당 조항이 계약의 핵심 조건임을 분명히 해야 합니다. "본 특약 위반 시 매수인은 계약을 해제할 수 있다"는 문구를 함께 기재하면 분쟁 시 강력한 보호를 받을 수 있습니다.',
      },
    ],
    faq: [
      {
        question: '특약 사항은 법적으로 어떤 효력이 있나요?',
        answer:
          '특약 사항은 <strong>계약 당사자 간의 합의</strong>로서 법적 구속력이 있습니다. 민법상 계약자유의 원칙에 따라 강행법규에 반하지 않는 한 특약의 내용대로 의무가 발생하며, 위반 시 손해배상 청구나 계약 해제의 근거가 됩니다.',
      },
      {
        question: '중개사가 제안한 특약을 그대로 써도 되나요?',
        answer:
          '중개사가 제안한 특약은 <strong>관행적인 내용</strong>인 경우가 많아 내 상황에 맞지 않을 수 있습니다. 특히 하자 범위, 말소 기한, 위약금 금액 등은 거래마다 다르므로 반드시 상황에 맞게 수정하세요.',
      },
      {
        question: '특약에 위약금 금액을 안 적으면 어떻게 되나요?',
        answer:
          '위약금 금액을 명시하지 않으면 <strong>실제 손해액을 입증</strong>해야 배상받을 수 있습니다. 일반적으로 매매대금의 10%를 위약금으로 정하는 것이 관례이며, 이를 초과하는 손해가 있다면 별도 청구도 가능합니다.',
      },
      {
        question: '잔금일에 근저당이 말소되지 않으면 바로 해제할 수 있나요?',
        answer:
          '특약에 "잔금일까지 말소 미완료 시 매수인은 계약을 해제할 수 있다"고 명시해두었다면 <strong>별도의 최고 없이도 해제</strong>할 수 있습니다. 특약이 없으면 상당한 기간을 정한 최고 후 해제해야 하므로 절차가 복잡해집니다.',
      },
      {
        question: '특약을 구두로만 합의하면 효력이 있나요?',
        answer:
          '구두 합의도 법적으로 유효하지만, <strong>분쟁 시 입증이 극히 어렵습니다</strong>. 부동산 매매처럼 금액이 큰 거래에서는 반드시 계약서에 서면으로 기재하고 양 당사자가 서명·날인해야 확실한 보호를 받을 수 있습니다.',
      },
    ],
    cta: {
      text: '💬 내 매매계약서 특약 사항, AI로 빠르게 점검받기',
      link: '/diagnosis/real-estate-sale',
    },
    internalLinks: [
      { label: '홈', href: '/' },
      { label: '부동산 매매 진단', href: '/diagnosis/real-estate-sale' },
      { label: '부동산 매매 사기 의심 시 대처법', href: '/guide/real-estate-sale/sale-fraud-suspicion-response' },
      { label: '등기부등본 보는 법 핵심 정리', href: '/guide/real-estate-sale/registry-document-reading-guide' },
      { label: '부동산 계약 해제 절차 총정리', href: '/guide/real-estate-sale/contract-cancellation-procedure' },
    ],
  },
  {
    domain: 'drug-crime',

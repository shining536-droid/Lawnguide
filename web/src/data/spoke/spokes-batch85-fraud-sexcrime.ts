...
export const spokesBatch85FraudSexCrime: SpokePage[] = [
  ...
  // ─── 2. fraud-monthly-rent-double-contract-deposit-track ───
  {
    ...
    internalLinks: [
      { label: '사기 고소 절차', href: '/guide/fraud/fraud-criminal-complaint-procedure' },
      { label: '부동산 계약 사기 대응', href: '/guide/fraud/fraud-real-estate-deal-track' },
      { label: '계좌 지급정지·피해구제', href: '/guide/fraud/fraud-payment-suspension-relief-track' },
      { label: '기망 고의 입증', href: '/guide/fraud/fraud-deception-intent-track' },
      { label: '보증금 반환 청구', href: '/guide/fraud/fraud-deposit-recovery-track' },
    ],
  },
  ...
  // ─── 4. fraud-romance-overseas-remittance-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '계좌 지급정지·피해구제', href: '/guide/fraud/fraud-payment-suspension-relief-track' },
      { label: '해외송금 사기 추적', href: '/guide/fraud/fraud-overseas-remittance-track' },
      { label: '피해금 환급 절차', href: '/guide/fraud/fraud-victim-refund-procedure' },
    ],
  },
  ...
  // ─── 5. fraud-unlisted-stock-pre-ipo-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '비상장주식 투자 대응', href: '/guide/fraud/fraud-unlisted-stock-response-track' },
      { label: '계좌 지급정지·피해구제', href: '/guide/fraud/fraud-payment-suspension-relief-track' },
      { label: '피해금 환급 절차', href: '/guide/fraud/fraud-victim-refund-procedure' },
    ],
  },
  ...
  // ─── 6. fraud-voice-phishing-cashout-courier-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '보이스피싱 가담 무고 대응', href: '/guide/fraud/fraud-phishing-falsely-accused-track' },
      { label: '고의·공모 다툼', href: '/guide/fraud/fraud-intent-conspiracy-dispute-track' },
  ...
  // ─── 7. sex-crime-taxi-passenger-asleep-track ───
  {
    ...
    internalLinks: [
      { label: '준강제추행 신고 절차', href: '/guide/sex-crime/sex-crime-quasi-indecent-report-procedure' },
      { label: '심신상실·항거불능 입증', href: '/guide/sex-crime/sex-crime-incapacitation-proof-track' },
  ...
  // ─── 8. sex-crime-massage-shop-treatment-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '시술·서비스 중 추행 대응', href: '/guide/sex-crime/sex-crime-service-contact-track' },
      { label: '추행 증거 보전', href: '/guide/sex-crime/sex-crime-evidence-preservation-track' },
      { label: '성범죄 피해자 보호제도', href: '/guide/sex-crime/sex-crime-victim-protection-system' },
      { label: '피해 손해배상 청구', href: '/guide/sex-crime/sex-crime-civil-damages-track' },
    ],
  ...
  // ─── 9. sex-crime-deepfake-synthetic-image-track ───
  {
    ...
    cta: { text: '성범죄 피해 대응 순서, AI로 정리하기', link: '/chat?domain=sex-crime' },
    internalLinks: [
      { label: '딥페이크·합성물 신고 절차', href: '/guide/sex-crime/sex-crime-deepfake-report-procedure' },
      { label: '불법촬영물 삭제·차단', href: '/guide/sex-crime/sex-crime-takedown-blocking-track' },
      { label: '디지털 성범죄 증거 보전', href: '/guide/sex-crime/sex-crime-digital-evidence-track' },
      { label: '성범죄 피해자 보호제도', href: '/guide/sex-crime/sex-crime-victim-protection-system' },
      { label: '피해 손해배상 청구', href: '/guide/sex-crime/sex-crime-civil-damages-track' },
    ],
  },
  ...
  // ─── 10. sex-crime-workplace-superior-contact-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '직장 내 추행 분쟁 대응', href: '/guide/sex-crime/sex-crime-workplace-dispute-track' },

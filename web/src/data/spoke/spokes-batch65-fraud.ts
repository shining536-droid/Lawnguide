...
export const spokesBatch65Fraud: SpokePage[] = [
  ...
  // ─── 2. fraud-funeral-prepay-cancel-refund-refuse-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '필라테스·헬스장 폐업 선결제 환불', href: '/guide/fraud/fraud-pilates-prepay-bankruptcy-installment-defense-track' },
  ...
  // ─── 3. fraud-medical-device-elderly-doortodoor-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '선불카드 대량 할인 판매 사기', href: '/guide/fraud/fraud-prepaid-card-discount-bulk-resale-track' },
  ...
  // ─── 5. fraud-nft-game-item-rugpull-developer-flee-track ───
  {
    ...
    internalLinks: [
      { label: '사기죄 고소 절차 총정리', href: '/guide/fraud/fraud-complaint-procedure-comprehensive' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '코인 에어드롭 시드 탈취', href: '/guide/fraud/fraud-crypto-airdrop-seed-phrase-theft-track' },
      { label: 'SNS 명품 공구 사기', href: '/guide/fraud/fraud-sns-luxury-group-buy-track' },

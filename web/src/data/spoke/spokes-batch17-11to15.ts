...
export const spokesBatch17_11to15: SpokePage[] = [
  ...
  // ── 4. real-estate-sale: 중도금 미지급 시 매도인 대응 방법 ──
  {
    ...
    cases: [
      {
        title: '판례 — 채무불이행을 이유로 한 계약 해제의 요건',
        summary:
          '대법원 2022다246757 사건(대법원, 2022.10.14 선고)에서 법원은 상대방의 채무불이행을 이유로 계약 해제의 의사표시를 했더라도 실제로는 채무불이행의 요건을 갖추지 못한 것으로 밝혀진 경우, 당사자 사이에 분쟁이 있었다는 사정만으로 그 의사표시에 임의해제의 의사까지 포함되어 있다고 볼 수는 없다고 판시했습니다.',
        takeaway:
          '중도금 미지급을 이유로 계약을 해제하려면 상당한 기간을 정해 이행을 최고하는 등 해제 요건을 먼저 갖추는 것이 안전합니다. 요건 없이 성급하게 해제하면 해제 자체가 인정되지 않을 수 있으니 내용증명 등으로 절차를 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {

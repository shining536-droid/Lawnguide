...
export const spokesBatch75DivorceInherit: SpokePage[] = [
  ...
  // ─── 2 divorce-bilingual-bicultural-conflict-track ───
  {
    ...
    internalLinks: [
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
      { label: '양육권 이사 분쟁', href: '/guide/divorce/divorce-custody-relocation-dispute-track' },
  ...
  // ─── 3 divorce-spouse-incarcerated-divorce-track ───
  {
    ...
    internalLinks: [
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
      { label: '친권 양육권 분리 지정 가능성', href: '/guide/divorce/divorce-custody-vs-physical-custody-split' },
  ...
  // ─── 4 divorce-property-trust-foreign-asset-track ───
  {
    ...
    cta: { text: '협의이혼 준비서류, AI로 정리하기', link: '/chat?domain=divorce' },
    internalLinks: [
      { label: '혼인 30년 황혼이혼 재산분할 비율 평가요소', href: '/guide/divorce/divorce-30years-marriage-property-division-ratio' },
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
      { label: '위자료 산정 기준 금액 총정리', href: '/guide/divorce/divorce-alimony-calculation-standard' },
  ...
  // ─── 5 divorce-mental-illness-spouse-care-track ───
  {
    ...
    internalLinks: [
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
      { label: '국제 이혼 자녀 양육권 불법 탈취 대응', href: '/guide/divorce/divorce-international-child-custody-abduction' },
      { label: '사업 채무 재산분할', href: '/guide/divorce/divorce-business-debt-property-division-track' },
      { label: '조부모 면접교섭권 인정 요건 청구 절차', href: '/guide/divorce/divorce-grandparent-visitation-rights-guide' },
      { label: '해외거주 배우자 이혼 절차', href: '/guide/divorce/divorce-overseas-spouse-procedure-track' },
    ],
  },
  ...
  // ─── 6 inheritance-overseas-marriage-spousal-share-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '기여분 다툼', href: '/guide/inheritance/inheritance-contribution-portion-dispute' },
    ],
  },
];

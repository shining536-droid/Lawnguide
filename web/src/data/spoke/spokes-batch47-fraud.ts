...
export const spokesBatch47Fraud: SpokePage[] = [
  // ─── 1. fraud / romance-international-marriage-recovery ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기 자수 자진신고 합의 형 감경', href: '/guide/fraud/fraud-self-surrender-settlement-mitigation' },
    ],
  },
    ...
    faq: [
      {
        ...
        answer:
          '<strong>입금 계좌 추적으로 수사가 진행됩니다.</strong> 플랫폼 주소(가짜여도)·이체 계좌·IP 정보를 경찰이 추적할 수 있어요. 대화 캡처와 이체 계좌번호를 가능한 한 보전해두세요.',
      },
      {
  ...
  // ─── 3. fraud / realtor-deposit-embezzlement ───
  {
    ...
    intro:
      '<p>"중개사가 매도인 대리인이라며 계약금을 직접 받아 가더니 이후 연락이 끊겼어요. 등기부를 떼보니 소유권은 아직 매도인 명의입니다." 공인중개사를 통한 계약금 횡령은 신뢰 기반을 악용하는 전형적 부동산 사기로 검토될 수 있습니다. 형법상 사기죄·횡령죄 고소와 함께 공인중개사 공제조합을 통한 손해보전 절차를 병행하면 피해 회복 가능성을 검토해볼 수 있습니다.</p>',
    sections: [
      {
    ...
    internalLinks: [
      { label: '사기 고소 시 필요한 서류 정리', href: '/guide/fraud/fraud-complaint-required-documents' },
      { label: '월세 이중계약 보증금 편취', href: '/guide/fraud/fraud-monthly-rent-double-contract-deposit-track' },
      { label: '부동산 컨설팅 성공보수 선납 잠적', href: '/guide/fraud/fraud-real-estate-consulting-success-fee-upfront-vanish-track' },
      { label: '보험사기 가담 무고', href: '/guide/fraud/fraud-staged-insurance-claim-falsely-accused-defense' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
    ],
  },

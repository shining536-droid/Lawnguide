...
export const spokesBatch46Nonlabor3: SpokePage[] = [
  ...
  // ─── 3. defamation / doctor-malpractice-review ───
  {
    ...
    internalLinks: [
      ...
      { label: '직장 허위루머 고소 준비', href: '/guide/defamation/defamation-workplace-rumor-complaint-prep' },
    ],
  },
  ...
  // ─── 4. jeonse / tax-arrears-priority-payment ───
  {
    ...
    internalLinks: [
      ...
      { label: '전세보증금 반환 체크리스트', href: '/guide/jeonse/deposit-return-checklist' },
  ...
  // ─── 5. jeonse / monthly-renewal-cap ───
  {
    ...
    internalLinks: [
      ...
      { label: '묵시갱신 중개수수료 부담', href: '/guide/jeonse/jeonse-implicit-renewal-broker-fee-burden' },
      { label: '보증금 월세 환산 한도', href: '/guide/jeonse/jeonse-monthly-rent-conversion-deposit-cap-track' },
      { label: '묵시적 갱신 임대료 인상 요구 거부', href: '/guide/jeonse/jeonse-implicit-renewal-landlord-rent-increase-demand-refuse-track' },
    ],
  },
  ...
  // ─── 7. rehabilitation / card-loan-included ───
  {
    ...
    internalLinks: [
      ...
      { label: '개인회생 실직 변제 중단', href: '/guide/rehabilitation/rehabilitation-job-loss-payment-suspension' },
      { label: '개인회생 신청 중 채권자 추심 중단시키는 방법', href: '/guide/rehabilitation/rehabilitation-creditor-collection-stop' },
      { label: '개인회생 양육비 부양료 납부 의무 면책', href: '/guide/rehabilitation/rehabilitation-alimony-child-support-obligation' },
      { label: '도박 사행성 채무 개인회생 인가 면책 조건', href: '/guide/rehabilitation/rehabilitation-gambling-debt-discharge' },
    ],
  },
  ...
  // ─── 8. bankruptcy / housewife-no-income-eligibility ───
  {
    ...
    internalLinks: [
      ...
      { label: '파산 채권자 누락 면책 여부 3가지 기준', href: '/guide/bankruptcy/bankruptcy-omitted-creditor-discharged' },
  ...
  // ─── 10. stalking / ex-coworker-checklist ───
  {
    ...
    internalLinks: [
      ...
      { label: '스토킹 고소장 필요서류', href: '/guide/stalking/complaint-filing-required-documents' },

...
export const spokesBatch47Dismissal: SpokePage[] = [
    ...
    cases: [
      {
        ...
        summary:
          '대법원 2021두33470 사건(대법원, 2023.12.28 선고)에서 법원은 근무성적이나 근무능력이 불량하다는 이유로 해고하려면 사용자가 교육과 전환배치 등 개선을 위한 기회를 부여했는지 여부를 가능한 한 종합적으로 고려해야 한다고 판시했습니다. 특히 개선 기회 없이 단기간에 이루어진 해고는 정당성이 인정되기 어렵습니다.',
    ...
    faq: [
      {
        ...
        answer:
          '<strong>인정될 수 있습니다.</strong> 장애인차별금지법은 신체적·정신적·지적 장애를 모두 포괄하며 우울증·공황장애도 포함됩니다.',
      },
      {
  ...
  // ─── 5. dismissal / dismissal-overtime-refusal-relief ───
  {
    ...
    faq: [
      {
        question: '주 52시간을 초과하는 야근을 거부하면 원칙적으로 보호받나요?',
        answer:
      ...
      },
      {
        ...
        answer:
          '<strong>구두 해고도 효력이 인정될 수 있습니다.</strong> 통보 날짜를 메모하고, 이후 급여 미지급·사내 시스템 접근 차단 등 해고 징표를 기록해두면 됩니다.',
      },
      {

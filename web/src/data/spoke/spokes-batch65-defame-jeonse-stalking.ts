...
export const spokesBatch65DefameJeonseStalking: SpokePage[] = [
  // ─── 1. defamation-medical-malpractice-online-review-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '직장 동료 험담 유포', href: '/guide/defamation/defamation-coworker-spread-victim' },
  ...
  // ─── 2. defamation-political-public-figure-criticism-comment-track ───
  {
    ...
    internalLinks: [
      { label: '명예훼손 대응', href: '/guide/defamation/defamation-accused-response' },
      { label: '언론 인터뷰 사실적시 공익 명예훼손 무고 방어', href: '/guide/defamation/defamation-media-interview-true-fact-public-interest-falsely-accused-defense' },
  ...
  // ─── 3. defamation-livestream-realtime-record-evidence-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '학원 원장 학부모 단체방 학생 비방', href: '/guide/defamation/defamation-academy-director-student-criticism-parent-chat-bifurcation' },
  ...
  // ─── 4. jeonse-multi-household-officetel-residence-proof-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '전세 보증금 우선변제권 경합', href: '/guide/jeonse/jeonse-deposit-priority-competing' },
  ...
  // ─── 5. jeonse-landlord-tax-arrears-priority-loss-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '임대인 국세 체납 보증금 우선순위', href: '/guide/jeonse/jeonse-landlord-tax-arrears-priority-loss-track' },
      { label: '소액임차인 우선변제 지역별 한도', href: '/guide/jeonse/jeonse-small-amount-tenant-priority-payment-region-cap-track' },
  ...
  // ─── 7. stalking-online-game-real-life-doxxing-track ───
  {
    ...
    internalLinks: [
      { label: '스토킹 종합 가이드', href: '/guide/stalking' },
      { label: '스토킹 잠정조치 긴급응급조치 신청', href: '/guide/stalking/stalking-emergency-protection-order-apply' },
      { label: '스토킹 잠정조치 항고', href: '/guide/stalking/stalking-provisional-measure-appeal-procedure' },
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '스토킹 신고 정상 연락 입증', href: '/guide/stalking/stalking-accused-normal-contact-proof' },
    ],
  },
];

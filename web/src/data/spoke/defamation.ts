...
export const defamationPages: SpokePage[] = [
  {
    ...
    type: '상황형',
    meta: {
      title: '악플 명예훼손 대응 4단계 — 증거 확보부터 손해배상까지 | 로앤가이드',
      description: '온라인 악성 댓글로 명예훼손을 당했다면 스크린샷 확보, 삭제 요청, 형사 고소, 민사 손해배상 4단계로 대응하세요. 고소 기간은 6개월 이내입니다. 지금 확인하세요.',
    },
  ...
  },
  {
    ...
    type: '절차형',
    meta: {
      title: '인터넷 악플 명예훼손 고소 3단계 — 준비 서류 총정리 | 로앤가이드',
      description: '인터넷 커뮤니티 악성 댓글로 명예훼손을 당했다면 증거 수집, 고소장 작성, 경찰 접수 3단계로 진행하세요. 정보통신망법 제70조 기준 처벌과 필요 서류를 정리했습니다. 지금 확인하세요.',
    },
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '사실인데 명예훼손 고소당했을 때 — 형법 310조 방어법 | 로앤가이드',
      description: '사실을 말했는데 명예훼손으로 고소당했다면 형법 제310조 공익목적 면책을 주장할 수 있습니다. 위법성 조각 요건 3가지와 경찰 조사 대응 전략을 정리했습니다. 바로 정리해보세요.',
    },
  ...
  },
  {
    ...
    type: '절차형',
    meta: {
      title: '온라인 모욕죄 고소 — 성립 요건부터 처벌 수위까지 총정리 | 로앤가이드',
      description: '온라인 모욕죄는 공연성 있는 경멸적 표현이 요건입니다. 1년 이하 징역 또는 200만원 이하 벌금에 해당하며 친고죄이므로 6개월 내 고소해야 합니다. 증거 확보법까지 지금 확인하세요.',
    },
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '공익 목적 글인데 명예훼손 고소당했을 때 방어법 | 로앤가이드',
      description: '공익 목적으로 글을 썼는데 명예훼손으로 고소당했다면 형법 제310조 위법성 조각사유를 주장할 수 있습니다. 방어 전략을 지금 확인하세요.',
    },
    ...
    faq: [
      {
        question: '공익 목적으로 쓴 글인데 명예훼손 고소를 당하면 어떻게 방어하나요?',
  ...
  },
  {
    ...
    type: '체크리스트형',
    meta: {
      title: '명예훼손 성립 요건 4가지 체크리스트 | 로앤가이드',
      description: '명예훼손이 성립하려면 공연성, 사실적시, 명예훼손 사실, 위법성 4가지 요건을 모두 충족해야 합니다. 각 요건별 판단 기준과 실무 체크포인트를 정리했습니다. 지금 확인하세요.',
    },
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '정당한 비판인데 명예훼손 고소당했을 때 대응 3단계 | 로앤가이드',
      description: '정당한 비판인데 명예훼손으로 고소당했다면 형법 제310조 면책 요건 확인, 공익성 입증 자료 준비, 경찰 진술 전략 수립 3단계로 대응하세요. 판례별 방어 논리를 바로 정리해보세요.',
    },
    ...
    cases: [
      {
        title: '대법원 2020도16897 — 비판적 표현의 위법성 조각 인정',
        summary: '피고인이 페이스북에 공적 활동을 하는 상대방을 향해 다소 모욕적인 표현을 사용해 모욕 혐의로 기소된 사건에서, 대법원은 그 표현이 모욕죄의 구성요건에는 해당하지만 객관적으로 타당한 사실관계를 전제로 자신의 의견을 강조하는 과정에서 나온 것이라면 사회상규에 위배되지 않아 형법 제20조에 따라 위법성이 조각될 수 있다고 판시했습니다.',
        takeaway: '정당한 비판이 다소 날 선 표현을 담았더라도 사실적 근거와 의견 표명의 맥락을 정리해두면 위법성 조각을 검토해볼 수 있습니다.',
      },
      {
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '직장 내 명예훼손 대응 — 증거 확보부터 고소까지 총정리 | 로앤가이드',
      description: '직장 동료가 허위 사실을 퍼뜨렸다면 사내 메신저·이메일을 즉시 캡처하세요. 내부 고충처리 신청과 형사 고소를 병행할 수 있습니다. 직장 내 명예훼손 단계별 대응법을 지금 확인하세요.',
    },
    intro:
  ...
  },
  {
    ...
    type: 'Q&A형',
    meta: {
      title: '공인 비판 후 명예훼손 고소 — 형법 310조 면책 방어법 | 로앤가이드',
      description: '공인을 비판하다 명예훼손 고소를 당했다면 형법 제310조 공익목적 면책을 주장할 수 있습니다. 공인의 공적 영역 판단 기준, 의견과 사실 구분법, 방어 전략을 정리했습니다. 바로 정리해보세요.',
    },
    intro:
  ...
  },
  {
    ...
    type: '비교형',
    meta: {
      title: '명예훼손 손해배상 금액 — 유형별 위자료 판례 총정리 | 로앤가이드',
      description: '명예훼손 위자료는 온라인 100만~500만원, 언론 보도 500만~3,000만원이 판례 기준입니다. 유형별 인용액, 재산적 손해 입증법, 형사합의금과의 차이를 정리했습니다. 지금 확인하세요.',
    },
    intro:
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '명예훼손 허위 고소 — 무고죄 반대고소 방법 총정리 | 로앤가이드',
      description: '명예훼손으로 허위 고소를 당했다면 무고죄(형법 제156조) 반대고소가 가능합니다. 반대고소 요건, 허위 사실 입증 방법, 민사 손해배상 병행 전략까지 정리했습니다. 바로 정리해보세요.',
    },
    intro:
    ...
    cases: [
      {
        title: '대법원 2021도17744 — 명예훼손 고의·사실 적시가 부정된 사례',
        summary:
          '대법원 2021도17744(대법원, 2022.04.14 선고)에서 법원은 회의 자리에서 상급자의 책임 추궁에 답하는 과정에서 나온 발언은 그 내용·경위·동기에 비추어 명예훼손의 고의를 인정하기 어렵고, 단순한 확인 취지의 소극적 답변은 명예훼손에서 말하는 사실의 적시로 단정할 수 없다고 판시했습니다.',
        takeaway:
          '명예훼손으로 고소당했다면 발언의 맥락·동기와 "사실 적시" 여부가 방어의 핵심 — 대화 경위 자료를 정리해 대응 방향을 검토해볼 수 있습니다.',
      },
      {
        title: '대법원 2014도6377 — 무고죄의 ‘징계처분’ 범위 판단',
        summary:
          '피고인이 사립대학교 교수인 피해자들로 하여금 징계처분을 받게 할 목적으로 국민신문고에 민원을 제기한 사건에서, 대법원은 무고죄에서 말하는 ‘징계처분’은 공법상 감독관계에 근거한 것을 의미하고 학교법인이 사립학교 교원에게 하는 징계는 사법적 법률행위여서 이에 포함되지 않는다고 판시했습니다.',
        takeaway:
          '무고죄로 반대고소를 검토할 때는 상대의 신고가 형사처분이나 공법상 징계처분을 받게 할 목적이었는지 요건부터 정리해볼 수 있습니다.',
      },
    ],
    faq: [
      {
  ...
  },
  {
    ...
    perspective: 'accused',
    meta: {
      title: '명예훼손 고소당했을 때 첫 대응 순서 | 로앤가이드',
      description: '허위사실 적시 vs 사실 적시·위법성 조각·합의 트랙까지 단계별 대응을 확인해보세요.',
    },
    intro: '<p>명예훼손 고소장이 도착했을 때 가장 결정적인 변수는 ① 적시한 내용이 사실인지 ② 공공의 이익 목적이 있는지 ③ 비방 목적이 부재한지 세 가지예요. 사실 적시 + 공익 + 비방 목적 부재가 모이면 위법성이 조각되는 영역이고, 표현 수정·삭제 합의로 종결되는 사례도 다수 있습니다. 정보통신망법 제70조 기준입니다.</p>',

...
export const defamationPages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '공익 목적 글 — 명예훼손 고소 시 위법성 조각 방어법 | 로앤가이드',
      description: '공익 목적으로 작성한 글이 명예훼손으로 고소되었다면 형법 제310조 위법성 조각사유를 적극 주장하세요. 공익성 입증 방법, 의견과 사실 구분, 방어 전략을 정리했습니다. 바로 정리해보세요.',
    },

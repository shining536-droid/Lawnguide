...
export const spokesBatch25_8to14: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    internalLinks: [
      ...
      { label: '해고 통보 받았을 때 첫 24시간 대응', href: '/guide/dismissal/fired-notice-first-24-hours' },
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>회사가 폐업했더라도 사업주 개인에 대해 신고할 수 있습니다.</strong> 다만 사업주에게 지급 능력이 없으면 근로복지공단에 대지급금(최대 1,000만 원)을 신청하는 것이 실질적인 구제 방법입니다.',
      },
    ],
    cta: {

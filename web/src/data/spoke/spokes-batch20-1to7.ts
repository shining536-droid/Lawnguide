...
export const spokesBatch20_1to7: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    cases: [
      {
        title: '재산 은닉·처분 주의 — 정직한 신청서 작성',
        summary:
          '대법원 2001도679 사건(대법원, 2001.05.08 선고)에서 법원은 파산법 제366조 제1호가 정한 "채권자에게 불이익하게 처분을 하는 행위"란 부당한 저가 매매나 무상 증여처럼 은닉·손괴에 견줄 만큼 채권자 전체에게 절대적으로 불이익을 미치는 행위를 뜻하고, 단순히 특정 채권자 1인에게 변제한 것만으로는 원칙적으로 이에 해당하지 않는다고 판시했습니다.',
        takeaway:
          '신청서를 작성할 때는 재산과 채무를 있는 그대로 기재하고, 재산을 몰래 빼돌리거나 헐값에 넘기는 처분은 피하는 것이 안전합니다. 은닉·염가 처분은 면책에 불리하게 작용할 수 있으니 사실대로 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    cases: [
      {
        title: '매매계약의 효력과 소유권이전등기 청구',
        summary:
          '대법원 2025다211003 사건(대법원, 2026.01.08 선고)에서 법원은 법규를 위반해 체결된 계약이라도 그 법규가 효력규정이 아니라 단순 단속규정에 그치는 경우에는 계약의 사법상 효력이 원칙적으로 유효하다고 보고, 입법 취지·보호법익·위반의 중대성 등을 종합해 효력을 판단해야 한다고 판시했습니다.',
        takeaway:
          '매매계약이 유효하게 성립했다면 매수인은 이를 근거로 소유권이전등기 이행을 청구할 수 있습니다. 계약서 문언과 관련 규정을 미리 점검해 계약의 효력에 다툼의 소지가 없는지 확인해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {

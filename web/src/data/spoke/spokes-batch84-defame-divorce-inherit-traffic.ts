...
export const spokesBatch84DefameDivorceInheritTraffic: SpokePage[] = [
  ...
  // ─── 3. divorce-adultery-proof-alimony-track ───
  {
    ...
    internalLinks: [
      { label: '양육비 산정 기준표와 계산 방법', href: '/guide/divorce/child-support-calculation-standard' },
      { label: '배우자 상간자 위자료 공동책임', href: '/guide/divorce/divorce-third-party-adultery-joint-liability-track' },
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
  ...
  // ─── 6. defamation-office-gossip-coworker-track ───
  {
    ...
    internalLinks: [
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '직장 평가앱 비방 글 명예훼손 판단', href: '/guide/defamation/defamation-workplace-blind-app-criticism-track' },
      { label: '학부모 단톡방 모욕 방어', href: '/guide/defamation/defamation-pta-groupchat-insult-charged' },
      { label: '직장 내 허위 소문 명예훼손 입증', href: '/guide/defamation/defamation-false-rumor-workplace-claim' },
  ...
  // ─── 7. defamation-store-review-bombing-track ───
  {
    ...
    cta: { text: '명예훼손 고소당했을 때 대응, AI로 정리하기', link: '/chat?domain=defamation' },
    internalLinks: [
      { label: '의료기관 후기 명예훼손 고소', href: '/guide/defamation/defamation-medical-review-sued-response' },
  ...
  // ─── 8. defamation-anonymous-tip-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '무례한 표현 모욕죄 고소 혐의 방어', href: '/guide/defamation/defamation-rude-expression-not-insult-accused-defense' },
      { label: '회사 내부고발 명예훼손 무고', href: '/guide/defamation/defamation-whistleblower-falsely-accused-defense' },
  ...
  // ─── 10. traffic-accident-pedestrian-crosswalk-fault-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '전동킥보드 인도 주행 보행자 충돌', href: '/guide/traffic-accident/traffic-accident-electric-scooter-sidewalk-pedestrian-collision-track' },

    ...
    faq: [
      {
        ...
        answer:
          '<p>정기 감독은 사전 통보가 있을 수 있으나, 익명신고에 의한 수시 감독은 예고 없이 진행됩니다. 일부 사업주는 사전에 알고 자료를 조작하려 하지만, 이는 추가 위반 사유에 해당합니다.</p>',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>재계약 시 "고정OT 초과분에 대한 차액 지급 조항"을 반드시 포함하도록 요청하세요. 2026년 지침에 따르면 고정OT 약정이 있어도 실제 초과분은 차액을 반드시 지급해야 합니다.</p>',
      },
      {

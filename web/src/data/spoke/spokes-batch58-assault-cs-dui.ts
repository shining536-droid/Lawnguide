    ...
    cases: [
      {
        ...
        summary:
          '서울북부지방법원 2025고단1523 사건(서울북부지방법원, 2025.10.29 선고)에서 법원은 일면식 없는 사람에게 갑자기 침입·공격당한 피고인이 책상 위 고무망치로 1회 가격해 공격에서 벗어난 행위를 정당방위 또는 면책적 과잉방위(형법 제21조 제3항)에 해당해 위법성이 조각된다고 보고 무죄로 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요합니다. 운동경기 중 폭행 사안에서도 형법 제20조 사회상규·정당행위 법리가 유사하게 적용되어, 경기 규칙·관례 범위 내 행위라면 위법성 조각 영역으로 다툼을 검토해볼 수 있습니다.',

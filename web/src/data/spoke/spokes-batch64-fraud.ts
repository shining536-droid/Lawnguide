...
export const spokesBatch64Fraud: SpokePage[] = [
  // ─── 1. fraud-membership-prepay-gym-closure-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '상조서비스 해약 환급 거부', href: '/guide/fraud/fraud-funeral-prepay-cancel-refund-refuse-track' },
    ],
  },
  ...
  // ─── 4. fraud-secondhand-luxury-fake-track ───
  {
    ...
    internalLinks: [
      { label: '사기죄 고소 절차 총정리', href: '/guide/fraud/fraud-complaint-procedure-comprehensive' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '국세환급 사칭 보이스피싱', href: '/guide/fraud/fraud-government-refund-phishing-variant' },

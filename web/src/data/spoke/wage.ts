...
export const wagePages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '야근수당 못 받았는데 지금이라도 받을 수 있나요? | 로앤가이드',
      description:
        '시간외근로 미지급은 3년 시효 안 청구 가능해요. 입증 자료·진정·민사 청구까지 순서대로 확인해보세요.',
    },
    intro:
      '<p>야근수당(시간외근로수당)을 받지 못한 경우 임금채권 시효 3년 안이면 진정 또는 민사 청구가 가능한 영역이에요. 핵심은 출퇴근 로그·이메일 송수신 시각·메신저 야간 업무 지시 같은 실근로시간 입증 자료. 통상임금에 정기상여·식대가 산입되면 산정액이 커지는 사례가 일반적이고, 1350 임금체불 진정은 무료·서면 가능합니다.</p>',

...
export const spokesBatch75WageUnempRetireIa: SpokePage[] = [
  ...
  // ─── 6. industrial-accident1-burnout-mental-comp-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 업무와 질병의 인과관계 증명 기준',
        summary:
          '대법원 2015두3867 사건(대법원, 2017.08.29 선고)에서 법원은 업무상 질병으로 인정하기 위한 업무와 질병 사이의 인과관계는 의학적·자연과학적으로 명백히 증명되어야 하는 것은 아니고 법적·규범적 관점에서 상당인과관계가 인정되면 증명이 있다고 보아야 하며, 그 판단은 사회 평균인이 아니라 질병이 생긴 근로자 본인의 건강과 신체조건을 기준으로 해야 한다고 판시했습니다.',
        takeaway: '업무 스트레스로 인한 정신질환도 업무와의 상당인과관계가 인정되면 산재로 검토될 수 있으므로, 업무량·근무환경·발병 경위를 정리하고 진료 기록을 확보해 요양급여 신청을 준비해볼 수 있습니다.',
      },
    ],
    faq: [
      {

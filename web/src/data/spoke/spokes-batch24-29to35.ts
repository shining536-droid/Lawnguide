...
export const spokesBatch24_29to35: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    slug: 'accident-settlement-fair-amount',
    keyword: '교통사고 합의금 적정 금액',
    questionKeyword: '교통사고 합의금이 적정한지 어떻게 판단하나요?',
    ctaKeyword: '합의금 적정성 확인',
    type: '수치기한형',
    perspective: '피해자',
    meta: {
      title: '교통사고 합의금 적정 금액 — 5가지 산정 기준 | 로앤가이드',
      description:
        '보험사에서 제안한 합의금이 너무 낮은 건 아닌지 불안하다면 항목별 적정 금액 산정 기준을 지금 확인하세요.',
    },
    intro:
      '<p>교통사고를 당하고 치료를 받는 중인데, 보험사에서 합의금을 제안해왔습니다.</p><p>금액이 적당한 건지, 아니면 더 받을 수 있는데 모르고 사인하는 건 아닌지 불안합니다.</p><p>합의금은 치료비, 휴업 손해, 위자료, 향후 치료비 등 여러 항목으로 구성되는데, 보험사는 자체 기준으로 최소 금액을 제시하는 경우가 많습니다.</p><p>합의서에 서명하기 전에 반드시 확인해야 할 5가지 산정 기준을 정리해드립니다.</p>',
    sections: [
      {
        title: '1단계 — 합의금을 구성하는 5가지 항목을 먼저 파악하세요',
        content:
          '<p><strong style="color:#1e3a5f">합의금은 단일 금액이 아니라 치료비·휴업손해·위자료·향후치료비·기타손해를 합산한 금액입니다</strong></p>\n<ul>\n<li><strong>치료비(기왕증 치료비)</strong> — 사고 발생일부터 치료 종결일까지 실제 지출된 병원비·약값·물리치료비 전액을 말합니다. 건강보험 본인부담금뿐 아니라 비급여 항목(MRI, 도수치료 등)도 포함됩니다</li>\n<li><strong>휴업손해</strong> — 사고로 일을 못 한 기간의 소득 손실입니다. 직장인은 급여명세서 기준, 자영업자는 매출·소득자료 기준으로 산정합니다. 무직자도 일용노임 기준으로 청구할 수 있습니다</li>\n<li><strong>위자료</strong> — 정신적 고통에 대한 배상입니다. 부상 정도, 과실비율, 치료 기간 등에 따라 달라지며 보통 상해등급별로 기준표가 있습니다</li>\n<li><strong>향후치료비</strong> — 치료가 종결되지 않았거나 후유장해가 예상되는 경우 향후 발생할 치료비를 현재 가치로 환산해 청구합니다</li>\n<li><strong>기타 손해</strong> — 교통비, 간병비, 차량수리비(또는 시가 감액분) 등이 포함됩니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">합의금 = 치료비 + 휴업손해 + 위자료 + 향후치료비 + 기타 손해</blockquote>',
      },
      {
        title: '2단계 — 보험사 제안 금액과 실제 산정 기준을 비교하세요',
        content:
          '<p><strong style="color:#1e3a5f">보험사는 자체 지급 기준으로 최소 금액을 산정하므로, 법원 판례 기준과 차이가 큽니다</strong></p>\n<ul>\n<li><strong>보험사 기준 vs 법원 기준</strong> — 보험사는 자동차보험 약관과 내부 지급 기준표에 따라 합의금을 산정합니다. 반면 법원은 대한변호사협회 발행 "교통사고 손해배상 산정 기준표"를 참고합니다. 위자료만 해도 보험사 제안과 법원 인정 금액이 2~5배 차이나는 경우가 있습니다</li>\n<li><strong>과실비율 적용</strong> — 보험사가 피해자 과실을 과도하게 산정하면 전체 합의금이 크게 줄어듭니다. 과실비율은 사고 유형별 기본 과실 + 수정 요소로 결정되므로, 도로교통공단 과실비율 인정 기준을 직접 확인해보세요</li>\n<li><strong>치료비 누락 확인</strong> — 비급여 항목, 한방치료, 향후치료비를 보험사가 임의로 제외하는 경우가 있습니다. 진단서와 의무기록을 기준으로 누락 항목을 확인하세요</li>\n<li><strong>합의 전 반드시 할 일</strong> — 치료가 완전히 종결된 뒤 합의하세요. 치료 중 합의하면 후유장해나 추가 치료비를 받을 수 없게 됩니다</li>\n</ul>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>💬 AI 법률 상담으로 빠르게 확인하세요</strong></p>\n<p style="margin:0;font-size:0.95em">변호사 상담 전, AI가 사고 유형별 적정 합의금 범위를 분석해드립니다.</p>\n<a href="/chat?domain=traffic-accident" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '3단계 — 합의가 불리하면 이의 제기 또는 소송을 검토하세요',
        content:
          '<p><strong style="color:#1e3a5f">보험사 합의에 응하지 않아도 되며, 교통사고분쟁심의위원회·손해배상소송으로 적정 금액을 받을 수 있습니다</strong></p>\n<ul>\n<li><strong>교통사고분쟁심의위원회</strong> — 금융감독원 산하 기구로, 보험사와 합의가 되지 않을 때 무료로 조정 신청할 수 있습니다. 조정 결과는 법적 구속력은 없지만 보험사가 수용하는 경우가 많습니다</li>\n<li><strong>손해배상소송</strong> — 조정이 불성립하거나 금액 차이가 크면 민사소송을 제기할 수 있습니다. 소송에서는 법원 기준표에 따라 합의금이 다시 산정되므로 보험사 제안보다 높은 금액을 받는 경우가 많습니다</li>\n<li><strong>소멸시효 주의</strong> — 교통사고 손해배상 청구권은 "손해 및 가해자를 안 날"로부터 3년, 사고일로부터 10년 이내에 행사해야 합니다. 시효가 임박하면 내용증명 발송이나 소제기로 시효를 중단시키세요</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">합의 거부 가능 → 분쟁심의 무료 조정 → 소송으로 법원 기준 산정</blockquote>',
      },
    ],
    cases: [
      {
        title: '대법원 2022다225897 — 보험약관 설명의무 기준',
        summary:
    ...
    faq: [
      {
        question: '보험사 합의금 제안을 거절하면 불이익이 있나요?',
        answer:

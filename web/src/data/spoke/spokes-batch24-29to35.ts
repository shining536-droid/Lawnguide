  ...
  */
  ...
  // ───────────────────────────────────────────
  {
    ...
    internalLinks: [
      ...
      { label: '교통사고 보상 가이드', href: '/guide/traffic-accident/traffic-accident-compensation-calculation-guide' },
  ...
  // ───────────────────────────────────────────
  {
    ...
    intro:
      '<p>경찰의 음주 측정 요구를 거부했습니다. 그 자리에서는 피할 수 있을 거라 생각했지만, 오히려 상황이 더 나빠졌습니다.</p><p>음주 측정 거부는 실제 음주운전보다 더 무거운 처벌을 받을 수 있다는 사실을 뒤늦게 알게 되었습니다.</p><p>도로교통법 제148조의2 제1항 제2호에 따르면 측정 거부 시 1년 이상 6년 이하 징역 또는 500만 원 이상 3천만 원 이하 벌금에 처할 수 있습니다.</p><p>측정 거부 혐의를 받고 있다면, 처벌 기준과 대응 방법을 먼저 확인해보세요.</p>',
    sections: [
      {

...
export const spokesBatch48Dismissal: SpokePage[] = [
  // ─── 1. dismissal / dismissal-pregnancy-rehire-rejected-relief ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>임금이나 직책 격하는 그 자체로 차별행위·불이익 처우에 해당합니다.</strong> 부당해고가 아니더라도 남녀고용평등법 위반 + 손해배상 청구로 다툴 수 있습니다.',
      },
      {
  ...
  // ─── 5. dismissal / dismissal-confidentiality-trade-secret-relief ───
  {
    ...
    intro:
      '<p>"퇴사 의사를 밝힌 직후 거래처 정보를 빼돌렸다는 의혹으로 곧바로 징계해고 통보를 받았습니다." 영업비밀 누설을 이유로 한 해고는 ① 정보가 영업비밀에 해당하는지, ② 본인의 고의·중과실이 있었는지, ③ 비례성 원칙에 부합하는지를 모두 충족해야 정당한 이유로 인정됩니다. 부정경쟁방지법 제2조 제2호의 영업비밀 정의(비공지성·비밀관리성·경제적 가치) 3요건이 핵심 다툼 포인트입니다. 해고일 3개월 이내 노동위 구제신청이 가장 짧은 기한입니다.</p>',
    sections: [
      {

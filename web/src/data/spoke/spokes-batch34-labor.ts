    ...
    cases: [
      {
        ...
        takeaway:
          '고용보험 가입 시기를 놓치면 피보험기간에 산입되지 않아 실업급여 수급에 불이익이 생길 수 있습니다. 장애인 근로자도 입사 후 고용보험 피보험자격 취득 여부를 가능한 한 확인하세요.',
      },
    ],
    faq: [
      {
        ...
        answer:
          '<strong>장애 악화로 근로가 불가능해져 퇴사한 경우 정당한 이직 사유로 인정될 수 있습니다.</strong> 고용보험법 시행규칙 별표2에 따라 본인의 질병·부상으로 계속 근무가 어려운 경우는 비자발적 이직과 동일하게 취급됩니다. 다만 장애 악화를 증명하는 의사 진단서를 가능한 한 첨부해야 합니다.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<strong>구직활동 보고 의무는 있지만 인정 범위가 넓습니다.</strong> 장애인고용공단 상담, 직업능력평가, 직업재활 프로그램 참여가 모두 구직활동으로 인정될 수 있습니다. 거동이 불편한 경우 영상 실업인정도 가능합니다.',
      },
      {
    ...
    cases: [
      {
        ...
        takeaway:
          '시간제·겸직 근로자도 근로조건의 중대한 변경(임금 감소, 근무시간 변경 등)으로 퇴사한 경우 정당한 이직 사유로 인정될 수 있습니다. 근로조건 변경 전후를 비교할 수 있는 자료를 가능한 한 보관하세요.',
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          '<strong>소정급여일수의 1/2 이상을 남기고 재취업하면 조기재취업수당을 받을 수 있습니다.</strong> 재취업한 사업장에서 12개월 이상 계속 근무해야 하며, 시간제 재취업이어도 주 15시간 이상이면 안정적 취업으로 인정될 수 있습니다.',
      },
    ],
    cta: {
    ...
    cases: [
      {
        ...
        takeaway:
          '야간·연장근로수당이 관행적으로 지급되었더라도, 취업규칙이나 단체협약에 명시되어 있지 않으면 평균임금 포함 여부가 다투어질 수 있습니다. 급여규정이나 근로계약서에 수당 지급 근거가 명시되어 있는지 가능한 한 확인하세요.',
      },
    ],
    faq: [
      {
    ...
    faq: [
      {
        ...
        answer:
          '<strong>계약 형식보다 근로 제공의 실질이 중요합니다.</strong> 출퇴근 시간이 정해져 있고, 사용자의 지시를 받아 일했으며, 본인 장비 없이 사업장 시설을 사용했다면 프리랜서가 아닌 근로자로 인정될 수 있습니다. 고용노동부에 근로자성 판단을 요청할 수 있습니다.',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '<strong>수습기간이 아무리 길어도 최저임금 감액은 3개월까지만 허용됩니다.</strong> 4개월째부터는 가능한 한 최저임금 전액을 지급받아야 합니다. 3개월 초과 기간의 감액분은 임금체불로 신고할 수 있습니다.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<strong>최저임금 위반은 고용보험법 시행규칙 별표2의 정당한 이직 사유에 해당할 소지가 있습니다.</strong> 자진 퇴사하더라도 실업급여 수급 자격을 받을 수 있으므로, 최저임금 위반 증거를 확보하여 고용센터에 제출하세요.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>병역법상 "지체 없이" 복직시켜야 하므로 합리적 사유 없는 지연은 복직 거부에 해당할 소지가 있습니다.</strong> 내용증명으로 복직 기한을 설정하고, 기한 내 미이행 시 노동위원회 구제신청과 형사고소를 병행하세요.',
      },
      {
        question: '군 복무 중 회사가 폐업하면 어떻게 되나요?',
        answer:
          '<strong>회사 폐업 시 복직 자체가 불가능하므로 퇴직금과 체불 임금을 청구해야 합니다.</strong> 군 복무 기간이 근속기간에 포함되므로 해당 기간까지 합산한 퇴직금을 받을 수 있습니다. 폐업 시 고용노동부 대지급금 제도를 활용할 수 있습니다.',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '<strong>연장 거부 자체가 해고 사유가 될 수는 없습니다.</strong> 연장을 거부하면 수습기간이 종료되어 정규직으로 전환되는 것이 원칙입니다. 회사가 연장 거부를 이유로 해고하면 부당해고에 해당할 소지가 있습니다.',
      },
      {
      ...
      {
        question: '수습 해고 시 해고예고수당은 가능한 한 받을 수 있나요?',
        answer:

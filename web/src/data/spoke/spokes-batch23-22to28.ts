...
export const spokesBatch23_22to28: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    questionKeyword: '직장 내 성희롱을 당했을 때 어디에 신고하나요?',
    ctaKeyword: '직장 성희롱 신고',
    type: '절차타임라인형',
    perspective: '피해자',
    meta: {
      title: '직장 내 성희롱 신고 절차 5단계 — 기관별 방법 | 로앤가이드',
      description:
        '직장 내 성희롱을 당했지만 어디에 어떻게 신고해야 하는지 모르시겠나요? 사내 신고부터 노동청·인권위까지 5단계 절차를 지금 확인하세요.',
    },
    intro:
      '<p>상사가 반복적으로 성적 발언을 하거나 신체 접촉을 했는데, 참아야 하는 건지 신고를 해야 하는 건지 갈등됩니다.</p><p>신고했다가 회사에서 불이익을 받을까 봐 두렵고, 신고 방법도 복잡해 보입니다.</p><p>하지만 법은 피해자를 보호하기 위한 여러 단계의 창구를 마련해 놓았습니다. 사내 신고부터 국가인권위원회, 고용노동청, 형사 고소까지 상황에 따라 선택할 수 있습니다.</p><p>5단계 절차와 각 단계에서 무엇을 해야 하는지 정리했습니다.</p>',
    timelineSteps: [
      '피해 기록 및 증거 수집',
      '사내 성희롱 고충 신고',
      '사업주 조치 결과 확인',
      '국가인권위원회 진정 또는 고용노동청 신고',
      '형사 고소(강제추행 등 형사 해당 시)',
    ],
    sections: [
      {
        title: '신고 전 — 증거를 먼저 수집하세요',
        content:
          '<p><strong style="color:#1e3a5f">신고하기 전에 증거를 확보하면 조사 결과에 결정적으로 유리합니다</strong></p>\n<ul>\n<li><strong>피해 일지</strong> — 성희롱 행위의 날짜, 시간, 장소, 행위자, 구체적인 발언·행동 내용을 날짜별로 기록합니다. 기억이 흐려지기 전에 당일 또는 다음 날 작성하세요</li>\n<li><strong>디지털 증거</strong> — 카카오톡·이메일·메신저의 성적 발언을 스크린샷으로 저장하고 클라우드에 백업합니다. 삭제될 수 있으므로 원본 저장을 우선시하세요</li>\n<li><strong>녹음</strong> — 본인이 대화 당사자라면 몰래 녹음해도 적법합니다. 반복적으로 성적 발언을 하는 경우 핸드폰 녹음 앱을 활용하세요</li>\n<li><strong>목격자</strong> — 회식이나 사무실에서 목격자가 있었다면 연락처를 파악해 두세요. 동료에게 피해 사실을 알린 카카오톡 기록도 간접 증거가 됩니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">증거 목록: 피해 일지 / 디지털 대화 캡처 / 녹음 / 목격자 연락처 / 동료에게 알린 기록</blockquote>',
      },
      {
        title: '1단계 — 사내 성희롱 고충 신고',
        content:
          '<p><strong style="color:#1e3a5f">남녀고용평등법 제14조는 사업주에게 조사·조치 의무를 부여합니다</strong></p>\n<p>회사 내 고충처리위원회 또는 인사팀에 성희롱 신고를 합니다. 신고는 서면으로 하는 것이 권장됩니다(구두 신고도 가능하지만 기록이 남지 않습니다).</p>\n<ul>\n<li>사업주는 신고를 받으면 <strong>지체 없이 조사</strong>를 실시해야 합니다</li>\n<li>조사 중에는 피해자를 보호하기 위해 <strong>근무 장소 변경, 업무 분리, 유급 휴가</strong> 등 조치를 요청할 수 있습니다</li>\n<li>조사 결과 성희롱이 확인되면 사업주는 행위자에게 <strong>징계, 전보, 그 밖의 조치</strong>를 취해야 합니다</li>\n<li>사업주가 피해자에게 불이익(해고·전보·차별 등)을 주면 <strong>3년 이하 징역 또는 3,000만원 이하 벌금</strong>에 처해집니다</li>\n</ul>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>💬 AI 법률 상담으로 빠르게 확인하세요</strong></p>\n<p style="margin:0;font-size:0.95em">변호사 상담 전, AI가 맞춤 대응 전략을 세워드립니다.</p>\n<a href="/chat?domain=sexual-harassment" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '2단계 — 고용노동청 신고와 국가인권위원회 진정',
        content:
          '<p><strong style="color:#1e3a5f">사내 해결이 안 되거나 불이익을 받은 경우 외부 기관에 신고할 수 있습니다</strong></p>\n<ul>\n<li><strong>고용노동청 신고</strong> — 사업주가 조사를 하지 않거나, 피해자에게 불이익을 준 경우. 고용노동부 고객상담센터(1350) 또는 사업장 소재지 관할 지방고용노동청에 진정을 넣습니다. 사업주에 대한 행정 제재(과태료·시정 명령·고발 등)가 이루어집니다</li>\n<li><strong>국가인권위원회 진정</strong> — 성희롱 행위 자체에 대한 판단을 받고 싶을 때. 피해 발생일로부터 <strong>1년 이내</strong>에 진정을 제기합니다. 인권위는 피해자·행위자 양측을 조사하여 성희롱 해당 여부를 결정하고 권고를 내립니다</li>\n<li><strong>여성가족부 디지털 성희롱 신고센터</strong> — 온라인·메신저를 통한 성희롱의 경우 활용할 수 있습니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">사내 해결 실패 시: 고용노동청(사업주 조치 의무 위반) + 인권위(성희롱 행위 자체 판단)</blockquote>',
      },
      {
        title: '3단계 — 형사 고소(신체 접촉·강제추행이 포함된 경우)',
        content:
          '<p><strong style="color:#1e3a5f">신체 접촉이 수반된 경우 강제추행죄로 형사 고소도 가능합니다</strong></p>\n<p>언어적 성희롱은 형사처벌 대상이 되기 어렵지만, <strong>신체 접촉·강제추행</strong>이 포함된 경우 형사 고소를 병행할 수 있습니다.</p>\n<ul>\n<li><strong>강제추행죄(형법 제298조)</strong> — 10년 이하 징역 또는 1,500만원 이하 벌금. 신체에 대한 불법적인 접촉이 있을 때 적용됩니다</li>\n<li><strong>통신매체이용음란죄(성폭력처벌법 제13조)</strong> — 문자·카카오톡·이메일로 성적 수치심을 주는 내용을 보낸 경우. 대법원 2025도3890 사건에서도 메시지로 전송된 성희롱 사진이 피해아동에게 도달한 것만으로 기수가 성립한다고 판시했습니다</li>\n<li><strong>경찰 고소</strong> — 거주지 또는 피의자 주소지 관할 경찰서에 고소장을 제출합니다</li>\n<li><strong>고소 기한</strong> — 친고죄가 아니므로 기한 제한이 없습니다. 다만 증거가 살아있을 때 빨리 하는 것이 유리합니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">신체 접촉 → 강제추행 형사 고소 / 메시지 성희롱 → 통신매체이용음란죄</blockquote>',
      },
    ],
    cases: [
      {
        title: '대법원 2025도3890 — 메시지 성희롱의 기수 성립 기준',
        summary:
          '대법원 2025도3890 사건(대법원, 2025.07.18. 선고)에서 피고인이 8세 여아에게 성기 사진이 포함된 메시지를 전송한 사안입니다. 법원은 아동이 현실적으로 메시지를 인식하지 못했더라도, 객관적으로 도달하여 인식할 수 있는 상태에 이른 경우 아동복지법 위반 및 통신매체이용음란죄의 기수가 성립한다고 판시했습니다.',
        takeaway:
          '메신저·통신매체를 통한 성희롱은 상대방이 실제로 읽지 않아도 도달만 하면 범죄가 성립합니다. 디지털 성희롱 피해는 메시지 원본을 즉시 보존하고 신고하세요.',
      },
    ],
    faq: [
      {
        question: '신고하면 가해자가 아니라 내가 불이익을 받을까 봐 두려워요.',
        answer:
          '남녀고용평등법 제14조는 <strong>신고를 이유로 한 불이익 조치를 명시적으로 금지</strong>합니다. 불이익을 주면 사업주는 3년 이하 징역 또는 3,000만원 이하 벌금에 처해집니다. 불이익을 받으면 즉시 고용노동청에 추가 신고하세요.',
      },
      {
        question: '사내 신고를 하지 않고 바로 외부 기관에 신고해도 되나요?',
        answer:
          '가능합니다. 사내 신고 없이 <strong>국가인권위원회 진정, 고용노동청 신고, 형사 고소</strong>를 바로 할 수 있습니다. 사내 분위기상 신고가 어렵거나 가해자가 대표인 경우 외부 기관을 먼저 활용하세요.',
      },
      {
        question: '성희롱이라는 증거가 없어도 신고할 수 있나요?',
        answer:
          '할 수 있습니다. 성희롱 사건은 객관적 증거 확보가 어려운 경우가 많아, <strong>피해자의 진술도 중요한 증거</strong>로 인정됩니다. 피해 일지를 성실하게 작성하면 조사 과정에서 유의미한 역할을 합니다.',
      },
      {
        question: '인권위 진정과 고용노동청 신고를 동시에 해도 되나요?',
        answer:
          '가능합니다. 두 기관은 다루는 내용이 다릅니다. <strong>인권위</strong>는 성희롱 행위 자체를 판단하고, <strong>고용노동청</strong>은 사업주의 조치 의무 위반을 제재합니다. 동시 진행하면 보완적으로 활용됩니다.',
      },
      {
        question: '성희롱 피해자도 손해배상을 청구할 수 있나요?',
        answer:
          '가능합니다. <strong>민사소송으로 정신적 손해배상(위자료)</strong>을 청구할 수 있습니다. 가해자 개인과 사업주(사용자 책임) 모두를 상대로 청구할 수 있으며, 인권위 판단이 나오면 민사소송에서 유리하게 활용됩니다.',
      },
    ],
    cta: {
      text: '성희롱 신고 방법과 대응 전략을 AI로 확인하세요',
  ...
  // ───────────────────────────────────────────
  {
    ...
    questionKeyword: '소액소송 소장을 제출하면 어떻게 진행되나요?',
    ctaKeyword: '소액사건 전체 절차 확인',
    type: '절차타임라인형',
    perspective: '피해자',
    meta: {
      title: '소액사건 소장 제출부터 판결까지 6단계 절차 | 로앤가이드',
      description:
        '소액소송 소장을 제출하면 어떻게 진행되는지 몰라서 막막하신가요? 소장 접수부터 강제집행까지 6단계를 지금 확인하세요.',
    },
    intro:
      '<p>거래처가 물품대금 800만원을 4개월째 미루고 있습니다. 내용증명을 두 번이나 보냈지만 묵묵부답입니다.</p><p>소송을 결심했지만 소장을 제출하면 그 다음에 어떻게 되는 건지, 얼마나 걸리는 건지, 변호사가 꼭 있어야 하는 건지 모르는 것투성이입니다.</p><p>소액사건심판법이 적용되는 3,000만원 이하 사건은 절차가 일반 민사소송보다 훨씬 간단합니다. 소장 접수부터 강제집행까지 6단계로 정리했습니다.</p>',
    timelineSteps: [
      '소장 작성 및 법원 접수(전자소송 가능)',
      '이행권고결정 발령(법원 직권)',
      '피고 이의신청 여부 확인(2주)',
      '이의 없으면 확정 / 이의 있으면 변론기일 지정',
      '1회 변론 및 판결 선고',
      '강제집행 신청(채권압류·추심 또는 부동산 경매)',
    ],
    sections: [
      {
        title: '1~2단계 — 소장 접수와 이행권고결정',
        content:
          '<p><strong style="color:#1e3a5f">소장을 접수하면 법원이 자동으로 이행권고결정을 발령합니다</strong></p>\n<p>소액사건심판법 제5조의3에 따라 판사는 소장이 접수되면 상당한 이유가 없는 한 직권으로 <strong>이행권고결정</strong>을 발령합니다. 이는 소액사건에만 있는 제도로, 별도 심리 없이 피고에게 지급을 권고하는 결정입니다.</p>\n<ul>\n<li><strong>소장 제출 방법</strong>: 피고 주소지 관할 법원 민원실에 직접 제출하거나, 대한민국 법원 전자소송(ecfs.scourt.go.kr)에서 온라인 제출. 전자소송은 인지대 10% 할인 혜택이 있습니다</li>\n<li><strong>인지대·송달료</strong>: 청구금액 500만원 기준 인지대 약 2만5천원, 송달료 약 5만원 수준입니다</li>\n<li><strong>소장 양식</strong>: 법원 홈페이지에서 소액사건 소장 양식을 다운로드할 수 있습니다. 청구 취지, 청구 원인, 증거 목록을 작성합니다</li>\n<li><strong>이행권고결정 발령 시기</strong>: 소장 접수 후 통상 1~2주 내에 발령됩니다</li>\n</ul>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>💬 AI 법률 상담으로 빠르게 확인하세요</strong></p>\n<p style="margin:0;font-size:0.95em">변호사 상담 전, AI가 맞춤 대응 전략을 세워드립니다.</p>\n<a href="/chat?domain=small-claims" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '3~4단계 — 이의신청 여부와 변론',
        content:
          '<p><strong style="color:#1e3a5f">피고가 이의하지 않으면 바로 확정됩니다. 이의하면 1회 변론으로 판결합니다</strong></p>\n<ul>\n<li><strong>이의 없는 경우</strong>: 피고가 이행권고결정을 받은 날로부터 <strong>2주 이내에 이의신청을 하지 않으면</strong> 확정판결과 동일한 효력이 발생합니다. 이 경우 소송은 종결되고 강제집행 단계로 바로 넘어갈 수 있습니다</li>\n<li><strong>이의 있는 경우</strong>: 이의신청이 접수되면 사건은 변론절차로 전환됩니다. 법원이 변론기일을 지정하여 통보합니다</li>\n<li><strong>1회 변론 원칙</strong>: 소액사건심판법 제7조에 따라 원칙적으로 <strong>1회 변론기일에 심리를 종결</strong>하고 즉시 판결을 선고합니다. 모든 증거와 주장을 변론기일에 제출해야 합니다</li>\n<li><strong>불출석 시 주의</strong>: 원고가 출석하지 않으면 소 취하 간주, 피고가 출석하지 않으면 자백 간주로 원고 승소 판결이 날 수 있습니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">이의 없음 → 2주 후 확정(집행 가능) / 이의 있음 → 1회 변론 → 즉시 판결</blockquote>',
      },
      {
        title: '5단계 — 판결 후 강제집행 신청',
        content:
          '<p><strong style="color:#1e3a5f">승소해도 상대방이 안 주면 강제집행을 별도로 신청해야 합니다</strong></p>\n<p>이행권고결정 확정 또는 판결 선고 후, 상대방이 자발적으로 돈을 주지 않으면 법원에 강제집행을 신청합니다.</p>\n<ul>\n<li><strong>채권압류 및 추심명령</strong>: 가장 흔한 방법. 상대방의 은행 계좌에 있는 예금을 압류하고 추심합니다. 거래 은행을 알면 바로 신청 가능합니다</li>\n<li><strong>급여 압류</strong>: 상대방이 직장인이면 급여 채권을 압류합니다. 급여의 1/2까지 압류 가능합니다</li>\n<li><strong>부동산 강제경매</strong>: 상대방 명의의 부동산이 있으면 강제경매를 신청할 수 있습니다. 시간이 더 걸리지만 금액이 클 경우 활용합니다</li>\n<li><strong>재산 파악 방법</strong>: 재산조회 신청(법원에 신청, 국세청·지자체·금융기관 조회 가능)으로 상대방 재산을 파악할 수 있습니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">집행 순서: 집행문 부여 신청 → 압류 신청(예금·급여) → 추심명령 → 실제 수령</blockquote>',
      },
      {
        title: '추심명령과 당사자적격 — 판례로 본 주의사항',
        content:
          '<p><strong style="color:#1e3a5f">추심명령이 있어도 채무자가 직접 소송을 제기할 수 있다는 대법원 판례가 있습니다</strong></p>\n<p>대법원 2022다299829 사건에서 법원은 채무자의 채권에 추심명령이 있더라도, <strong>채무자는 피압류채권에 관한 이행의 소를 제기할 당사자적격을 상실하지 않는다</strong>고 판시했습니다. 다만 추심명령을 받은 채권자가 추심소송에서 받은 확정판결의 기판력은 채무자에게도 미칩니다.</p>\n<ul>\n<li>이미 추심명령이 내려진 채권에 대해 채무자가 다시 소송을 제기하면 기판력으로 각하될 수 있습니다</li>\n<li>강제집행 과정에서 복잡한 권리관계가 생기기 전에 소액소송을 먼저 진행하는 것이 유리합니다</li>\n<li>강제집행과 소송이 겹치면 전문가 상담을 통해 절차를 정리하세요</li>\n</ul>\n<p>참고 링크: <a href="/guide/small-claims/small-claims-vs-payment-order-comparison">소액소송 vs 지급명령 비교</a> | <a href="/guide/small-claims/lending-money-not-returned-lawsuit">돈 빌려줬는데 안 갚을 때</a></p>',
      },
    ],
    cases: [
      {
        title: '대법원 2022다299829 — 추심명령 후 채무자 당사자적격',
        summary:
          '대법원 2022다299829 사건(대법원, 2025.12.04. 선고)에서 물품대금 채권에 추심명령이 있은 후 채무자가 제3채무자를 상대로 별도 소송을 제기한 사안입니다. 법원은 추심명령이 있어도 채무자는 피압류채권에 대한 이행의 소를 제기할 당사자적격을 상실하지 않지만, 추심채권자의 확정판결 기판력이 채무자에게도 미친다고 판시했습니다.',
        takeaway:
          '강제집행 중에도 소송 제기 자체는 가능하지만, 이미 확정된 판결의 기판력으로 패소할 수 있습니다. 소송과 강제집행 순서를 신중히 결정하세요.',
      },
    ],
    faq: [
      {
        question: '소장 접수부터 판결까지 얼마나 걸리나요?',
        answer:
          '이행권고결정이 확정되면 <strong>약 1~2개월</strong>이면 종결됩니다. 상대방이 이의를 제기하면 1회 변론까지 포함하여 <strong>3~4개월 내</strong>가 일반적입니다. 상대방이 행방불명이거나 공시송달이 필요한 경우 더 걸릴 수 있습니다.',
      },
      {
        question: '이행권고결정과 지급명령의 차이는 무엇인가요?',
        answer:
          '이행권고결정은 소액사건에서 <strong>소장 접수 시 법원이 자동으로</strong> 발령하는 제도입니다. 지급명령은 채권자가 <strong>별도로 독촉절차를 신청</strong>하는 제도로, 소장 없이도 신청할 수 있습니다. 소액소송에서는 이행권고결정 쪽이 더 효율적인 경우가 많습니다.',
      },
      {
        question: '상대방이 이행권고결정 후 이의신청을 하면 추가 비용이 드나요?',
        answer:
          '이의신청 자체로 추가 비용이 발생하지 않습니다. 사건이 변론절차로 전환되어 기일이 열리지만, 원고 입장에서는 이미 납부한 인지대와 송달료로 계속 진행됩니다.',
      },
      {
        question: '변론기일에 반드시 직접 출석해야 하나요?',
        answer:
          '<strong>소액사건은 본인 출석이 원칙</strong>입니다. 출석하지 않으면 소 취하 간주가 될 수 있으니 반드시 출석하세요. 기일 변경이 필요하면 미리 법원에 기일 변경 신청서를 제출하세요.',
      },
      {
        question: '상대방 은행 계좌를 모르면 압류를 할 수 없나요?',
        answer:
          '<strong>재산조회 신청(금융거래정보 조회)</strong>을 법원에 신청하면 상대방의 금융기관 계좌 정보를 조회할 수 있습니다. 판결 확정 후 집행문을 받아 신청하면 됩니다.',
      },
    ],
    cta: {
      text: '소액소송 절차와 성공 가능성을 AI로 먼저 확인하세요',

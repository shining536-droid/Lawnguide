...
export const spokesBatch19_22to28: SpokePage[] = [
  ...
  },
  {
    ...
    ctaKeyword: '계약금 반환 청구',
    type: '절차타임라인형',
    meta: {
      title: '매매계약 해제 계약금 반환 4단계 — 내용증명부터 소송까지 | 로앤가이드',
      description: '매매계약이 해제됐는데 계약금을 안 돌려준다면, 내용증명부터 소송까지 반환 청구 4단계를 확인하세요. 지금 확인하세요.',
    },
    intro: '부동산 매매계약을 체결하고 계약금까지 보냈는데, 매도인이 계약을 일방적으로 파기했습니다. 계약금 반환을 요구했지만 연락이 끊겼습니다. 매매계약이 해제되면 계약금은 법적으로 반환받을 수 있습니다. 절차를 확인해보세요.',
    timelineSteps: [
      '1단계: 계약 해제 사유 확인 — 누구의 귀책사유인지, 해약금 약정 여부 확인',
      '2단계: 내용증명 발송 — 계약금 반환 청구 + 반환 기한 설정',
      '3단계: 지급명령 또는 민사소송 — 반환 거부 시 법원에 청구',
      '4단계: 강제집행 — 판결·지급명령 확정 후 재산 압류·추심',
    ],
    sections: [
      {
        title: '1단계: 계약 해제 사유와 반환 가능 여부를 확인하세요',
        content:
          '<p><strong style="color:#1e3a5f">민법 제565조에 따라 매수인이 계약금을 교부한 경우, 상대방이 이행에 착수하기 전에는 매수인은 계약금을 포기하고, 매도인은 계약금의 배액을 상환하고 계약을 해제할 수 있습니다</strong></p>\n<p>계약금 반환 가능 여부는 <strong>누구의 귀책사유로 계약이 해제되었는지</strong>에 달려 있습니다.</p>\n<ul>\n<li><strong>매도인 귀책</strong>: 계약금의 배액(2배) 반환 의무</li>\n<li><strong>매수인 귀책</strong>: 계약금 포기 (반환 불가)</li>\n<li><strong>쌍방 합의 해제</strong>: 약정에 따르되, 원상회복으로 계약금 반환</li>\n</ul>\n<p>이미 이행에 착수한 후에는 계약금 해약이 불가능하므로, <strong>이행 착수 시점</strong>(중도금 지급, 소유권이전등기 서류 준비 등)도 확인하세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심 확인: 해제 사유(귀책사유) → 해약금 약정 → 이행 착수 여부</blockquote>',
      },
      {
        title: '2단계: 내용증명으로 계약금 반환을 정식 청구하세요',
        content:
          '<p><strong style="color:#1e3a5f">민법 제548조에 따라 계약이 해제되면 각 당사자는 원상회복의무가 있으며, 금전은 받은 날부터 이자를 붙여 반환해야 합니다</strong></p>\n<p>우체국 또는 전자내용증명으로 <strong>계약금 반환 청구서</strong>를 발송하세요. 반환 금액, 반환 기한(통상 14일), 미반환 시 법적 조치를 취하겠다는 내용을 포함합니다.</p>\n<p>내용증명에 <strong>매매계약서 사본, 계약금 입금 내역, 계약 해제 통보 내역</strong>을 참고자료로 언급하세요. 내용증명 발송 기록은 소송에서 반환 청구의 시작점을 증명하는 핵심 증거입니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">내용증명: 반환 금액·기한 명시 → 미반환 시 법적 조치 예고 → 발송 기록 보관</blockquote>\n<div style="margin-top:16px;padding:14px 18px;background:linear-gradient(135deg,#fff8e1,#fff3cd);border-left:4px solid #f9a825;border-radius:8px">\n<strong style="color:#e65100">지금 바로 확인하세요</strong><br/>\n<a href="/diagnosis/real-estate-sale" style="color:#1565c0;font-weight:600">내 계약금 반환 가능 여부 진단받기 &rarr;</a>\n</div>',
      },
      {
        title: '3단계: 지급명령 또는 민사소송으로 반환을 받으세요',
        content:
          '<p><strong style="color:#1e3a5f">민사소송법 제462조에 따라 금전 지급을 구하는 경우, 지급명령 절차를 이용하면 소송보다 빠르고 간편합니다</strong></p>\n<p>내용증명 후에도 반환하지 않으면 법원에 <strong>지급명령</strong>을 신청하세요. 인지대가 소송의 1/10이고, 상대방이 이의하지 않으면 2~4주 만에 확정됩니다.</p>\n<p>상대방이 이의를 제기하면 자동으로 <strong>민사소송</strong>으로 전환됩니다. 소송에서는 매매계약서, 계약금 입금 증빙, 해제 통보 내역, 내용증명 발송 기록 등을 증거로 제출합니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">법적 절차: 지급명령 신청(빠름, 저렴) → 이의 시 민사소송 전환 → 증거 제출</blockquote>',
      },
      {
        title: '4단계: 판결 확정 후 강제집행으로 돈을 받으세요',
        content:
          '<p><strong style="color:#1e3a5f">민사집행법에 따라 확정된 판결이나 지급명령을 근거로 상대방의 재산(예금·부동산·급여)에 대한 강제집행이 가능합니다</strong></p>\n<p>판결이나 지급명령이 확정되면 <strong>집행문을 부여</strong>받고, 상대방의 은행 예금이나 부동산에 대해 압류·추심명령을 신청합니다.</p>\n<p>상대방의 재산이 파악되지 않으면 법원에 <strong>재산조회</strong>를 신청하세요. 또한 가압류를 미리 해두면 상대방이 재산을 은닉하는 것을 방지할 수 있으므로, <strong>소송 전 가압류 신청</strong>을 적극 검토하세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">강제집행: 집행문 부여 → 예금·부동산 압류 → 재산 불명 시 재산조회 → 가압류 활용</blockquote>',
      },
    ],
    cases: [
      {
        title: '부동산 매매 소유권이전등기청구권 양도의 대항요건 관련 판례',
        summary:
          '대법원 2024다248290 사건(2025.04.24 선고)에서 법원은 부동산 매매로 인한 소유권이전등기청구권은 성질상 양도가 제한되어 채무자(매도인)의 동의나 승낙 없이는 양도의 효력이 발생하지 않으며, 통상의 채권양도와 달리 단순 통지만으로는 대항력이 생기지 않는다고 판시했습니다.',
        takeaway:
          '부동산 매매계약에서 권리 양도가 이루어질 때는 반드시 매도인의 동의가 필요합니다. 계약금 반환을 청구할 때도 계약 당사자가 맞는지, 권리관계가 변동되지 않았는지 확인하세요.',
      },
    ],
    faq: [
      {
        question: '매도인이 이행에 착수한 후에도 계약금을 돌려받을 수 있나요?',
        answer: '이행에 착수한 후에는 <strong>해약금에 의한 해제가 불가</strong>합니다. 다만 매도인의 채무불이행(중도금 수령 후 등기이전 거부 등)이 있으면 법정해제를 통해 원상회복으로 계약금을 반환받을 수 있습니다.',
      },
      {
        question: '계약금 반환에 이자도 붙나요?',
        answer: '민법 제548조 제2항에 따라 <strong>금전은 받은 날부터 이자를 붙여 반환</strong>해야 합니다. 법정이율은 연 5%(상사의 경우 연 6%)이며, 소송 확정 후부터는 연 12%의 지연손해금이 적용됩니다.',
      },
      {
        question: '매도인이 배액배상(2배)을 안 해주면 어떻게 하나요?',
        answer: '매도인 귀책으로 해제된 경우 <strong>계약금의 2배</strong>를 청구할 수 있습니다. 내용증명으로 배액배상을 요구하고, 거부하면 지급명령이나 소송을 통해 강제할 수 있습니다.',
      },
      {
        question: '중개업자에게도 손해배상을 청구할 수 있나요?',
        answer: '중개업자가 <strong>중요 사항을 확인·설명하지 않은 과실</strong>이 있으면 공인중개사법에 따라 손해배상을 청구할 수 있습니다. 중개업자의 공제증서나 보증보험으로 배상받는 것도 가능합니다.',
      },
      {
        question: '가압류를 하면 비용이 얼마나 드나요?',
        answer: '가압류 신청에는 인지대, 송달료(약 <strong>5만~10만원</strong>)와 법원이 정하는 담보금(청구금액의 10~30%)이 필요합니다. 담보금은 본안 소송 승소 후 돌려받을 수 있습니다.',
      },
    ],
    cta: {
      text: '💬 지금 내 계약금 반환 가능 여부 확인하기',
    ...
    internalLinks: [
      ...
      { label: '매매계약 필수 조항 체크리스트', href: '/guide/real-estate-sale/sale-contract-essential-clauses' },
    ],
  },
];

...
export const spokesBatch45Nonlabor1: SpokePage[] = [
    ...
    faq: [
      {
        ...
        answer:
          '<strong>다시보기 종료 전 화면녹화·캡처를 반드시 해두어야 합니다.</strong> 플랫폼에 보전 요청 공문을 보내면 일정 기간 보관해주는 경우도 있습니다.',
      },
      {
  ...
  // ─── 2. fraud / fake-job-deposit-recover ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>전기통신금융사기는 1년 이상 유기징역 또는 10년 이하 징역으로 가중처벌됩니다.</strong> 일반 사기죄(10년 이하 징역)보다 무거운 형량입니다.',
      },
    ],
    cta: {
      text: '사기 고소 전 준비자료, AI로 체크하기',
  ...
  // ─── 3. fraud / rental-deposit-vanish-report ───
  {
    ...
    intro:
      '<p>"계약금 1,000만 원을 입금하고 잔금일을 기다렸는데 임대인이 연락두절입니다." 등기부 권리관계가 정상이라도 처음부터 잔금만 받고 도주할 의도였다면 명백한 사기입니다. 실제 거주가 막힌 임차인은 계약 해제·계약금 반환·형사고소를 동시에 추진해야 환수 가능성이 살아납니다. 잠적 인지 후 7일 안에 등기부 변동·중복계약 흔적부터 확인하세요.</p>',
    sections: [
      {
  ...
  // ─── 10. traffic-accident / trailer-jacknife-fault ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>후유장해 진단은 1~2년 후 확정되는 경우가 많습니다.</strong> 합의 시 "후유증 추가 청구권 유보" 조항을 반드시 명시.',
      },
    ],
    cta: {
      text: '교통사고 합의 전 체크리스트, AI로 정리하기',

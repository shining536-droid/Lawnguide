...
export const spokesBatch45Nonlabor1: SpokePage[] = [
  // ─── 1. fraud / livestream-counterfeit-purchase ───
  {
    ...
    internalLinks: [
      ...
      { label: '해외쇼핑몰 사기 차지백', href: '/guide/fraud/fraud-overseas-shop-card-chargeback' },
      ...
      { label: '사기 일부 변제 합의 감형', href: '/guide/fraud/fraud-partial-repayment-settlement-reduction' },
    ],
  },
  ...
  // ─── 2. fraud / fake-job-deposit-recover ───
  {
    ...
    internalLinks: [
      { label: '취업 사기 교육비 환급', href: '/guide/fraud/fraud-employment-job-offer-deposit-scam' },
  ...
  // ─── 3. fraud / rental-deposit-vanish-report ───
  {
    ...
    internalLinks: [
      ...
      { label: '에어비앤비 가짜 매물 보증금', href: '/guide/fraud/fraud-airbnb-fake-listing-deposit-track' },
    ],
  },
  ...
  // ─── 4. fraud / online-cert-class-refund ───
  {
    ...
    internalLinks: [
      ...
      { label: '라이브 커머스 협찬 미공개 직접사용 가장', href: '/guide/fraud/fraud-livestream-product-review-misleading-undisclosed-paid-track' },
    ],
  },
  ...
  // ─── 5. fraud / deepfake-impersonation-money ───
  {
    ...
    internalLinks: [
      ...
      { label: '댓글 알바 선금 입금 잠적', href: '/guide/fraud/fraud-comment-part-time-advance-deposit-track' },
  ...
  // ─── 7. traffic-accident / cargo-fallen-object-injury ───
  {
    ...
    internalLinks: [
      ...
      { label: '저속 추돌 후유증 청구', href: '/guide/traffic-accident/traffic-accident-low-speed-rear-end-aftereffect' },
    ],
  },
  ...
  // ─── 8. traffic-accident / electric-scooter-pedestrian-injury ───
  {
    ...
    internalLinks: [
      { label: '자배법 의무보험 책임보험금 한도 초과 손해 청구', href: '/guide/traffic-accident/traffic-accident-mandatory-insurance-coverage-limit-excess-claim-track' },
  ...
  // ─── 9. traffic-accident / parked-car-damage-discovery ───
  {
    ...
    internalLinks: [
      ...
      { label: '렌터카 자기부담금 임차인 청구', href: '/guide/traffic-accident/traffic-accident-rental-car-self-cover-claim' },
  ...
  // ─── 10. traffic-accident / trailer-jacknife-fault ───
  {
    ...
    internalLinks: [
      ...
      { label: '합의 후 후유증 추가 청구', href: '/guide/traffic-accident/traffic-accident-aftereffect-additional-claim-settlement' },
      { label: '산악도로 낙석 사고 국가배상', href: '/guide/traffic-accident/traffic-accident-mountain-road-fallen-rock-state-liability-track' },
    ],
  },
];

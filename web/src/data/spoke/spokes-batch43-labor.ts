...
export const spokesBatch43Labor: SpokePage[] = [
  ...
  // ─── 6. wage / team-dinner-mandatory-payment ───
  {
    ...
    internalLinks: [
      { label: '포괄임금 약정 연장수당 미산입 차액', href: '/guide/wage/wage-comprehensive-pay-overtime-not-included-claim-track' },
  ...
  // ─── 7. wage / uniform-cost-deducted-illegal ───
  {
    ...
    internalLinks: [
      ...
      { label: '임금체불 형사고소 절차', href: '/guide/wage/unpaid-wage-criminal-complaint-procedure' },
      { label: '최저임금 미달 임금 차액 청구', href: '/guide/wage/wage-below-minimum-difference-track' },
      { label: '포괄임금 약정 연장수당 미산입 차액', href: '/guide/wage/wage-comprehensive-pay-overtime-not-included-claim-track' },
    ],
  },
  ...
  // ─── 8. wage / training-period-unpaid-legal ───
  {
    ...
    internalLinks: [
      { label: '수습기간 최저임금 위반 신고 구제', href: '/guide/wage/unpaid-wage-probation-minimum-wage-violation' },
  ...
  // ─── 10. retirement / promotion-salary-average-calc ───
  {
    ...
    internalLinks: [
      ...
      { label: '퇴직급여 종합 가이드', href: '/guide/retirement' },
      { label: '격일제 퇴직금 평균임금 산정', href: '/guide/retirement/retirement-alternate-day-shift-calculation' },
  ...
  // ─── 12. unemployment / workplace-closed-sudden-procedure ───
  {
    ...
    internalLinks: [
      { label: '실업급여 종합 가이드', href: '/guide/unemployment' },
      { label: '폐업 권고사직 수급', href: '/guide/unemployment/unemployment-business-closure-separation-track' },
      { label: '실업급여 180일 피보험단위기간 계산', href: '/guide/unemployment/unemployment-180days-insurance-period-calc' },
      { label: '실업급여 신청에서 수급까지 전체 절차', href: '/guide/unemployment/application-to-payment-full-procedure' },
      { label: '건설 일용직 실업급여 신청 방법', href: '/guide/unemployment/unemployment-construction-daily-apply' },
    ],
  },
];

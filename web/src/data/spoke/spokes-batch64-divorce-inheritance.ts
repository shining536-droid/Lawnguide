...
export const spokesBatch64DivorceInheritance: SpokePage[] = [
  ...
  // ─── 3. divorce-child-custody-grandparent-visitation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
      { label: '외국인 배우자 이혼 국제재판 준거법', href: '/guide/divorce/divorce-foreign-spouse-litigation-procedure' },
      { label: '가정폭력 피해자보호명령 우선 이혼 위자료', href: '/guide/divorce/divorce-domestic-violence-protective-order-priority-track' },
      { label: '양육권 주 양육자 친권 판단', href: '/guide/divorce/divorce-child-custody-primary-caregiver-determination-track' },
    ],
  },
  ...
  // ─── 4. divorce-international-asset-hidden-discovery-track ───
  {
    ...
    cta: { text: '재산분할·양육비 쟁점, AI로 먼저 점검하기', link: '/chat?domain=divorce' },
    internalLinks: [
      { label: '장래 퇴직금 재산분할 판단', href: '/guide/divorce/divorce-future-severance-pay-property-division-track' },
      { label: '외국인 배우자 이혼 국제재판 준거법', href: '/guide/divorce/divorce-foreign-spouse-litigation-procedure' },
      { label: '재산분할 직권조사 변론종결일', href: '/guide/divorce/divorce-court-ex-officio-asset-investigation-track' },
  ...
  // ─── 6. inheritance-stepfamily-half-sibling-portion-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '고령 부모 부양 기여분 청구 판단', href: '/guide/inheritance/inheritance-contribution-share-elderly-care-claim-track' },
  ...
  // ─── 7. inheritance-foster-adopted-child-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '유류분 부족분 반환청구 절차', href: '/guide/inheritance/inheritance-forced-heir-share-shortfall-return-claim-track' },
      { label: '한정승인', href: '/guide/inheritance/inheritance-limited-acceptance-preparation' },
      { label: '공동상속인 초과 증여 유류분 반환 판단', href: '/guide/inheritance/inheritance-joint-heir-excess-gift-return-track' },
      { label: '상속포기·승인', href: '/guide/inheritance/inheritance-acceptance-renunciation-decision-track' },
    ],
  },
];

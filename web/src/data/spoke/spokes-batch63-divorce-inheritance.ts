...
export const spokesBatch63DivorceInheritance: SpokePage[] = [
  ...
  // ─── 3. divorce-marriage-annulment-mental-illness-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '배우자 사업체 재산분할', href: '/guide/divorce/divorce-business-entity-asset-division-track' },
    ...
    cases: [
      {
        ...
        summary:
          '대구고등법원 2024나14177(대구고등법원, 2024.10.23 선고) 유류분반환청구 등에서는 유류분 산정 시 상속인이 받은 생전 증여(특별수익)는 기간 제한 없이 산입되고, 그 평가는 증여 시점이 아닌 상속개시 당시 시가를 기준으로 한다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하니, 본인 사건에 적용할 때는 개별 검토를 해볼 수 있습니다.',
    ...
    cases: [
      {
        ...
        summary:
          '유류분 관련 판례 흐름에서는 사망보험금은 수익자 지정이 있으면 수익자의 고유 권리로 상속재산에 포함되지 않으나, 피상속인이 보험료를 납입한 경우 그 보험금은 수익자의 특별수익으로 유류분 산정 시 산입될 여지가 있다고 본 사례 흐름이 있습니다 (대구고등법원 2024나14177 등 유류분 일반 법리 참조, 다만 하급심 판단으로 확정 여부는 별도 확인이 필요합니다).',

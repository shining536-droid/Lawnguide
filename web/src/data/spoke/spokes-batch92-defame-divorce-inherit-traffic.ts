...
export const spokesBatch92DefameDivorceInheritTraffic: SpokePage[] = [
  ...
  // ─── 4. divorce-disposed-asset-substitute-property-division-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 재산분할 기준시기와 기여도를 넘는 소비',
        summary:
          '서울가정법원 95느2952(서울가법, 1996.03.28 선고) 사건에서는 이혼에 따른 재산분할은 부부가 공동의 노력으로 형성·유지한 재산을 기여도에 따라 나누는 것이므로, 공동의 노력이나 기여의 여지가 없었던 기간까지 포함해 계산할 수는 없다고 보았습니다. 그래서 형식적인 이혼 성립 시점이 아니라 실질적으로 부부 공동생활이 유지되던 최초 가출 시점의 재산 상태를 기준으로 삼고, 그 당시 자신의 기여도로 인정되는 것보다 많은 금액을 가지고 나가 소비한 배우자의 재산분할 청구를 받아들이지 않은 사례가 있습니다. 다만 재산분할 기준시기와 처분된 재산의 취급은 사안의 별거 경위와 자료에 따라 달라질 수 있으므로, 별거 시점과 그 무렵 재산 내역을 함께 정리해두는 방향을 검토해볼 수 있습니다.',
        takeaway: '별거 시점과 그 무렵 재산 내역, 처분·소비 경위를 함께 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {

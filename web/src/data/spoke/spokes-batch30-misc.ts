...
export const spokesBatch30Misc: SpokePage[] = [
  ...
  // ── 전세 7. 전세 특약사항 체크리스트 필수 10개 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>보증보험에 가입하면 임대인이 보증금을 돌려주지 않아도 보험사에서 대신 지급합니다. 임대인이 서류 제공을 거부하면 가입이 불가능하므로 반드시 특약으로 명시하세요.</p>',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>합리적인 특약은 양쪽 모두를 보호합니다. 임대인도 시설물 파손 방지 특약 등을 넣을 수 있으므로 상호 조율하세요. 핵심 5개는 반드시 포함하되 나머지는 상황에 맞게 조정합니다.</p>',
      },
      {
  ...
  // ── 전세 8. 전세→월세 전환 시 세입자 권리 보호 ──
  {
    ...
    faq: [
      {
        question: '집주인이 전세를 월세로 바꾸자고 하면 반드시 응해야 하나요?',
        answer:

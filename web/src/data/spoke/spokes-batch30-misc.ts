...
export const spokesBatch30Misc: SpokePage[] = [
  ...
  // ── 양육비 2. 양육비 변경 신청 (소득 변동 시) ──
  {
    ...
    cases: [
      {
        title: '판례 — 자의 복리에 따른 사후 조정',
        summary:
          '대법원 2017스628(대법원, 2021.12.16 선고)에서 법원은 자녀를 직접 양육하지 않는 부모와 자녀가 서로 면접교섭할 권리를 가진다고 하면서도, 자녀의 복리를 위해 필요한 때에는 당사자의 청구나 직권으로 가정법원이 면접교섭을 제한·배제·변경할 수 있다고 판시했습니다. 이혼 후 정해진 자녀 관련 사항도 사정 변화가 있으면 자녀의 복리를 기준으로 다시 조정될 수 있다는 취지입니다. 이러한 흐름에 비추어 양육비 역시 부모의 소득 등 사정이 크게 달라진 경우 변경을 구하는 방안을 검토해볼 수 있으므로, 소득 변동을 뒷받침할 자료를 정리해두는 것이 좋습니다.',
        takeaway:
          '소득 변동을 객관적으로 입증하면 양육비 변경 청구가 받아들여질 수 있는 영역이므로, 건강보험료 변동내역 등 소득 증빙을 준비해 변경 청구를 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {

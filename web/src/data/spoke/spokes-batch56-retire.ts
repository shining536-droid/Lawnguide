    ...
    cases: [
      {
        ...
        summary:
          '대법원 2004다25123(대법원, 2004.12.10 선고)에서 법원은 이사에 대한 퇴직위로금은 재직 중 직무집행의 대가로 지급되는 보수의 일종으로서 상법 제388조의 보수에 포함되고, 정관이나 주주총회에서 이사의 보수·퇴직금을 정하도록 규정한 경우 그에 관한 주주총회 결의가 있었음을 인정할 증거가 없으면 임원 퇴직금을 청구할 수 없다고 판시했습니다. 다만 실질적 1인회사에서 임원 퇴직금 규정에 따른 퇴직금이 실질적 1인 주주의 결재·승인을 거쳐 관행적으로 지급되어 왔다면 주주총회 결의가 있었던 것으로 볼 수 있다고 보았습니다. 재직 1년 미만의 단기 임원이라도 정관·규정·결의 여부에 따라 청구 가능성이 갈릴 수 있으니 관련 자료를 정리해볼 수 있습니다.',
        takeaway: '임원 퇴직금은 정관·주주총회 결의 요건 충족 여부가 핵심. 정관·임원 퇴직금 규정·결의서·관행적 지급 정황을 확보해 청구 가능성을 점검해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          '<strong>주주총회 결의 부재 시 임원 퇴직금 청구권 자체에 다툼이 발생합니다(대법원 2004다25123).</strong> 다만 근로자성 인정 트랙이 결합되면 근로자 퇴직금 규정 적용 영역으로 청구 가능 사례가 있습니다.',
      },
      {

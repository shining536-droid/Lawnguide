    ...
    cases: [
      {
        ...
        summary:
          '서울행정법원 2014구합2270(서울행정법원, 2014.07.03 선고)에서는 실적급이 임금에 포함되는 사업장에서 부서이동으로 실적급 지급구조상 월 평균 임금이 46% 이상 하락하게 되는 등 이직일 전 1년 이내에 2개월 이상 실제 근로조건이 종전보다 낮아질 것이 장래에 확정된 경우로 보아 수급자격이 제한되지 않는 정당한 이직사유에 해당한다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하며, 부서이동으로 임금이 상당 비율 하락한 이직을 검토할 때에도 근로조건 저하의 정도와 장래 확정성을 살펴볼 수 있습니다.',

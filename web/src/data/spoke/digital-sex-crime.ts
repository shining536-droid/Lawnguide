...
export const digitalSexCrimePages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '헤어진 연인이 사적 영상 유포 협박할 때 대처법 | 로앤가이드',
      description: '전 연인이 사적 영상 유포를 협박할 때 성폭력처벌법 제14조 제2항에 따른 증거 확보, 신고, 삭제 지원, 법적 대응 방법을 정리했습니다.',
    },
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '불법촬영 무고 대응법 | 로앤가이드',
      description: '불법촬영을 하지 않았는데 무고당한 경우 형법 제156조 무고죄 반소, 성폭력처벌법 제14조 혐의 방어 전략을 정리했습니다.',
    },

...
export const spokesBatch22_8to14: SpokePage[] = [
    ...
    sections: [
      {
        ...
        content:
          '<p><strong style="color:#1e3a5f">근로자 사망사고가 발생하면 산업안전보건법, 형법, 중대재해처벌법이 동시에 적용될 수 있습니다</strong></p>\n<ul>\n<li><strong>산업안전보건법</strong> — 안전조치·보건조치 의무를 위반하여 근로자를 사망에 이르게 한 경우, 7년 이하의 징역 또는 1억 원 이하의 벌금에 처할 수 있습니다(제167조 제1항). 양벌규정에 따라 법인에도 1억 원 이하의 벌금이 부과됩니다</li>\n<li><strong>형법 제268조(업무상과실치사)</strong> — 업무상 주의의무를 게을리하여 사람을 사망에 이르게 한 경우 5년 이하의 금고 또는 2,000만 원 이하의 벌금에 처할 수 있습니다</li>\n<li><strong>중대재해처벌법</strong> — 경영책임자가 안전보건확보의무를 위반하여 사망사고가 발생한 경우, 1년 이상의 징역 또는 10억 원 이하의 벌금에 처할 수 있습니다. 법인에는 최대 50억 원의 벌금이 부과될 수 있습니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">3가지 법률이 동시 적용 가능 — 가장 무거운 중대재해처벌법은 징역 1년 이상(하한) + 벌금 10억 원 이하</blockquote>',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>과태료 납부와 선임 의무는 별개입니다.</strong> 과태료를 납부하더라도 선임 의무는 계속되며, 시정명령 후에도 미이행하면 과태료가 가중됩니다. 사고 발생 전에 가능한 한 선임을 완료하세요.',
      },
    ],
    cta: {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      {
        question: '야간이나 공휴일 공사는 원칙적으로 불법인가요?',
        answer:
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>취득시효가 완성될 수 있습니다.</strong> 민법 제245조에 따라 20년간 소유의 의사로 평온·공연하게 점유한 경우 소유권 이전등기를 청구할 수 있습니다. 다만 점유 조건이 엄격하므로 가능한 한 법률 상담을 받으세요.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>관리규약에 주차 위반 시 과태료(관리비 부과) 조항이 있으면 가능합니다.</strong> 관리규약에 근거 없이 관리비를 부과하면 부당이득이 될 수 있으므로 가능한 한 규약을 확인하세요.',
      },
      {

...
export const spokesBatch85AssaultDuiJeonseFraud: SpokePage[] = [
  ...
  // ─── 2. assault-bar-drunk-stranger-track ───
  {
    ...
    cta: { text: '폭행 증거 수집 순서, AI로 정리하기', link: '/chat?domain=assault' },
    internalLinks: [
      { label: '정당방위·위법성 조각', href: '/guide/assault/assault-self-defense-standard' },
  ...
  // ─── 4. assault-delivery-rider-customer-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '폭행·상해 고소 절차', href: '/guide/assault/assault-injury-complaint-procedure' },
      { label: '위험한 물건 휴대 판단', href: '/guide/assault/assault-dangerous-object-carry' },
      { label: 'CCTV 영상 확보', href: '/guide/assault/assault-cctv-evidence-secure' },
      { label: '범죄피해자 지원 제도', href: '/guide/assault/assault-victim-support-system' },
    ],
  },
  ...
  // ─── 5. dui-repeat-offense-aggravated-track ───
  {
    ...
    internalLinks: [
      { label: '혈중알코올농도 증명 다툼', href: '/guide/dui/dui-blood-alcohol-proof' },
  ...
  // ─── 6. dui-breath-test-refusal-revocation-track ───
  {
    ...
    cta: { text: '탄원서와 감경 요소, AI로 먼저 정리하기', link: '/chat?domain=dui' },
    internalLinks: [
      { label: '음주측정 거부 성립', href: '/guide/dui/dui-breath-test-refusal-standard' },
      { label: '음주 측정 절차', href: '/guide/dui/dui-breath-test-procedure' },
  ...
  // ─── 7. dui-parked-car-engine-start-track ───
  {
    ...
    cta: { text: '탄원서와 감경 요소, AI로 먼저 정리하기', link: '/chat?domain=dui' },
    internalLinks: [
      { label: '음주운전 운전 성립 기준', href: '/guide/dui/dui-driving-element-standard' },
      { label: '음주 측정 절차', href: '/guide/dui/dui-breath-test-procedure' },
      { label: '음주운전 양형·감경', href: '/guide/dui/dui-sentencing-mitigation-factors' },
      { label: '면허취소·정지 기준', href: '/guide/dui/dui-license-revocation-suspension-standard' },
      { label: '음주운전 행정심판 절차', href: '/guide/dui/dui-administrative-appeal-procedure' },
  ...
  // ─── 8. jeonse-fraud-multi-household-senior-lien-track ───
  {
    ...
    internalLinks: [
      { label: '다가구 선순위 보증금 확인', href: '/guide/jeonse-fraud/jeonse-fraud-multi-household-senior-deposit' },
      { label: '대항요건 존속·전출 위험', href: '/guide/jeonse-fraud/jeonse-fraud-opposing-power-maintenance' },
  ...
  // ─── 9. jeonse-fraud-broker-collusion-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '다가구 선순위 보증금 확인', href: '/guide/jeonse-fraud/jeonse-fraud-multi-household-senior-deposit' },
      { label: '확인·설명서 분쟁', href: '/guide/jeonse-fraud/jeonse-fraud-confirmation-explanation-dispute' },
      { label: '경매 배당요구 절차', href: '/guide/jeonse-fraud/jeonse-fraud-auction-distribution-claim' },
      { label: '보증금반환소송', href: '/guide/jeonse-fraud/jeonse-fraud-deposit-return-lawsuit' },
    ],
  },
  ...
  // ─── 10. jeonse-fraud-mortgage-concealment-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '근저당 고지·설명 분쟁', href: '/guide/jeonse-fraud/jeonse-fraud-mortgage-disclosure-dispute' },
      { label: '보증금반환소송', href: '/guide/jeonse-fraud/jeonse-fraud-deposit-return-lawsuit' },

...
export const duiPages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '준비서류형',
    meta: {
      title: '음주운전 선처 탄원서 작성법과 필요서류 | 로앤가이드',
      description: '음주운전 재판에서 선처를 구하기 위한 탄원서 작성법, 첨부서류 목록, 양형 참작 자료 준비 방법을 정리했습니다.',
    },
  ...
  },
  {
    ...
    type: '어디부터형',
    meta: {
      title: '음주운전으로 적발됐는데 어디부터 해야 할까 | 로앤가이드',
      description: '음주운전 적발 직후 가장 먼저 해야 할 조치, 형사·행정 절차 순서, 불이익을 줄이기 위한 초기 대응을 정리했습니다.',
    },

...
export const duiPages: SpokePage[] = [
  ...
  },
  {
    ...
    cases: [
      {
        title: '대법원 2008도9182 — 음주운전 사고와 위험운전치사상죄',
        summary:
          '대법원 2008도9182(대법원, 2008.12.11 선고)에서 법원은 음주 등으로 정상적인 운전이 곤란한 상태에서 사고를 낸 경우 성립하는 위험운전치사상죄(특정범죄가중처벌법)와 교통사고처리특례법 위반죄가 흡수관계에 있어 음주운전 사고가 하나의 무거운 죄로 평가된다고 판단했습니다. 음주운전은 그 자체로 사고의 중대한 원인으로 다뤄진다는 취지입니다. 따라서 음주운전 차량에 다친 피해자라면 보험사가 제시하는 과실비율을 그대로 받아들이기보다, 가해자의 음주 중과실을 근거로 과실 정도를 다투는 방안을 검토해볼 수 있습니다.',
        takeaway:
          '비슷한 상황이라면 보험사의 과실 주장을 그대로 수용하기 전에, 음주운전 가해자의 중과실을 근거로 과실비율을 다투는 방향을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {

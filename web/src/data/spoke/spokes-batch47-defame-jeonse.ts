...
export const spokesBatch47DefameJeonse: SpokePage[] = [
  // ─── 1. defamation / cafe-id-disclosure-request ───
  {
    ...
    internalLinks: [
      ...
      { label: '익명 게시글 작성자 특정 방법', href: '/guide/defamation/anonymous-post-identify-method' },
      { label: '명예훼손 손해배상 금액 기준과 판례', href: '/guide/defamation/defamation-damages-amount-standard' },
      { label: '온라인 폭로글 신상공개', href: '/guide/defamation/defamation-online-exposure-personal-info-track' },
  ...
  // ─── 2. defamation / job-review-app-defense ───
  {
    ...
    internalLinks: [
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '익명 메시지앱 명예훼손 신원확인', href: '/guide/defamation/defamation-anonymous-app-criminal' },
  ...
  // ─── 4. jeonse / landlord-bankruptcy-priority-payment ───
  {
    ...
    internalLinks: [
      ...
      { label: '보증금 분할반환 합의', href: '/guide/jeonse/jeonse-deposit-installment-return' },
      { label: '소액임차인 우선변제 지역별 한도', href: '/guide/jeonse/jeonse-small-amount-tenant-priority-payment-region-cap-track' },
      { label: '임대인 전출신고 거부 임차권등기', href: '/guide/jeonse/jeonse-landlord-refuse-move-out-transfer-registration-track' },
    ],
  },

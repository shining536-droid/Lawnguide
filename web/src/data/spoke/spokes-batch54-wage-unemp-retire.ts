...
export const spokesBatch54WageUnempRetire: SpokePage[] = [
  ...
  // ─── 7. retirement / retirement-alternate-day-shift-calculation ───
  {
    ...
    cases: [
      {
        title: '판례 — 평균임금에 포함되는 임금의 범위',
        summary:
          '대법원 2002다4399(대법원, 2002.08.23 선고)에서 법원은 운송회사 운전사들이 사납금을 공제하고 남긴 초과 수입금도 근로의 대가인 임금에 해당하지만, 퇴직금 산정의 기초가 되는 평균임금에는 사용자가 관리·지배할 수 있는 부분만 포함된다고 판시했습니다. 근로자가 초과 수입을 개인에게 직접 귀속시켜 회사가 그 금액을 알 수 없는 경우에는 평균임금에서 제외되지만, 회사에 전부 납부한 뒤 다시 지급받는 구조라면 평균임금에 포함된다고 보았습니다. 격일제처럼 임금 구성이 특수한 경우에도 어떤 항목이 평균임금에 들어가는지에 따라 퇴직금 차액이 달라질 수 있으니 이를 정리해볼 수 있습니다.',
        takeaway: '격일제·변동급 근로도 어떤 임금이 평균임금에 포함되는지가 퇴직금 차액의 핵심. 급여명세서와 임금 구성 자료를 모아 평균임금 산정 기준을 점검해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          '<strong>네. 1주 40시간·1일 8시간 초과분 연장수당 누락도 같은 트랙으로 청구 가능합니다.</strong> 통상임금 재산정과 묶으면 차액 규모가 커져요.',
      },
    ],
    cta: { text: '퇴직금 계산과 청구 절차, AI로 정리하기', link: '/chat?domain=retirement' },
    internalLinks: [

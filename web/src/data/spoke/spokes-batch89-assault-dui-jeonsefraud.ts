...
export const spokesBatch89AssaultDuiJeonseFraud: SpokePage[] = [
  // ─── 1. assault-parking-dispute-shove-injury-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '층간소음 항의 이웃 폭행 상해 신고', href: '/guide/assault/assault-floor-noise-complaint-neighbor-strike-report-track' },
  ...
  // ─── 4. assault-nursing-home-caregiver-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '연인 다툼 붙잡음 폭행 무고 방어', href: '/guide/assault/assault-couple-quarrel-grab-false-accusation-defense' },
      { label: '공동주택 엘리베이터 폭행 CCTV', href: '/guide/assault/assault-apartment-elevator-cctv-evidence-track' },
  ...
  // ─── 6. dui-construction-forklift-site-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '음주운전 종합 가이드', href: '/guide/dui' },
      { label: '음주측정거부 가중조항 위헌', href: '/guide/dui/dui-refusal-prior-record-unconstitutional-aggravation-track' },
    ],
  },
  ...
  // ─── 8. jeonse-fraud-officetel-illegal-conversion-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '매수인 임대인 지위 승계 보증금', href: '/guide/jeonse-fraud/jeonse-fraud-new-owner-deposit-takeover-track' },
    ],
  },
  ...
  // ─── 9. jeonse-fraud-corporate-landlord-bankruptcy-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '신축 빌라 깡통전세 우선변제 절차', href: '/guide/jeonse-fraud/jeonse-fraud-new-villa-empty-deposit-priority-track' },
    ],
  },
  ...
  // ─── 10. jeonse-fraud-deposit-loan-bank-collusion-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '선순위 근저당 경매 배당 보증금 회수 절차', href: '/guide/jeonse-fraud/jeonse-fraud-priority-mortgage-auction-distribution-recovery-track' },
      { label: '신축 빌라 감정가 부풀리기 보증금 회수 판단', href: '/guide/jeonse-fraud/jeonse-fraud-new-villa-inflated-appraisal-deposit-track' },
    ],
  },
];

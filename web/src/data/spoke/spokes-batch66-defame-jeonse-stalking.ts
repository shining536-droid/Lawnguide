...
export const spokesBatch66DefameJeonseStalking: SpokePage[] = [
  // ─── 1. defamation-revenge-photo-distribute-threat-accused-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 명예훼손의 공연성과 위법성 조각 기준',
        summary:
          '대법원 2005도2049(대법원, 2006.05.25 선고)에서 법원은 명예훼손죄의 ‘공연성’은 불특정 또는 다수인이 인식할 수 있는 상태를 의미하고, 형법 제310조의 ‘오로지 공공의 이익에 관한 때’에 해당하는지는 적시된 사실의 내용과 성질, 공표 상대방의 범위, 표현 방법 등을 종합해 판단해야 한다고 판시했습니다. 사진이나 글을 여러 사람이 볼 수 있는 형태로 퍼뜨리면 공연성이 인정될 수 있고, 사적 감정에 따른 것이라면 공익 목적도 부정될 수 있습니다. 관련 혐의를 받고 있다면 실제 유포 여부와 그 범위, 표현의 맥락을 정리해 대응을 검토해볼 수 있습니다.',
        takeaway: '관련 혐의를 받고 있다면 실제 유포 여부와 전파 범위, 표현의 맥락을 정리해 대응 방향을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '명예훼손 허위 고소 무고 방어', href: '/guide/defamation/defamation-falsely-accused-counter-fact-disprove-victim-track' },
      { label: 'AI 딥페이크 합성 명예훼손', href: '/guide/defamation/defamation-aiart-deepfake-honor-injury-civil-track' },
    ],
  },
  ...
  // ─── 4. jeonse-landlord-relative-substitute-tenant-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '전세 전입신고 대항력 요건', href: '/guide/jeonse/jeonse-tenant-registration-requirement' },
      { label: '주택임대차 종합 가이드', href: '/guide/jeonse' },
      { label: 'HUG 보증보험 청구 거절 심사 통과', href: '/guide/jeonse/jeonse-hug-guarantee-claim-rejected-review-pass-strategy' },
  ...
  // ─── 6. stalking-workplace-coworker-after-resign-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '온라인 DM 반복 전송 사이버 스토킹 처벌 기준', href: '/guide/stalking/cyber-stalking-repeated-dm' },
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '스토킹 고소당했을때', href: '/guide/stalking/stalking-accused-response' },
    ],
  },
  ...
  // ─── 7. stalking-delivery-rider-customer-info-misuse-track ───
  {
    ...
    internalLinks: [
      { label: '스토킹 종합 가이드', href: '/guide/stalking' },
      { label: '스토킹 잠정조치 긴급응급조치 신청', href: '/guide/stalking/stalking-emergency-protection-order-apply' },
      { label: '동호회 회원 스토킹', href: '/guide/stalking/stalking-club-member-pursuit-procedure' },
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '스토킹 고소당했을 때', href: '/guide/stalking/stalking-accused-where-to-start' },
    ],
  },
];

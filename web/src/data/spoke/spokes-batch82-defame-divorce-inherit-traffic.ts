...
export const spokesBatch82DefameDivorceInheritTraffic: SpokePage[] = [
  // ─── 1. divorce-international-marriage-jurisdiction-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '배우자 부정행위 상간자 손해배상 청구', href: '/guide/divorce/divorce-adultery-third-party-claim-track' },
  ...
  // ─── 8. defamation-workplace-rumor-coworker-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '언론 인터뷰 사실적시 공익 명예훼손 무고 방어', href: '/guide/defamation/defamation-media-interview-true-fact-public-interest-falsely-accused-defense' },
      { label: '직장 상사 갑질 폭로 명예훼손 고소', href: '/guide/defamation/defamation-boss-workplace-abuse-disclosure-accused-track' },
  ...
  // ─── 9. inheritance-overseas-asset-foreign-account-division-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '해외상속재산 신고', href: '/guide/inheritance/inheritance-overseas-asset-inheritance-tax-report' },
    ],
  },
  ...
  // ─── 10. traffic-accident-bicycle-crosswalk-pedestrian-collision-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '공유 자전거 결함 사고', href: '/guide/traffic-accident/traffic-accident-shared-bicycle-rental-defect-liability-track' },

...
export const spokesBatch64DefameJeonseStalking: SpokePage[] = [
  ...
  // ─── 2. defamation-deceased-person-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '온라인 후기 의견 사실적시 구분 명예훼손', href: '/guide/defamation/defamation-online-review-opinion-vs-fact-victim-track' },
      { label: '음식점 별점 테러 명예훼손', href: '/guide/defamation/defamation-business-star-rating-attack-victim' },
      { label: 'AI 딥페이크 합성 명예훼손', href: '/guide/defamation/defamation-aiart-deepfake-honor-injury-civil-track' },
    ],
  },
  ...
  // ─── 3. defamation-online-stalking-mass-comment-track ───
  {
    ...
    cta: { text: '명예훼손 고소당했을 때 대응, AI로 정리하기', link: '/chat?domain=defamation' },
    internalLinks: [
      { label: '유튜브 영상 댓글 명예훼손 고소', href: '/guide/defamation/defamation-youtube-comment-victim-complaint' },
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '학술 표절·왜곡 글로 공격 (학자/저자 입장)', href: '/guide/defamation/defamation-academic-paper-misrepresent-track' },
  ...
  // ─── 4. jeonse-fixed-term-end-renewal-refusal-no-reason-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '전세 월세 전환 적정 전환율 분쟁 대응', href: '/guide/jeonse/jeonse-monthly-rent-conversion-dispute' },
      { label: '근저당 경매 임차인 보증금 우선변제', href: '/guide/jeonse/jeonse-bank-mortgage-foreclosure-deposit-priority-track' },
      { label: '계약갱신 임대료 5% 초과 인상', href: '/guide/jeonse/jeonse-renewal-rent-increase-cap-overrun-track' },
      { label: '전세집 화재 보증금 반환', href: '/guide/jeonse/jeonse-house-fire-damage-deposit-recovery-rebuilding-track' },
    ],
  },
  ...
  // ─── 6. stalking-ex-spouse-child-handover-recontact-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '헤어진 후 연락 스토킹 성립', href: '/guide/stalking/ex-contact-after-breakup-stalking' },
    ],
  },
  ...
  // ─── 7. stalking-online-game-channel-rejection-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '헤어진 연인이 계속 연락할 때 스토킹 해당 여부', href: '/guide/stalking/ex-keeps-contacting-is-it-stalking' },

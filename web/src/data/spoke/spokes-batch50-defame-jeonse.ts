...
export const spokesBatch50DefameJeonse: SpokePage[] = [
  // ─── 1. defamation / online-review-truth-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '의료사고 진료 후기 명예훼손', href: '/guide/defamation/defamation-medical-malpractice-online-review-track' },
  ...
  // ─── 2. defamation / public-figure-criticism-protect ───
  {
    ...
    internalLinks: [
      { label: '명예훼손 고소장 작성 가이드', href: '/guide/defamation/defamation-complaint-writing-guide' },
      { label: '악플로 명예훼손 당했을 때 대응법', href: '/guide/defamation/online-defamation-response' },
      { label: '온라인 상품 후기 악의적 비방 명예훼손 신고', href: '/guide/defamation/defamation-online-product-review-malicious-report-track' },
      { label: '온라인 게시글 삭제 요청 절차', href: '/guide/defamation/defamation-online-post-deletion-request-procedure' },
      { label: '단톡방 모욕·명예훼손 캡처', href: '/guide/defamation/defamation-pta-groupchat-insult-charged' },
    ],
  },
  ...
  // ─── 4. jeonse / deposit-illegal-deduction-fight ───
  {
    ...
    internalLinks: [
      ...
      { label: '임대인 파산 보증금 우선변제', href: '/guide/jeonse/jeonse-landlord-bankruptcy-priority-payment' },
  ...
  // ─── 5. jeonse / tenant-substitute-payment-recovery ───
  {
    ...
    internalLinks: [
      ...
      { label: '계약 만료 1개월 전 통보 갱신 거절', href: '/guide/jeonse/jeonse-one-month-notice-implicit-renewal' },
      { label: '보증금 미반환 임차권등기 후 이사', href: '/guide/jeonse/jeonse-deposit-not-returned-move-out-procedure' },
      { label: '임대인 파산 우선변제권', href: '/guide/jeonse/jeonse-landlord-bankruptcy-priority-payment-track' },
      { label: '보증금 공제 미납 차임 관리비', href: '/guide/jeonse/jeonse-deposit-deduction-unpaid-rent-fee' },
    ],
  },
];

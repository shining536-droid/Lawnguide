...
export const spokesBatch74Traffic: SpokePage[] = [
  // ─── 1. traffic-accident-electric-scooter-pmd-shared-rental-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '전동킥보드 차량 충돌', href: '/guide/traffic-accident/traffic-accident-electric-kickboard-vehicle-collision-track' },
  ...
  // ─── 2. traffic-accident-school-bus-child-passenger-injury-track ───
  {
    ...
    internalLinks: [
      { label: '교통사고 합의금 산정', href: '/guide/traffic-accident/settlement-amount-calculation' },
      { label: '어린이보호구역 12대 중과실 형사', href: '/guide/traffic-accident/traffic-accident-child-zone-12-major-faults-criminal' },
      { label: '전동킥보드 사고 대응', href: '/guide/traffic-accident/traffic-accident-electric-scooter-collision-response' },
      { label: '후유증 추가 청구', href: '/guide/traffic-accident/traffic-accident-post-settlement-additional-claim' },
      { label: '보행자·자전거 교통사고 피해자 합의금 청구 4단계', href: '/guide/traffic-accident/traffic-accident-pedestrian-cyclist-victim-compensation' },
    ],
  },
  ...
  // ─── 3. traffic-accident-construction-truck-falling-cargo-track ───
  {
    ...
    internalLinks: [
      { label: '교통사고 합의금 산정', href: '/guide/traffic-accident/settlement-amount-calculation' },
      { label: '어린이보호구역 12대 중과실 형사', href: '/guide/traffic-accident/traffic-accident-child-zone-12-major-faults-criminal' },
      { label: '전동킥보드 헬멧 미착용 과실', href: '/guide/traffic-accident/traffic-accident-electric-scooter-helmet-fault-gain-track' },
  ...
  // ─── 4. traffic-accident-medical-emergency-driver-faint-collision-track ───
  {
    ...
    internalLinks: [
      { label: '교통사고 합의금 산정', href: '/guide/traffic-accident/settlement-amount-calculation' },
      { label: '어린이보호구역 12대 중과실 형사', href: '/guide/traffic-accident/traffic-accident-child-zone-12-major-faults-criminal' },
      { label: '어린이보호구역 사고 형사처벌', href: '/guide/traffic-accident/traffic-accident-school-zone-criminal-response' },
      { label: '전동킥보드 사고 과실 보상', href: '/guide/traffic-accident/traffic-accident-electric-scooter-liability' },
  ...
  // ─── 5. traffic-accident-snowstorm-blizzard-multi-pileup-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '공유 전동킥보드 PMD 사고 책임', href: '/guide/traffic-accident/traffic-accident-electric-scooter-pmd-shared-rental-track' },
      { label: '자동차 보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
    ],
  },
];

...
export const spokesBatch63DefameJeonseStalking: SpokePage[] = [
  // ─── 1. defamation-momcafe-realname-criticism-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '온라인 커뮤니티 비방글 명예훼손', href: '/guide/defamation/defamation-online-community-post-track' },
      { label: '명예훼손 손해배상 금액 기준과 판례', href: '/guide/defamation/defamation-damages-amount-standard' },
      { label: '방송 보도 후 SNS 2차 가해', href: '/guide/defamation/defamation-broadcast-press-victim-secondary-leak-track' },
      { label: '회사 평가 후기 명예훼손', href: '/guide/defamation/defamation-employee-real-feedback-platform-accused-track' },
    ],
  },
  ...
  // ─── 2. defamation-delivery-rider-customer-review-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 허위사실 유포와 업무방해 판단',
        summary:
          '대법원 2021도6634(대법원, 2021.09.30 선고)에서 법원은 업무방해죄의 ‘허위사실의 유포’란 객관적으로 진실과 부합하지 않는 사실을 유포하는 것으로 단순한 의견이나 가치판단은 이에 해당하지 않고, 의견 표현과 사실 적시가 섞여 있으면 전체적으로 보아 허위사실을 유포해 업무를 방해했는지 판단해야 하며, 중요한 부분이 객관적 사실과 합치되고 세부적으로 다소 과장된 정도에 그친다면 업무방해로 보기 어렵다고 판시했습니다. 배달 서비스에 대한 후기도 실제 경험한 사실인지 허위 사실을 유포한 것인지에 따라 평가가 달라질 수 있습니다. 따라서 후기 내용이 사실에 부합하는지부터 정리해볼 수 있습니다.',
        takeaway: '후기가 실제 사실에 기반했는지, 허위 사실을 유포한 것인지에 따라 명예훼손·업무방해 성립 여부가 갈릴 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '온라인 쇼핑몰 허위 후기 명예훼손 신고', href: '/guide/defamation/defamation-online-shopping-mall-false-review-report-track' },
      { label: '명예훼손 손해배상 금액 기준과 판례', href: '/guide/defamation/defamation-damages-amount-standard' },
      { label: '변호사 의사 평판 플랫폼 별점', href: '/guide/defamation/defamation-lawyer-doctor-rating-platform-track' },
    ],
  },
  ...
  // ─── 3. defamation-lawyer-doctor-rating-platform-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 전문직 평가와 비방 목적 판단',
        summary:
          '대법원 2008도4740(대법원, 2008.09.25 선고)에서 법원은 정보통신망법상 ‘사람을 비방할 목적’은 가해의 의사와 목적을 뜻하고, 적시한 사실의 공공성·사회성과 표현의 목적·방법 등을 종합해 판단해야 하며 주된 목적이 공익을 위한 것이라면 비방 목적이 부정될 수 있다고 판시했습니다. 변호사·의사 등 전문직에 대한 평판 후기도 실제 경험한 사실을 알리려는 것인지, 허위 사실로 깎아내리려는 것인지에 따라 평가가 달라질 수 있습니다. 따라서 후기가 사실에 기반했는지와 그 작성 목적을 함께 정리해볼 수 있습니다.',
        takeaway: '전문직 평가 후기라도 사실 기반·공익 목적인지, 허위로 비방한 것인지에 따라 명예훼손 성립 여부가 갈릴 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '병원 항의 업무방해 명예훼손', href: '/guide/defamation/defamation-hospital-protest-business-interference-track' },
      { label: '명예훼손 손해배상 금액 기준과 판례', href: '/guide/defamation/defamation-damages-amount-standard' },
      { label: '타인 글 공유 재게시 명예훼손 책임 무고 방어', href: '/guide/defamation/defamation-reposting-others-article-liability-falsely-accused-defense' },
      { label: '리뷰 플랫폼 악성 리뷰 삭제', href: '/guide/defamation/defamation-review-platform-malicious-removal' },
    ],
  },
  ...
  // ─── 5. jeonse-broker-deposit-misappropriation-track ───
  {
    ...
    cta: { text: '전세보증금 반환 절차, AI로 정리하기', link: '/chat?domain=jeonse' },
    internalLinks: [
      { label: '전세 중개사 확인의무 위반 배상', href: '/guide/jeonse/jeonse-broker-liability-failure' },
  ...
  // ─── 6. stalking-pt-trainer-member-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '스토킹 잠정조치 위반 대응', href: '/guide/stalking/stalking-emergency-measure-violation-response' },
      { label: '스토킹 증거 수집할 때 흔히 하는 실수', href: '/guide/stalking/evidence-collection-common-mistakes' },
      { label: '직장 상사 스토킹 회사 사용자책임', href: '/guide/stalking/stalking-supervisor-employer-vicarious-liability-occupational-safety-track' },
      { label: '소액소송 vs 지급명령 어떤 게 유리한가', href: '/guide/small-claims/small-claims-vs-payment-order-comparison' },
    ],
  },

...
export const spokesBatch67WageUnempRetire: SpokePage[] = [
  ...
  // ─── 2. wage-yearend-bonus-customary-revoke-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '관행적 보너스 지급 거부', href: '/guide/wage/wage-bonus-customary-payment-refusal-track' },
    ],
  },
  ...
  // ─── 3. unemployment-private-academy-instructor-contract-end-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '구직활동 인정 거절 이의 재제출', href: '/guide/unemployment/unemployment-job-search-activity-recognition-rejected-objection-track' },
    ],
  },
  ...
  // ─── 4. retirement-foreign-currency-bonus-fluctuation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '통상임금 상여금 포함', href: '/guide/wage/wage-ordinary-wage-bonus-inclusion-track' },
  ...
  // ─── 5. retirement-meal-card-prepaid-welfare-included-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '퇴직금 중간정산 무효 재산정 판단', href: '/guide/retirement/retirement-pay-interim-settlement-invalid-recalculation-track' },
      { label: '퇴직금 시효', href: '/guide/retirement/retirement-statute-of-limitations' },
    ],
  },
];

...
export const spokesBatch56Inheritance: SpokePage[] = [
  // ─── 1. inheritance / inheritance-de-facto-spouse-no-right ───
  {
    ...
    cases: [
      {
        title: '판례 — 상속재산과 고유재산의 구별',
        summary:
          '대법원 2017스516(대법원, 2019.05.17 선고)에서 법원은 고인이 사망 전에 배우자를 급여 수급권자로 지정한 퇴직생활급여는 그 배우자가 독자적으로 수령할 권한이 있는 고유재산이므로 상속재산의 범위에 포함되지 않는다고 판시했습니다. 어떤 재산이 상속재산인지, 특정인의 고유재산인지에 따라 회수 방법이 달라진다는 취지입니다. 사실혼 배우자는 상속인은 아니지만, 공동으로 형성한 재산과 상속재산의 경계를 정리해두면 재산분할·임차권 승계 등 가능한 회수 경로를 검토해볼 수 있습니다.',
        takeaway: '사실혼 배우자는 상속권은 없지만 공동형성 재산·임차권 승계·유족연금 등 다른 경로를 검토해볼 수 있음. 상속재산과 고유재산의 경계를 가르는 자료부터 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {

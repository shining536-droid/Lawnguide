...
export const spokesBatch39Nonlabor2: SpokePage[] = [
  ...
  // ─── 3. rehabilitation / monthly-payment-adjustment ───
  {
    ...
    internalLinks: [
      { label: '개인회생 신청 절차 A to Z', href: '/guide/rehabilitation/rehabilitation-application-procedure-atoz' },
      { label: '회생 변제금 미납 결과 대응', href: '/guide/rehabilitation/rehabilitation-payment-default-consequences' },
      { label: '회생 자격 요건', href: '/guide/rehabilitation/rehabilitation-eligibility-requirements-faq' },
  ...
  // ─── 4. bankruptcy / credit-recovery-steps ───
  {
    ...
    internalLinks: [
      ...
      { label: '개인파산 종합 가이드', href: '/guide/bankruptcy' },
      { label: '파산 면책 보유 가능 재산', href: '/guide/bankruptcy/bankruptcy-personal-property-exempt' },
      { label: '파산 신청 시 압류 해제되는 재산과 절차', href: '/guide/bankruptcy/bankruptcy-seizure-release-process' },
    ],
  },
  ...
  // ─── 5. inheritance / limited-acceptance-preparation ───
  {
    ...
    perspective: 'victim',
    meta: {
      title: '한정승인 준비서류, 무엇부터 챙겨야 하나요? | 로앤가이드',
      description:
        '한정승인 신청 전 사망진단서·재산목록·채무자료까지 단계별 준비물을 확인해보세요. 3개월 시한도 함께 정리했습니다.',
    },
    intro:
      '<p>한정승인은 상속재산 한도 안에서만 채무를 책임지는 절차로, 사망을 안 날부터 3개월 안에 가정법원에 신청해야 하는 영역이에요. 신청 전 사망진단서·재산목록·채무자료를 미리 챙기면 절차가 훨씬 매끄럽고, 시한 도과 시에는 특별한정승인 트랙으로 회복 가능한 사례가 있습니다. 민법 제1019조 기준입니다.</p>',
    sections: [
      {
    ...
    internalLinks: [
      ...
      { label: '상속 3개월 후 채무 발견 특별한정승인 절차', href: '/guide/inheritance/inheritance-renunciation-after-3months-late-debt-discovery-track' },
      { label: '상속 등기 절차와 필요 서류 총정리', href: '/guide/inheritance/inheritance-registration-procedure-docs' },
    ],
  },
  ...
  // ─── 6. inheritance / renunciation-vs-limited-comparison ───
  {
    ...
    internalLinks: [
      ...
      { label: '한정승인 가이드', href: '/guide/inheritance/inheritance-limited-acceptance-post-debt' },
      { label: '상속 3개월 후 채무 발견 특별한정승인 절차', href: '/guide/inheritance/inheritance-renunciation-after-3months-late-debt-discovery-track' },
      { label: '빚 더 많은 한정승인 신청', href: '/guide/inheritance/inheritance-debt-larger-limited-acceptance' },
  ...
  // ─── 8. defamation / employer-review-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '회사 리뷰 플랫폼 허위 글 명예훼손 신고', href: '/guide/defamation/defamation-company-review-platform-false-post-report-track' },
  ...
  // ─── 9. stalking / victim-restraining-petition ───
  {
    ...
    perspective: 'victim',
    meta: {
      title: '스토킹 피해 — 접근금지 어떻게 신청하나요? 5단계 | 로앤가이드',
      description:

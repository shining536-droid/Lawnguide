...
export const retirementPages: SpokePage[] = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: '노동청 근로감독관이 <strong>실질적 근로관계</strong> 여부를 판단합니다. 출퇴근 시간 지정, 업무 지시, 보수의 정기성 등이 있으면 근로자로 인정됩니다.',
      },
      {

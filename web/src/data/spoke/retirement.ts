...
export const retirementPages: SpokePage[] = [
  {
    ...
    type: '절차형',
    meta: {
      title: '퇴직금 안 줄 때 신고하는 방법 | 로앤가이드',
      description: '퇴직금 미지급 시 노동청 신고 절차, 필요 서류, 체당금 제도를 정리했습니다.',
    },
  ...
  },
  {
    ...
    type: '수치기한형',
    meta: {
      title: '퇴직금 계산 기준과 확인 방법 | 로앤가이드',
      description: '퇴직금 산정 기준, 평균임금 계산법, 포함 항목, 확인 방법을 정리했습니다.',
    },

...
export const spokesBatch83AssaultDuiJeonseFraud: SpokePage[] = [
  // ─── 1. assault-bar-drunk-customer-confrontation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '술집 보안요원 손님 부상', href: '/guide/assault/assault-bouncer-customer-injury-defense-track' },
  ...
  // ─── 2. assault-road-rage-stop-exit-confrontation-track ───
  {
    ...
    cta: { text: '폭행 증거 수집 순서, AI로 정리하기', link: '/chat?domain=assault' },
    internalLinks: [
      { label: '특수폭행 흉기 위험한 물건 가중 분기', href: '/guide/assault/assault-armed-special-aggravated-weapon-bring-distinction' },
      { label: '보복운전 끼어들기 운전자 폭행 상해 신고', href: '/guide/assault/assault-road-rage-cut-in-driver-strike-report-track' },
      { label: '폭행 종합 가이드', href: '/guide/assault' },
      { label: '공동주택 엘리베이터 폭행 CCTV', href: '/guide/assault/assault-apartment-elevator-cctv-evidence-track' },
      { label: '폭행 합의금 기준', href: '/guide/assault/assault-settlement-amount-standard' },
    ],
  ...
  // ─── 3. assault-school-parent-staff-confrontation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '학부모 교사 폭행', href: '/guide/assault/assault-parent-teacher-school-track' },
  ...
  // ─── 6. dui-morning-after-residual-alcohol-track ───
  {
    ...
    cta: { text: '탄원서와 감경 요소, AI로 먼저 정리하기', link: '/chat?domain=dui' },
    internalLinks: [
      { label: '숙취 다음날 잔존 알코올 음주운전 여부', href: '/guide/dui/dui-morning-after-residual-alcohol-falsely-accused-defense' },
  ...
  // ─── 9. jeonse-fraud-senior-mortgage-underwater-deposit-track ───
  {
    ...
    internalLinks: [
      { label: '신축 빌라 분양 보증금 회수 판단', href: '/guide/jeonse-fraud/jeonse-fraud-new-villa-presale-deposit-recovery-track' },
      { label: '중개사 보증금 전세사기 주의의무', href: '/guide/jeonse-fraud/jeonse-fraud-agent-embezzlement-track' },
      ...
      { label: '법인 임대인 도산 보증금 회수 판단', href: '/guide/jeonse-fraud/jeonse-fraud-corporate-landlord-insolvency-deposit-track' },
    ],
  },
  ...
  // ─── 10. jeonse-fraud-double-contract-broker-collusion-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '이중계약 중개사 전세사기', href: '/guide/jeonse-fraud/jeonse-fraud-double-contract-broker-track' },
      { label: '전세사기 고소장 작성 방법', href: '/guide/jeonse-fraud/jeonse-fraud-complaint-writing' },
      { label: '법인 임차 직원 거주 대항력', href: '/guide/jeonse-fraud/jeonse-fraud-corporate-tenant-opposing-power-track' },
      { label: '전세대출 임대인 잠적 보증금', href: '/guide/jeonse-fraud/jeonse-fraud-deposit-loan-absconding-track' },
    ],
  },
];

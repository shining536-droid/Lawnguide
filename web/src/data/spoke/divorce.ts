    ...
    sections: [
      {
        ...
        content:
          '<p><strong style="color:#1e3a5f">상대방이 동의한다면 협의이혼으로 빠르게 정리할 수 있습니다</strong></p>\n<p>부부 둘 다 "이혼하자"는 데 동의하고 있다면 협의이혼을 선택할 수 있습니다. <strong>가정법원</strong>에 이혼의사 확인을 신청한 뒤 숙려기간을 거치고, 법원에서 최종 확인을 받으면 이혼신고로 마무리됩니다. 양육할 자녀가 있으면 숙려기간이 <strong>3개월</strong>, 없으면 <strong>1개월</strong>입니다(민법 제836조의2). 이 기간 동안 재산분할이나 양육비에 대해 합의하는 경우가 많습니다. 변호사 없이도 진행할 수 있어 비용 부담이 적고, 전체적으로 <strong>1~4개월</strong>이면 마무리되는 편입니다. 다만, 재산분할이나 양육권에 대한 합의가 안 되면 이혼 자체는 되더라도 나머지는 별도 소송으로 가야 할 수 있으니 합의 내용을 꼼꼼히 정리해두는 것이 좋습니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">준비: 혼인관계증명서, 이혼의사확인 신청서, 양육사항 협의서(자녀 있는 경우)</blockquote>',
      },
      {
    ...
    sections: [
      {
        ...
        content:
          '<p><strong style="color:#1e3a5f">혼인관계증명서와 가족관계증명서를 가장 먼저 준비하세요</strong></p>\n<p>이혼 상담의 출발점은 "지금 법적으로 혼인 상태인지"를 확인하는 것입니다. <strong>혼인관계증명서</strong>는 현재 혼인 상태를, <strong>가족관계증명서</strong>는 자녀 유무와 가족 구성을 보여줍니다. 주민등록등본도 현재 거주지와 세대 구성을 확인하는 데 필요합니다. 정부24나 주민센터에서 발급받을 수 있으며, "상세" 증명서로 떼면 과거 이력까지 나옵니다. 이 세 장만 있어도 상담사가 기본 상황을 빠르게 파악할 수 있으니 반드시 준비해보세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">준비: 혼인관계증명서(상세), 가족관계증명서(상세), 주민등록등본</blockquote>',
      },
      {

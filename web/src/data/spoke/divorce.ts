...
export const divorcePages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '수치기한형',
    meta: {
      title: '위자료 부당 청구 방어 기한과 금액 기준 | 로앤가이드',
      description:
        '상대방이 과도한 위자료를 청구했을 때 방어 방법, 답변서 기한, 판례별 위자료 금액 기준, 감액 전략을 정리했습니다.',
    },
    intro:
  ...
  },
  {
    ...
    type: '체크리스트형',
    meta: {
      title: '이혼 재산분할 재산은닉 방어 체크리스트 | 로앤가이드',
      description:
        '이혼 재산분할에서 재산은닉 의심을 받고 있을 때 방어 방법, 특유재산 주장, 금융재산조회 대응, 가처분 절차를 정리했습니다.',
    },
    intro:
  ...
  },
  {
    ...
    type: '어디부터형',
    meta: {
      title: '이혼을 결심했는데 어디부터 시작해야 할까 | 로앤가이드',
      description:
        '이혼 결심 후 첫 단계부터 전략 수립까지 순서대로 안내합니다. 협의이혼과 재판이혼 선택, 증거 확보, 변호사 상담 준비법을 확인하세요.',
    },
    intro:

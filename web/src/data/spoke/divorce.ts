...
export const divorcePages: SpokePage[] = [
  {
    ...
    intro:
      '남편과 대화가 끊긴 지 6개월이 넘었습니다. 이제 정리를 하고 싶은데, 협의이혼을 해야 하는지 재판이혼을 해야 하는지부터 막막합니다. 아이 둘의 양육권, 아파트 재산분할, 위자료까지 생각하면 머리가 복잡해집니다. 이런 상황이라면 두 절차의 차이를 먼저 정리해보는 것이 좋습니다.',
    sections: [
      {
        title: '상대방이 이혼에 동의한다면 — 협의이혼으로 빠르게 정리할 수 있습니다',
        content:
          '부부 둘 다 "이혼하자"는 데 동의하고 있다면 협의이혼을 선택할 수 있습니다. 가정법원에 이혼의사 확인을 신청한 뒤 숙려기간을 거치고, 법원에서 최종 확인을 받으면 이혼신고로 마무리됩니다. 양육할 자녀가 있으면 숙려기간이 3개월, 없으면 1개월입니다(민법 제836조의2). 이 기간 동안 재산분할이나 양육비에 대해 합의하는 경우가 많습니다. 변호사 없이도 진행할 수 있어 비용 부담이 적고, 전체적으로 1~4개월이면 마무리되는 편입니다. 다만, 재산분할이나 양육권에 대한 합의가 안 되면 이혼 자체는 되더라도 나머지는 별도 소송으로 가야 할 수 있으니 합의 내용을 꼼꼼히 정리해두는 것이 좋습니다.',
      },
      {
      ...
      },
      {
        ...
        content:
          '협의이혼에서는 부부가 직접 재산 목록을 정리하고 분할 비율을 합의합니다. "아파트는 내가 갖고 대출은 네가 갚는다" 같은 식이죠. 합의가 안 되면 이혼 후 2년 이내에 별도로 청구할 수 있습니다(민법 제839조의2). 재판이혼에서는 법원이 혼인 기간, 재산 형성 기여도, 부채 상황 등을 종합적으로 따져서 분할 비율을 정합니다. 전업주부의 가사노동도 기여도로 인정되는 경우가 많으므로, 소득이 없더라도 재산분할 청구를 포기하지 않는 것이 좋습니다. 어떤 절차를 선택하든 부부 명의 재산과 부채를 먼저 정리해두면 협상이나 소송에서 유리합니다.',
      },
      {
        title: '아이가 있을 때 — 양육권과 양육비, 언제 정해야 하나요',
        content:
          '미성년 자녀가 있다면 양육권자 지정이 필수입니다. 협의이혼에서는 부부가 합의해서 정하고, 합의가 안 되면 법원이 결정합니다. 재판이혼에서는 법원이 자녀의 연령, 의사, 양육환경, 부모의 양육 능력을 종합적으로 고려해서 판단합니다(민법 제837조). 양육비는 서울가정법원 양육비 산정기준표를 참고하면 대략적인 금액을 확인해볼 수 있습니다. 면접교섭(비양육 부모의 만남 권리)도 함께 정해두는 것이 좋습니다. 나중에 다투지 않으려면 양육비 금액, 지급일, 면접교섭 빈도까지 구체적으로 합의서에 적어두세요.',
      },
      {
        title: '내 상황에서 어떤 절차가 맞을까 — 판단 기준 정리',
        content:
          '이혼 자체에는 동의하지만 조건(재산, 양육권)에서 이견이 있다면, 일단 협의이혼을 진행하고 나머지는 별도 소송으로 해결하는 방법도 있습니다. 상대방이 이혼을 완전히 거부하거나, 폭력·외도 등으로 위자료를 청구하고 싶다면 재판이혼이 더 적합합니다. 급한 경우(폭력, 스토킹)에는 법원에 접근금지 가처분을 먼저 신청하는 것도 검토해보세요. 비용, 기간, 정서적 부담을 모두 고려해서 선택하되, 판단이 어렵다면 법률구조공단(전화 132) 무료 상담을 활용해보는 것이 좋습니다.',
      },
    ],
    comparison: {
    ...
    faq: [
      {
        ...
        answer:
          '협의이혼은 숙려기간 포함 1~4개월, 재판이혼은 6개월~2년 이상 걸릴 수 있습니다. 자녀 유무, 재산 규모, 상대방의 태도에 따라 달라지므로 본인 상황을 기준으로 확인해보세요.',
      },
      {
        question: '배우자가 이혼을 거부하면 어떻게 하나요?',
        answer:
          '상대방이 동의하지 않으면 협의이혼은 불가능합니다. 민법 제840조의 이혼 사유(부정행위, 유기, 폭력 등)에 해당하는지 확인하고, 해당된다면 재판이혼을 검토해보세요.',
      },
      {
        question: '이혼 비용이 얼마나 드나요?',
        answer:
          '협의이혼은 법원 수수료가 소액이고 변호사 없이도 가능합니다. 재판이혼은 소송인지대·송달료에 변호사 비용까지 합하면 수백만 원 이상 들 수 있습니다. 법률구조공단에서 소득 기준에 따라 무료 지원을 받을 수 있으니 확인해보세요.',
      },
      {
        question: '전업주부인데 재산분할을 받을 수 있나요?',
        answer:
          '가사노동과 양육으로 재산 형성에 기여한 부분이 인정되므로 소득이 없어도 재산분할 청구가 가능합니다. 혼인 기간 중 가사·양육에 참여한 내역을 구체적으로 정리해보세요.',
      },
      {
        question: '아이를 내가 키우고 싶은데 어떻게 해야 하나요?',
        answer:
          '법원은 자녀의 복리를 최우선으로 봅니다. 현재 누가 주로 양육하고 있는지, 양육환경이 안정적인지, 아이의 의사는 어떤지 등이 판단 기준입니다. 양육 참여 내역과 양육 계획을 구체적으로 정리해두세요.',
      },
      {
        question: '숙려기간을 줄일 수 있나요?',
        answer:
          '원칙적으로 자녀가 있으면 3개월, 없으면 1개월은 의무입니다. 다만 가정폭력 등 급박한 사정이 있으면 법원이 단축할 수 있으므로, 해당 사유가 있다면 법원에 문의해보세요.',
      },
      {
        question: '위자료는 얼마나 받을 수 있나요?',
        answer:
          '위자료는 혼인 기간, 귀책사유의 정도, 경제적 상황 등에 따라 달라집니다. 정해진 기준 금액은 없으며 법원이 사안별로 판단합니다. 상대방의 잘못을 입증할 자료(문자, 사진, 진단서 등)를 정리해두면 도움이 됩니다.',
      },
      {
        question: '이혼 후에도 재산분할을 청구할 수 있나요?',
        answer:
          '이혼 후 2년 이내에 청구할 수 있습니다(민법 제839조의2). 기한이 지나면 청구가 어려워지므로, 이혼 전에 재산 목록을 미리 정리해두는 것이 좋습니다.',
      },
    ],
    cta: {
  ...
  },
  {
    ...
    intro:
      '변호사 상담 예약을 잡았는데, 막상 가려니 뭘 들고 가야 할지 모르겠습니다. 혼인관계증명서는 어디서 떼는 건지, 재산 서류는 뭘 준비해야 하는지, 아이 학교 서류도 필요한지 — 상담 시간은 30분인데 준비 없이 가면 핵심을 놓칠 수 있습니다. 이런 상황이라면 아래 체크리스트를 기준으로 하나씩 확인해보세요.',
    sections: [
      {
        title: '가장 먼저 챙길 것 — 혼인관계증명서와 가족관계증명서',
        content:
          '이혼 상담의 출발점은 "지금 법적으로 혼인 상태인지"를 확인하는 것입니다. 혼인관계증명서는 현재 혼인 상태를, 가족관계증명서는 자녀 유무와 가족 구성을 보여줍니다. 주민등록등본도 현재 거주지와 세대 구성을 확인하는 데 필요합니다. 정부24나 주민센터에서 발급받을 수 있으며, "상세" 증명서로 떼면 과거 이력까지 나옵니다. 이 세 장만 있어도 상담사가 기본 상황을 빠르게 파악할 수 있으니 반드시 준비해보세요.',
      },
      {
        title: '재산 정리가 핵심 — 부동산, 예금, 보험, 대출 서류',
        content:
          '재산분할 상담을 받으려면 부부 명의 재산과 부채를 정리해야 합니다. 부동산은 등기부등본과 공시지가 확인서를 준비하고, 금융재산은 예금잔액증명서, 보험증권 사본, 주식·펀드 거래내역서를 챙기세요. 주택담보대출이나 신용대출이 있다면 대출잔액증명서도 필요합니다. "결혼 전부터 있던 재산"과 "결혼 후 함께 모은 재산"을 구분해서 정리해두면 재산분할 기여도를 판단하는 데 도움이 됩니다. 상대방 명의 재산은 소송 중 법원을 통해 조회할 수 있으니, 지금은 알고 있는 범위에서 메모해두세요.',
      },
      {
      ...
      },
      {
        ...
        content:
          '미성년 자녀가 있다면 양육권과 면접교섭에 대해서도 상담받게 됩니다. 자녀의 재학증명서, 건강검진 기록, 병원 진료 기록 등 현재 양육 환경을 보여주는 자료를 준비하세요. 학교 행사 참석 기록, 등하교 담당 내역 같은 것도 양육 참여도를 보여주는 자료가 됩니다. 법원은 양육권 판단 시 자녀의 복리를 최우선으로 봅니다(민법 제837조). "누가 실질적으로 아이를 돌봐왔는지"를 보여줄 수 있는 자료가 있으면 함께 가져가보세요.',
      },
      {
  ...
  },
  {
    ...
    intro:
      '이혼 합의는 어느 정도 되었는데, 아이 문제에서 멈췄습니다. 초등학교 3학년인 딸아이를 누가 키울 것인지, 양육비는 얼마를 줄 것인지, 주말에는 어떻게 만나게 할 것인지 — 정해야 할 게 한두 가지가 아닙니다. 아이에게 가장 좋은 결정을 내리려면 감정보다 준비가 먼저입니다. 합의 전에 아래 사항들을 먼저 정리해보세요.',
    sections: [
      {
        title: '아이를 누가 키울지 — 합의 전에 먼저 정리할 것',
        content:
          '양육권이란 아이를 직접 보호하고, 교육하고, 일상적인 생활을 관리하는 권리와 의무입니다. 민법 제837조는 이혼 시 양육할 사람을 부부가 합의해서 정하도록 하고 있습니다. 합의가 안 되면 법원이 결정하게 됩니다. 양육권은 친권과 다른 개념이라는 점도 알아두세요 — 친권자와 양육권자를 다르게 지정할 수도 있습니다. 합의에 앞서 "내가 아이를 직접 키울 수 있는 여건이 되는지" — 주거 안정성, 근무시간, 돌봄 지원 여부 등을 구체적으로 정리해보세요.',
      },
      {
        title: '법원은 무엇을 보나요 — 양육권 판단 기준',
        content:
          '법원은 양육권을 결정할 때 아이의 복리를 최우선으로 봅니다. 구체적으로는 아이의 나이, 아이 본인의 의사(의사를 표현할 수 있는 나이인 경우), 지금까지 누가 주로 돌봐왔는지, 부모 각자의 경제적 능력과 시간적 여건, 주거 환경의 안정성 등이 판단 기준입니다. "엄마니까 당연히 양육권을 받는다"는 법에 없습니다. 아이에게 더 안정적인 환경을 제공할 수 있는 쪽이 유리합니다. 현재 양육에 어떻게 참여하고 있는지, 앞으로 어떤 양육 계획이 있는지를 구체적으로 정리해보세요.',
      },
      {
      ...
      },
      {
        ...
        content:
          '양육권 합의는 반드시 서면으로 남기세요. 협의이혼의 경우 양육사항 협의서를 법원에 제출해야 합니다. 합의서에는 양육권자, 양육비 금액과 지급 방법, 면접교섭 방법, 특별비용 분담 등을 빠짐없이 적어야 합니다. 가장 중요한 것은 "상대방이 안 지켰을 때 강제할 수 있는지"입니다. 공증을 받아두거나, 법원 조정조서로 만들면 불이행 시 별도 소송 없이 바로 강제집행이 가능합니다. 합의서 최종 확인 전에 빠뜨린 항목이 없는지 꼭 체크해보세요.',
      },
    ],
    cases: [
      {

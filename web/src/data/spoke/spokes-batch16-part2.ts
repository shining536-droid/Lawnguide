...
export const spokesBatch16Part2Pages: SpokePage[] = [
  ...
  },
  {
    ...
    faq: [
      {
        question: '성매매 초범이면 가능한 한 기소유예를 받을 수 있나요?',
        answer:
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>조사참여자의 비밀 누설은 위법 소지가 있습니다.</strong> 남녀고용평등법에 따라 조사 과정에서 알게 된 비밀을 피해자 의사에 반하여 누설하면 안 됩니다. 누설한 사람과 이를 방치한 사업주에게 손해배상을 청구할 수 있습니다.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<strong>진실한 사실에 기한 성희롱 신고는 명예훼손에 해당하지 않습니다.</strong> 사내 신고 절차를 통한 문제 제기는 정당한 권리 행사이며, 공익적 목적으로 인정될 수 있습니다. 가해자의 고소 위협에 위축되지 마세요.',
      },
      {
    ...
    cases: [
      {
        ...
        takeaway:
          '직접적 신체 접촉이 아닌 성적 발언, 소문 유포도 성희롱에 해당할 소지가 있습니다. 이런 행위를 목격했거나 들었다면, 그 내용과 유포 경위를 기록하고 증거를 확보하세요.',
      },
    ],
    faq: [
      {
        ...
        answer:
          '<strong>녹음 하나만으로도 신고와 소송이 가능합니다.</strong> 본인이 참여한 대화의 녹음은 합법적인 증거이며, 법원에서도 증거로 인정될 수 있습니다. 녹음과 함께 사건 기록 메모를 보강하면 더욱 효과적입니다.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<strong>행위자의 의도가 아니라 피해자의 관점에서 판단합니다.</strong> 성희롱은 행위자에게 성적 동기나 의도가 없더라도, 객관적으로 합리적인 사람이 성적 굴욕감이나 혐오감을 느낄 수 있는 행위이면 성립할 수 있습니다.',
      },
      {

...
export const spokesBatch84FraudSexCrime: SpokePage[] = [
  // ─── 1. fraud-used-car-mileage-tampering-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '월세 이중계약 보증금 편취', href: '/guide/fraud/fraud-monthly-rent-double-contract-track' },
      { label: '미술품 조각투자 운용수익 허위', href: '/guide/fraud/fraud-art-investment-fractional-ownership-track' },
    ],
  },
  ...
  // ─── 2. fraud-crypto-exchange-fake-withdrawal-block-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '코인 리딩방 수익보장 투자 출금 거부 사기', href: '/guide/fraud/fraud-crypto-leading-room-profit-guarantee-withdrawal-block-track' },
  ...
  // ─── 5. fraud-government-subsidy-impersonation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '딥페이크 사칭 송금 사기', href: '/guide/fraud/fraud-deepfake-impersonation-money' },
      { label: '모바일게임 계정 거래 사기', href: '/guide/fraud/fraud-mobile-game-account-resale-chargeback-track' },
      { label: '보이스피싱 송금 환급 절차', href: '/guide/fraud/fraud-phishing-transfer-refund-procedure' },
    ],
  },
  ...
  // ─── 6. fraud-loan-brokerage-advance-fee-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '미술품 갤러리 감정서 진품 위작', href: '/guide/fraud/fraud-art-painting-authentic-certificate-fake-track' },
    ],
  },
  ...
  // ─── 7. sex-crime-company-dinner-intoxication-contact-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '시내버스 추행', href: '/guide/sex-crime/sex-crime-city-bus-track' },
    ],
  },
  ...
  // ─── 8. sex-crime-gym-personal-training-session-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '성범죄 디지털 증거 보존기한 정리', href: '/guide/sex-crime/sex-crime-digital-evidence-timeline' },
      { label: '진료 처치 중 강제추행', href: '/guide/sex-crime/sex-crime-clinic-treatment-track' },
      { label: '마사지샵 준강간 피해', href: '/guide/sex-crime/sex-crime-massage-shop-quasi-rape-victim-track' },
      { label: '동호회 뒤풀이 추행 무고', href: '/guide/sex-crime/sex-crime-club-afterparty-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 9. sex-crime-public-restroom-hidden-camera-track ───
  {
    ...
    cta: { text: '성범죄 피해 대응 순서, AI로 정리하기', link: '/chat?domain=sex-crime' },
    internalLinks: [
      { label: '공중화장실 불법촬영', href: '/guide/sex-crime/sex-crime-public-restroom-illegal-filming-track' },
      { label: '클럽 무도장 신체접촉 추행 무고 방어', href: '/guide/sex-crime/sex-crime-club-dance-floor-contact-falsely-accused-defense' },
      { label: '성범죄 디지털 증거 보존기한 정리', href: '/guide/sex-crime/sex-crime-digital-evidence-timeline' },
      { label: '의료시술 마취 중 성폭력', href: '/guide/sex-crime/sex-crime-medical-procedure-anesthesia-victim-track' },
      { label: '클럽 댄스플로어 추행', href: '/guide/sex-crime/sex-crime-club-dancefloor-contact-track' },
    ],
  },
  ...
  // ─── 10. sex-crime-online-message-coercion-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '클럽 댄스플로어 모르는 사람 밀착 신체접촉 추행', href: '/guide/sex-crime/sex-crime-club-dancefloor-stranger-groping-track' },
      { label: '인터넷 방송 채팅 통신매체이용음란', href: '/guide/sex-crime/sex-crime-livestream-chat-obscene-message-track' },

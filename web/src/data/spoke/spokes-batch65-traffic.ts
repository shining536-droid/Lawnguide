...
export const spokesBatch65Traffic: SpokePage[] = [
  // ─── 1. traffic-accident-electric-kickboard-vehicle-collision-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '자전거 횡단보도 통행 사고 과실비율 판단', href: '/guide/traffic-accident/traffic-accident-bicycle-crosswalk-crossing-fault-ratio-track' },
  ...
  // ─── 2. traffic-accident-parking-lot-door-zone-collision-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '화물차 적재물 낙하 사고', href: '/guide/traffic-accident/traffic-accident-cargo-fall-truck-injury' },
      { label: '무보험차 피해자 청구', href: '/guide/traffic-accident/traffic-accident-uninsured-vehicle-victim-claim-track' },
    ],
  },
  ...
  // ─── 3. traffic-accident-snowchain-failure-skid-singlecar-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '적재물 돌출 낙하 사고', href: '/guide/traffic-accident/traffic-accident-cargo-overhang-falling-injury-track' },
  ...
  // ─── 4. traffic-accident-roadwork-zone-sign-missing-collision-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '화물 덮개 풀림 도로 낙하', href: '/guide/traffic-accident/traffic-accident-cargo-tarp-failure-debris-track' },
  ...
  // ─── 5. traffic-accident-cargo-overhang-falling-injury-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '화물차 과적 사각지대 자전거 우회전', href: '/guide/traffic-accident/traffic-accident-cargo-truck-overload-blind-spot-cyclist-track' },

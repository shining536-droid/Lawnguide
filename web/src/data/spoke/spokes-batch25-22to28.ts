...
export const spokesBatch25_22to28: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    slug: 'post-settlement-aftereffect-additional-claim',
    keyword: '교통사고 합의 후 후유증 추가 청구 3가지 방법',
    questionKeyword: '교통사고 합의했는데 후유증이 나타나면 추가 보상을 받을 수 있나요?',
    ctaKeyword: '교통사고 후유증 추가 청구 상담',
    type: '상황형',
    perspective: 'victim',
    meta: {
      title: '교통사고 합의 후 후유증 추가 청구 3가지 방법 | 로앤가이드',
      description:
        '교통사고 합의서에 서명했는데 뒤늦게 후유증이 나타나 추가 보상이 가능한지 궁금하다면 3가지 청구 방법을 지금 확인하세요',
    },
    intro:
      '<p>합의금을 받고 서명까지 마쳤는데, 몇 달 뒤 목 통증이 심해지고 손에 저림 증상이 생겼습니다. 병원에서는 사고 후유증이라고 하는데, 이미 합의한 건 다시 청구할 수 없는 건지 걱정됩니다. 원칙적으로 합의 후 추가 청구는 어렵지만, 합의 당시 예측할 수 없었던 후유증이라면 예외적으로 인정되는 경우가 있습니다. 추가 보상이 가능한 조건과 절차를 정리해보세요.</p>',
    sections: [
      {
        title: '합의 후 추가 청구가 인정되는 3가지 조건',
        content:
          '<p><strong style="color:#1e3a5f">대법원 판례에 따르면 합의 당시 예상할 수 없었던 손해가 발생한 경우 추가 청구가 가능합니다.</strong></p>\n<ol>\n<li><strong>합의 시 예측 불가능한 후유증</strong> — 합의 당시 의학적으로 예상할 수 없었던 새로운 증상이 나타나야 합니다. 합의 전 이미 증상이 있었는데 단순히 무시한 경우는 해당하지 않습니다</li>\n<li><strong>사고와 후유증 사이 인과관계 입증</strong> — 후유증이 교통사고로 인해 발생했다는 의학적 소견이 필요합니다. 담당 의사의 진단서에 "교통사고와의 인과관계가 있다"는 내용이 명시되어야 합니다</li>\n<li><strong>합의서에 "일체의 청구를 포기한다" 조항 검토</strong> — 합의서 문구에 따라 추가 청구 가능 여부가 달라집니다. 포괄적 부제소 합의라도 예측 불가능한 손해에는 효력이 미치지 않을 수 있습니다</li>\n</ol>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">핵심: 합의서에 서명했다고 모든 권리를 포기한 것은 아닙니다. "합의 당시 예견할 수 없었느냐"가 핵심 판단 기준입니다</blockquote>',
      },
      {
        title: '후유증 추가 청구를 위한 준비 절차',
        content:
          '<p><strong style="color:#1e3a5f">추가 청구가 인정되려면 의학적 근거와 법률적 요건을 체계적으로 갖춰야 합니다.</strong></p>\n<ul>\n<li><strong>정밀 검사 실시</strong> — MRI, CT, 근전도 검사 등 후유증을 객관적으로 증명할 수 있는 검사를 받으세요. 단순 주관적 통증만으로는 입증이 어렵습니다</li>\n<li><strong>후유장해 진단서 발급</strong> — 증상이 고정된 시점(통상 사고 후 6개월~1년)에 전문의에게 후유장해 진단서를 발급받으세요</li>\n<li><strong>기존 합의서 사본 확보</strong> — 합의 당시 어떤 항목이 포함되었는지, 부제소 합의 조항이 있는지 확인해야 합니다</li>\n<li><strong>보험사에 추가 보상 요청</strong> — 서면(내용증명)으로 후유증 발생 사실과 추가 보상 근거를 전달하세요. 전화 통화만으로는 기록이 남지 않습니다</li>\n</ul>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>💬 AI 법률 상담으로 빠르게 확인하세요</strong></p>\n<p style="margin:0;font-size:0.95em">변호사 상담 전, AI가 합의 후 추가 청구 가능 여부를 분석해드립니다.</p>\n<a href="/chat?domain=traffic-accident" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '추가 청구 시 소멸시효와 소송 절차',
        content:
          '<p><strong style="color:#1e3a5f">후유증 발생을 안 날로부터 3년 이내에 청구해야 하며, 보험사가 거부하면 소송으로 진행합니다.</strong></p>\n<ul>\n<li><strong>소멸시효</strong> — 손해를 안 날(후유증 진단일)로부터 3년, 사고일로부터 10년 중 먼저 도래하는 시점이 기한입니다. 후유증 진단을 받으면 즉시 청구를 시작하세요</li>\n<li><strong>민사소송 제기</strong> — 보험사가 추가 보상을 거부하면 손해배상 청구 소송을 제기할 수 있습니다. 소장에 합의 당시 예측 불가능했던 사실을 구체적으로 기재해야 합니다</li>\n<li><strong>감정 신청</strong> — 소송 중 법원에 의료감정을 신청하여 사고와 후유증의 인과관계를 객관적으로 확인받을 수 있습니다</li>\n<li><strong>기존 합의금 공제</strong> — 추가 보상액은 총 손해액에서 이미 받은 합의금을 공제한 금액으로 산정됩니다</li>\n</ul>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">주의: 합의 후 후유증 추가 청구는 입증 난이도가 높으므로 전문 변호사 상담을 강력히 권합니다. 처음 합의 시 "향후 후유증 별도 협의" 조항을 넣는 것이 가장 안전합니다</blockquote>',
      },
    ],
    cases: [
      {
        title: '판례 — 합의 후 추가 손해배상 청구 가능 여부',
        summary:
          '대법원 2023다297141 사건(대법원, 2025.06.26 선고)에서 법원은 보험급여를 받은 근로자가 추가 손해를 청구할 때 각 손해 항목별로 보험급여를 먼저 공제한 뒤 과실상계를 적용해야 한다고 판시했습니다.',
        takeaway:
          '합의 당시 예측할 수 없었던 후유증이 발생하면 추가 청구가 가능하며, 손해액 산정은 항목별로 세밀하게 이루어집니다.',
      },
    ],
    faq: [
      {
        question: '합의서에 "일체의 이의를 제기하지 않는다"고 써 있으면 추가 청구가 불가능한가요?',
        answer:
          '<strong>반드시 불가능한 것은 아닙니다.</strong> 대법원은 합의 당시 전혀 예상할 수 없었던 후유증이 발생한 경우, 포괄적 부제소 합의의 효력이 미치지 않는다고 보고 있습니다. 다만 이를 입증해야 하므로 의학적 소견서가 핵심입니다.',
      },
      {
        question: '후유증이 사고 때문인지 어떻게 증명하나요?',
        answer:
          '<strong>전문의의 진단서와 정밀검사 결과가 핵심 증거입니다.</strong> MRI, CT 등 객관적 검사에서 사고로 인한 손상이 확인되어야 하며, 사고 전 동일 부위 치료 이력이 없다는 점도 중요합니다. 소송에서는 법원 감정을 통해 인과관계를 확인받을 수 있습니다.',
      },
      {
        question: '합의 후 얼마 안에 추가 청구를 해야 하나요?',
        answer:
          '<strong>후유증을 진단받은 날로부터 3년 이내에 청구해야 합니다.</strong> 사고일 기준이 아니라 손해를 안 날 기준이므로, 후유증 진단일이 기산점이 됩니다. 다만 사고일로부터 10년이 지나면 절대적 시효가 만료되니 주의하세요.',
      },
      {
        question: '경미한 사고인데도 후유증 추가 청구가 가능한가요?',
        answer:
          '<strong>사고의 경중보다는 후유증의 의학적 입증 여부가 중요합니다.</strong> 경미한 추돌 사고라도 디스크 탈출이나 신경 손상이 발생할 수 있으며, 객관적 검사로 입증되면 추가 청구가 가능합니다.',
      },
      {
        question: '추가 청구 시 변호사 비용은 어느 정도 드나요?',
        answer:
          '<strong>착수금 100~300만 원, 성공보수 10~15%가 일반적입니다.</strong> 추가 보상액이 500만 원 이상이면 변호사 선임이 경제적으로 유리한 경우가 많습니다. 대한법률구조공단 무료 상담을 먼저 받아보는 것도 방법입니다.',
      },
    ],
    cta: {
      text: '합의 후 후유증 추가 보상, AI가 가능 여부를 분석해드립니다',
    ...
    internalLinks: [
      ...
      { label: '교통사고 합의금 바로 합의 주의', href: '/guide/traffic-accident/settlement-offer-dont-accept-immediately-reasons' },
      { label: '교통사고 과실비율 다툼', href: '/guide/traffic-accident/traffic-accident-fault-ratio-dispute' },
    ],
  },

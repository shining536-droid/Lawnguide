...
export const spokesBatch64Traffic: SpokePage[] = [
  // ─── 1. traffic-accident-construction-site-equipment-collision-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '무단횡단 야간 보행자 사고 과실비율 판단', href: '/guide/traffic-accident/traffic-accident-pedestrian-jaywalk-night-fault-ratio-track' },
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '자전거 횡단보도 보행자 충돌 청구', href: '/guide/traffic-accident/traffic-accident-bicycle-rider-vs-pedestrian-crosswalk-claim-track' },
      { label: '어린이 교통사고 보상 청구', href: '/guide/traffic-accident/traffic-accident-child-pedestrian-claim' },
    ],
  },
  ...
  // ─── 2. traffic-accident-tunnel-pile-up-multi-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '출퇴근 교통사고 산재 자동차보험 동시청구', href: '/guide/traffic-accident/traffic-accident-commute-work-injury-double-claim' },
    ],
  },
  ...
  // ─── 3. traffic-accident-night-pedestrian-jaywalk-fault-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '자전거 차대차 차대보행자 처리 분기', href: '/guide/traffic-accident/traffic-accident-bicycle-vs-car-vs-pedestrian-fault-track-split' },
      { label: '교통사고 동승자 탑승자 보상 청구', href: '/guide/traffic-accident/traffic-accident-passenger-injury-claim' },
    ],
  },
  ...
  // ─── 4. traffic-accident-dashcam-altered-evidence-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '자전거도로 보행자 진입 충돌', href: '/guide/traffic-accident/traffic-accident-bike-lane-pedestrian-collision' },
      { label: '반려동물 교통사고 손해배상', href: '/guide/traffic-accident/traffic-accident-pet-hit-civil-claim' },
    ],
  },
  ...
  // ─── 5. traffic-accident-foreign-driver-license-recognize-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '자전거 보행자 사고', href: '/guide/traffic-accident/traffic-accident-bike-pedestrian-collision' },
      { label: '택시 승객 교통사고 보상 청구', href: '/guide/traffic-accident/traffic-accident-taxi-passenger-claim' },
    ],
  },
];

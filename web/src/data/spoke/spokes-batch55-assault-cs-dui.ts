...
export const spokesBatch55AssaultCsDui: SpokePage[] = [
  ...
  // ─── 4. child-support / detention-order-3-times-unpaid (victim, 절차형) ───
  {
    ...
    cases: [
      {
        title: '판례 — 감치명령 요건과 이행명령 후 미이행 판단',
        summary:
          '대법원 2025으517 사건(대법원, 2025.07.31 선고)에서 법원은 양육비 감치명령의 요건인 \'이행명령 후 3기 이상 정당한 이유 없이 미이행\'의 판단 기준에 관한 법리를 확인했습니다. \'정당한 이유\'는 실직·중대 질병·사고 등 객관적 사유여야 하며, 단순한 경제적 어려움 호소만으로는 인정되기 어렵다는 점에서, 양육비를 받지 못한 양육친은 통장 거래내역·이행명령 결정문·미지급 월별 내역을 정리해 감치명령 신청을 검토할 수 있습니다.',
        takeaway: '감치명령은 단계별 요건이 정확히 충족되어야 인정됩니다. 양육비이행관리원의 무료 지원을 활용하면 단계별 진행을 차근차근 밟아 강제력 있는 결과를 만들 수 있습니다.',
      },
    ],
    faq: [
      {

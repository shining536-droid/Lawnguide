...
export const spokesBatch55AssaultCsDui: SpokePage[] = [
  ...
  // ─── 2. assault / family-parent-sibling-domestic-violence (victim, 절차형) ───
  {
    ...
    internalLinks: [
      ...
      { label: '아파트 층간소음 항의 폭행 상해 신고', href: '/guide/assault/assault-apartment-floor-noise-complaint-strike-report-track' },
  ...
  // ─── 6. dui / after-driving-drank-widmark-counter (accused, Q&A형) ───
  {
    ...
    internalLinks: [
      ...
      { label: '생계형 운전자 음주 면허취소 구제', href: '/guide/dui/dui-hardship-license-relief-track' },
    ],
  },
];

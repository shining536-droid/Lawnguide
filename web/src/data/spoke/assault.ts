...
export const assaultPages: SpokePage[] = [
  {
    ...
    type: '상황형',
    meta: {
      title: '폭행 피해 증거 모으는 4단계 — 진단서부터 고소까지 | 로앤가이드',
      description: '폭행을 당했다면 48시간 내 진단서 발급, CCTV 확보, 고소장 제출, 손해배상 청구까지 4단계로 대응하세요. 형법 제260조 기준 증거별 입증력과 수집 요령을 정리했습니다. 지금 확인하세요.',
    },
  ...
  },
  {
    ...
    type: '체크리스트형',
    meta: {
      title: '폭행 피해 증거 체크리스트 7가지 — 놓치면 불리해집니다 | 로앤가이드',
      description: '폭행 피해 입증에 필요한 진단서, CCTV, 목격자 진술, 사진, 녹음 등 7가지 증거를 체크리스트로 정리했습니다. 증거 없으면 고소해도 무혐의 처분될 수 있습니다. 지금 확인하세요.',
    },

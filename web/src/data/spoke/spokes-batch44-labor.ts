...
export const spokesBatch44Labor: SpokePage[] = [
  // ─── 1. dismissal / acquisition-fixed-term-rights ───
  {
    ...
    internalLinks: [
      { label: '기간제 갱신기대권 입증', href: '/guide/dismissal/dismissal-fixed-term-non-renewal-expectation' },
      ...
      { label: '무단결근 3일 자동면직 직권면직', href: '/guide/dismissal/dismissal-3days-absence-auto-termination-clause' },
    ],
  },
  ...
  // ─── 2. dismissal / incomplete-reason-letter ───
  {
    ...
    internalLinks: [
      ...
      { label: '해고근로자 종합 가이드', href: '/guide/dismissal' },
      { label: '부당해고 구제신청 절차', href: '/guide/dismissal/dismissal-relief-procedure-comprehensive' },
      { label: '결근 처벌규정 해고 과중', href: '/guide/dismissal/dismissal-absence-rule-excessive-punishment' },
    ],
  },
  ...
  // ─── 3. dismissal / constructive-forced-resignation ───
  {
    ...
    internalLinks: [
      { label: '권고사직 강요 부당해고', href: '/guide/dismissal/dismissal-forced-resignation-coercion-track' },
      { label: '권고사직 합의서 작성 주의사항', href: '/guide/dismissal/recommended-resignation-agreement-tips' },
      { label: '해고근로자 종합 가이드', href: '/guide/dismissal' },
      { label: '부당해고 구제신청 절차', href: '/guide/dismissal/dismissal-relief-procedure-comprehensive' },
      { label: '권고사직과 해고 차이점과 대응법', href: '/guide/dismissal/voluntary-resignation-vs-dismissal' },
    ],
  },
  ...
  // ─── 5. dismissal / subcontractor-principal-responsibility ───
  {
    ...
    internalLinks: [
      ...
      { label: '육아기 근로자 해고 대응 5가지 보호 요건', href: '/guide/dismissal/dismissal-childcare-worker-protection' },
      { label: '경영악화 일방휴직 후 해고', href: '/guide/dismissal/dismissal-employer-bankruptcy-temp-closure-track' },
      { label: '부당해고 구제신청 절차', href: '/guide/dismissal/dismissal-relief-procedure-comprehensive' },
    ],
  },
  ...
  // ─── 6. wage / production-bonus-regular-include ───
  {
    ...
    internalLinks: [
      { label: '임금 종합 가이드', href: '/guide/wage' },
      { label: '출퇴근 기록 없을 때 야근수당 입증', href: '/guide/wage/no-attendance-record-overtime-proof' },
      ...
      { label: '임금체불 소멸시효 3년 규정 상세', href: '/guide/wage/unpaid-wage-3year-limitation' },
    ],
  },
  ...
  // ─── 7. wage / night-sleeping-hours-working-time ───
  {
    ...
    internalLinks: [
      { label: '휴게시간 미부여 근로시간 임금 청구 판단', href: '/guide/wage/wage-break-time-denied-working-hour-claim-track' },
      { label: '야간근로 가산수당 기준', href: '/guide/wage/wage-night-shift-premium-claim' },
      { label: '임금 종합 가이드', href: '/guide/wage' },
      { label: '주 연장근로 12시간 한도 위반 가산수당', href: '/guide/wage/wage-weekly-overtime-12hour-limit-premium-track' },
  ...
  // ─── 8. wage / welfare-card-point-minimum ───
  {
    ...
    internalLinks: [
      ...
      { label: '상여금 분할지급 최저임금 회피', href: '/guide/wage/wage-bonus-split-minimum-wage-evasion-track' },
  ...
  // ─── 9. unemployment / fixed-term-expire-voluntary-distinguish ───
  {
    ...
    internalLinks: [
      ...
      { label: '공정수당 실업급여 비교', href: '/guide/unemployment/fixed-term-contract-1year-vs-fair-allowance' },

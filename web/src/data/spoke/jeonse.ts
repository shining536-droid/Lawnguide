    ...
    faq: [
      {
        ...
        answer:
          '내용증명 후에도 응답이 없다면 <strong>임차권등기명령</strong>으로 대항력을 보전한 뒤, 지급명령이나 소송으로 법적 청구를 진행하는 순서를 검토해볼 수 있습니다. 내용증명 발송 기록과 배달증명은 이후 절차에서 반환 요청 시점을 입증하는 핵심 증거가 되므로 가능한 한 보관해두세요.',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '반환보증보험은 가입 요건으로 대항력(전입신고 포함)을 요구하는 경우가 많습니다. 전입신고가 안 되어 있으면 보험금 지급이 거절될 수 있으므로 약관의 <strong>면책 사유</strong>를 가능한 한 확인해보세요. 가입 후에도 전입신고 상태를 유지해두는 것이 중요합니다.',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '이사를 가면 전입신고가 이전되어 기존 대항력을 잃을 수 있습니다. 가능한 한 <strong>임차권등기명령</strong>을 먼저 신청하고, 등기 완료를 확인한 뒤에 이사하세요. 임차권등기는 임대인 동의 없이 법원 결정만으로 진행되므로 연락이 안 되는 상황에서도 가능합니다.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '대항력과 확정일자를 갖추고 있다면 경매 절차에서 배당을 받을 수 있습니다. 소액임차인에 해당하면 최우선변제도 가능합니다. 다만 <strong>배당요구종기일</strong> 이전에 배당요구를 해야 하므로, 경매 진행 상황과 기한을 가능한 한 확인하세요.',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '일부만 수령해도 됩니다. 다만 가능한 한 <strong>"잔액 ○○원은 별도 청구한다"</strong>는 내용을 서면으로 남기세요. 전액 합의로 오해받지 않으려면 문서화가 중요합니다.',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: '전입신고를 하지 말라는 요구는 <strong>세입자의 권리를 포기</strong>시키는 것입니다. 가능한 한 전입신고를 하세요.',
      },
      {

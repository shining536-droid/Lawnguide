...
export const jeonsePages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '전세 만료 후 집주인이 안 나가라고 할 때 대응법 | 로앤가이드',
      description: '전세 계약이 끝났는데 집주인이 계속 살라고 한다면? 묵시적 갱신 여부, 보증금 반환 요구 방법, 임차권등기명령 활용법을 지금 확인하세요.',
    },
    intro:
  ...
  },
  {
    ...
    type: '절차형',
    meta: {
      title: '전세 만료 후 보증금 돌려받는 4단계 절차 | 로앤가이드',
      description: '전세 계약이 만료됐는데 보증금을 안 돌려준다면? 내용증명, 임차권등기명령, 보증보험 청구, 소송까지 보증금 반환 4단계를 바로 정리해보세요.',
    },
  ...
  },
  {
    ...
    type: '실수함정형',
    meta: {
      title: '전입신고 놓쳤을 때 보증금 보호 즉시 조치법 | 로앤가이드',
      description: '전입신고를 안 했는데 보증금이 위험하다면? 대항력 상실의 의미, 지금이라도 할 수 있는 보호 조치, 보증보험 가입 가능 여부를 지금 확인하세요.',
    },

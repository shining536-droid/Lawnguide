...
export const spokesBatch29Unemployment2: SpokePage[] = [
  // ── 7. 국민연금과 실업급여 동시 수급 ──
  {
    ...
    perspective: 'victim',
    meta: {
      title: '국민연금과 실업급여 동시 수급 가능한가요? | 로앤가이드',
      description:
        '조기노령연금·노령연금·실업급여 동시 수급 가능성, 만 65세 이상 예외 사례를 함께 확인해보세요.',
    },
    intro:
      '<p>국민연금과 실업급여 동시 수급은 원칙적으로 가능한 영역이지만, 조기노령연금 수급 중이면 실업급여 신청 자체가 제한될 수 있는 사례가 있어요. 만 65세 이전 가입자·이직 시점·연금 종류에 따라 적용이 달라져 본인 사례 분류가 핵심입니다. 고용보험법과 국민연금법 기준입니다.</p>',
    sections: [
      {
  ...
  // ── 8. 실업급여 대기기간 7일 ──
  {
    ...
    perspective: 'victim',
    meta: {
      title: '실업급여 대기기간 7일, 이 기간엔 뭘 해야 하나요? | 로앤가이드',
      description:
        '신청 후 7일은 무급이지만 수급기간엔 차감되지 않아요. 워크넷 등록과 구직활동 계획, 첫 인정일 일정까지 순서대로 확인해보세요.',
    },
    intro:
      '<p>실업급여 대기기간 7일은 신청 후 바로 돈이 나오는 기간이 아니라 급여 지급이 시작되기 전의 무급 대기 기간이에요. 다만 총 수급기간에서 차감되지 않아 실질 손실은 7일분뿐이고, 이 기간에 워크넷 이력서 등록과 구직활동 계획 수립을 미리 해두면 첫 실업인정일이 훨씬 수월합니다. 고용보험법 제49조 기준입니다.</p>',
    timelineSteps: [
      '수급자격 인정신청(D-day)',
      '수급자격 인정 결정(1~2주)',
      '대기기간 7일(급여 미지급)',

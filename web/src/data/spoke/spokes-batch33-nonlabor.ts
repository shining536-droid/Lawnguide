...
export const spokesBatch33Nonlabor: SpokePage[] = [
  ...
  // ── 교통사고 3. 보험금 청구 절차 총정리 ──
  {
    ...
    perspective: 'victim',
    meta: {
      title: '교통사고 보험금 청구 서류, 어디서부터 챙기나요? | 로앤가이드',
      description:
        '사고 직후 진단서·사고사실확인원·치료비 영수증까지 단계별 청구 서류를 확인해보세요. 보험사 처리 기한도 함께 정리했습니다.',
    },
    intro:
      '<p>교통사고 보험금 청구는 사고 직후 24시간 안 응급실·사고사실확인원 확보부터 시작하는 영역이에요. 본인이 받을 수 있는 보상 항목은 치료비·휴업손해·위자료·후유장해로 나뉘고, 보험사가 처리 기한(통상 30일 이내)을 어기면 지연이자 청구도 별도 트랙. 손해사정사·금감원 분쟁조정으로 보강 가능합니다.</p>',
    sections: [
      {

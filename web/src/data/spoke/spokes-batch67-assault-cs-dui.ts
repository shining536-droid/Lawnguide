...
export const spokesBatch67AssaultCsDui: SpokePage[] = [
  // ─── 1. assault-tenant-landlord-rent-dispute-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '폭행 혐의를 받았을 때 대응법', href: '/guide/assault/assault-accusation-defense' },
  ...
  // ─── 5. child-support-overseas-payer-currency-exchange-loss-track ───
  {
    ...
    cta: { text: '양육비 못 받을 때 다음 단계, AI로 확인하기', link: '/chat?domain=child-support' },
    internalLinks: [
      { label: '양육비 일시금 합의 후 추가 청구', href: '/guide/child-support/child-support-lump-sum-paid-additional-claim-possibility' },
      { label: '양육의무자 해외 도주 추심', href: '/guide/child-support/child-support-overseas-flee-non-payer-collection-track' },
  ...
  // ─── 6. dui-private-residential-parking-lot-no-public-impaired-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '아파트 주차장 차량 위치 이동 음주운전 여부', href: '/guide/dui/dui-apartment-parking-lot-reposition-falsely-accused-defense' },
      { label: '처음 음주운전 면허정지 면허취소 분기', href: '/guide/dui/dui-first-offense-license-suspension-vs-revocation-criteria' },
      { label: '음주측정 거부 자진출두 형사 행정', href: '/guide/dui/dui-test-refusal-voluntary-surrender-criminal-administrative-track' },
    ],
  },
];

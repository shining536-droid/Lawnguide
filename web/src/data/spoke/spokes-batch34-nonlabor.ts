...
export const spokesBatch34Nonlabor: SpokePage[] = [
  ...
  // ── 교통사고 2. 버스·택시 급정거 승객 부상 손해배상 청구 4단계 ──
  {
    ...
    perspective: 'victim',
    meta: {
      title: '버스 급정거로 다쳤어요, 보상 어떻게 받나요? | 로앤가이드',
      description:
        '버스·택시 급정거 사고로 다친 승객은 운수회사 공제·보험으로 치료비·휴업·위자료 보상이 가능해요. 청구 순서를 확인해보세요.',
    },
    intro:
      '<p>버스·택시 급정거로 승객이 다친 사고는 운수회사 공제·자동차보험으로 치료비·휴업손해·위자료·후유장해까지 청구 가능한 영역이에요. 사고 직후 응급실 진단서 + 운수회사 사고증명서가 핵심 자료이고, 보험사 처리 기한(통상 30일)을 어기면 지연이자 청구도 별도 트랙으로 가능합니다.</p>',
    sections: [
      {
  ...
  // ── 사기 2. 부동산 임대 보증금 사기 예방과 피해 구제 4단계 ──
  {
    ...
    cases: [
      {
        title: '판례 — 부동산 거래에서 기망행위의 판단 기준',
        summary:
          '대법원 2004도45 사건(대법원, 2007.01.25 선고)에서 법원은 부동산 거래에서 다소의 과장·허위가 있더라도 일반 상거래 관행과 신의칙상 시인될 수 있는 정도라면 사기죄의 기망행위로 보기 어렵지만, 거래상 중요한 사항에 관한 구체적 사실을 신의성실의 의무에 반해 허위로 알리는 것은 기망행위가 될 수 있다고 판시했습니다.',
        takeaway:
          '임대인이 선순위 근저당·다른 보증금 등 보증금 회수에 중요한 사실을 숨기거나 사실과 다르게 설명했다면 사기 피해로 정리가 필요한 상황일 수 있으니, 계약서·등기부·대화 기록을 모아 대응 방법을 점검해볼 수 있습니다.',
      },
    ],
    faq: [
      {
  ...
  // ── 층간소음. 관리사무소 민원과 법적 조치 절차 5단계 ──
  {
    ...
    cases: [
      {
        title: '판례 — 소음이 법령으로 규율되는 영역이라는 점',
        summary:
          '대법원 2019도6588 판결에서는 소음·진동관리법 등이 정한 인증·신고 의무를 이행하지 않아 결과적으로 인증을 받지 않은 경우 처벌 대상이 될 수 있다고 보았습니다. 이는 소음이 법령으로 규율되는 영역임을 보여주는 사례로, 생활 소음 분쟁도 관련 기준과 절차에 따라 대응 방법을 검토해볼 수 있습니다.',
        takeaway:
          '층간소음 문제는 우선 관리사무소 중재와 층간소음 이웃사이센터 상담을 거치고, 소음 측정 자료를 확보한 뒤 조정·소송 등 법적 절차를 단계적으로 검토해보는 것이 좋습니다.',
      },
    ],
    faq: [
      {

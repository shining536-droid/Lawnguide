...
export const spokesBatch84AssaultDuiJeonseFraud: SpokePage[] = [
  // ─── 1. assault-apartment-floor-noise-confrontation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '반려견 목줄 시비 폭행 상해 신고', href: '/guide/assault/assault-dog-leash-dispute-injury-report-track' },
      { label: '정당방위 입증 방어 범위', href: '/guide/assault/assault-self-defense-proof-defensive-boundary-track' },
  ...
  // ─── 2. assault-taxi-fare-dispute-passenger-track ───
  {
    ...
    internalLinks: [
      { label: '폭행 종합 가이드', href: '/guide/assault' },
      { label: '술자리 폭행 단순 상해 구분', href: '/guide/assault/assault-drinking-sudden-fight-simple-vs-injury' },
  ...
  // ─── 3. assault-futsal-match-tackle-confrontation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '폭행 종합 가이드', href: '/guide/assault' },
      { label: '카페 소란 항의 밀침 상해 대응', href: '/guide/assault/assault-cafe-noise-complaint-shove-track' },
      { label: '폭행 합의금 기준', href: '/guide/assault/assault-settlement-amount-standard' },
      { label: '폭행 진단서 CCTV 증거 우열 다툼', href: '/guide/assault/assault-medical-certificate-vs-cctv-evidence-priority' },
    ],
  },
  ...
  // ─── 4. assault-care-facility-elderly-resident-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '공동주택 엘리베이터 폭행 CCTV', href: '/guide/assault/assault-apartment-elevator-cctv-evidence-track' },
      { label: '지인 모임 폭행 무고', href: '/guide/assault/assault-acquaintance-gathering-falsely-accused-defense' },
  ...
  // ─── 5. dui-accident-leave-scene-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '음주 사고 위험운전치상 특가법', href: '/guide/dui/dui-accident-injury-yunchangho-aggravated-track' },
  ...
  // ─── 8. jeonse-fraud-newbuild-villa-inflated-deposit-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '전세대출 명의 전세사기', href: '/guide/jeonse-fraud/jeonse-fraud-deposit-loan-bank-collusion-track' },
    ],
  },
  ...
  // ─── 9. jeonse-fraud-fake-landlord-impersonation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '중개보조원 보증금 횡령 사용자책임', href: '/guide/jeonse-fraud/jeonse-fraud-broker-assistant-officetel-employer-liability-track' },
  ...
  // ─── 10. jeonse-fraud-trust-property-unauthorized-lease-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '가짜 임대인 신분 사칭 보증금 회수 판단', href: '/guide/jeonse-fraud/jeonse-fraud-fake-landlord-impersonation-deposit-track' },
    ],
  },
];

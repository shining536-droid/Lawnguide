...
export const spokesBatch55Inheritance: SpokePage[] = [
  // ─── 1. inheritance / limited-acceptance-after-sell-deemed-simple ───
  {
    ...
    internalLinks: [
      ...
      { label: '미성년 상속인 상속포기', href: '/guide/inheritance/inheritance-minor-heir-renunciation-track' },
      { label: '상속 임대보증금 반환 공동상속 구상', href: '/guide/inheritance/inheritance-coheir-deposit-return-indivisible-debt-recourse-track' },
    ],
  },
  ...
  // ─── 3. inheritance / tax-after-6months-redivision-claim ───
  {
    ...
    internalLinks: [
      ...
      { label: '상속 부동산 감정 분쟁 해결법', href: '/guide/inheritance/inheritance-real-estate-valuation-dispute' },

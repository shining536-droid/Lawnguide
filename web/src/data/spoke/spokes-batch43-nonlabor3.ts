...
export const spokesBatch43Nonlabor3: SpokePage[] = [
  // ─── 1. jeonse / jeonse-monthly-rent-conversion-deposit-return ───
  {
    ...
    internalLinks: [
      ...
      { label: '계약갱신 거부 사유 부재', href: '/guide/jeonse/jeonse-fixed-term-end-renewal-refusal-no-reason-track' },
  ...
  // ─── 2. jeonse / jeonse-house-sold-new-landlord-deposit ───
  {
    ...
    internalLinks: [
      ...
      { label: '임차권등기명령 신청 절차와 비용', href: '/guide/jeonse/lease-registration-order-process' },
      { label: '전세 계약갱신 거절 임차인 대응', href: '/guide/jeonse/jeonse-renewal-landlord-refusal' },
  ...
  // ─── 3. child-support / child-support-ex-unemployed-reduction-refuse ───
  {
    ...
    internalLinks: [
      ...
      { label: '양육비 안 주면 어떻게 받아낼 수 있나요', href: '/guide/child-support/child-support-overdue-collection' },
  ...
  // ─── 4. rehabilitation / rehabilitation-cosigner-joint-debt-include ───
  {
    ...
    internalLinks: [
      ...
      { label: '사업자 개인회생 신청 가능 여부', href: '/guide/rehabilitation/business-owner-rehabilitation-eligibility' },
  ...
  // ─── 5. bankruptcy / bankruptcy-cryptocurrency-holdings-disclosure ───
  {
    ...
    internalLinks: [
      ...
      { label: '개인파산 신청에서 면책 결정까지 전체 절차', href: '/guide/bankruptcy/application-to-discharge-full-procedure' },
      { label: '파산 면책 후 신용회복 5단계', href: '/guide/bankruptcy/bankruptcy-post-discharge-credit-rebuild-5steps' },
      { label: '파산 연대보증인 영향 대응', href: '/guide/bankruptcy/bankruptcy-guarantor-impact-response' },
      { label: '개인파산 신청서 양식과 작성 가이드', href: '/guide/bankruptcy/application-form-template-guide' },
    ],
  },

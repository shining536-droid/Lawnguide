...
export const spokesBatch48Misc: SpokePage[] = [
  ...
  // ─── 5. bankruptcy / 보증채무 파산 면책 ───
  {
    ...
    cases: [
      {
        title: '판례 — 면책 후 채무 다툼과 면책확인의 소·청구이의의 소',
        summary:
          '대법원 2017다17771 사건(대법원, 2017.10.12 선고)에서 법원은 면책결정이 확정된 뒤 어떤 채권이 비면책채권에 해당하는지 다투어지는 경우 채무자가 면책확인의 소로 법률상 불안을 제거할 수 있다고 보면서도, 채권자가 이미 집행권원을 가지고 있는 경우에는 청구이의의 소로 집행력 배제를 구하는 것이 더 유효적절한 수단이므로 면책확인의 소는 확인의 이익이 없다고 판시했습니다.',
        takeaway: '보증채무까지 면책결정을 받은 뒤 채권자가 그 채무를 계속 청구하면, 집행권원이 있는지에 따라 면책확인의 소 또는 청구이의의 소 중 적절한 방법을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {

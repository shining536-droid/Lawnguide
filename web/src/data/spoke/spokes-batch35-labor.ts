  ...
  // ───────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        title: '소액재판과 대지급금제도',
        content:
          '<p><strong style="color:#1e3a5f">3,000만 원 이하 임금체불은 소액재판으로 빠르게 해결할 수 있고, 사업주 무자력 시 대지급금으로 보전받을 수 있습니다.</strong></p>\n<ul>\n<li><strong>소액재판(이행권고)</strong> — 청구금액 3,000만 원 이하는 소액사건심판법에 따라 간이절차로 진행됩니다. 1회 변론으로 판결이 나오는 경우가 많아 2~3개월 내에 결과를 받을 수 있습니다</li>\n<li><strong>지급명령 신청</strong> — 금액이 명확하고 증거가 충분하면 지급명령 신청이 더 빠릅니다. 상대방이 이의하지 않으면 확정판결과 같은 효력이 생깁니다</li>\n<li><strong>간이대지급금(간이대지급금)</strong> — 사업주가 도산하지 않았더라도 재판 확정 후 지급 불능인 경우, 고용노동부에 간이대지급금을 신청할 수 있습니다. 최대 1,000만 원까지 정부가 대신 지급합니다</li>\n<li><strong>대지급금제도</strong> — 사업주가 도산(파산, 회생 등)한 경우 최종 3개월분 임금과 최종 3년분 퇴직금을 근로복지공단에서 대신 지급받을 수 있습니다</li>\n</ul>',
      },
    ],
    cases: [
      {
    ...
    faq: [
      ...
      {
        question: '대지급금은 최대 얼마까지 받을 수 있나요?',
        answer:
          '<strong>간이대지급금(간이대지급금)은 최대 1,000만 원, 일반 대지급금은 최종 3개월분 임금과 최종 3년분 퇴직금입니다.</strong> 다만 연령별 상한액이 있으며, 대지급금은 사업주 도산 또는 지급 불능이 확인되어야 신청 가능합니다. 근로복지공단에 직접 신청합니다.',
      },
    ],
    cta: {

    ...
    cases: [
      {
        ...
        summary:
          '대법원 2016두36864(대법원, 2016.08.30 선고)에서 법원은 재산분할이 부부가 혼인 중 공동의 노력으로 이룩한 재산을 청산하는 제도로서, 실질적으로 부부공동재산에 해당하면 그 형성·유지에 대한 쌍방의 기여를 반영해 청산 대상이 된다고 판시했습니다. 부부가 함께 일군 사업체의 자산도 이런 공동재산 청산의 관점에서 접근할 수 있으므로, 유사한 상황이라면 기여도 입증 자료를 정리해 재산분할 대상 여부를 검토해볼 수 있습니다.',
        takeaway: '부부가 함께 일군 재산은 공동 청산 대상. 기여도는 50:50 자동 아님 — 회계장부·기여 입증 자료 확보가 분기점.',
      },
    ],
    faq: [
      {
    ...
    cases: [
      {
        title: '판례 — 외도 상대방 위자료',
        summary:
          '서울가정법원 2009드합8574(서울가정법원, 2011.04.20 선고)에서는 부정행위로 부부공동생활이 파탄에 이른 사안에서 유책 있는 상대방에게 위자료 지급 책임이 인정된다고 본 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하며, 외도 상대방(제3자)에게 책임을 물을 수 있는지는 상대가 혼인 사실을 알았거나 알 수 있었는지 등 구체적 사정에 따라 달라질 수 있으므로, 유사한 상황이라면 관련 증거를 정리해 위자료 청구 가능성을 검토해볼 수 있습니다.',
        takeaway: '외도 상대방에게 책임을 묻는 핵심은 \"혼인 사실 인식\" 여부 — 관련 대화·정황 증거부터 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {

...
export const spokesBatch37Labor: SpokePage[] = [
  ...
  // ─── 3. retirement / unpaid-guarantee-fund-simple ───
  {
    ...
    intro:
      '<p>퇴직금을 받지 못한 채 몇 달이 지났습니다. 회사는 돈이 없다고 버티고, 민사소송은 시간과 비용이 부담됩니다. 이럴 때 국가가 체불 임금·퇴직금 일부를 선지급하는 "간이대지급금(구 간이대지급금)" 제도가 있습니다. 요건만 맞으면 사업주 재산 상태와 무관하게 빠르게 지급받을 수 있습니다. 신청 절차와 한도, 주의사항을 정리해드립니다.</p>',
    sections: [
      {
  ...
  // ─── 8. dismissal / tardiness-repeated-discipline ───
  {
    ...
    perspective: 'victim',
    meta: {
      title: '지각 자주 했다고 해고됐어요. 다툴 수 있나요? | 로앤가이드',
      description:

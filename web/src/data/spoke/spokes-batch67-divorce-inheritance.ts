...
export const spokesBatch67DivorceInheritance: SpokePage[] = [
  ...
  // ─── 2. divorce-spouse-game-screen-addiction-divorce-track ───
  {
    ...
    internalLinks: [
      { label: '외국인 배우자 이혼 국제재판 준거법', href: '/guide/divorce/divorce-foreign-spouse-litigation-procedure' },
      { label: '재산분할 기준시점 변론종결일', href: '/guide/divorce/divorce-property-division-cutoff-date' },
      { label: '배우자 외도 위자료 청구', href: '/guide/divorce/divorce-adultery-consolation-money-track' },
      { label: '협의이혼 거부 재판상 이혼', href: '/guide/divorce/divorce-mediation-refused-trial-procedure' },
      { label: '협의이혼 준비', href: '/guide/divorce/divorce-consultation-prep' },
    ],
  ...
  // ─── 3. divorce-spouse-cult-religion-excessive-donation-track ───
  {
    ...
    internalLinks: [
      { label: '외국인 배우자 이혼 국제재판 준거법', href: '/guide/divorce/divorce-foreign-spouse-litigation-procedure' },
      { label: '이혼 사망 재산분할 상속', href: '/guide/divorce/divorce-property-division-inheritance' },
  ...
  // ─── 4. divorce-spouse-employee-stock-option-vesting-asset-division-track ───
  {
    ...
    cta: { text: '협의이혼 준비서류, AI로 정리하기', link: '/chat?domain=divorce' },
    internalLinks: [
      { label: '배우자 사업 채무 분담 재산분할 판단', href: '/guide/divorce/divorce-spouse-business-debt-burden-property-division-track' },
      { label: '재산분할 범위', href: '/guide/divorce/divorce-property-division-scope-faq' },
      { label: '외국인 배우자 이혼 국제재판 준거법', href: '/guide/divorce/divorce-foreign-spouse-litigation-procedure' },
      { label: '협의이혼 준비', href: '/guide/divorce/divorce-consultation-prep' },
      { label: '협의이혼 거부 재판상 이혼', href: '/guide/divorce/divorce-mediation-refused-trial-procedure' },

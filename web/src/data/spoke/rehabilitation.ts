...
export const rehabilitationPages: SpokePage[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      {
        question: '소득이 적으면 원칙적으로 기각되나요?',
        answer:
          '소득이 적더라도 <strong>최저 생계비를 초과하는 가용소득</strong>이 있으면 신청 가능합니다. 가용소득이 월 몇만 원이라도 변제가 가능하면 인정될 수 있습니다. 최저 생계비 기준은 가구원 수에 따라 달라지므로 본인의 가구 상황에 맞춰 확인하세요.',
      },
      {
        question: '사채도 채권자 목록에 넣어야 하나요?',
        answer:
          '가능한 한 넣어야 합니다. <strong>사채, 개인 간 차용금, 보증채무</strong> 등 빠뜨리면 허위기재로 간주되어 기각 또는 면책 불허가 사유가 됩니다.',
      },
      {

...
export const rehabilitationPages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '실수함정형',
    meta: {
      title: '개인회생 기각 사유와 방지 방법 | 로앤가이드',
      description:
        '개인회생 기각 사유(소득 부족, 채무한도 초과, 서류 미비, 허위기재 등)와 각각의 방지 방법을 정리했습니다.',
    },
    intro:
  ...
  },
  {
    ...
    type: '절차타임라인형',
    meta: {
      title: '개인회생 신청 절차 A to Z | 로앤가이드',
      description:
        '채무자회생법 제579조·제600조에 따른 개인회생 신청 자격 확인부터 변제계획 인가, 면책 결정까지 전체 과정을 단계별로 안내합니다.',
    },
    intro:

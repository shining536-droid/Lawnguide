...
export const spokesBatch74WageUnempRetire: SpokePage[] = [
  // ─── 1. wage-incentive-clawback-leaving-bonus-recovery-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '연봉 재계약 포괄임금 조항 삭제 요청', href: '/guide/wage/wage-pogual-contract-renegotiation' },
      { label: '퇴사 후 야근수당 청구', href: '/guide/wage/post-resignation-overtime-claim' },
  ...
  // ─── 2. wage-on-call-standby-no-pay-claim-track ───
  {
    ...
    internalLinks: [
      { label: '임금체불 신고 절차와 처리 기간', href: '/guide/wage/unpaid-wage-report-procedure-timeline' },
      { label: '정기 상여금 통상임금 포함', href: '/guide/wage/wage-regular-bonus-ordinary-wage-track' },
  ...
  // ─── 5. retirement-corporate-officer-deemed-employee-track ───
  {
    ...
    internalLinks: [
      { label: '퇴직급여 종합 가이드', href: '/guide/retirement' },
      { label: '건설 일용직 퇴직공제금', href: '/guide/retirement/retirement-construction-daily-claim' },
      { label: '임원 근로자성 퇴직금', href: '/guide/retirement/retirement-executive-employee-status-track' },
      { label: '퇴직금 시효 3년', href: '/guide/retirement/retirement-statute-of-limitations' },

...
export const spokesBatch49WageUnempRetire: SpokePage[] = [
  // ─── 1. wage / unpaid-one-year-statute-claim ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>사업주가 자연인이라면 개인 재산에 대해 청구 가능하며, 도산대지급금(대지급금) 신청도 검토할 수 있습니다.</strong> 고용노동부에 도산대지급금 신청을 하면 최대 1,000만 원 한도 내에서 우선 변제받을 수 있어요.',
      },
      {
  ...
  // ─── 4. unemployment / contract-non-renewal-just-cause ───
  {
    ...
    cases: [
      {
        title: '재결례 — 계약기간 만료를 비자발적 이직으로 본 사례',
        summary:
  ...
  // ─── 5. unemployment / fraudulent-recovery-penalty ───
  {
    ...
    cases: [
      {
        title: '재결례 — 노무 제공내역 미신고 부정수급 처분 취소 사례',
        summary:

...
export const spokesBatch74DivorceInheritCs: SpokePage[] = [
  ...
  // ─── 2. divorce-foreign-spouse-visa-link-pressure-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '배우자 비상장주식 재산분할 판단', href: '/guide/divorce/divorce-unlisted-company-shares-property-division-track' },
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
  ...
  // ─── 3. divorce-postnuptial-agreement-validity-dispute-track ───
  {
    ...
    cta: { text: '재산분할·양육비 쟁점, AI로 먼저 점검하기', link: '/chat?domain=divorce' },
    internalLinks: [
      { label: '미확정 스톡옵션 재산분할 대상 판단', href: '/guide/divorce/divorce-unvested-stock-option-property-division-track' },
      { label: '외국인 배우자 이혼 국제재판 준거법', href: '/guide/divorce/divorce-foreign-spouse-litigation-procedure' },
      { label: '사실혼 파기 위자료', href: '/guide/divorce/divorce-de-facto-marriage-alimony-claim' },
      { label: '협의이혼 의사 철회 시점 절차', href: '/guide/divorce/divorce-consensual-intent-withdrawal-procedure' },
      { label: '가정폭력 긴급피난처 보호명령', href: '/guide/divorce/divorce-domestic-violence-emergency-shelter' },
    ],
  },
  ...
  // ─── 4. divorce-spouse-debt-hidden-after-marriage-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '사업실패 채무 재산분할', href: '/guide/divorce/divorce-business-failure-debt-division-track' },
      { label: '협의이혼 의사 철회 시점 절차', href: '/guide/divorce/divorce-consensual-intent-withdrawal-procedure' },
    ],
  },
  ...
  // ─── 8. child-support-step-mother-bio-father-deceased-claim-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '과거 양육비 소급 청구 가능 여부', href: '/guide/child-support/retroactive-child-support-claim' },
      { label: '양육비 변경 신청 소득 변동', href: '/guide/child-support/child-support-modification-income-change' },
  ...
  // ─── 9. child-support-recipient-cohabit-new-partner-reduction-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '양육비 감액 채무자 장해 수입 감소', href: '/guide/child-support/child-support-modification-payer-disability-income-drop-track' },
      { label: '양육비 채권 양도 추심', href: '/guide/child-support/child-support-claim-assignment-recovery-track' },
      { label: '양육비 소송 절차', href: '/guide/child-support/child-support-lawsuit-process' },
      { label: '양육비 직접지급명령', href: '/guide/child-support/child-support-direct-payment-order-process' },
    ],
  },

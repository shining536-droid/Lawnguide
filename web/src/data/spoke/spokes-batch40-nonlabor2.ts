...
export const spokesBatch40Nonlabor2: SpokePage[] = [
  ...
  // ─── 7. jeonse / partial-deposit-return-remaining-claim ───
  {
    domain: 'jeonse',
    slug: 'jeonse-partial-deposit-return-remaining-claim',
    keyword: '보증금 일부 반환 잔액 청구',
    questionKeyword: '전세보증금 일부만 받고 잔액은 어떻게 하나요?',
    ctaKeyword: '보증금 잔액 청구 점검',
    type: '절차형',
    perspective: 'victim',
    meta: {
      title: '전세보증금 일부 반환 후 잔액 청구 4단계 절차 | 로앤가이드',
      description:
        '보증금 일부만 돌려받고 잔액을 못 받는 상황에서 권리 유지와 잔액 회수 절차를 정리했습니다. 임차권등기명령·지급명령·소액소송 순서를 지금 확인하세요.',
    },
    intro:
      '<p>집주인이 "먼저 일부만 돌려줄 테니 이사 나가 달라"고 하는 상황은 세입자에게 위험이 큽니다. 일부 반환을 받고 짐·주소를 빼면 대항력·우선변제권이 일부 소멸해 잔액 회수가 어려워질 수 있습니다. 일부 받고 잔액을 청구하는 상황에서 권리 유지·소송 순서를 정리합니다.</p>',
    sections: [
      {
        title: '일부 수령 시 주의점 — 권리 소멸 여부',
        content:
          '<p><strong style="color:#1e3a5f">보증금 일부만 수령해도 계약 종료·이사·전출 여부에 따라 대항력·우선변제권이 사라질 수 있습니다.</strong></p>\n<ul>\n<li><strong>대항력 유지 조건</strong> — 주택 점유 + 주민등록(전입신고)이 유지되어야 함.</li>\n<li><strong>우선변제권</strong> — 대항력 + 확정일자 유지 시 경매에서 우선 배당.</li>\n<li><strong>일부 수령 자체는 중립</strong> — 받는 것만으로 권리가 소멸되지는 않음.</li>\n<li><strong>위험한 조합</strong> — "일부 수령 + 이사 + 전출"은 권리 소멸로 이어질 수 있음.</li>\n</ul>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">핵심: 일부만 받고 잔액 미수령 상태라면, 전출·이사 전에 반드시 "임차권등기명령" 등 보호조치를 먼저 검토하세요.</blockquote>',
      },
      {
        title: '임차권등기명령 — 이사해야 할 때 필수',
        content:
          '<p><strong style="border-bottom:2px solid #f4c430">잔액을 받지 못한 채 이사해야 한다면, 임차권등기명령이 유일한 권리 보존책입니다.</strong></p>\n<ul>\n<li><strong>제도 개요</strong> — 주택임대차보호법 제3조의3, 계약 종료 후 보증금을 반환받지 못한 임차인이 단독 신청.</li>\n<li><strong>효과</strong> — 등기된 날부터 대항력·우선변제권을 유지한 채 전출·이사 가능.</li>\n<li><strong>신청처</strong> — 임차주택 소재지 지방법원.</li>\n<li><strong>필요서류</strong> — 임대차계약서·주민등록등본·확정일자 받은 계약서·전출 불가 사유서 등.</li>\n</ul>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>💬 AI 법률 상담으로 빠르게 확인하세요</strong></p>\n<p style="margin:0;font-size:0.95em">변호사 상담 전, AI가 보증금 잔액 회수 전략을 분석해드립니다.</p>\n<a href="/chat?domain=jeonse" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '잔액 청구 — 내용증명 → 지급명령 → 소송',
        content:
          '<p><strong style="color:#1e3a5f">잔액 반환은 내용증명→지급명령→민사소송→강제집행 순서로 진행됩니다.</strong></p>\n<ul>\n<li><strong>1단계 내용증명</strong> — 잔액·이자·지연손해금 명시한 반환 촉구 내용증명 발송.</li>\n<li><strong>2단계 지급명령</strong> — 이의 없으면 판결 효력. 신속·저비용.</li>\n<li><strong>3단계 반환청구소송</strong> — 이의 또는 다툼 있으면 본안 소송. 6~12개월.</li>\n<li><strong>4단계 강제집행</strong> — 판결·조정조서로 예금·부동산·급여 등 집행.</li>\n</ul>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">팁: 일부 수령 영수증에는 "잔액은 계속 청구한다"는 문구를 반드시 기재해 포기 의사가 없음을 명확히 해두세요.</blockquote>',
      },
      {
        title: '실무 체크리스트 — 일부 수령 전 확인사항',
        content:
          '<p><strong style="color:#1e3a5f">일부 수령을 수락하기 전에 반드시 확인하고 조치해야 할 항목들입니다.</strong></p>\n<ul>\n<li><strong>계약 종료 일자 확인</strong> — 계약기간·묵시갱신 여부를 먼저 정리.</li>\n<li><strong>확인서 작성</strong> — 수령금액·수령일·잔액·지급기일을 명시한 확인서를 작성하고 서명.</li>\n<li><strong>전출 금지</strong> — 잔액 지급 전까지 전출·이사 보류, 불가피 시 임차권등기명령 선행.</li>\n<li><strong>보증보험 확인</strong> — 전세보증금 반환보증 가입자는 보험사 지급 청구도 병행 가능.</li>\n</ul>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">주의: "일부 수령 = 전부 포기"로 오해받지 않도록 모든 대화·문서를 기록으로 남겨야 합니다.</blockquote>',
      },
    ],
    cases: [
      {
        title: '판례 — 일부 수령만으로 반환채권 포기가 아님',
        summary:
    ...
    faq: [
      {
        question: '일부만 받고 이사 들어가도 되나요?',
        answer:
          '<strong>임차권등기명령이 완료된 후 이사하는 편이 안전합니다.</strong> 선(先) 전출은 대항력·우선변제권 소멸 위험이 있습니다.',
      },
      {
        question: '잔액에 지연이자도 청구 가능한가요?',
        answer:
          '<strong>가능합니다.</strong> 법정이자(연 5%) 또는 소송촉진법상 연 12% 이자가 판결 시점부터 가산됩니다.',
      },
      {
        question: '집주인이 "이사가면 돌려준다"고 하면?',
        answer:
          '<strong>문자·녹취로 증거를 확보하고 이사 전에 임차권등기를 먼저 하세요.</strong> 말만 믿고 전출하면 권리가 약해집니다.',
      },
      {
        question: '보증금 반환보증 가입 중이면 어떻게 하나요?',
        answer:
          '<strong>보증보험 청구와 법적 회수를 병행하면 안전합니다.</strong> 보험 지급 요건에 맞춰 임차권등기·내용증명을 순서대로 진행하세요.',
      },
      {
        question: '잔액이 소액(3천만원 이하)이면 어디에 소송하나요?',
        answer:
          '<strong>소액사건심판 절차로 빠르게 진행 가능합니다.</strong> 변호사 없이도 서식·절차가 간소해 단기에 판결을 받을 수 있습니다.',
      },
    ],
    cta: {
      text: '보증금 잔액 청구 AI 점검',
      link: '/chat?domain=jeonse',
    },
    internalLinks: [
      { label: '전세보증금 반환 종합 가이드', href: '/guide/jeonse/jeonse-deposit-return-comprehensive-guide' },
      { label: '보증금 미반환 대응 절차', href: '/guide/jeonse/jeonse-deposit-not-returned-response' },
      { label: '보증금 반환 소송 준비서류', href: '/guide/jeonse/deposit-lawsuit-preparation' },

...
export const spokesBatch33Unemployment: SpokePage[] = [
  ...
  {
    domain: 'unemployment',
    slug: 'unemployment-recognized-job-search-activity-guide',
    keyword: '실업급여 구직활동 인정 유형 총정리',
    questionKeyword: '실업급여 받으려면 어떤 구직활동이 인정되나요?',
    ctaKeyword: '실업급여 구직활동 인정 상담',
    type: '체크리스트형',
    perspective: 'victim',
    meta: {
      title: '실업급여 구직활동 인정 유형 7가지 | 로앤가이드',
      description:
        '실업인정일에 구직활동을 뭘 해야 하는지 모르겠다면 인정되는 7가지 유형과 증빙 방법을 정리했습니다. 지금 확인하세요',
    },
    intro:
      '<p>실업급여를 받고 있는데 다음 실업인정일까지 구직활동을 어떻게 채워야 할지 막막합니다. 입사지원을 했는데 증빙이 안 되면 어쩌나, 직업훈련을 들으면 인정이 되는 건지 확신이 서지 않습니다. 구직활동이 부족하다고 판단되면 해당 회차 급여가 지급되지 않으므로, 인정되는 유형과 증빙 방법을 미리 파악해두는 것이 중요합니다.</p>',
    sections: [
      {
        title: '구직활동 인정 유형 7가지 전체 목록',
        content:
          '<p><strong style="color:#1e3a5f">고용보험법 시행규칙에 따라 실업인정을 위해 인정되는 구직활동은 크게 7가지로 분류됩니다.</strong></p>\n<ol>\n<li><strong>구인업체 입사지원</strong> — 워크넷, 잡코리아, 사람인 등을 통한 온라인 입사지원 또는 직접 방문 지원</li>\n<li><strong>구인업체 면접</strong> — 서류 합격 후 면접에 참석한 경우</li>\n<li><strong>직업훈련 수강</strong> — 국민내일배움카드 등을 통한 직업능력개발 훈련 참여</li>\n<li><strong>고용센터 취업특강·세미나 참석</strong> — 고용센터에서 주관하는 취업 관련 프로그램 참여</li>\n<li><strong>자영업 준비 활동</strong> — 창업사업계획서 작성, 창업교육 수강, 사업자등록 준비 등</li>\n<li><strong>직업심리검사·직업상담</strong> — 고용센터의 직업심리검사 또는 직업상담 프로그램 참여</li>\n<li><strong>그 밖의 적극적 구직활동</strong> — 취업박람회 참석, 직업능력 관련 자격시험 응시 등</li>\n</ol>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 1~4차 실업인정까지는 온라인 입사지원만으로 인정되지만, 5차부터는 면접·훈련·세미나 등 보다 적극적인 활동이 1건 이상 포함되어야 합니다</blockquote>',
      },
      {
        title: '유형별 증빙 방법과 제출 서류',
        content:
          '<p><strong style="color:#1e3a5f">구직활동은 반드시 증빙 자료와 함께 실업인정 신청서에 기재해야 하며, 증빙이 불충분하면 불인정될 수 있습니다.</strong></p>\n<ul>\n<li><strong>온라인 입사지원</strong> — 지원 완료 화면 캡처, 지원 확인 이메일 등이 증빙이 됩니다. 워크넷 지원 내역은 자동 연동되어 별도 증빙이 필요 없습니다</li>\n<li><strong>면접 참석</strong> — 면접 안내 문자·이메일, 면접 확인서 등을 제출합니다</li>\n<li><strong>직업훈련</strong> — HRD-Net에서 출석 현황이 자동 연동됩니다. 출석률이 80% 이상이어야 인정됩니다</li>\n<li><strong>취업특강·세미나</strong> — 고용센터 프로그램은 참석 기록이 자동 반영됩니다</li>\n<li><strong>자영업 준비</strong> — 창업교육 수료증, 사업계획서, 상담 확인서 등을 제출합니다</li>\n</ul>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>💬 구직활동 증빙이 부족할 때, AI가 대안을 찾아드립니다</strong></p>\n<p style="margin:0;font-size:0.95em">실업인정일 전에 어떤 활동을 추가해야 하는지 빠르게 확인할 수 있습니다.</p>\n<a href="/chat?domain=unemployment" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '실업인정 횟수별 요구 활동 기준',
        content:
          '<p><strong style="color:#1e3a5f">실업인정 횟수가 늘어날수록 요구되는 구직활동의 수준이 높아집니다.</strong></p>\n<ul>\n<li><strong>1차 실업인정</strong> — 수급자격 교육 이수만으로 인정됩니다. 별도 구직활동 불필요</li>\n<li><strong>2~4차 실업인정</strong> — 실업인정 기간 중 최소 2회 이상 구직활동 필요. 온라인 입사지원도 인정됩니다</li>\n<li><strong>5차 이후</strong> — 최소 2회 구직활동 중 1회 이상은 면접, 직업훈련, 취업특강 등 적극적 활동이어야 합니다</li>\n<li><strong>장기수급자(7차 이후)</strong> — 고용센터 담당자와 개별 구직활동 계획을 수립하고, 계획에 따른 활동을 이행해야 합니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">주의: 동일한 기업에 같은 직무로 반복 지원하면 구직활동으로 인정되지 않을 수 있습니다. 서로 다른 기업 또는 다른 직무에 지원해야 합니다</blockquote>',
      },
      {
        title: '구직활동 불인정 사례와 대처법',
        content:
          '<p><strong style="color:#1e3a5f">구직활동이 불인정되면 해당 회차 구직급여가 지급되지 않으며, 다음 실업인정일에 보충 활동을 해야 합니다.</strong></p>\n<ol>\n<li><strong>형식적 지원</strong> — 지원 자격 요건에 전혀 맞지 않는 채용공고에 지원하면 형식적 활동으로 판단되어 불인정될 수 있습니다</li>\n<li><strong>대리 신고</strong> — 타인이 대신 온라인으로 실업인정을 신청하면 부정수급에 해당합니다. 본인이 직접 출석하거나 온라인으로 신청해야 합니다</li>\n<li><strong>허위 입사지원</strong> — 존재하지 않는 기업에 지원하거나 허위 면접 확인서를 제출하면 부정수급으로 처벌받을 수 있습니다</li>\n</ol>\n<p>구직활동이 부족한 경우, 해당 회차 급여만 지급되지 않으며 수급자격 자체가 박탈되지는 않습니다. 다음 실업인정일까지 구직활동을 보충하면 이후 급여는 정상 지급됩니다. 단, 부정수급이 적발되면 지급받은 금액의 최대 5배를 반환해야 할 수 있으므로 정직하게 신고하는 것이 중요합니다.</p>',
      },
    ],
    cases: [
      {
        title: '판례 — 해외 체류 중 대리 실업인정 신고와 부정수급',
        summary:
    ...
    faq: [
      {
        question: '워크넷 외 사람인·잡코리아 지원도 구직활동으로 인정되나요?',
        answer:
          '<strong>민간 채용사이트를 통한 입사지원도 구직활동으로 인정됩니다.</strong> 다만 워크넷 지원은 자동 연동되어 별도 증빙이 필요 없지만, 사람인·잡코리아 등 민간 사이트는 지원 완료 화면을 캡처하거나 확인 이메일을 보관해야 합니다.',
      },
      {
        question: '유튜브 취업 강의를 들어도 구직활동으로 인정되나요?',
        answer:
          '<strong>일반 유튜브 강의는 구직활동으로 인정되지 않습니다.</strong> 고용센터가 주관하거나 HRD-Net에 등록된 공식 직업훈련 과정만 인정됩니다. 다만 고용센터 온라인 취업특강은 인정되므로, 워크넷에서 온라인 프로그램을 확인해보세요.',
      },
      {
        question: '실업인정일에 깜빡 잊고 출석하지 못하면 어떻게 되나요?',
        answer:
          '<strong>실업인정일에 출석하지 않으면 해당 기간의 구직급여가 지급되지 않습니다.</strong> 다만 질병, 천재지변 등 정당한 사유가 있으면 사후에 증빙을 제출하여 인정받을 수 있습니다. 부득이한 사유가 예상되면 미리 고용센터에 실업인정일 변경을 요청하세요.',
      },
      {
        question: '자격증 시험을 준비하는 것도 구직활동에 포함되나요?',
        answer:
          '<strong>직업능력 관련 자격시험에 응시하면 구직활동으로 인정됩니다.</strong> 시험 준비만으로는 인정되지 않으며, 실제 시험에 응시한 사실(수험표, 응시 확인서)이 증빙되어야 합니다. 취업과 무관한 취미성 자격증은 인정되지 않을 수 있습니다.',
      },
      {
        question: '해외에 나가 있는 동안 실업인정을 받을 수 있나요?',
        answer:
          '<strong>해외 체류 중에는 원칙적으로 실업인정을 받을 수 없습니다.</strong> 출국 전에 고용센터에 사유를 신고하고 실업인정일 변경을 요청해야 합니다. 무단으로 출국한 뒤 대리인이 신고하면 부정수급으로 판정되어 급여 반환 및 추가징수 처분을 받을 수 있습니다.',
      },
    ],
    cta: {
      text: '구직활동 인정 여부, AI가 바로 확인해드립니다',
      link: '/chat?domain=unemployment',
    },
    internalLinks: [
      { label: '실업급여 수급 요건 총정리', href: '/guide/unemployment/unemployment-benefit-requirements' },

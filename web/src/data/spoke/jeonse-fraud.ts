...
export const jeonseFraudPages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '절차형',
    meta: {
      title: '전세사기 경매 보증금 돌려받는 법·배당 절차 | 로앤가이드',
      description: '전세사기로 경매가 진행되면 보증금을 돌려받을 수 있을까요? 우선변제권 확보, 소액임차인 최우선변제, 배당이의 신청까지 지금 확인하세요.',
    },
    intro:
  ...
  },
  {
    ...
    cases: [
      {
        title: '대법원 2008다51120 — 다수 임차인의 손해배상과 공동불법행위',
        summary:
          '대법원 2008다51120 사건(대법원, 2009.08.20 선고)에서 법원은 임대차 교섭 과정에서 임차인들에게 중요한 사정에 관한 신의칙상 고지·설명의무를 위반한 사업시행자와 이를 조장·방치한 기관이 공동불법행위자로서 연대하여 임차인들에게 손해를 배상할 의무가 있다고 판시했습니다. 여러 임차인이 입은 손해액은 우선 각자에게 입증 기회를 부여하고, 그래도 구체적 액수를 알기 어려우면 관련 간접사실을 종합해 산정해야 한다고 보았습니다.',
        takeaway:
          '같은 임대인에게 피해를 입은 다수 임차인이 함께 대응하면 책임 주체들의 연대책임과 손해액을 한꺼번에 다툴 수 있으므로, 피해자별 계약서·이체 내역을 모아 공동 신청·소송을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {

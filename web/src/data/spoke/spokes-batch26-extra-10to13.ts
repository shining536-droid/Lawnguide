    ...
    faq: [
      {
        ...
        answer:
          '계약서에 "포괄임금"이라는 표현이 없어도 기본급과 법정수당이 구분되지 않고 총액으로만 기재되어 있다면 사실상 정액급제에 해당할 소지가 있습니다. 판례는 명칭이 아니라 실질 지급 방식으로 포괄임금 여부를 판단합니다.',
      },
      {
    ...
    cases: [
      {
        ...
        takeaway:
          '비슷한 상황이라면 간주근로시간제나 재량근로시간제 도입을 고려할 때 가능한 한 노사 서면 합의를 먼저 체결하고, 법정 업무 요건에 해당하는지 확인하세요. 요건 없이 도입하면 포괄임금과 동일한 문제가 생깁니다.',
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          '법정 재량근로 업무인 정보처리시스템 설계·분석에 해당하면 적용 가능합니다. 단, 단순 코딩 업무나 유지보수 업무는 해당하지 않을 수 있습니다. 노사 서면 합의가 없으면 재량근로로 인정되지 않으므로 가능한 한 합의서를 체결하고 취업규칙에 반영해야 합니다.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '네, 가능한 한 근로자 대표와의 서면 합의가 필요합니다. 개별 근로계약서도 변경해야 하며, 근로자 불이익이 없는 경우 동의 절차가 비교적 간단합니다. 그러나 실질적으로 임금이 줄어드는 경우 근로자 과반수 동의가 필요합니다.',
      },
    ],
    internalLinks: [
      { label: '로앤가이드 홈', href: '/' },

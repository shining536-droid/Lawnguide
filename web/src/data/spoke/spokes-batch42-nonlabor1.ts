...
export const spokesBatch42Nonlabor1: SpokePage[] = [
  ...
  // ─── 9. divorce / omitted-asset-additional-claim ───
  {
    ...
    cases: [
      {
        title: '판례 — 재산분할 대상과 기여도 산정',
        summary:
          '제주지방법원 2019드단13537(제주지방법원, 2022.09.27 선고)에서는 혼인기간 중 형성된 재산을 나누면서 부부 각자의 기여 정도, 혼인기간, 가사·육아 분담과 소득활동 등을 두루 고려해 재산분할 비율을 정한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하며, 이혼 당시 드러나지 않았던 재산이 뒤늦게 확인된 경우에도 이런 기준에 따라 분할 대상에 포함될 수 있는지 검토해볼 수 있습니다.',
        takeaway:
          '재산분할은 부부 각자의 기여도를 종합해 정해지며, 민법 제839조의2에 따라 이혼한 날부터 2년의 제척기간 안이라면 누락 재산의 추가 분할도 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {

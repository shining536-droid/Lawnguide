...
export const spokesBatch42Nonlabor1: SpokePage[] = [
  // ─── 1. fraud / secondhand-settlement-accept-criteria ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>피의자 경제력이 확실할 때만 고려하세요.</strong> 분납 중 미이행 시 처벌불원 철회 조항 반드시 포함.',
      },
    ],
    cta: {
  ...
  // ─── 4. fraud / investment-complaint-prep-5items ───
  {
    ...
    meta: {
      ...
      description:
        '주식·코인·부동산 투자 사기를 당했을 때 고소장 제출 전 반드시 모아야 할 5가지 증거자료와 수집 순서를 지금 확인하세요.',
    },
    intro:
  ...
  // ─── 10. defamation / group-chat-requirements-4items ───
  {
    ...
    intro:
      '<p>"단톡방에서 뒷담화 당했는데 명예훼손으로 고소할 수 있나요?"라는 질문이 늘고 있습니다. 형법 제307조 명예훼손은 "공연히 사실(또는 허위)을 적시해 사람의 명예를 훼손"할 것을 요건으로 하며, 정보통신망법 제70조는 정보통신망 이용 시 가중처벌합니다. 단톡방도 참여자 수·공연성·특정성·명예훼손적 표현 4가지가 갖춰지면 성립합니다.</p>',
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          '<strong>네, 3인 이상이면 공연성 인정됩니다.</strong> 판례상 2인만 있는 방은 일반적으로 불인정.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<strong>모욕죄로 별도 처벌됩니다.</strong> 사실 적시 없이 욕설만 있으면 모욕죄(형법 제311조).',
      },
      {

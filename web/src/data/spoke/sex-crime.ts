...
export const sexCrimePages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '어디부터형',
    meta: {
      title: '성추행 혐의 받았을 때 즉시 해야 할 3가지 | 로앤가이드',
      description: '성추행 혐의로 고소당해 막막하신가요? 초기 대응, 수사 절차, 단계별 변호 전략까지 바로 정리해보세요.',
    },
  ...
  },
  {
    ...
    type: '절차타임라인형',
    meta: {
      title: '강제추행 피해 수사~재판 6단계 절차 | 로앤가이드',
      description: '강제추행 피해를 신고하면 어떤 절차를 거치나요? 증거 확보, 경찰 수사, 검찰 기소, 재판, 선고까지 단계별로 지금 확인하세요.',
    },
    intro: '회식 자리에서, 지하철에서, 혹은 아는 사람에게서 갑작스러운 신체 접촉을 당했습니다. 충격과 수치심 속에서 신고해야 할지, 신고하면 어떤 절차를 거치게 되는지 알 수가 없습니다. 수사 과정에서 또다시 상처받을까 두려운 마음도 큽니다. 하지만 절차를 미리 이해하면 불안을 줄이고 더 효과적으로 대응할 수 있습니다. 피해자로서 수사부터 재판까지 전체 과정을 단계별로 안내합니다.',
    ...
    cta: {
      text: '강제추행 피해 상황에 맞는 대응 절차를 확인해보세요',
      link: '/diagnosis/sex-crime',
    },
    internalLinks: [
      { label: '홈', href: '/' },

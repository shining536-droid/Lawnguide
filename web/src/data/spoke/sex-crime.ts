...
export const sexCrimePages: SpokePage[] = [
  {
    ...
    type: '상황형',
    meta: {
      title: '성추행 혐의 대응 방법과 합의 절차 | 로앤가이드',
      description:
        '성추행 혐의를 받고 있을 때 변호사 선임, 합의 절차, 처벌 수위, 진술 준비와 증거 확인까지 대응 방법을 정리했습니다.',
    },
    intro:
  ...
  },
  {
    ...
    type: 'Q&A형',
    meta: {
      title: '성범죄 무고를 당했을 때 반대고소 가능한지 | 로앤가이드',
      description:
        '성범죄 무고를 당했을 때 무고죄 성립 요건, 반대고소 시기와 절차, 증거 확보 방법, 변호사 상담까지 정리했습니다.',
    },
    intro:
  ...
  },
  {
    ...
    type: '절차형',
    meta: {
      title: '성폭력 피해자 국선변호사 신청 방법 | 로앤가이드',
      description:
        '성폭력 피해자를 위한 국선변호사 제도 안내, 신청 방법, 지원 범위, 추가 법률 지원까지 정리했습니다.',
    },
    intro:
  ...
  },
  {
    ...
    type: '절차타임라인형',
    meta: {
      title: '강제추행 피해 수사에서 재판까지 절차 | 로앤가이드',
      description: '강제추행(형법 제298조) 피해자 관점에서 신고, 증거 확보, 경찰 수사, 검찰 기소, 재판, 선고까지 전체 절차를 단계별로 정리했습니다.',
    },
  ...
  },
  {
    ...
    type: '실수함정형',
    meta: {
      title: '성범죄 혐의 받을 때 흔히 하는 실수 | 로앤가이드',
      description: '성범죄 혐의를 받았을 때 피해야 할 초기 대응 실수와 올바른 방어 전략을 대법원 2019도14876 판례를 바탕으로 정리했습니다.',
    },

...
export const spokesBatch28PogualDismissal: SpokePage[] = [
  ...
  // ── 1. IT개발자 포괄임금 야근수당 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>네, 재택근무 중 업무 지시를 받고 실제 근로한 시간은 연장근로에 해당할 소지가 있습니다. VPN 접속 기록, 메신저 활동 시간이 증거가 됩니다.</p>',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>사용자의 지휘·감독 아래 대기하는 시간은 근로시간에 포함됩니다. 배포 대기, 장애 대응 대기 등이 이에 해당할 소지가 있습니다.</p>',
      },
      {
  ...
  // ── 2. 신입사원 포괄임금 계약서 점검 ──
  {
    ...
    meta: {
      ...
      description:
        '첫 직장 계약서에 포괄임금이 적혀 있다면, 불리한 조항 5가지를 가능한 한 점검하세요. 계약서 점검 방법을 지금 확인하세요.',
    },
    intro:
    ...
    faq: [
      {
        ...
        answer:
          '<p>네, 인수인계가 22시 이후에 이루어지면 그 시간도 야간근로에 해당할 소지가 있습니다. 나이트 근무 전 인수인계로 21시 30분에 출근해야 한다면 21시 30분~22시는 연장근로, 22시 이후는 야간근로입니다.</p>',
      },
      {
        question: '이브닝 근무도 야간수당 대상인가요?',
        answer:
          '<p>이브닝 근무가 22시까지 이어지는 경우, 22시 이후 인수인계 시간이 야간근로에 해당할 소지가 있습니다. 22시 이전에 퇴근한다면 야간수당 대상이 아닙니다.</p>',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '<p>네, 근로계약서가 없어도 실제 근로한 사실이 있으면 근로관계가 인정될 수 있습니다. 통장 입금내역, 동료 증언, CCTV 등이 증거가 됩니다.</p>',
      },
      {
  ...
  // ── 6. 임신 중 해고 법적 보호 ──
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          '<p><strong style="color:#1e3a5f">직접 해고가 아니더라도 다음과 같은 불이익은 위법입니다.</strong></p>\n<ul>\n<li><strong>계약 갱신 거부</strong> — 기간제 근로자의 경우 계약 만료를 이유로 갱신을 거부하더라도, 임신이 실질적 원인이면 부당해고에 해당할 소지가 있습니다.</li>\n<li><strong>근로조건 불이익 변경</strong> — 임신 후 업무량 축소, 부서 이동, 임금 삭감 등은 불이익 처우에 해당할 소지가 있습니다.</li>\n<li><strong>자발적 퇴직 강요</strong> — "쉬는 게 좋지 않겠느냐"는 퇴직 권유도 실질적으로 거부 불가능하면 해고와 동일하게 봅니다.</li>\n</ul>',
      },
      {
        title: '즉시 확보해야 할 증거',
        content:
    ...
    faq: [
      {
        ...
        answer:
          '<p>네, 기간제 근로자도 근로기준법상 임신 중 해고 금지 규정의 보호를 받습니다. 계약 만료를 명목으로 하더라도 실질적으로 임신이 원인이면 부당해고로 검토될 수 있습니다.</p>',
      },
      {
  ...
  // ── 8. 아르바이트 부당해고 구제 ──
  {
    ...
    sections: [
      {
        ...
        content:
          '<p><strong style="color:#1e3a5f">아르바이트, 파트타임, 일용직도 근로기준법상 근로자에 해당할 소지가 있습니다.</strong></p>\n<ol>\n<li><strong>근로자 판단 기준</strong> — 사용자의 지휘·감독 아래 근로를 제공하고 임금을 받으면 근로자입니다. 고용 형태, 호칭(알바, 프리랜서 등)은 중요하지 않습니다.</li>\n<li><strong>해고 제한</strong> — 5인 이상 사업장에서는 정당한 이유 없는 해고가 금지됩니다(근로기준법 제23조). 해고 시 서면 통지도 필수입니다.</li>\n<li><strong>해고예고수당</strong> — 30일 전 예고 없이 해고하면 30일분 통상임금을 지급해야 합니다. 다만 3개월 미만 근속자는 예외입니다.</li>\n</ol>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: "알바는 아무 때나 자를 수 있다"는 것은 잘못된 상식입니다. 정당한 사유와 서면 통지가 없으면 부당해고로 검토될 수 있습니다.</blockquote>',
      },
      {
        title: '구제 방법 4가지',
        content:
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>근로계약서 미교부 자체가 근로기준법 위반입니다(500만원 이하 벌금). 근로계약서가 없어도 실제 근로 사실이 있으면 근로자로 인정될 수 있습니다.</p>',
      },
      {

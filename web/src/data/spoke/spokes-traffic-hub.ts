...
export const spokesTrafficHub: SpokePage[] = [
  ...
  // ─── 교통사고 통원치료·합의 종합 가이드 (클러스터 허브) ───
  {
    ...
    intro:
      '<p>교통사고 후에는 치료·합의·보험사 대응·과실비율을 함께 판단해야 해서 어디부터 정리할지 막막할 수 있습니다. 이 가이드는 통원 횟수, 치료기간, 합의금, 보험사 대응, 후유증, 과실비율을 순서대로 확인하도록 정리했으니 아래에서 내 상황에 가까운 주제를 골라 검토해볼 수 있습니다.</p>',
    sections: [
      {
        title: '🚑 교통사고 통원치료 기본 구조 — 사고 직후부터 합의까지',
        content:
          '<p>사고 직후엔 현장 안전 확보와 경찰·보험사 접수, 사고 사진·블랙박스 확보, 이른 병원 진료가 기본입니다. 부상 보상은 치료비·위자료·휴업손해·향후치료비·후유장해 손해 등으로 나뉘므로, 어떤 항목이 있는지 먼저 알아두면 도움이 됩니다.</p>',
        links: [
      ...
      },
      {
        ...
        content:
          '<p>치료기간·통원 횟수는 부상 정도와 치료 경과를 보여주는 자료 중 하나일 뿐, 몇 회를 받으면 얼마가 나온다고 단정할 수 있는 것은 아닙니다. 치료는 증상에 맞게 받고 진단서·진료기록·영수증을 챙겨두면 이후 손해 정리의 근거가 됩니다.</p>',
        links: [
      ...
      },
      {
        ...
        content:
          '<p>합의금은 치료비·위자료·휴업손해 등을 종합해 정해지고, 통원 횟수 하나로 결정되지 않습니다. 합의는 되돌리기 어려우니, 치료가 끝나기 전 성급한 합의는 신중히 판단하는 것이 좋습니다.</p>',
        links: [
      ...
      },
      {
        ...
        content:
          '<p>보험사가 합의나 치료 종결을 재촉하더라도, 정리된 항목과 남은 항목을 서류로 확인하며 차분히 대응하는 것이 좋습니다. 안내는 문자·서면으로 남기고, 이견이 크면 금융감독원(1332)·손해보험협회 조정 절차를 검토해볼 수 있습니다.</p>',
        links: [
      ...
      },
      {
        ...
        content:
          '<p>입원·통원·한방 중 어떤 치료를 받을지는 증상에 대한 의료진의 판단 영역이라 이 가이드에서 대신 정할 수는 없습니다. 다만 어떤 치료든 진단·진료기록과 영수증을 남겨두면 이후 손해를 정리할 때 근거가 됩니다.</p>',
      },
      {
        title: '🩹 후유증·추가진단·치료연장 — 합의 후 추가 청구',
        content:
          '<p>합의 뒤 통증이 남거나 새 증상이 나타나면, 합의 당시 예상하기 어려웠던 후유증에 한해 추가 청구가 검토되는 사례가 있습니다. 증상이 지속되면 담당 의료진과 상의해 후유장해 진단 등 자료를 남겨두는 것이 중요합니다.</p>',
        links: [
      ...
      },
      {
        ...
        content:
          '<p>과실비율은 사고 유형과 도로·신호 상황으로 판단되며, 보험사가 처음 안내한 비율이 확정은 아니어서 이견이 있으면 다툴 수 있습니다. 블랙박스가 없어도 목격자·사고 흔적으로 입증을 시도할 수 있습니다.</p>',
        links: [
      ...
      },
      {
        title: '❓ 자주 묻는 질문',
        content:
          '<p>교통사고 치료와 합의에서 많이 나오는 질문을 모았습니다. 답변은 일반 안내이며, 구체적인 사안은 담당 의료진과 보험회사·분쟁조정기관 안내로 확인해보는 것이 좋습니다.</p>',
      },
    ],
    cases: [],
    faq: [

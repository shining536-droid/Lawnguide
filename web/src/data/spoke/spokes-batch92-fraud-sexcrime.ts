...
export const spokesBatch92FraudSexCrime: SpokePage[] = [
  ...
  // ─── 5. fraud-business-loan-civil-dispute-falsely-accused-defense ───
  {
    ...
    cases: [
      {
        title: '판례 — 편취 범의는 차용 당시를 기준으로 판단',
        summary:
          '대법원 95도3034(대법원, 1996.03.26 선고) 사건에서 법원은 차용금 편취에 의한 사기죄의 성립 여부는 차용 당시를 기준으로 판단해야 하므로, 빌릴 당시에 변제할 의사와 능력이 있었다면 그 뒤에 변제를 거부하더라도 이는 민사상 채무불이행에 그칠 뿐 곧바로 사기죄가 된다고 볼 수 없다고 판시했습니다. 또한 편취의 범의는 자백이 없는 한 범행 전후의 재력·환경·거래의 이행과정·상대방과의 관계 같은 객관적 사정을 종합해 판단해야 한다고 보아, 이를 충분히 심리하지 않고 유죄로 단정한 원심을 파기했습니다. 사업자금 대여를 사기로 다투는 사안에서도 자금을 받을 당시의 변제 의사·능력과 이후 이행 과정을 나누어 정리해두는 방향을 검토해볼 수 있습니다.',
        takeaway: '대여 당시의 변제 의사·능력 자료와 이후 이행 과정을 나눠 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '취업사기 피해 대응 방법', href: '/guide/fraud/fraud-employment-scam-response' },
    ],
  },
  ...
  // ─── 6. sex-crime-photo-studio-posing-touch-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '노래방 회식 강제추행', href: '/guide/sex-crime/sex-crime-karaoke-afterparty-track' },
    ],
  },
  ...
  // ─── 7. sex-crime-yoga-class-correction-touch-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '성범죄 디지털 증거 보존기한 정리', href: '/guide/sex-crime/sex-crime-digital-evidence-timeline' },
      { label: '노래방 도우미 추행', href: '/guide/sex-crime/sex-crime-karaoke-assistant-track' },
    ],
  },
  ...
  // ─── 8. sex-crime-public-pool-changing-illegal-filming-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '합성사진 SNS 유포', href: '/guide/sex-crime/sex-crime-synthetic-photo-sns-spread-track' },
      { label: 'KTX 기차 옆좌석 강제추행', href: '/guide/sex-crime/sex-crime-ktx-adjacent-seat-track' },
    ],
  },
  ...
  // ─── 9. sex-crime-telecom-obscene-message-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '합성사진 SNS 유포', href: '/guide/sex-crime/sex-crime-synthetic-photo-sns-spread-track' },
      { label: '숙박업소 몰래카메라', href: '/guide/sex-crime/sex-crime-lodging-hidden-cam-track' },
    ],
  },

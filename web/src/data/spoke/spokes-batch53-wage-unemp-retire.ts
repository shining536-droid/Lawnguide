    ...
    faq: [
      {
        ...
        answer:
          '<strong>네. 노동청 체불사실 확인서가 있으면 간이대지급금 신청이 가능합니다.</strong> 사업주 잠적이 오히려 도산대지급금 \'사실상 도산\' 인정의 한 사정으로 활용될 수 있어요.',
      },
      {

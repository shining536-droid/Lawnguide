...
export const spokesBatch17GscFraud: SpokePage[] = [
  {
    ...
    internalLinks: [
      { label: '사기 혐의를 받고 있다면 처음 해야 할 일', href: '/guide/fraud-accused-response' },
      { label: '사기 합의·선처에서 형량 줄이는 법', href: '/guide/fraud-penalty-settlement-reduction' },
      { label: '사기 합의 과정과 주의사항', href: '/guide/fraud-accused-settlement-penalty' },
      { label: '사기 재범 시 양형 기준', href: '/guide/fraud-repeat-offense-sentencing' },
      { label: '사기 고소장 준비 체크리스트', href: '/guide/fraud-complaint-required-documents' },
    ],
  },
  {
    domain: 'fraud',
    ...
    internalLinks: [
      { label: '사기 혐의자 첫 대응 가이드', href: '/guide/fraud-accused-response' },
      { label: '사기 피의자 신문 시 흔한 실수', href: '/guide/fraud-suspect-interrogation-mistakes' },
      { label: '사기 합의 시 형량 차이 비교', href: '/guide/fraud-settlement-sentencing-impact' },
      { label: '사기 합의·선처에서 형량 줄이기', href: '/guide/fraud-penalty-settlement-reduction' },
      { label: '사기 혐의 반박 전략', href: '/guide/fraud-charge-rebuttal' },
    ],
  },
  {
    domain: 'fraud',
    ...
    internalLinks: [
      { label: '사기 합의 시 형량 차이 비교', href: '/guide/fraud-settlement-sentencing-impact' },
      { label: '사기 합의 과정과 주의사항', href: '/guide/fraud-accused-settlement-penalty' },
      { label: '사기 공탁 vs 합의 차이 정리', href: '/guide/fraud-deposit-vs-settlement-difference' },
      { label: '사기 초범 반성문 전 준비사항', href: '/guide/fraud-first-offense-before-apology-letter' },
      { label: '사기 혐의자 첫 대응 가이드', href: '/guide/fraud-accused-response' },
    ],
  },
  {
    ...
    internalLinks: [
      { label: '사기 합의 시 형량 차이 비교', href: '/guide/fraud-settlement-sentencing-impact' },
      { label: '피해자 합의 거부 시 감형 자료', href: '/guide/fraud-victim-refuses-settlement-alternatives' },
      { label: '사기 합의·선처에서 형량 줄이기', href: '/guide/fraud-penalty-settlement-reduction' },
      { label: '사기 혐의자 첫 대응 가이드', href: '/guide/fraud-accused-response' },
      { label: '사기 초범 반성문 전 준비사항', href: '/guide/fraud-first-offense-before-apology-letter' },
    ],

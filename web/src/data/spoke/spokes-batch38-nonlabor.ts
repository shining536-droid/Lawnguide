...
export const spokesBatch38Nonlabor: SpokePage[] = [
  ...
  // ─── 9. inheritance / adopted-child-legal-share ───
  {
    ...
    cases: [
      {
        title: '판례 — 법정상속분에 따른 권리승계',
        summary:
          '대법원 2020다292626(대법원, 2023.04.27 선고)에서 법원은 민법 제1007조의 \'상속분\'은 법정상속분을 의미하므로 상속이 개시되면 공동상속인은 각자의 법정상속분 비율에 따라 모든 상속재산을 승계하고, 상속재산분할 전에는 법정상속분에 따라 잠정적으로 공유한다고 판시했습니다. 특정 상속인의 구체적 상속분이 없다는 이유로 법정상속분에 따른 권리승계 자체가 이루어지지 않았다고 주장하는 것은 허용되지 않는다고 보았습니다. 입양된 자녀도 친생자와 같은 순위의 상속인으로서 법정상속분을 가지므로, 분할 협의에서 이를 근거로 자신의 몫을 정리해볼 수 있습니다.',
        takeaway:
          '입양자녀도 법정상속분에 따라 상속인이 됨. 분할 전에는 법정상속분대로 상속재산을 공유. 차별·배제 다툼이 있으면 상속회복·유류분 청구를 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {

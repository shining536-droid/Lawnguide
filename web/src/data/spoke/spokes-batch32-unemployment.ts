...
export const spokesBatch32Unemployment: SpokePage[] = [
  // ── 1. 직장 내 괴롭힘 퇴사 실업급여 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>네, 사업주가 직접 괴롭힘을 한 경우에도 동일하게 비자발적 이직 사유에 해당합니다. 다만 사내 신고 대신 지방고용노동청에 직접 진정을 제기하는 것이 더 효과적입니다.</p>',
      },
      {
  ...
  // ── 4. 실업급여 수급 중 부업 소득 한도 ──
  {
    ...
    intro:
      '<p>실업급여를 받으면서 생활비가 빠듯해 가벼운 아르바이트를 하고 싶습니다. 그런데 부업 소득이 생기면 실업급여가 깎이거나 중단되는 건 아닌지 걱정됩니다. 고용보험법 제58조에 따르면 실업급여 수급 중에도 일정 조건 하에 취업활동이 가능하지만, 신고 의무를 지키지 않으면 부정수급으로 처벌받을 수 있으므로 정확한 기준을 반드시 알아야 합니다.</p>',
    sections: [
      {
        title: '실업급여 수급 중 허용되는 소득 범위',
        content:
          '<p><strong style="color:#1e3a5f">월 60시간(주 15시간) 미만의 단시간 근로는 취업으로 보지 않으며, 실업급여와 병행할 수 있습니다.</strong></p>\n<p>다만 모든 소득 활동은 고용센터에 반드시 신고해야 합니다. 미신고 시 부정수급에 해당합니다.</p>\n<ol>\n<li><strong>주 15시간(월 60시간) 미만</strong> — 1주 소정근로시간이 15시간 미만이면 취업으로 보지 않습니다. 다만 3개월 이상 계속 근로하면 취업으로 간주됩니다.</li>\n<li><strong>일용직 근로</strong> — 1일 단위로 고용되는 일용직 근로를 한 날은 그날의 실업급여가 지급되지 않지만, 나머지 날의 실업급여는 정상 지급됩니다.</li>\n<li><strong>자영업 준비 활동</strong> — 사업자등록 없이 단순 준비 활동(시장조사, 사업계획서 작성 등)을 하는 것은 허용됩니다. 다만 실제 영업을 시작하면 취업으로 봅니다.</li>\n</ol>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 주 15시간 미만 단시간 근로는 실업급여와 병행 가능하지만, 반드시 고용센터에 신고해야 합니다.</blockquote>',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '<p>주 9시간(3시간 x 3일)이므로 주 15시간 미만에 해당하여 취업으로 보지 않습니다. 다만 근로한 날의 실업급여는 조정될 수 있으며, 반드시 실업인정 시 신고해야 합니다.</p>',
      },
      {
  ...
  // ── 6. 근로조건 위반 퇴사 실업급여 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>근로계약서에 "수습 기간 급여 90%"와 같이 명시되어 있다면 위반이 아닙니다. 다만 수습 기간 급여 감액 조건 없이 채용했으면서 일방적으로 급여를 낮춘 경우는 위반에 해당합니다.</p>',
      },
      {

...
export const spokesBatch32Unemployment: SpokePage[] = [
  // ── 1. 직장 내 괴롭힘 퇴사 실업급여 ──
  {
    ...
    perspective: 'victim',
    meta: {
      title: '직장 괴롭힘으로 퇴사했어요. 실업급여 받을 수 있나요? | 로앤가이드',
      description:
  ...
  // ── 5. 실업급여 신청 기한 초과 구제 ──
  {
    ...
    perspective: 'victim',
    meta: {
      title: '실업급여 신청 12개월 지났어요. 구제 가능한가요? | 로앤가이드',
      description:
  ...
  // ── 7. 전역 군인 실업급여 수급 자격 ──
  {
    ...
    perspective: 'victim',
    meta: {
      title: '전역 후 실업급여 받을 수 있나요? 군 복무·자격 정리 | 로앤가이드',
      description:
  ...
  // ── 8. 5인 미만 사업장 폐업 일용직 실업급여 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>네, 실업급여 신청과 별도로 체불 임금에 대해서는 노동청에 체불 진정을 제기하거나, 사업주가 도산한 경우 근로복지공단에 대지급금 신청(고용보험법상 도산 등 사실인정)을 할 수 있습니다.</p>',
      },
    ],

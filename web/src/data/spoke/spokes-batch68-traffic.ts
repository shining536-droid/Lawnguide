...
export const spokesBatch68Traffic: SpokePage[] = [
  // ─── 1. traffic-accident-drunk-driver-companion-passenger-liability-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '교통사고 뒤늦게 신고 보상', href: '/guide/traffic-accident/traffic-accident-delayed-report-consequence' },
  ...
  // ─── 2. traffic-accident-pm-kickboard-insurance-coverage-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '배달 라이더 사고 플랫폼 책임', href: '/guide/traffic-accident/traffic-accident-delivery-rider-platform-employment-status-injury-track' },
  ...
  // ─── 3. traffic-accident-unsignalized-intersection-right-angle-priority-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '배달라이더 교통사고 산재', href: '/guide/traffic-accident/traffic-accident-delivery-rider-workers-comp' },
  ...
  // ─── 4. traffic-accident-infant-carseat-nonuse-settlement-reduction-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '개문사고 과실비율', href: '/guide/traffic-accident/traffic-accident-door-opening-fault' },
  ...
  // ─── 5. traffic-accident-vehicle-flood-damage-insurance-dispute-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '졸음운전 의료적 사유', href: '/guide/traffic-accident/traffic-accident-drowsy-driving-medical-cause-track' },

...
export const spokesBatch21_1to7: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    keyword: '임금체불 신고 절차 처리 기간',
    questionKeyword: '임금체불 신고하면 얼마나 걸리나요?',
    ctaKeyword: '임금체불 신고 절차',
    type: '절차타임라인형',
    perspective: '피해자',
    meta: {
      title: '임금체불 신고 절차 6단계 처리 기간 | 로앤가이드',
      description: '밀린 월급을 받으려고 노동청에 신고하려는데 절차와 기간이 궁금하다면 6단계 타임라인을 지금 확인하세요.',
    },
    intro:
      '<p>월급날이 지났는데 통장에 입금이 없습니다. 사장은 "자금 사정이 어려우니 좀 기다려달라"고 합니다. 한 달, 두 달 기다렸지만 달라지는 것이 없습니다. 노동청에 신고하면 되다는 건 알지만, 접수부터 돈을 받기까지 얼마나 걸리는지 몰라 망설여집니다. 단계별 소요 기간을 미리 알면 불안이 줄어듭니다.</p>',
    timelineSteps: [
      '1단계: 고용노동부 진정서 접수 (당일)',
      '2단계: 담당 근로감독관 배정 (접수 후 7일 이내)',
      '3단계: 사업주 출석 요구 및 사실 조사 (배정 후 2~4주)',
      '4단계: 시정 지시 (체불 확인 후 즉시)',
      '5단계: 시정 이행 기간 (시정 지시 후 14일)',
      '6단계: 미이행 시 사법 처리 또는 체당금 신청 (시정 불이행 확인 후)',
    ],
    sections: [
      {
        title: '1~2단계: 접수와 감독관 배정 (1주 이내)',
        content:
          '<p><strong style="color:#1e3a5f">고용노동부 민원마당이나 관할 지방고용노동청에 진정서를 접수하면 7일 이내에 담당 근로감독관이 배정됩니다</strong></p>\n<ul>\n<li><strong>접수 방법</strong> — 온라인(민원마당), 방문, 우편 3가지 중 선택합니다. 온라인 접수가 가장 빠릅니다</li>\n<li><strong>관할 확인</strong> — 사업장 소재지를 관할하는 지방고용노동청이 담당합니다. 본인 거주지가 아닙니다</li>\n<li><strong>감독관 연락</strong> — 배정된 근로감독관이 진정인에게 전화로 접수 사실을 확인하고 추가 자료를 요청할 수 있습니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">소요 기간: 접수일로부터 약 1주</blockquote>',
      },
      {
        title: '3~4단계: 사실 조사와 시정 지시 (2~6주)',
        content:
          '<p><strong style="color:#1e3a5f">근로감독관이 사업주를 출석시켜 체불 사실을 조사하고, 확인되면 즉시 시정 지시를 내립니다</strong></p>\n<ul>\n<li><strong>사업주 출석</strong> — 근로감독관이 사업주에게 출석을 요구합니다. 사업주가 불응하면 방문 조사로 전환됩니다</li>\n<li><strong>장부 확인</strong> — 임금대장, 출퇴근 기록, 급여 이체 내역 등을 대조하여 체불 금액을 확정합니다</li>\n<li><strong>시정 지시</strong> — 체불이 확인되면 근로기준법 제36조에 따라 14일 이내에 임금을 지급하라는 시정 지시를 합니다</li>\n<li><strong>근로자 확인</strong> — 체불 금액 확정 결과를 진정인에게 통보하고, 이의가 있으면 보정할 수 있습니다</li>\n</ul>\n<p>사업장 규모가 크거나 쟁점이 복잡하면 조사 기간이 <strong>최대 2~3개월</strong>까지 늘어날 수 있습니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">소요 기간: 배정 후 약 2~6주 (복잡한 경우 2~3개월)</blockquote>',
      },
      {
        title: '5~6단계: 이행 확인과 사법 처리 (2주~수 개월)',
        content:
          '<p><strong style="color:#1e3a5f">사업주가 시정 지시를 이행하지 않으면 형사 고발 또는 체당금 제도를 활용할 수 있습니다</strong></p>\n<ul>\n<li><strong>이행 확인</strong> — 시정 지시 후 14일이 지나면 근로감독관이 사업주의 이행 여부를 확인합니다</li>\n<li><strong>사법 처리</strong> — 미이행 시 근로기준법 제109조에 따라 3년 이하의 징역 또는 3천만 원 이하의 벌금으로 사법 처리됩니다</li>\n<li><strong>체당금 신청</strong> — 사업주가 도산(부도·파산·폐업)한 경우 임금채권보장법에 따라 근로복지공단에 체당금을 신청할 수 있습니다. 최대 3개월분의 임금과 3년분의 퇴직금 한도 내에서 지급받습니다</li>\n<li><strong>민사소송</strong> — 형사 절차와 별도로 임금 지급을 구하는 민사소송도 가능합니다. 소액사건심판(3천만 원 이하)은 1회 변론으로 판결이 나올 수 있습니다</li>\n</ul>\n<div style="margin-top:16px;padding:14px 18px;background:linear-gradient(135deg,#fff8e1,#fff3cd);border-left:4px solid #f9a825;border-radius:8px">\n<strong style="color:#e65100">지금 바로 확인하세요</strong><br/>\n<a href="/diagnosis/wage" style="color:#1565c0;font-weight:600">내 임금체불 신고 절차 무료 진단받기 &rarr;</a>\n</div>',
      },
      {
        title: '처리 기간을 단축하는 3가지 방법',
        content:
          '<p><strong style="color:#1e3a5f">증거를 미리 정리해두면 조사 기간이 크게 단축됩니다</strong></p>\n<ul>\n<li><strong>증거를 한 세트로 정리</strong> — 근로계약서, 급여명세서, 계좌이체 내역, 출퇴근 기록을 날짜순으로 정리해서 진정서에 첨부하세요</li>\n<li><strong>체불 금액을 미리 계산</strong> — 항목별(기본급, 연장수당, 야간수당, 퇴직금)로 정확한 금액을 산출하세요. 근로감독관이 확인만 하면 되므로 처리가 빨라집니다</li>\n<li><strong>감독관과 적극 소통</strong> — 배정된 근로감독관의 연락처를 확보하고, 추가 자료 요청에 신속하게 대응하세요</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">단축 핵심: 증거 사전 정리 + 금액 미리 계산 + 감독관 적극 소통</blockquote>',
      },
    ],
    cases: [
      {
        title: '상시 근로자 5인 이상 사업장 판단과 가산임금 — 대법원 판결',
        summary:
          '대법원 2020도16228 사건(대법원, 2023.06.15 선고)에서 법원은 상시 5인 이상 근로자를 사용하는 사업장인지는 주휴일에 출근하지 않은 근로자를 제외하고 상태적으로 판단해야 하며, 이에 따라 근로기준법상 가산임금 규정의 적용 여부가 달라진다고 판시했습니다.',
        takeaway:
          '5인 미만 사업장이라고 해서 임금체불이 허용되는 것은 아닙니다. 다만 가산임금 적용 여부가 달라지므로 사업장 규모를 정확히 확인한 후 체불 금액을 산출하세요.',
      },
    ],
    faq: [
      {
        question: '진정서 접수 후 감독관 배정이 안 되면 어떻게 하나요?',
        answer:
          '접수 후 10일이 지나도 연락이 없으면 <strong>관할 노동청 민원실에 직접 전화</strong>하세요. 접수 번호를 알려주면 진행 상황을 확인할 수 있습니다.',
      },
      {
        question: '사업주가 출석을 거부하면 어떻게 되나요?',
        answer:
          '<strong>출석 거부 자체가 과태료 부과 대상</strong>입니다. 근로감독관이 사업장에 직접 방문하여 조사하고, 정당한 사유 없이 거부하면 과태료 500만 원 이하가 부과됩니다.',
      },
      {
        question: '신고부터 돈을 받기까지 보통 얼마나 걸리나요?',
        answer:
          '사업주가 시정 지시에 순응하면 <strong>접수 후 1~2개월 이내</strong>에 받을 수 있습니다. 사업주가 불응하면 사법 처리까지 3~6개월 이상 소요될 수 있습니다.',
      },
      {
        question: '퇴사 전에도 임금체불 신고가 가능한가요?',
        answer:
          '<strong>재직 중에도 신고할 수 있습니다.</strong> 다만 재직 중 신고는 관계가 악화될 수 있으므로, 퇴사 의사가 확정된 후 진행하는 것이 일반적입니다.',
      },
      {
        question: '체당금은 누구나 신청할 수 있나요?',
        answer:
          '체당금은 <strong>사업주가 도산(부도·파산·폐업)하거나 사실상 도산 상태</strong>일 때 신청할 수 있습니다. 사업주가 영업 중이면 해당되지 않으므로 시정 지시→사법 처리 경로를 진행하세요.',
      },
    ],
    cta: {
      text: '임금체불 신고 절차 무료 진단받기',
      link: '/diagnosis/wage',
    },
    internalLinks: [
      { label: '임금체불 가이드', href: '/guide/wage' },

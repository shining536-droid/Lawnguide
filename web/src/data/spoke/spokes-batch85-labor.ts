...
export const spokesBatch85Labor: SpokePage[] = [
  // ─── 1. dismissal-economic-layoff-criteria-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '경영상 정리해고 다툼', href: '/guide/dismissal/dismissal-economic-layoff-track' },
      { label: '해고회피노력 쟁점', href: '/guide/dismissal/dismissal-avoidance-effort-track' },
  ...
  // ─── 3. dismissal-oral-notice-no-writing-track ───
  {
    ...
    internalLinks: [
      { label: '부당해고 구제 절차', href: '/guide/dismissal/unfair-dismissal-relief-procedure' },
      { label: '해고 서면통지 요건', href: '/guide/dismissal/dismissal-written-notice-requirement' },
      { label: '구두해고 효력 다툼', href: '/guide/dismissal/dismissal-oral-notice-track' },
      { label: '권고사직 다툼', href: '/guide/dismissal/dismissal-recommended-resignation-track' },
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
    ],
  },
  ...
  // ─── 4. wage-holiday-work-allowance-track ───
  {
    ...
    internalLinks: [
      { label: '휴일근로수당 청구', href: '/guide/wage/wage-holiday-work-allowance-claim' },
      ...
      { label: '가산수당 미지급', href: '/guide/wage/wage-premium-allowance-unpaid-track' },
  ...
  // ─── 5. wage-night-shift-premium-track ───
  {
    ...
    cta: { text: '임금체불 대응 순서, AI로 바로 정리하기', link: '/chat?domain=wage' },
    internalLinks: [
      { label: '야간근로수당 청구', href: '/guide/wage/wage-night-work-allowance-claim' },
      { label: '주휴수당 최저임금 다툼', href: '/guide/wage/wage-weekly-holiday-minimum-wage-track' },
      { label: '통상임금 산정 기준', href: '/guide/wage/wage-ordinary-wage-calculation-standard' },
      { label: '가산수당 미지급', href: '/guide/wage/wage-premium-allowance-unpaid-track' },
      { label: '임금체불 진정 절차', href: '/guide/wage/unpaid-wage-report-procedure-timeline' },
    ],
  ...
  // ─── 6. unemployment-contract-expiry-separation-track ───
  {
    ...
    internalLinks: [
      { label: '계약만료 이직 수급자격', href: '/guide/unemployment/contract-expiry-eligibility-track' },
      { label: '조기재취업수당 신청', href: '/guide/unemployment/early-reemployment-allowance-track' },
  ...
  // ─── 7. unemployment-workplace-relocation-commute-track ───
  {
    ...
    cta: { text: '실업급여 받을 수 있는지 AI로 점검하기', link: '/chat?domain=unemployment' },
    internalLinks: [
      { label: '통근곤란 이직 수급자격', href: '/guide/unemployment/commute-difficulty-eligibility-track' },
      { label: '부정수급 반환·추가징수 다툼', href: '/guide/unemployment/illegal-receipt-recovery-track' },
      { label: '실업급여 신청 절차', href: '/guide/unemployment/benefit-application-procedure' },
      { label: '수급 중 취업신고 의무', href: '/guide/unemployment/work-report-duty-track' },
      { label: '피보험단위기간 확인', href: '/guide/unemployment/insured-period-check-track' },
    ],
  },
  ...
  // ─── 9. retirement-executive-employee-status-track ───
  {
    ...
    internalLinks: [
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
      { label: '임원 근로자성 다툼', href: '/guide/retirement/retirement-executive-status-track' },
      { label: '근속기간 통산 다툼', href: '/guide/retirement/retirement-continuous-service-track' },
      { label: '퇴직금 재산정 차액', href: '/guide/retirement/retirement-recalculation-difference' },
      { label: '퇴직금 체불 진정', href: '/guide/retirement/retirement-pay-unpaid-report-track' },
    ],
  },
  ...
  // ─── 10. industrial-accident-mental-stress-disorder-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '과로사 산재 인정', href: '/guide/industrial-accident/industrial-accident-overwork-death-track' },
      { label: '유족급여·장의비 청구', href: '/guide/industrial-accident/industrial-accident-survivor-benefit-track' },

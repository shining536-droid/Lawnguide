...
export const spokesBatch18_16to20: SpokePage[] = [
  ...
  },
  {
    ...
    keyword: '매매 목적물 하자 손해배상 청구',
    questionKeyword: '매매한 부동산에 하자가 있으면 손해배상을 받을 수 있나요?',
    ctaKeyword: '부동산 하자 손해배상',
    type: '상황형',
    meta: {
      title: '부동산 하자 손해배상 청구 4단계 절차 총정리 | 로앤가이드',
      description: '매매한 부동산에서 누수나 균열 등 하자를 발견했다면, 손해배상 청구 요건과 절차를 확인하세요. 지금 확인하세요.',
    },
    intro: '잔금을 치르고 입주한 지 일주일 만에 천장에서 물이 떨어지기 시작했습니다. 벽지 뒤에는 곰팡이가 가득합니다. 매도인에게 연락했더니 "인도 이후 책임 없다"고 합니다. 부동산 매매에서 하자가 발견되었을 때 손해배상을 청구하는 절차를 확인해보세요.',
    sections: [
      {
        title: '첫째, 하자의 종류와 매도인 책임 범위를 확인하세요',
        content:
          '<p><strong style="color:#1e3a5f">민법 제580조에 따라 매도인은 매매 목적물의 하자에 대해 담보책임을 집니다</strong></p>\n<p><strong>물건의 하자</strong>란 매매 목적물이 통상 갖추어야 할 품질이나 성능이 결여된 것을 말합니다. 누수, 균열, 배관 불량, 석면 잔존 등이 대표적입니다.</p>\n<p>매도인의 하자담보책임은 <strong>매도인의 과실 여부와 무관</strong>합니다. 매도인이 하자를 몰랐더라도 책임을 집니다. 다만 매수인이 하자를 <strong>알았거나 과실로 알지 못한 경우</strong>에는 책임이 제한될 수 있습니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">하자담보책임: 매도인 과실 무관 → 매수인이 하자를 몰랐어야 청구 가능</blockquote>',
      },
      {
        title: '둘째, 하자 발견 즉시 증거를 확보하고 매도인에게 통지하세요',
        content:
          '<p><strong style="color:#1e3a5f">민법 제582조에 따라 매수인은 하자를 안 날로부터 6개월 이내에 권리를 행사해야 합니다</strong></p>\n<p>하자를 발견하면 <strong>즉시 사진과 동영상으로 현황을 촬영</strong>하세요. 누수라면 물이 떨어지는 장면, 곰팡이라면 범위를 알 수 있는 사진이 필요합니다.</p>\n<p>촬영 후 <strong>내용증명 우편으로 매도인에게 하자 사실을 통지</strong>하세요. 통지 내용에는 하자의 구체적 내용, 발견 일시, 수리 또는 손해배상 요구를 기재합니다. 6개월의 제척기간을 놓치지 마세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">즉시 조치: 사진·영상 촬영 → 내용증명 통지 → 6개월 이내 권리 행사</blockquote>\n<div style="margin-top:16px;padding:14px 18px;background:linear-gradient(135deg,#fff8e1,#fff3cd);border-left:4px solid #f9a825;border-radius:8px">\n<strong style="color:#e65100">지금 바로 확인하세요</strong><br/>\n<a href="/diagnosis/real-estate-sale" style="color:#1565c0;font-weight:600">내 부동산 하자 상황 진단받기 &rarr;</a>\n</div>',
      },
      {
        title: '셋째, 하자 보수 견적서와 감정서를 확보하세요',
        content:
          '<p><strong style="color:#1e3a5f">손해배상 금액 산정의 근거가 되는 객관적 자료를 준비하세요</strong></p>\n<p><strong>전문 업체 2~3곳에 하자 보수 견적</strong>을 받으세요. 견적서에는 하자 항목별 수리 비용이 구분되어야 합니다. 견적 금액이 클 경우 <strong>감정평가사의 하자감정</strong>을 받으면 소송에서 더 유리합니다.</p>\n<p>하자가 건물 구조에 영향을 미치는 수준이라면 <strong>건축사 또는 건축구조기술사의 안전진단</strong>도 고려하세요. 이 비용은 나중에 손해배상에 포함하여 청구할 수 있습니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">견적 확보: 2~3곳 수리 견적 + 필요시 감정평가·안전진단 → 소송 증거 활용</blockquote>',
      },
      {
        title: '넷째, 합의가 안 되면 민사소송으로 손해배상을 청구하세요',
        content:
          '<p><strong style="color:#1e3a5f">하자담보책임에 따른 손해배상 청구소송을 제기할 수 있습니다</strong></p>\n<p>매도인이 배상을 거부하면 <strong>관할 법원에 손해배상 청구소송</strong>을 제기하세요. 청구 금액은 하자 보수 비용, 감정 비용, 이사 비용 등 <strong>하자로 인해 발생한 모든 손해</strong>를 포함합니다.</p>\n<p>소액사건(3,000만원 이하)은 소액사건심판법에 따라 빠르게 진행됩니다. 하자가 심각하여 <strong>계약의 목적을 달성할 수 없는 수준</strong>이면 계약해제도 청구할 수 있습니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">소송 청구: 보수 비용 + 감정 비용 + 기타 손해 → 계약 목적 불달성 시 해제 가능</blockquote>',
      },
      {
        title: '다섯째, 매매계약서의 하자면책 특약이 있는지 확인하세요',
        content:
          '<p><strong style="color:#1e3a5f">하자면책 특약이 있어도 매도인이 하자를 알고 고지하지 않았다면 무효입니다</strong></p>\n<p>일부 매매계약서에는 <strong>"현 상태 인수" 또는 "하자에 대해 이의를 제기하지 않는다"</strong>는 특약이 있을 수 있습니다. 이런 특약이 있으면 하자담보책임이 제한될 수 있습니다.</p>\n<p>하지만 민법 제584조에 따라 <strong>매도인이 하자를 알면서 고지하지 않은 경우</strong>에는 하자면책 특약이 있더라도 책임을 면할 수 없습니다. 매도인의 고의적 은폐가 의심되면 적극적으로 다투세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">면책 특약: 매도인이 하자를 알고 숨긴 경우 → 특약 무효 → 손해배상 가능</blockquote>',
      },
    ],
    cases: [
      {
        title: '회생절차에서 채권 확정 청구와 소송절차에 관한 판결',
        summary:
    ...
    faq: [
      {
        question: '중고 주택을 사면 하자담보책임을 물을 수 없나요?',
        answer: '중고 주택도 <strong>통상의 품질을 갖추지 못한 하자</strong>가 있다면 매도인에게 하자담보책임을 물을 수 있습니다. 다만 노후화에 따른 자연적 마모는 하자로 보기 어렵습니다.',
      },
      {
        question: '하자 발견 후 6개월이 지나면 청구할 수 없나요?',
        answer: '민법상 <strong>하자담보책임의 제척기간은 하자를 안 날로부터 6개월</strong>입니다. 다만 매도인이 하자를 알고도 숨긴 경우에는 불법행위에 기한 손해배상(3년)으로 청구할 수 있습니다.',
      },
      {
        question: '부동산 중개업자에게도 책임을 물을 수 있나요?',
        answer: '중개업자가 <strong>하자를 알았거나 알 수 있었는데 고지하지 않은 경우</strong> 공인중개사법에 따른 손해배상책임이 있습니다. 중개업자의 과실이 확인되면 매도인과 공동으로 청구할 수 있습니다.',
      },
      {
        question: '하자 보수 비용 전액을 배상받을 수 있나요?',
        answer: '원칙적으로 <strong>하자를 보수하는 데 필요한 합리적인 비용</strong>을 배상받을 수 있습니다. 다만 과도한 수리(리모델링 수준)는 인정되지 않을 수 있으므로 객관적인 견적서를 기준으로 청구하세요.',
      },
    ],
    cta: {
      text: '💬 지금 내 상황에 맞는 대응 전략 확인하기',
    ...
    internalLinks: [
      ...
      { label: '부동산 하자 손해배상 절차', href: '/guide/real-estate-sale/real-estate-defect-damage-claim' },

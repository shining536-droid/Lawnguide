  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: '<p><strong style="color:#1e3a5f">형법 제347조에 따라 전세사기는 사기죄에 해당하며, 10년 이하의 징역 또는 2천만 원 이하의 벌금에 처할 수 있습니다. 형사 고소와 민사소송을 동시에 진행하는 것이 가장 효과적인 전략입니다.</strong></p>\n<p><strong>형사 고소</strong>: 관할 경찰서에 임대인을 사기죄로 고소합니다. 이중 근저당 설정, 허위 권리관계 고지, 전세금 반환 능력 없이 계약 체결 등의 기망 행위를 구체적으로 기재합니다. 동일 건물의 다른 피해자들과 함께 고소하면 수사가 신속하게 진행됩니다.</p>\n<p><strong>민사소송</strong>: 전세보증금 반환 청구소송을 제기합니다. 판결을 받은 후 임대인의 재산에 강제집행을 할 수 있습니다. 소송 전에 임대인의 다른 부동산이나 예금에 대해 가압류를 해두면 재산 도피를 방지할 수 있습니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 형사 고소로 임대인을 압박하면서, 민사소송과 가압류로 보증금 회수 경로를 동시에 확보하세요.</blockquote>'
      }
    ],
    cases: [
      {
        title: '대법원 2021다202309 — 임대인의 의무와 보증금 반환',
        summary: '대법원 2021다202309 사건(대법원, 2021.04.29 선고)에서 법원은 보증금 반환 등 임대차 분쟁에서 계약서와 같은 처분문서는 그 내용을 부인할 분명한 반증이 없으면 기재된 문언대로 의사표시의 존재와 내용을 인정해야 한다고 보았고, 임대인은 자신에게 귀책사유가 없더라도 임차인이 목적물을 사용·수익할 수 있도록 유지할 의무를 진다고 판시했습니다.',
        takeaway: '전세사기가 의심될 때는 먼저 계약서·등기부·이체 내역 등 문서를 정리해 임대인의 의무와 보증금 반환 근거를 확인하고, 대항력 유지·임차권등기명령 등 다음 절차를 단계적으로 검토해보는 것이 좋습니다.'
      }
    ],
    faq: [
      {

...
export const spokesBatch77WageUnempRetireIa: SpokePage[] = [
  ...
  // ─── 3. unemployment-contract-expiry-eligibility-track ───
  {
    ...
    cases: [
      {
        title: '재결례 — 계약기간 만료 이직과 수급자격 제한 판단',
        summary:
    ...
    internalLinks: [
      ...
      { label: '질병 사직 구직급여 정당한 사유 인정 절차', href: '/guide/unemployment/unemployment-resignation-chronic-illness-eligibility-track' },
    ],
  },
  ...
  // ─── 6. industrial-accident-musculoskeletal-disease-track ───
  {
    ...
    internalLinks: [
      { label: 'industrial-accident 종합 가이드', href: '/guide/industrial-accident' },

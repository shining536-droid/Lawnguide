...
export const spokesBatch62Fraud: SpokePage[] = [
  // ─── 1. fraud-secondhand-shipped-vanish-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '가짜 임대인 사칭 보증금 사기', href: '/guide/fraud/fraud-fake-landlord-impersonation-victim' },
    ],
  },
  ...
  // ─── 2. fraud-sns-luxury-group-buy-track ───
  {
    ...
    internalLinks: [
      { label: '사기죄 고소 절차 총정리', href: '/guide/fraud/fraud-complaint-procedure-comprehensive' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '투자사기 집단 대응', href: '/guide/fraud/fraud-investment-collective-action' },
      { label: '투자 플랫폼 수익률 조작', href: '/guide/fraud/fraud-investment-platform-yield-fake-display-track' },
      { label: '대포통장 명의대여 무고', href: '/guide/fraud/fraud-borrowed-name-account-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 3. fraud-jeonse-deposit-embezzle-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '전세 월세 전환 보증금 반환', href: '/guide/jeonse/jeonse-monthly-rent-conversion-deposit-return' },
      { label: '팬미팅·콘서트 취소 환불 거절', href: '/guide/fraud/fraud-celebrity-fanmeet-cancel-refund-track' },
  ...
  // ─── 4. fraud-dating-app-romance-scam-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '중고나라 안전결제 우회 사기', href: '/guide/fraud/fraud-secondhand-escrow-bypass-victim' },
    ],
  },
  ...
  // ─── 5. fraud-crypto-exchange-withdrawal-refuse-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '게임 아이템 계정 거래 회수', href: '/guide/fraud/fraud-game-item-account-reclaim-track' },
    ],
  },
];

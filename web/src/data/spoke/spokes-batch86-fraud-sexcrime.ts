...
export const spokesBatch86FraudSexCrime: SpokePage[] = [
  ...
  // ─── 3. fraud-loan-advance-fee-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '비트코인 채굴기 임대 사기', href: '/guide/fraud/fraud-bitcoin-mining-machine-fake-rental-track' },
      { label: '보이스피싱 송금 환급 절차', href: '/guide/fraud/fraud-phishing-transfer-refund-procedure' },
    ],
  },
  ...
  // ─── 5. fraud-job-placement-deposit-track ───
  {
    ...
    internalLinks: [
      { label: '거래 분쟁의 사기 고소 둔갑', href: '/guide/fraud/fraud-business-dispute-criminal-complaint-false-accused-defense' },
      { label: '채용 보증금 사기', href: '/guide/fraud/fraud-job-recruit-deposit-scam' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
  ...
  // ─── 6. fraud-staged-insurance-claim-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '사업자금 대여 분쟁 사기 무고', href: '/guide/fraud/fraud-business-loan-civil-dispute-falsely-accused-defense' },
      { label: '취업사기 피해 대응 방법', href: '/guide/fraud/fraud-employment-scam-response' },
      { label: '사업자금 대여 변제 사기 무고', href: '/guide/fraud/fraud-business-fund-loan-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 7. sex-crime-club-dancefloor-contact-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '회식 만취 추행 무고', href: '/guide/sex-crime/sex-crime-company-dinner-intoxicated-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 8. sex-crime-subway-illegal-filming-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '회식 음주 만취 접촉 강제추행 무고 방어', href: '/guide/sex-crime/sex-crime-company-dinner-intoxicated-misunderstanding-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 9. sex-crime-sextortion-image-threat-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '회식 택시 동승 강제추행', href: '/guide/sex-crime/sex-crime-company-dinner-taxi-molestation-track' },
    ],
  },
  ...
  // ─── 10. sex-crime-medical-exam-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '동의 촬영물 사후 유포 피해', href: '/guide/sex-crime/sex-crime-consensual-footage-later-distribution-track' },
      { label: '만원 버스 접촉 추행 무고 방어', href: '/guide/sex-crime/sex-crime-crowded-bus-contact-falsely-accused-defense' },

...
export const spokesBatch66DivorceInheritance: SpokePage[] = [
  ...
  // ─── 2. divorce-pet-custody-companion-animal-track ───
  {
    ...
    cta: { text: '협의이혼 준비서류, AI로 정리하기', link: '/chat?domain=divorce' },
    internalLinks: [
      { label: '국민연금 분할 재산분할 판단', href: '/guide/divorce/divorce-national-pension-split-property-division-track' },
  ...
  // ─── 3. divorce-ivf-frozen-embryo-disposition-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 이혼 시 공동형성 재산의 분할',
        summary:
          '대법원 2008스111(대법원, 2009.06.09 선고)에서 법원은 제3자 명의의 재산이라도 부부 쌍방의 협력으로 형성된 것이거나 그 자원에 기한 것이면 재산분할의 대상이 되고, 한쪽이 상속·증여로 취득한 재산도 상대방의 가사노동 등이 형성·유지에 기여했다면 분할 대상이 될 수 있다고 판시했습니다. 재산분할은 혼인 중 이룩한 실질적 공동재산을 청산·분배하는 제도라는 취지입니다. 동결 배아 자체의 처분은 부부의 동의가 원칙이라 재산분할과는 다른 논의가 필요하지만, 이혼 과정에서 부부가 함께 형성한 대상을 어떻게 정리할지 검토할 때 참고해볼 수 있습니다.',
        takeaway: '이혼 시 재산·권리의 정리는 부부 공동 기여 여부가 기준. 동결 배아 처분은 부부 합의가 원칙이라 별도 검토가 필요. 관련 자료와 협의 경위를 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '외국인 배우자 이혼 국제재판 준거법', href: '/guide/divorce/divorce-foreign-spouse-litigation-procedure' },
      { label: '협의이혼 준비', href: '/guide/divorce/divorce-consultation-prep' },
      { label: '배우자 해외 은닉재산 재산분할 판단', href: '/guide/divorce/divorce-overseas-hidden-asset-property-division-track' },
      { label: '배우자 외도 위자료 청구', href: '/guide/divorce/divorce-adultery-consolation-money-track' },
    ],
  },
  ...
  // ─── 4. divorce-childless-property-division-housewife-track ───
  {
    ...
    cta: { text: '협의이혼 준비서류, AI로 정리하기', link: '/chat?domain=divorce' },
    internalLinks: [
      { label: '개인 채무 재산분할 영향', href: '/guide/divorce/divorce-personal-debt-marriage-property-division-track' },
      { label: '재산분할 범위', href: '/guide/divorce/divorce-property-division-scope-faq' },
      { label: '배우자 외도 위자료 청구', href: '/guide/divorce/divorce-adultery-consolation-money-track' },
      { label: '외국인 배우자 이혼 국제재판 준거법', href: '/guide/divorce/divorce-foreign-spouse-litigation-procedure' },
      { label: '협의이혼 준비', href: '/guide/divorce/divorce-consultation-prep' },
  ...
  // ─── 5. inheritance-debt-vs-asset-unclear-decision-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '상속재산 분할 협의 안 될 때 조정·심판 절차', href: '/guide/inheritance/inheritance-division-mediation-tribunal' },
    ],
  },
  ...
  // ─── 7. inheritance-pension-survivor-vs-estate-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '해외거주자 상속세 신고', href: '/guide/inheritance/inheritance-foreign-resident-tax-report' },
      { label: '상속채무 초과 한정승인 신청 절차', href: '/guide/inheritance/inheritance-debt-over-asset-limited-acceptance-procedure-track' },
      { label: '유족연금 수급 우선권', href: '/guide/inheritance/inheritance-survivor-pension-priority-track' },
    ],
  },
];

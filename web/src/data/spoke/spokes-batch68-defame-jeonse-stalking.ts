...
export const spokesBatch68DefameJeonseStalking: SpokePage[] = [
  ...
  // ─── 3. defamation-livestream-chat-screen-capture-secondary-spread-victim-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '유튜브 댓글 신상공개 피해자', href: '/guide/defamation/defamation-youtube-doxxing-victim-takedown' },
  ...
  // ─── 6. stalking-ex-spouse-visitation-handover-pretext-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '직장 동료 퇴근 후 미행 SNS 모니터링 스토킹', href: '/guide/stalking/stalking-coworker-after-work-following-route-track' },
    ],
  },
  ...
  // ─── 7. stalking-provisional-measure-violation-recidivism-aggravation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '직장 동료 퇴근길 동선 추적 스토킹', href: '/guide/stalking/stalking-coworker-commute-route-following-track' },
    ],
  },
];

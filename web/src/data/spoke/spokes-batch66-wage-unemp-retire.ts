...
export const spokesBatch66WageUnempRetire: SpokePage[] = [
  ...
  // ─── 2. wage-piece-rate-pay-minimum-wage-floor-track ───
  {
    ...
    internalLinks: [
      { label: '임금체불 형사고소 절차', href: '/guide/wage/unpaid-wage-criminal-complaint-procedure' },
      { label: '채권추심원 근로자성 임금 청구', href: '/guide/wage/wage-debt-collection-agent-worker-status-claim-track' },
  ...
  // ─── 3. unemployment-recurring-illness-quit-medical-track ───
  {
    ...
    internalLinks: [
      { label: '계약기간 만료 갱신거절 구직급여 수급 절차', href: '/guide/unemployment/unemployment-contract-expiry-nonrenewal-just-cause-track' },
  ...
  // ─── 5. retirement-probation-included-tenure-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '퇴직금 중간정산 효력 재산정', href: '/guide/retirement/retirement-interim-settlement-void-track' },
      { label: '퇴직금 시효', href: '/guide/retirement/retirement-statute-of-limitations' },
    ],
  },
];

...
export const spokesBatch46Nonlabor2: SpokePage[] = [
  ...
  // ─── 3. divorce / online-game-affair-evidence ───
  {
    ...
    internalLinks: [
      ...
      { label: '온라인 외도 증거 수집', href: '/guide/divorce/divorce-online-affair-evidence-collection' },
      { label: '사실혼 일방 잠적 사망 재산분할 제척기간', href: '/guide/divorce/divorce-de-facto-marriage-claim-deadline-spouse-missing' },
  ...
  // ─── 4. divorce / asset-discovered-after-trial ───
  {
    ...
    internalLinks: [
      ...
      { label: '배우자 은닉 가상자산 재산분할 판단', href: '/guide/divorce/divorce-spouse-hidden-cryptocurrency-property-division-track' },
    ],
  },
  ...
  // ─── 5. inheritance / stepfather-relationship-share ───
  {
    ...
    internalLinks: [
      ...
      { label: '대습상속인 대습원인 이전 증여 특별수익', href: '/guide/inheritance/inheritance-grandchild-substitute-special-gift-exclusion' },
  ...
  // ─── 6. inheritance / debt-larger-limited-acceptance ───
  {
    ...
    internalLinks: [
      ...
      { label: '상속 종합 가이드', href: '/guide/inheritance' },
      { label: '한정승인 후 재산 누락 단순승인 의제 기준', href: '/guide/inheritance/inheritance-limited-acceptance-undisclosed-asset-simple-acceptance-track' },
      { label: '한정승인 후 추가 청구', href: '/guide/inheritance/inheritance-limited-acceptance-creditor-additional-claim' },
    ],
  },
  ...
  // ─── 7. inheritance / multiple-marriages-distribution ───
  {
    ...
    internalLinks: [
      ...
      { label: '상속 기여분 산정', href: '/guide/inheritance/inheritance-contribution-share-claim-track' },

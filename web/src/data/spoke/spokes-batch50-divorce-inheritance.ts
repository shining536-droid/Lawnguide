...
export const spokesBatch50DivorceInheritance: SpokePage[] = [
  ...
  // ─── 3. divorce / pension-split-formula ───
  {
    ...
    cases: [
      {
        title: '판례 — 연금의 재산분할 대상성',
        summary:
          '서울고등법원 2012르3326(서울고등법원, 2013.04.25 선고)에서는 매월 수령하는 공무원 퇴직연금이 이혼 시 재산분할 대상이 되는지 문제 된 사안에서, 퇴직연금은 사회보장적 성격과 함께 임금 후불의 성격을 가져 부부 공동의 협력으로 이룩한 재산으로 볼 수 있으므로 재산분할 대상이 된다고 보고, 장래 연금을 받을 수 있다는 사정을 분할비율을 정할 때 참작한 사례가 있습니다. 이 판단에서는 국민연금법이 이혼한 배우자를 분할연금 수급권자로 인정하는 것(국민연금법 제64조)과의 균형도 언급되었습니다. 다만 하급심 사례라 사건마다 결론이 달라질 수 있으니, 연금의 성격과 혼인기간을 정리해 분할연금 신청 요건을 검토해볼 수 있습니다.',
        takeaway: '연금도 부부 공동재산으로 보아 이혼 시 나누는 대상으로 검토될 수 있음. 국민연금 분할연금은 혼인기간·요건을 확인해 신청 여부를 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {

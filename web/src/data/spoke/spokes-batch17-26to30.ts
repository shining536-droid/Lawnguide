...
export const spokesBatch17_26to30: SpokePage[] = [
  // ── 1. 스토킹 고소장 작성 시 필요한 서류 목록 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>이전 연인이라도 이별 후 반복적 접근·연락은 스토킹에 해당할 소지가 있습니다.</strong> 대법원 2025도36 사건에서도 행위자와 상대방의 관계를 종합적으로 고려하되, 객관적으로 불안감을 주는 행위면 스토킹으로 인정된다고 판시했습니다.',
      },
    ],
    cta: {
    ...
    internalLinks: [
      { label: '스토킹 피해 즉시 대응 가이드', href: '/guide/stalking/stalking-immediate-response' },
      { label: '스토킹 증거 수집 FAQ', href: '/guide/stalking/stalking-evidence-collection-faq' },
      { label: '스토킹 신고와 접근금지명령', href: '/guide/stalking/stalking-report-and-restraining-order' },
      { label: '스토킹 처벌 수위와 접근금지', href: '/guide/stalking/stalking-penalty-restraining-order' },
      { label: '스토킹 긴급보호조치 신청법', href: '/guide/stalking/stalking-emergency-protective-measures' },
    ],
  },
  ...
  // ── 2. 사업 실패 후 개인파산 신청 가능한가 ──
  {
    ...
    internalLinks: [
      { label: '개인파산 면책까지 전 과정', href: '/guide/bankruptcy/bankruptcy-to-discharge-process' },
      { label: '파산 신청 요건 총정리', href: '/guide/bankruptcy/bankruptcy-fresh-start-requirements' },
      { label: '파산 후 신용 회복 타임라인', href: '/guide/bankruptcy/bankruptcy-credit-recovery-timeline' },
      { label: '면책 후 생활 변화 가이드', href: '/guide/bankruptcy/bankruptcy-after-discharge-life-changes' },
      { label: '파산 압류해제 절차', href: '/guide/bankruptcy/bankruptcy-seizure-release-process' },
    ],
  },
  ...
  // ── 3. 면책 불허가 사유와 주요 판례 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>정당한 사유 없이 면책심문기일에 불출석하면 매우 불리합니다.</strong> 법원은 채무자의 성실성을 중요하게 보므로, 가능한 한 출석하세요. 건강 등의 사유로 출석이 어려우면 사전에 사유서를 제출하고 기일 변경을 신청하세요.',
      },
      {
    ...
    internalLinks: [
      { label: '개인파산 면책까지 전 과정', href: '/guide/bankruptcy/bankruptcy-to-discharge-process' },
      { label: '사업 실패 후 개인파산 자격', href: '/guide/bankruptcy/business-failure-bankruptcy-eligible' },
      { label: '파산 후 신용 회복 타임라인', href: '/guide/bankruptcy/bankruptcy-credit-recovery-timeline' },
      { label: '파산 압류해제 절차', href: '/guide/bankruptcy/bankruptcy-seizure-release-process' },
      { label: '면책 후 생활 변화 가이드', href: '/guide/bankruptcy/bankruptcy-after-discharge-life-changes' },
    ],
  ...
  // ── 4. 사업자 개인회생 신청 가능한 경우 ──
  {
    ...
    internalLinks: [
      ...
      { label: '개인회생 채권자 추심 중지', href: '/guide/rehabilitation/rehabilitation-creditor-collection-stop' },
    ],
  },
  ...
  // ── 5. 개인회생 vs 개인워크아웃 비교 ──
  {
    ...
    internalLinks: [
      ...
      { label: '개인회생 사전 체크리스트', href: '/guide/rehabilitation/rehabilitation-pre-check' },
      { label: '개인회생 신청 절차 A to Z', href: '/guide/rehabilitation/rehabilitation-application-procedure-atoz' },
      { label: '신용카드 채무 개인회생 포함 여부', href: '/guide/rehabilitation/rehabilitation-credit-card-debt-included' },
      { label: '사업자 개인회생 신청 자격', href: '/guide/rehabilitation/business-owner-rehabilitation-eligibility' },
    ],
  },
];

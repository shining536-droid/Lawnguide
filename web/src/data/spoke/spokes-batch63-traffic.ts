...
export const spokesBatch63Traffic: SpokePage[] = [
    ...
    cases: [
      {
        ...
        summary:
          '부산지방법원 2001노696(부산지방법원, 2001.08.28 선고)에서는 어린이 통학버스 운행과 하차 직후 어린이 횡단이 예측되는 상황에서 운전자의 주의의무 위반이 인정될 경우 업무상과실치상 책임이 성립할 수 있다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하며, 유사 상황이라면 이런 기준을 검토해볼 수 있습니다.',
  ...
  // ─── 2. traffic-accident-road-rage-blackbox-proof-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '음주 면허취소 행정심판 청구', href: '/guide/dui/dui-license-revocation-admin-appeal-track' },
    ],
  },
  ...
  // ─── 3. traffic-accident-uninsured-vehicle-victim-claim-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '자전거 보행자 사고 과실비율', href: '/guide/traffic-accident/traffic-accident-bicycle-pedestrian-fault-track' },
    ],
  },
  ...
  // ─── 4. traffic-accident-multi-vehicle-rear-end-chain-track ───
  {
    ...
    cta: { text: '교통사고 합의 전 체크리스트, AI로 정리하기', link: '/chat?domain=traffic-accident' },
    internalLinks: [
      { label: '후방 추돌 30% 과실 반박', href: '/guide/traffic-accident/traffic-accident-rear-end-30-percent-fault-rebuttal' },
    ...
    cases: [
      {
        ...
        summary:
          '창원지방법원 2019가단36369(창원지방법원, 2020.06.05 선고)에서는 운전 중 의식상실이나 졸음으로 발생한 사고에서 운전자에게 사전 예측 가능성과 주의의무 위반이 있었는지 여부를 기준으로 책임 범위를 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하며, 유사 상황이라면 이런 기준을 검토해볼 수 있습니다.',

...
export const spokesBatch86AssaultDuiJeonseFraud: SpokePage[] = [
  ...
  // ─── 2. assault-floor-noise-confrontation-track ───
  {
    ...
    internalLinks: [
      { label: '폭행·상해 고소 절차', href: '/guide/assault/assault-injury-complaint-procedure' },
      { label: '강요·협박 성립 기준', href: '/guide/assault/assault-coercion-threat-standard' },
      { label: '층간소음 분쟁 대응', href: '/guide/assault/assault-floor-noise-dispute' },
  ...
  // ─── 3. assault-group-collective-track ───
  {
    ...
    cta: { text: '폭행 증거 수집 순서, AI로 정리하기', link: '/chat?domain=assault' },
    internalLinks: [
      { label: '공동폭행·집단폭행 대응', href: '/guide/assault/assault-collective-violence-response' },
      { label: '폭행·상해 고소 절차', href: '/guide/assault/assault-injury-complaint-procedure' },
      { label: '공모·가담 책임 판단', href: '/guide/assault/assault-conspiracy-liability' },
      { label: 'CCTV 영상 확보', href: '/guide/assault/assault-cctv-evidence-secure' },
      { label: '범죄피해자 지원 제도', href: '/guide/assault/assault-victim-support-system' },
    ],
  },
  ...
  // ─── 4. assault-workplace-supervisor-track ───
  {
    ...
    internalLinks: [
      { label: '폭행·상해 고소 절차', href: '/guide/assault/assault-injury-complaint-procedure' },
      { label: '피해자 진술 신빙성', href: '/guide/assault/assault-victim-statement-credibility' },
      { label: '직장 내 폭행·괴롭힘 대응', href: '/guide/assault/assault-workplace-violence-response' },
      { label: '녹취·정황 증거 활용', href: '/guide/assault/assault-recording-evidence' },
      { label: '범죄피해자 지원 제도', href: '/guide/assault/assault-victim-support-system' },
    ],
  },
  ...
  // ─── 5. dui-injury-dangerous-driving-track ───
  {
    ...
    internalLinks: [
      { label: '위험운전치사상 성립', href: '/guide/dui/dui-dangerous-driving-injury-standard' },
      ...
      { label: '음주 사고 합의·공탁', href: '/guide/dui/dui-settlement-deposit' },
  ...
  // ─── 6. dui-next-morning-hangover-track ───
  {
    ...
    cta: { text: '탄원서와 감경 요소, AI로 먼저 정리하기', link: '/chat?domain=dui' },
    internalLinks: [
      { label: '음주 측정 절차·적법성', href: '/guide/dui/dui-breath-test-procedure' },
      { label: '위법수집증거·임의수사', href: '/guide/dui/dui-illegal-evidence-collection' },
      { label: '숙취운전 음주운전 성립', href: '/guide/dui/dui-next-morning-driving-standard' },
      { label: '음주운전 양형·감경', href: '/guide/dui/dui-sentencing-mitigation-factors' },
      { label: '음주운전 행정심판 절차', href: '/guide/dui/dui-administrative-appeal-procedure' },
    ],
  },
  ...
  // ─── 8. jeonse-fraud-new-villa-overvalued-track ───
  {
    ...
    internalLinks: [
      { label: '신축빌라 깡통전세 확인', href: '/guide/jeonse-fraud/jeonse-fraud-new-villa-check' },
  ...
  // ─── 9. jeonse-fraud-landlord-impersonation-track ───
  {
    ...
    internalLinks: [
      { label: '임대인 파산·면책과 보증금', href: '/guide/jeonse-fraud/jeonse-fraud-landlord-bankruptcy-deposit' },
      { label: '우선변제권 행사·배당', href: '/guide/jeonse-fraud/jeonse-fraud-priority-payment-distribution' },
      { label: '확정일자·우선변제', href: '/guide/jeonse-fraud/jeonse-fraud-opposing-power-fixed-date' },
      { label: '경매 배당요구 절차', href: '/guide/jeonse-fraud/jeonse-fraud-auction-distribution-claim' },
      { label: '전세피해 지원 신청', href: '/guide/jeonse-fraud/jeonse-fraud-victim-support-application' },
    ],
  },
  ...
  // ─── 10. jeonse-fraud-prior-tenant-overlap-track ───
  {
    ...
    cta: { text: '보증금 돌려받을 수 있는지 AI로 점검하기', link: '/chat?domain=jeonse-fraud' },
    internalLinks: [
      { label: '대항력·임대차 존속 주장', href: '/guide/jeonse-fraud/jeonse-fraud-opposing-power-maintenance' },
      { label: '우선변제권 승계·배당', href: '/guide/jeonse-fraud/jeonse-fraud-priority-payment-distribution' },
      { label: '경매 배당요구 절차', href: '/guide/jeonse-fraud/jeonse-fraud-auction-distribution-claim' },

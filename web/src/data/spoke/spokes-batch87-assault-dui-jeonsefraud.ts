...
export const spokesBatch87AssaultDuiJeonseFraud: SpokePage[] = [
  ...
  // ─── 2. assault-parking-conflict-track ───
  {
    ...
    internalLinks: [
      { label: '폭행 종합 가이드', href: '/guide/assault' },
      { label: '층간소음 항의 이웃 쌍방폭행 무고 방어', href: '/guide/assault/assault-floor-noise-complaint-neighbor-mutual-falsely-accused-defense' },
      { label: '주차 시비 폭행 상해', href: '/guide/assault/assault-parking-conflict-injury-track' },
  ...
  // ─── 8. jeonse-fraud-multi-household-deposit-track ───
  {
    ...
    internalLinks: [
      { label: '다가구주택 보증금 합계 초과', href: '/guide/jeonse-fraud/jeonse-fraud-multi-household-deposit-excess-track' },
      ...
      { label: '임대인 체납 세금 우선 보증금 판단', href: '/guide/jeonse-fraud/jeonse-fraud-landlord-tax-arrears-priority-deposit-track' },
    ],
  },
  ...
  // ─── 9. jeonse-fraud-agent-embezzlement-track ───
  {
    ...
    cta: { text: '전세사기 피해 대응 순서, AI로 정리하기', link: '/chat?domain=jeonse-fraud' },
    internalLinks: [
      { label: '가짜 중개인 전세사기', href: '/guide/jeonse-fraud/jeonse-fraud-fake-agent-impersonation-track' },
      { label: '집주인 사칭 중개인 보증금 가로채기', href: '/guide/jeonse-fraud/jeonse-fraud-fake-landlord-agent-impersonation-track' },
      { label: '다가구주택 보증금 사기 대항요건 존속', href: '/guide/jeonse-fraud/jeonse-fraud-multi-household-deposit-track' },

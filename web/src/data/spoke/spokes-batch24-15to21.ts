...
export const spokesBatch24_15to21: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    meta: {
      ...
      description:
        '퇴사를 앞두고 실업급여를 확실히 받고 싶다면, 퇴사 전에 가능한 한 확인해야 할 5가지 요건과 서류를 지금 확인하세요.',
    },
    intro:
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>사직서를 냈더라도 실질적 이직 사유가 비자발적이면 가능합니다.</strong> 회사의 권유나 압박에 의한 사직, 근로조건 위반으로 인한 사직은 비자발적 이직으로 인정될 수 있습니다. 권유 문자, 대화 녹음, 동료 진술 등 증거를 함께 제출하세요.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    intro:
      '<p>회사에서 "합의서에 서명만 하면 깔끔하게 정리해줄게"라고 합니다. 그런데 합의서 내용을 자세히 보니 "향후 일체의 청구를 포기한다"는 문구가 있습니다. 서명 한 번 잘못하면 퇴직금, 실업급여, 미지급 수당까지 모두 포기하게 될 수 있습니다. 합의서에 서명하기 전에 가능한 한 확인해야 할 주의사항을 정리해드립니다.</p>',
    sections: [
      {
        title: '합의서에서 반드시 확인해야 할 3가지 핵심 조항',
        content:
          '<p><strong style="color:#1e3a5f">권고사직 합의서는 근로관계 종료의 조건을 정하는 문서이므로, 불리한 조항 하나가 수백만 원의 손해로 이어질 수 있습니다</strong></p>\n<ul>\n<li><strong>이직 사유 기재 확인</strong> — 합의서에 "자발적 사직"으로 기재되면 실업급여 수급이 불가능합니다. 가능한 한 "권고사직" 또는 "회사의 경영상 사유에 의한 이직"으로 명시되어야 합니다. 이직확인서에도 같은 사유가 기재되는지 확인하세요</li>\n<li><strong>청구권 포기 조항 삭제</strong> — "향후 일체의 민·형사상 청구를 포기한다"는 포괄적 부제소 합의 조항은 퇴직금, 미지급 수당, 연차수당 청구권까지 모두 포기하는 것입니다. 이 조항은 가능한 한 삭제하거나 범위를 특정하세요</li>\n<li><strong>퇴직금·정산금 명시</strong> — 퇴직금 금액, 미사용 연차수당, 미지급 임금 등 정산 항목과 금액을 구체적으로 명시해야 합니다. "추후 정산"이라는 모호한 표현은 분쟁의 원인이 됩니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 이직 사유 "권고사직" 명시 + 포괄 포기 조항 삭제 + 정산금 구체화</blockquote>',
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>법적 효과가 완전히 다릅니다.</strong> 사직서는 근로자의 일방적 사직 의사표시이고, 권고사직 합의서는 쌍방이 조건을 합의하는 계약입니다. 사직서만 쓰면 실업급여 수급이 어려워지므로, 가능한 한 "권고사직 합의서" 형태로 작성하세요.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>받을 수 있습니다.</strong> 직장 내 괴롭힘은 고용보험법상 "정당한 이직 사유"에 해당할 소지가 있습니다. 괴롭힘 증거(녹음, 진단서, 신고 기록 등)를 고용센터에 제출하면 자발적 퇴사라도 실업급여 수급이 인정될 수 있습니다.',
      },
      {
        question: '괴롭힘 가해자를 형사고소할 수 있나요?',
        answer:
          '<strong>행위 유형에 따라 가능합니다.</strong> 모욕(「형법」 제311조), 명예훼손(제307조), 협박(제283조), 상해(제257조)에 해당하면 별도로 형사고소가 가능합니다. 직장 내 괴롭힘 자체는 형사처벌 대상이 아니지만, 개별 행위가 형법에 해당하면 처벌 대상으로 검토될 수 있습니다.',
      },
    ],
    cta: {
  ...
  // ───────────────────────────────────────────
  {
    ...
    meta: {
      ...
      description:
        '임금체불로 근로감독관에게 신고하려는데 증거가 부족할까 걱정된다면, 가능한 한 준비해야 할 증거 7가지를 지금 확인하세요.',
    },
    intro:
      '<p>몇 달째 월급이 밀렸습니다. 노동청에 신고하려고 하는데, "증거가 없으면 소용없다"는 말이 걱정됩니다. 어떤 자료를 가져가야 근로감독관이 제대로 조사해주는지, 막막하기만 합니다. 신고 전에 가능한 한 확보해야 할 증거 목록을 체크리스트로 정리해드립니다.</p>',
    sections: [
      {
    ...
    cases: [
      {
        ...
        takeaway:
          '고용보험 관련 급여 신청에는 법정 기한이 엄격히 적용됩니다. 계약만료 후 실업급여도 퇴직일로부터 12개월 이내에 가능한 한 신청해야 합니다. 기한을 놓치면 구제가 불가능하니 즉시 고용센터를 방문하세요.',
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          '<strong>조건부로 가능합니다.</strong> 주 15시간 미만·월 60시간 미만의 단기 취업은 허용됩니다. 다만 소득이 발생하면 가능한 한 실업인정일에 신고해야 합니다. 미신고 시 부정수급으로 반환 명령과 추가 징수(2배)를 받을 수 있습니다.',
      },
    ],
    cta: {

...
export const spokesBatch45Labor: SpokePage[] = [
  // ─── 1. dismissal / mental-illness-disclosure-fired ───
  {
    ...
    internalLinks: [
      ...
      { label: '직장 내 괴롭힘 신고 절차', href: '/guide/dismissal/workplace-bullying-complaint-procedure' },
      { label: '부당해고 구제신청 절차', href: '/guide/dismissal/dismissal-relief-procedure-comprehensive' },
      { label: '인수합병 기간제 갱신기대권', href: '/guide/dismissal/dismissal-acquisition-fixed-term-rights' },
    ],
  },
  ...
  // ─── 2. dismissal / merger-fixed-term-distinction ───
  {
    ...
    internalLinks: [
      ...
      { label: '기간제 2년 초과 무기계약 전환 거절 대응 4단계', href: '/guide/dismissal/dismissal-fixed-term-2year-conversion' },
      { label: '긴박한 경영상 필요 정리해고', href: '/guide/dismissal/dismissal-managerial-layoff-requirements-track' },
      { label: '해고근로자 종합 가이드', href: '/guide/dismissal' },
      { label: '부당해고 구제신청 절차', href: '/guide/dismissal/dismissal-relief-procedure-comprehensive' },
    ],
  },
  ...
  // ─── 3. dismissal / ceo-relative-discharge-pressure ───
  {
    ...
    cta: { text: '부당해고 구제신청 순서, AI로 정리하기', link: '/chat?domain=dismissal' },
    internalLinks: [
      { label: '사표 강요 묵시적 해고', href: '/guide/dismissal/dismissal-implied-resignation-coercion-discharge-track' },
      { label: '직장 내 괴롭힘 신고 절차', href: '/guide/dismissal/workplace-bullying-complaint-procedure' },
      { label: '해고근로자 종합 가이드', href: '/guide/dismissal' },
  ...
  // ─── 4. dismissal / double-dispatch-redundancy ───
  {
    ...
    internalLinks: [
      { label: '해고근로자 종합 가이드', href: '/guide/dismissal' },
      { label: '파견 도급 묵시적 근로계약 직접고용', href: '/guide/dismissal/dismissal-dispatch-implicit-employment-direct-track' },
      { label: '사용자 도산·일부 사업 폐지 + 도산대지급금', href: '/guide/dismissal/dismissal-employer-insolvency-bankruptcy-deferred-pay-track' },
      { label: '위장폐업 해고 구제', href: '/guide/dismissal/dismissal-fake-closure-disguised-shutdown-track' },
      { label: '부당해고 구제신청 절차', href: '/guide/dismissal/dismissal-relief-procedure-comprehensive' },
    ],
  },
  ...
  // ─── 8. wage / mileage-allowance-cut ───
  {
    ...
    internalLinks: [
      ...
      { label: '월급 밀림 노동청 신고 절차 방법', href: '/guide/wage/delayed-salary-labor-office-report' },
      { label: '취업규칙 불리변경 임금 보호', href: '/guide/wage/wage-employment-rule-change-unfavorable' },
  ...
  // ─── 9. unemployment / spouse-relocation-eligible ───
  {
    ...
    internalLinks: [
      ...
      { label: '통근 1.5시간 대중교통 자진퇴사 실업급여', href: '/guide/unemployment/unemployment-commute-1-5hour-public-transit-quit-track' },
  ...
  // ─── 11. retirement / overseas-dispatch-continuous ───
  {
    ...
    internalLinks: [
      ...
      { label: '퇴직금 노동위원회 조정', href: '/guide/retirement/retirement-labor-commission-mediation' },
    ],
  },
  ...
  // ─── 12. retirement / merger-effective-date ───
  {
    ...
    cases: [
      {
        title: '판례 — 계약 형식 변경과 근로관계의 계속',
        summary:
          '대법원 2012다20550(대법원, 2015.07.09 선고)에서 법원은 채권추심원들이 계약기간 만료마다 재계약을 반복하며 업무를 수행하던 중 회사가 계약서 양식을 변경해 재계약했더라도, 그 사정만으로 이전과 달리 근로기준법상 근로자에 해당하지 않게 되었다고 단정할 수 없다고 판시했습니다. 계약 형식이 바뀌어도 실질적인 근로관계가 이어졌다면 근로자 지위가 그대로 유지된다는 취지입니다. 합병·영업양도로 사용자 명의가 바뀌는 경우에도 근로관계가 계속되는지, 그에 따라 퇴직금 기산일이 유지되는지를 이러한 관점에서 검토해볼 수 있습니다.',
        takeaway: '계약 형식·사용자 명의가 바뀌어도 실질적 근로관계가 이어지면 계속근로로 볼 수 있음. 합병·양도 시 퇴직금 기산일이 원래 입사일로 유지되는지 근로계약·재직 자료로 확인해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {

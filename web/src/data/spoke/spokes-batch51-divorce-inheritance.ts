    ...
    cases: [
      {
        ...
        summary:
          '서울가정법원 2014르2496(서울가정법원, 2015.10.23 선고)에서는 약 25년간 별거하며 사실상 일체의 교류를 단절한 부부 사안에서, 25년 이상 장기간의 별거생활이 지속되면서 혼인의 실체가 완전히 해소되고 각자 독립적인 생활관계를 갖기에 이른 점, 부부공동생활 관계의 해소 상태가 장기화되면서 유책성도 세월에 따라 약화된 점 등을 종합해 민법 제840조 제6호 "혼인을 계속하기 어려운 중대한 사유"가 존재한다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요합니다.',
    ...
    cases: [
      {
        ...
        summary:
          '서울가정법원 2008느합86(서울가정법원, 2010.11.02 선고)에서는 부의금이란 "장례비에 먼저 충당될 것을 조건으로 한 금전의 증여"라고 보고, 접수된 부의금 금액이 상속인 또는 가족별로 다르더라도 우선 장례비에 충당되어야 하며, 부의금 총액이 장례비를 초과하면 부의금 피교부자별로 접수된 금액의 비율대로 정산하고 잔여분은 그 사람들에게 귀속된다고 판단한 사례가 있습니다. 또한 부의금 합계가 장례비에 미치지 못하면 모두 장례비에 충당되고 부족분은 법정상속분에 따라 부담한다고 보았습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요합니다.',

...
export const fraudPages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '어디부터형',
    meta: {
      title: '사기 고소당했을 때 초기 대응 3단계 | 로앤가이드',
      description: '사기로 고소당했다면 지금 뭘 해야 할까? 경찰 출석 전 준비사항, 수사 절차, 합의 타이밍까지 초기 대응 3단계를 지금 확인하세요.',
    },
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '사기 허위고소 무고죄 반대고소 대응법 | 로앤가이드',
      description: '사실과 다르게 사기로 고소당했다면? 무고죄 반대고소 요건, 혐의 벗는 증거 확보법, 수사 단계별 대응 방법을 바로 정리해보세요.',
    },

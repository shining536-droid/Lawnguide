...
export const fraudPages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '준비서류형',
    meta: {
      title: '사기 고소장 쓰기 전 준비할 증거와 절차 | 로앤가이드',
      description: '사기 피해를 입었다면 고소 전에 증거부터 정리하세요. 송금 내역, 대화 기록, 계약서 등 필요 증거와 고소장 작성 요령을 지금 확인하세요.',
    },
    ...
    faq: [
      {
        question: '사기 고소장을 쓰려면 어떤 증거를 먼저 준비해야 하나요?',
  ...
  },
  {
    ...
    type: '수치기한형',
    meta: {
      title: '사기죄 처벌 얼마인가요? 합의하면 감형되나요? | 로앤가이드',
      description:

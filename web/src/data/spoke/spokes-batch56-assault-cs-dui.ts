...
export const spokesBatch56AssaultCsDui: SpokePage[] = [
  // ─── 1. assault / assault-pub-mutual-altercation-settlement-tier ───
  {
    ...
    cases: [
      {
        title: '판례 — 폭행죄와 처벌불원의 효력',
        summary:
          '대법원 2020도927(대법원, 2023.06.15 선고)에서 법원은 폭행죄가 원칙적으로 피해자가 처벌을 원하지 않으면 처벌할 수 없는 반의사불벌죄(형법 제260조 제3항)임을 전제하면서도, 군형법은 군인 등이 군사기지에서 군인 등을 폭행한 경우에는 그 반의사불벌 규정을 적용하지 않는다고 판단했습니다. 일반적인 폭행 사건에서는 피해자의 처벌불원 의사가 처벌 여부를 좌우하지만, 특별한 규정이 있는 영역에서는 그렇지 않을 수 있다는 취지입니다. 술집에서의 쌍방 폭행처럼 일반 폭행죄가 문제 되는 사안이라면 처벌불원서 교환과 합의가 종결·양형에서 중요한 변수가 되므로, CCTV·진단서·목격자 진술을 함께 정리해두는 것이 좋습니다.',
        takeaway: '쌍방폭행은 양측 처벌불원서 교환과 합의금 협의가 핵심 트랙이 되는 영역이라, CCTV·진단서·목격자 진술을 정리해 합의와 양형 대응을 함께 준비하는 방향을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
  ...
  // ─── 6. dui / dui-test-refusal-warrant-blood-extraction ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>음주감지기는 측정요구 부정 영역(인천지법 2008고정299 하급심).</strong> 호흡측정기 적법 요구가 측정거부죄 성립 요건. 절차 적법성 다툼 가능.',
      },
      {

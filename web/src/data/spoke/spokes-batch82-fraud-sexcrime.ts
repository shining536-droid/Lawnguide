...
export const spokesBatch82FraudSexCrime: SpokePage[] = [
  ...
  // ─── 2. fraud-pet-shop-sick-puppy-disease-concealment-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '보이스피싱 피해구제 전기통신금융사기', href: '/guide/fraud/fraud-voice-phishing-relief-law-application' },
      { label: '행사 예약금 취소 잠적 환수', href: '/guide/fraud/fraud-event-deposit-cancel-vanish-recovery-track' },
  ...
  // ─── 5. fraud-crypto-exchange-withdrawal-block-exit-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '보이스피싱 송금 환급 절차', href: '/guide/fraud/fraud-phishing-transfer-refund-procedure' },
      { label: 'NFT 디지털자산 리딩방 사기', href: '/guide/fraud/fraud-nft-digital-asset-leading-room' },
    ],
  },
  ...
  // ─── 6. fraud-private-loan-double-collateral-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '지인 차용금 변제지체 사기 무고', href: '/guide/fraud/fraud-acquaintance-loan-default-falsely-accused-defense' },
  ...
  // ─── 7. sex-crime-gym-personal-trainer-inappropriate-contact-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '학원 강사 강제추행', href: '/guide/sex-crime/sex-crime-academy-instructor-track' },
  ...
  // ─── 8. sex-crime-club-dancefloor-stranger-groping-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '지인 항거불능 상태 추행', href: '/guide/sex-crime/sex-crime-acquaintance-incapacitated-state-track' },
      { label: '회식 후 술자리 강제추행 무고', href: '/guide/sex-crime/sex-crime-afterwork-drink-contact-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 9. sex-crime-hospital-treatment-doctor-inappropriate-act-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '만취 블랙아웃 추행 무고', href: '/guide/sex-crime/sex-crime-blackout-drunk-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 10. sex-crime-company-dinner-intoxicated-misunderstanding-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '성범죄 합의금 적정 금액과 절차', href: '/guide/sex-crime/sex-crime-settlement' },
    ],
  },
];

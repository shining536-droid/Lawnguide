...
export const spokesBatch48DefameJeonse: SpokePage[] = [
  // ─── 1. defamation / false-review-perpetrator-defense ───
  {
    ...
    intro:
      '<p>"감정이 격해서 사실과 약간 다른 후기를 올렸는데 가게 사장님이 고소하셨어요"라는 상담이 늘고 있습니다. 거짓이 일부 섞인 후기는 진실성 항변이 흔들릴 수 있어 빠른 삭제·합의 검토가 핵심입니다. 사실과 다르게 신고되었다면 무조건 부인하기보다는 표현의 어떤 부분이 사실과 다른지 정리하고, 위법성조각 가능성과 합의 시점을 함께 점검해보는 것이 좋습니다.</p>',
    sections: [
      {
  ...
  // ─── 2. defamation / company-chat-insult-vs-defamation ───
  {
    ...
    faq: [
      ...
      {
        question: '직장 내 괴롭힘 신고하면 회사가 무조건 조사하나요?',
        answer:
  ...
  // ─── 5. jeonse / empty-house-warning-pre-contract-check ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>신탁회사 동의서 없이는 임대인이 적법하게 임대할 권한이 없을 수 있습니다.</strong> 신탁 부동산 계약 시 신탁원부 확인 + 신탁회사 동의 여부를 반드시 점검하세요.',
      },
    ],

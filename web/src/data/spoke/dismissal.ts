...
export const dismissalPages: SpokePage[] = [
  {
    ...
    type: '체크리스트형',
    meta: {
      title: '부당해고 당했을 때 먼저 할 3가지 | 로앤가이드',
      description: '부당해고를 당했을 때 즉시 해야 할 3가지 — 해고 통지서 확보, 증거 수집, 구제신청 준비를 정리했습니다.',
    },
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '해고예고수당 못 받았을 때 대처법 | 로앤가이드',
      description: '해고예고수당 청구 조건, 계산 방법, 노동청 신고 절차를 정리했습니다.',
    },

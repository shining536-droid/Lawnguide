  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>원칙적으로 2개월 이상 체불되어야 정당한 이직 사유로 인정될 수 있습니다.</strong> 다만 체불 금액이 크거나 상습적으로 지연 지급한 이력이 있다면 1개월이라도 인정받을 가능성이 있으므로, 통장 내역을 기준으로 지급 지연 패턴을 함께 정리해서 제출하세요.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>월 60시간 이상 근로하거나 3개월 이상 계속 근무하면 취업으로 간주됩니다.</strong> 단시간 일용직은 취업으로 보지 않을 수 있으나, 실업 인정 시 해당 근로 사실과 소득을 가능한 한 신고해야 부정수급을 피할 수 있습니다.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>근로조건이 이전 계약보다 현저히 불리하게 변경된 경우에는 거절해도 비자발적 이직으로 인정될 수 있습니다.</strong> 임금 삭감, 근무지 변경, 직종 변경 등이 해당하며, 변경된 계약 조건을 증빙할 수 있는 서류를 보관하세요.',
      },
      {
    ...
    cases: [
      {
        ...
        takeaway:
          '실업급여 연장 신청이든 육아휴직급여 청구든 법정 기한 내에 신청하지 않으면 권리가 소멸할 수 있으므로, 수급기간 만료 전에 가능한 한 연장 가능 여부를 확인하고 신청하세요.',
      },
    ],
    faq: [
      {
    ...
    faq: [
      {
        ...
        answer:
          '<strong>하루만 근로했더라도 실업 인정 신청 시 해당 일자의 근로 사실과 소득을 가능한 한 기재해야 합니다.</strong> 신고하면 해당일의 구직급여가 차감되지만, 미신고 시 부정수급으로 3배 환수 대상이 됩니다. 정직한 신고가 유리합니다.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>고용보험 홈페이지(www.ei.go.kr) → 개인서비스 → 수급자격 교육에서 온라인으로 수강합니다.</strong> 약 1시간 분량이며, 영상 시청 후 간단한 확인 문제를 풀면 이수 처리됩니다. 고용센터 방문 전에 가능한 한 완료하세요.',
      },
      {

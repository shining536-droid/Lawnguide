...
export const spokesBatch80DivorceInheritTraffic: SpokePage[] = [
    ...
    cases: [
      {
        ...
        summary:
          '서울가정법원 2002드합8421(서울가정법원, 2004.03.17 선고)에서는 협의이혼에서 부부 중 일방이 가정법원에 의한 이혼의사확인을 받기 전 그 신청을 취하할 수 있고, 가정법원에 의한 이혼의사확인이 있더라도 부부 일방에 의한 이혼신고 전 상대방의 이혼의사 철회가 있으면 이혼신고를 수리할 수 없다는 취지로 이혼의사의 변경 가능성을 설명한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하며, 이혼의사확인 후 철회 가능 여부를 다투는 사안에서 이 법리를 검토해볼 수 있습니다.',
        takeaway:
  ...
  // ─── 3 divorce-short-marriage-wedding-gifts-yedan-return-track ───
  {
    ...
    intro:
      '<p>"양가 인사를 마치고 적지 않은 예물과 예단을 주고받으며 결혼했는데, 함께 산 지 불과 몇 달 만에 관계가 돌이킬 수 없을 정도로 틀어졌습니다. 결혼 준비에 들인 비용과 예물·예단이 만만치 않았던 터라, 이렇게 단기간에 헤어지게 되면 주고받은 것을 돌려받을 수 있는지 막막합니다. 누가 누구에게 무엇을 돌려줘야 하는지, 잘못이 더 큰 쪽도 청구할 수 있는지 모르겠어요." 혼인예물·예단은 혼인의 성립을 증명하고 양가의 정리를 두텁게 할 목적으로 수수되는, 혼인의 불성립을 해제조건으로 하는 증여와 유사한 성질을 갖는 영역입니다. 서울가정법원 2010드합2787(서울가정법원, 2010.12.16 선고)은 혼인이 단기간 내에 파탄된 경우 혼인의 불성립에 준하여 증여의 해제조건이 성취되었다고 보아 예물·예단이 제공자에게 반환되어야 하나, 혼인관계 파탄에 과실이 있는 유책자에게는 자신이 제공한 예물·예단을 적극적으로 반환청구할 권리가 없다는 취지를 밝힌 하급심 사례입니다(확정 여부는 별도 확인이 필요합니다). 당사자라면 ① 수수 내역 정리 ② 파탄 시점·기간 확인 ③ 유책 정도 점검 ④ 반환 대상 산정 ⑤ 청구 방법 검토 5중 트랙으로 정리해두는 것을 검토할 수 있습니다.</p>',
    sections: [
      {
    ...
    cases: [
      {
        ...
        summary:
          '서울가정법원 2010드합2787(서울가정법원, 2010.12.16 선고)에서는 혼인예물·예단이 혼인의 불성립을 해제조건으로 하는 증여와 유사한 성질을 가지므로 혼인이 단기간 내에 파탄된 경우에는 혼인 불성립에 준하여 증여의 해제조건이 성취되었다고 보아 제공자에게 반환되어야 하나, 혼인관계 파탄에 과실이 있는 유책자에게는 자신이 제공한 예물·예단을 적극적으로 반환청구할 권리가 없다는 취지로 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하며, 단기 파탄 후 예물·예단 반환을 다투는 사안에서 이 법리를 검토해볼 수 있습니다.',
        takeaway:

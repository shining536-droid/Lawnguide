...
export const spokesBatch49DivorceInheritance: SpokePage[] = [
  ...
  // ─── 2. divorce / child-support-no-asset-enforcement ───
  {
    ...
    internalLinks: [
      ...
      { label: '이혼 후 양육비 안 줄 때 대처법', href: '/guide/divorce/child-support-non-payment' },
      { label: '협의이혼 후 양육비 미지급 변경청구 이행명령', href: '/guide/divorce/divorce-after-agreement-child-support-unpaid-modification' },
      { label: '외국인 배우자 이혼 국제재판 준거법', href: '/guide/divorce/divorce-foreign-spouse-litigation-procedure' },
    ],
  },

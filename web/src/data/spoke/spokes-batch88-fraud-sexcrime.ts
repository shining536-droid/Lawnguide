...
export const spokesBatch88FraudSexCrime: SpokePage[] = [
  ...
  // ─── 5. fraud-secondhand-furniture-bulk-noshow-track ───
  {
    ...
    internalLinks: [
      { label: '거래 분쟁의 사기 고소 둔갑', href: '/guide/fraud/fraud-business-dispute-criminal-complaint-false-accused-defense' },
      { label: '중고 냉장고 직거래 입금 후 미인도 사기', href: '/guide/fraud/fraud-used-refrigerator-direct-deal-deposit-no-delivery-track' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
  ...
  // ─── 7. sex-crime-gym-pt-trainer-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '음주 상태 성관계 동의 여부 판단기준', href: '/guide/sex-crime/sex-crime-drunk-consent-issue' },
    ],
  },
  ...
  // ─── 8. sex-crime-subway-bus-molestation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '엘리베이터 순간 접촉 추행 무고 방어', href: '/guide/sex-crime/sex-crime-elevator-momentary-contact-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 9. sex-crime-public-restroom-illegal-filming-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '엘리베이터 모르는 사람 밀착 접촉 피해', href: '/guide/sex-crime/sex-crime-elevator-stranger-close-contact-track' },
    ],
  },
  ...
  // ─── 10. sex-crime-workplace-afterparty-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '엘리베이터 낯선 사람 강제추행', href: '/guide/sex-crime/sex-crime-elevator-stranger-track' },

...
export const sanggaPages: SpokePage[] = [
  {
    ...
    type: '상황형',
    meta: {
      title: '상가 권리금 못 받았을 때 4단계 대응법 | 로앤가이드',
      description: '임대인이 신규 임차인을 거부해서 권리금을 못 받고 계신가요? 법적 근거, 손해배상 청구 절차, 증거 준비 방법을 지금 확인하세요.',
    },
  ...
  },
  {
    ...
    type: '상황형',
    meta: {
      title: '상가 계약 갱신 거절당했을 때 대처법 총정리 | 로앤가이드',
      description: '상가 갱신을 거절당해 나가야 하나 고민되시나요? 10년 갱신요구권, 정당한 거절 사유 판단, 분쟁조정·소송 절차를 바로 정리해보세요.',
    },
  ...
  },
  {
    ...
    type: '절차형',
    meta: {
      title: '상가 보증금 반환 4단계 절차 총정리 | 로앤가이드',
      description: '상가 보증금을 돌려받지 못하고 계신가요? 내용증명, 임차권등기명령, 지급명령, 강제집행까지 4단계 절차를 지금 확인하세요.',
    },

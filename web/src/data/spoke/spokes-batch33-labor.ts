  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>사업주가 도산하더라도 대지급금 제도로 퇴직금을 받을 수 있습니다.</strong> 고용노동부에 대지급금을 신청하면 최대 1,000만 원 범위에서 국가가 먼저 지급하고 사업주에게 구상합니다. 다만 퇴직 전 3년간의 퇴직금만 대상입니다.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>사업주 재산(부동산, 예금, 매출채권)에 대해 강제집행이 가능합니다.</strong> 판결이나 지급명령이 확정되면 법원에 재산조회를 신청하여 사업주 재산을 파악한 뒤 압류·추심 절차를 진행할 수 있습니다. 도산한 경우에는 대지급금 제도를 활용하세요.',
      },
      {

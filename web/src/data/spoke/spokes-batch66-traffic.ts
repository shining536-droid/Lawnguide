...
export const spokesBatch66Traffic: SpokePage[] = [
  ...
  // ─── 2. traffic-accident-flooded-vehicle-rental-customer-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '건설기계 작업 중 사고 교통사고처리법', href: '/guide/traffic-accident/traffic-accident-construction-machine-operation-special-track' },
  ...
  // ─── 3. traffic-accident-bicycle-pedestrian-collision-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '공사현장 장비 충돌', href: '/guide/traffic-accident/traffic-accident-construction-site-equipment-collision-track' },
  ...
  // ─── 4. traffic-accident-truck-cargo-unload-injury-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '공사장 트럭 적재물 낙하 사고', href: '/guide/traffic-accident/traffic-accident-construction-truck-falling-cargo-track' },

    ...
    cases: [
      {
        ...
        summary:
          '수원지방법원 2019가합20989(수원지방법원, 2020.10.29 선고)에서는 사용자가 근로자에게 일정 횟수 이상 주의를 받았다는 이유로 대기발령을 한 다음 대기발령 후 일정 기간이 지나도록 직위·직무를 받지 못했다는 이유로 면직을 통보한 사안에서, 위 대기발령과 이에 이어진 면직은 이를 전체적으로 보면 근로자의 의사에 반하여 사용자의 일방적 의사에 따라 근로계약관계를 종료시킨 것으로서 실질적으로 징계해고에 해당하는데도 사용자가 구체적인 사유를 서면으로 통지하지 않은 채 면직을 하였으므로 그 면직은 효력이 없다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요합니다. 대기발령 후 면직 대응 시 면직의 실질과 서면통지 요건을 함께 검토해볼 수 있습니다.',

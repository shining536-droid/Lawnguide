...
export const prostitutionPages: SpokePage[] = [
  {
    ...
    type: '상황형',
    meta: {
      title: '성매매 단속 적발 후 기소유예받는 방법 | 로앤가이드',
      description: '성매매로 단속에 적발됐다면 지금 뭘 해야 할까? 300만원 이하 벌금 기준, 초범 기소유예 조건, 존스쿨 수강, 진술 시 주의사항을 지금 확인하세요.',
    },
    ...
    cases: [
      {
        ...
        summary:
          '관련 사례에서도 단순 성매수 초범이 범행을 인정하고, 존스쿨을 수강한 뒤 반성문을 제출하여 기소유예 처분을 받은 경우가 자주 있습니다. 기소유예는 전과가 남지 않으며, 이후 취업이나 신원조회에서도 불이익이 발생하지 않습니다.',
        takeaway:
    ...
    faq: [
      {
        ...
        answer: '경찰·검찰이 직장에 <strong>자동 통보하지는 않습니다</strong>. 다만 구속되거나 공무원인 경우에는 소속 기관에 통보될 수 있으며, 수사 과정에서 직장 연락처가 노출되지 않도록 주의가 필요합니다.',
      },
      {
        question: '기소유예와 벌금의 차이는 뭔가요?',
        answer: '기소유예는 <strong>전과가 남지 않고</strong> 수사경력만 기록되며, 벌금은 형사처벌이므로 전과 기록이 남습니다. 벌금형은 5년간 수사경력회보서에 조회됩니다.',
      },
      {
        question: '온라인으로 성매매를 시도하다 적발된 경우도 처벌되나요?',
        answer: '성매매 <strong>광고·알선</strong>도 처벌 대상이며, 실제 성매매가 이루어지지 않더라도 온라인 대화 기록 등을 근거로 미수 또는 예비 단계에서 처벌될 수 있습니다.',
      },
      {
        question: '벌금은 얼마 정도 나오나요?',
        answer: '단순 성매수 초범 기준 통상 <strong>100~200만원</strong> 수준의 벌금이 부과됩니다. 재범이거나 알선 행위가 포함된 경우에는 벌금 금액이 상향될 수 있습니다.',
      },
      {
      ...
      },
      {
        ...
        answer: '아동·청소년 대상 성매매는 <strong>아청법</strong>이 적용되어 훨씬 무거운 처벌을 받으며, 미필적 고의(알 수 있었던 경우)도 처벌 대상이 될 수 있습니다.',
      },
      {
        question: '변호사 없이도 대응할 수 있나요?',
        answer: '가능하지만, 기소유예 등 <strong>유리한 처분</strong>을 위해서는 변호사 상담을 권장합니다. 특히 재범이거나 혐의를 다투어야 하는 경우에는 전문 변호사의 조력이 중요합니다.',
      },
      {

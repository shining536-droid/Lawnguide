...
export const spokesBatch27DismissalTraffic: SpokePage[] = [
  ...
  // ── 1. 출산휴가/육아휴직 복귀 후 해고 ──
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: '<p><strong style="color:#1e3a5f">해고가 아니더라도 불리한 부서 배치, 직급 하락, 임금 삭감은 불이익 처우에 해당할 소지가 있습니다.</strong></p>\n<ul>\n<li>휴직 전보다 낮은 직급이나 다른 직무로 배치</li>\n<li>임금이나 수당의 삭감</li>\n<li>승진 누락이나 평가 불이익</li>\n</ul>',
      },
    ],
  ...
  // ── 4. 노조 활동 보복 해고 ──
  {
    ...
    cases: [{ title: '판례 — 노조 가입 직후 해고의 부당노동행위 추정', summary: '대법원은 노조 가입 직후 해고된 경우, 해고 시점의 근접성과 사용자의 반노조 정서가 입증되면 부당노동행위로 추정합니다. 사용자가 해고의 정당한 사유를 입증하지 못하면 부당노동행위가 인정될 수 있습니다.', takeaway: '비슷한 상황이라면 노조 가입 시점과 해고 시점의 근접성, 사용자의 반노조 발언 등을 증거로 확보하세요.' }],
    faq: [

...
export const spokesBatch47Divorce: SpokePage[] = [
  // ─── 1. divorce / public-servant-pension-split ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>재산분할 제척기간 2년이 도과하면 연금 분할 청구도 어려워집니다.</strong> 제척기간은 합의로 연장되지 않으니, 이혼 후 2년 이내에 가능한 한 처리하는 것이 필요합니다.',
      },
    ],
    ...
    internalLinks: [
      ...
      { label: '배우자 회사 스톡옵션 재산분할 판단', href: '/guide/divorce/divorce-company-stock-option-property-division-track' },
  ...
  // ─── 2. divorce / spouse-business-debt-cosign ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>본인이 보증인이나 연대채무자가 아니라면 원칙적으로 본인 급여는 압류 대상이 아닙니다.</strong> 다만 금융거래에서 연대보증 여부를 가능한 한 먼저 확인하세요.',
      },
      {
  ...
  // ─── 4. divorce / stay-home-husband-property-split ───
  {
    ...
    internalLinks: [
      ...
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
      { label: '사실혼 파기 위자료', href: '/guide/divorce/divorce-de-facto-marriage-alimony-claim' },
    ],
  },
];

  ...
  // ── 파산 1. 소상공인·자영업자 파산 신청 요건과 면책 절차 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>종업원 임금, 퇴직금, 재해보상금은 비면책채권으로 파산·면책이 되어도 탕감되지 않습니다.</strong> 근로기준법에 따라 지급 의무가 존속하며, 대지급금 제도를 통해 근로자에게 먼저 지급될 수 있습니다.',
      },
      {

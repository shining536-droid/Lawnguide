...
export const spokesBatch70DivorceInheritCs: SpokePage[] = [
  ...
  // ─── 3. divorce-remarriage-environment-change-custodian-change-petition-track ───
  {
    ...
    cta: { text: '협의이혼 준비서류, AI로 정리하기', link: '/chat?domain=divorce' },
    internalLinks: [
      { label: '이혼 후 친권 양육권 변경', href: '/guide/divorce/divorce-custody-modification-after-divorce' },
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
      { label: '면접교섭권 거부 대응', href: '/guide/divorce/divorce-visitation-denied-response' },
      { label: '재혼 양육비 감액', href: '/guide/divorce/divorce-post-divorce-child-support-modification' },
      { label: '청소년 자녀 양육권 의사 반영', href: '/guide/divorce/divorce-child-custody-teen-preference' },
    ],
  },
  ...
  // ─── 5. inheritance-property-division-trial-contribution-portion-spouse-caregiving-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '이복형제 생전 증여 유류분 반환 청구', href: '/guide/inheritance/inheritance-half-sibling-lifetime-gift-yuryubun-track' },
    ],
  },
  ...
  // ─── 6. inheritance-limited-acceptance-additional-debt-discovered-special-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '한정승인 상속채무 처리', href: '/guide/inheritance/inheritance-limited-acceptance-debt-track' },
      { label: '한정승인 청산 절차', href: '/guide/inheritance/inheritance-limited-acceptance-liquidation-5steps' },
      { label: '상속포기 한정승인 비교', href: '/guide/inheritance/inheritance-renunciation-vs-limited-acceptance' },
      { label: '한정승인 신고 절차 상속채무 불확실', href: '/guide/inheritance/inheritance-limited-acceptance-filing-track' },
    ],
  },
  ...
  // ─── 7. inheritance-notarial-will-validity-contest-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '배우자 생전 증여 유류분 반환 청구', href: '/guide/inheritance/inheritance-spouse-lifetime-gift-yuryubun-claim-track' },

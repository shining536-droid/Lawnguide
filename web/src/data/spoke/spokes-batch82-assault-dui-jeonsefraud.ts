...
export const spokesBatch82AssaultDuiJeonseFraud: SpokePage[] = [
  // ─── 1. assault-parking-dispute-neighbor-shove-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '공항·항공기 내 시비 폭행', href: '/guide/assault/assault-airport-airline-gate-quarrel-injury-track' },
      { label: '폭행 합의금 기준', href: '/guide/assault/assault-settlement-amount-standard' },
      { label: '술집 쌍방폭행 합의 반의사불벌', href: '/guide/assault/assault-bar-fight-mutual-injury-settle' },
  ...
  // ─── 2. assault-online-game-offline-meetup-mutual-track ───
  {
    ...
    internalLinks: [
      { label: '술자리 시비 쌍방폭행 분리 다툼', href: '/guide/assault/assault-drinking-mutual-fight-separation-dispute-track' },
      { label: '폭행 종합 가이드', href: '/guide/assault' },
  ...
  // ─── 3. assault-elderly-care-facility-staff-resident-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '공동주택 엘리베이터 폭행 CCTV', href: '/guide/assault/assault-apartment-elevator-cctv-evidence-track' },
      { label: '묻지마 폭행 피해 회복', href: '/guide/assault/assault-stranger-random-attack-victim-track' },
    ],
  },
  ...
  // ─── 4. assault-amateur-sports-collision-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      { label: '폭행 종합 가이드', href: '/guide/assault' },
      { label: '운동경기 태클 상해', href: '/guide/assault/assault-sports-game-tackle-injury-track' },
      { label: '폭행 합의금 기준', href: '/guide/assault/assault-settlement-amount-standard' },
  ...
  // ─── 5. dui-electric-kickboard-pm-drunk-riding-track ───
  {
    ...
    internalLinks: [
      { label: '개인형이동장치 음주운전', href: '/guide/dui/dui-personal-mobility-pm-track' },
  ...
  // ─── 7. dui-property-damage-flee-combined-charge-track ───
  {
    ...
    internalLinks: [
      { label: '음주 후 물피도주', href: '/guide/dui/dui-property-damage-flee-after-drinking-track' },
      { label: '음주운전 종합 가이드', href: '/guide/dui' },
      { label: '위드마크 추정 음주운전', href: '/guide/dui/dui-widmark-estimation-track' },
      { label: '음주측정 거부 처벌 여부', href: '/guide/dui/dui-breath-test-refusal-penalty-falsely-accused-defense' },
      { label: '음주운전 선처 탄원서 작성법과 필요서류', href: '/guide/dui/dui-leniency-petition-documents' },
    ],
  },
  ...
  // ─── 9. jeonse-fraud-fake-landlord-agent-impersonation-track ───
  {
    ...
    internalLinks: [
      { label: '이중계약 중개사 가담 보증금 위험', href: '/guide/jeonse-fraud/jeonse-fraud-double-contract-broker-collusion-track' },
      { label: '공인중개사 보증금 횡령 전세사기', href: '/guide/jeonse-fraud/jeonse-fraud-agent-embezzle-track' },
      { label: '전세사기 민사소송 vs 형사고소 비교', href: '/guide/jeonse-fraud/jeonse-fraud-civil-vs-criminal' },
      { label: '중개보조원 보증금 가로채기 회수 판단', href: '/guide/jeonse-fraud/jeonse-fraud-broker-assistant-deposit-misappropriation-track' },
      { label: '전세사기 피해자 인정 신청 전 준비 서류', href: '/guide/jeonse-fraud/jeonse-fraud-victim-application-docs' },
    ],
  },

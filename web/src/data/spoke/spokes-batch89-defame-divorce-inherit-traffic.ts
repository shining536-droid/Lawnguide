...
export const spokesBatch89DefameDivorceInheritTraffic: SpokePage[] = [
  ...
  // ─── 4. divorce-foreign-judgment-recognition-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '재산분할 기준시점', href: '/guide/divorce/divorce-property-valuation-date-track' },
      { label: '재산명시·조회 신청', href: '/guide/divorce/divorce-property-disclosure-order' },
      { label: '협의이혼 준비서류', href: '/guide/divorce/divorce-agreement-document-checklist' },
    ],
  },
  ...
  // ─── 10. traffic-accident-merge-zipper-lane-fault-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '차로변경 사고 과실', href: '/guide/traffic-accident/traffic-accident-lanechange-fault-track' },

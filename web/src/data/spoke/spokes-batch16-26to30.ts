...
export const spokesBatch16Pages26to30: SpokePage[] = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>집행정지 신청을 하지 않으면 처분은 그대로 집행됩니다.</strong> 행정심판 청구 자체에는 집행을 정지하는 효력이 없으므로, 행정심판 청구서와 함께 가능한 한 집행정지 신청서를 별도로 제출해야 합니다. 집행정지가 인용되어야 전학 등 조치의 효력이 일시 정지됩니다.',
      },
      {
    ...
    internalLinks: [
      { label: '학교폭력 심의위원회 절차 총정리', href: '/guide/school-violence/school-violence-committee-procedure' },
      { label: '학교폭력 가해자 지목 시 부모 대응법', href: '/guide/school-violence/school-violence-accused-parent-response' },
      { label: '학폭 조치에 불복하는 방법', href: '/guide/school-violence/school-violence-measures-appeal' },
      { label: '학교폭력 가해학생 제재 방어 전략', href: '/guide/school-violence/perpetrator-sanction-defense' },
      { label: '학교폭력 무고 대응법', href: '/guide/school-violence/school-violence-false-report-response' },
    ],
  },
  {
    domain: 'inheritance',
    ...
    faq: [
      ...
      {
        question: '유류분 반환은 가능한 한 돈으로 받아야 하나요?',
        answer:
    ...
    internalLinks: [
      ...
      { label: '상속 숨겨진 빚 발견 시 대처법', href: '/guide/inheritance/inheritance-hidden-debt-discovery' },
      { label: '상속 가족분쟁 조정 절차', href: '/guide/inheritance/inheritance-family-dispute-mediation' },
      { label: '상속포기 기한 놓쳤을 때', href: '/guide/inheritance/inheritance-renunciation-deadline' },
    ],
  },
  {
    domain: 'stalking',
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>상대방의 의사에 반하여 반복적으로 접근하면 스토킹행위에 해당할 소지가 있습니다.</strong> 스토킹처벌법 제2조에 따라 "정당한 이유 없이" "상대방의 의사에 반하여" 반복 접근하면 그 의도와 관계없이 스토킹행위로 인정될 수 있습니다. 거부 의사를 명확히 전달한 증거(문자, 카톡 등)가 있으면 더 강력합니다.',
      },
      {
    ...
    internalLinks: [
      { label: '스토킹 즉시 대응 가이드', href: '/guide/stalking/stalking-immediate-response' },
      { label: '스토킹 처벌 수위와 접근금지', href: '/guide/stalking/stalking-penalty-restraining-order' },
      { label: '전 연인 연락이 스토킹인지 기준', href: '/guide/stalking/ex-partner-contact-stalking-criteria' },
      { label: '스토킹 증거 수집 FAQ', href: '/guide/stalking/stalking-evidence-collection-faq' },
      { label: '스토킹 신고와 접근금지 절차', href: '/guide/stalking/stalking-report-and-restraining-order' },
    ],
  },
  {
    domain: 'inheritance',
    ...
    internalLinks: [
      ...
      { label: '한정승인 절차 총정리', href: '/guide/inheritance/limited-inheritance-acceptance-process' },
      { label: '상속 숨겨진 빚 발견 시 대처법', href: '/guide/inheritance/inheritance-hidden-debt-discovery' },
      { label: '유류분 청구 소송 준비 가이드', href: '/guide/inheritance/inheritance-forced-share-lawsuit-guide' },
      { label: '상속포기 기한 놓쳤을 때', href: '/guide/inheritance/inheritance-renunciation-deadline' },
    ],
  },
  {
    ...
    meta: {
      ...
      description:
        '밀린 임금을 받지 못한 채 시간이 흐르고 있다면, 3년 소멸시효가 지나기 전에 가능한 한 해야 할 4가지를 지금 확인하세요.',
    },
    intro:
    ...
    cases: [
      {
        ...
        takeaway:
          '소멸시효가 지난 후에는 "사장이 줄 거라 믿었다"는 주장만으로는 권리를 되찾기 매우 어렵습니다. 가능한 한 3년 기한 내에 내용증명, 지급명령, 소송 등의 조치를 취하세요.',
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          '<strong>네, 채무 승인에 해당하여 시효가 중단됩니다.</strong> 민법 제168조 제3호에 따라 채무자의 승인은 시효 중단 사유입니다. 사업주가 문자, 카톡, 녹음 등으로 "주겠다"고 한 시점부터 새로 3년이 진행됩니다. 해당 증거를 가능한 한 보관하세요.',
      },
      {
    ...
    internalLinks: [
      ...
      { label: '퇴직 후 밀린 급여 받는 법', href: '/guide/wage/unpaid-salary-after-resignation' },
      ...
      { label: '최저임금 위반 신고 방법', href: '/guide/wage/minimum-wage-violation-complaint' },
    ],
  },
];

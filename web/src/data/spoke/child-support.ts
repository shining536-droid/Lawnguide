...
export const childSupportPages: SpokePage[] = [
  {
    ...
    type: '절차타임라인형',
    meta: {
      title: '양육비 청구 소송 절차와 기간 | 로앤가이드',
      description: '양육비 심판 청구, 양육비이행관리원 지원, 이행명령, 감치 절차와 기간을 단계별로 정리했습니다.',
    },
    ...
    cases: [
      {
        ...
        summary:
          '관련 사례에서도 양육비 미지급이 2년 이상 지속되어 감치를 신청한 결과, 상대방이 유치장에 수감되기 직전 밀린 양육비를 일괄 지급한 경우가 있습니다.',
        takeaway:
    ...
    faq: [
      {
        ...
        answer: '네, 이혼 후에도 <strong>가정법원에 양육비 심판 청구</strong>가 가능합니다.',
      },
      {
      ...
      },
      {
        ...
        answer: '인지대와 송달료를 합쳐 <strong>수만원 수준</strong>입니다. 변호사 없이 본인이 직접 청구할 수도 있습니다.',
      },
      {
      ...
      },
      {
        ...
        answer: '원칙적으로 자녀가 <strong>성년(만 19세)</strong>이 될 때까지입니다.',
      },
      {
        question: '혼인 외 자녀도 양육비를 청구할 수 있나요?',
        answer: '인지 청구를 통해 부자관계가 확인되면 <strong>양육비 청구가 가능</strong>합니다.',
      },
      {

...
export const spokesBatch88AssaultDuiJeonseFraud: SpokePage[] = [
  // ─── 1. assault-floor-noise-dispute-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '노부모 돌봄 가족 폭행 노인학대', href: '/guide/assault/assault-elderly-parent-care-conflict-adult-child-track' },
  ...
  // ─── 2. assault-taxi-driver-passenger-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '온라인 만남 오프라인 충돌 폭행', href: '/guide/assault/assault-online-meetup-offline-conflict-track' },
  ...
  // ─── 3. assault-parent-teacher-school-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '학부모 교사 폭행 교권보호위', href: '/guide/assault/assault-school-parent-teacher-classroom-track' },
      { label: '폭행 진단서 CCTV 증거 우열 다툼', href: '/guide/assault/assault-medical-certificate-vs-cctv-evidence-priority' },
  ...
  // ─── 5. dui-measurement-refusal-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '15년 전 음주 전과 가중 처벌', href: '/guide/dui/dui-pre-historical-conviction-15years-aggravation-track' },
    ],
  },
  ...
  // ─── 10. jeonse-fraud-guarantee-insurance-unsubscribed-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '갭투자 대규모 전세사기 대항력', href: '/guide/jeonse-fraud/jeonse-fraud-mass-gap-investment-track' },
      { label: '신축 오피스텔 시행사 부도 보증금 반환', href: '/guide/jeonse-fraud/jeonse-fraud-new-officetel-developer-default-deposit-track' },
    ],
  },
];

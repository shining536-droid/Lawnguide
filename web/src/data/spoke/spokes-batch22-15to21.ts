...
export const spokesBatch22_15to21: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>통상 50만~500만 원 범위에서 인정될 수 있습니다.</strong> 피해 기간, 소음의 정도, 건강 피해 여부 등에 따라 달라집니다. 수면장애 등 진단서가 있으면 위자료가 높아지고, 치료비도 별도 청구할 수 있습니다.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      {
        question: '유치권이 있으면 원칙적으로 낙찰자가 떠안아야 하나요?',
        answer:
      ...
      },
      {
        ...
        answer:
          '<strong>실무적으로 가능합니다.</strong> 유치권자도 장기 점유에 따른 관리 비용이 부담되므로, 피담보채권의 50~70% 수준에서 합의하는 사례가 많습니다. 합의 시 가능한 한 "유치권 포기" 확인서를 받으세요.',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '<strong>원칙적으로 불가능합니다.</strong> 대출 불가는 낙찰자 개인 사정이므로 매각불허가 사유가 되지 않습니다. 보증금은 몰수되고 재매각이 진행됩니다. 입찰 전에 대출 사전 승인을 가능한 한 받아두세요.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>가능하고, 가능한 한 받아야 합니다.</strong> 경매 물건 서류(등기부등본, 감정평가서, 매각물건명세서)를 가지고 은행에 방문하면 예상 대출 한도와 금리를 사전 안내받을 수 있습니다.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>맞습니다.</strong> 1회 유찰 시 최저매각가격이 20% 하락합니다. 2회 유찰이면 최초 감정가의 64% 수준이 됩니다. 유찰 물건은 가격 메리트가 있지만, 유찰 원인(권리 문제, 입지 등)을 가능한 한 분석하세요.',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '<strong>소액임차인이라면 확정일자 없이도 최우선변제를 받을 수 있습니다.</strong> 건물 인도와 사업자등록만 갖추면 소액임차인 요건을 충족합니다. 다만 보증금이 소액 기준을 초과하면 확정일자가 가능한 한 필요합니다.',
      },
      {

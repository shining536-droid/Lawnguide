  ...
  // ─── 2. wage / wage-penalty-deduction-prohibition-claim ───
  {
    ...
    sections: [
      ...
      },
      {
        title: '⚠️ 다툼 포인트 + 🏛️ 신청·상담 경로',
        content:
          '<p><strong style="color:#1e3a5f">A. 회사 측 자주 주장과 무료 상담 기관을 정리하면 다음과 같습니다.</strong></p>\n<ul>\n<li><strong>"서약서에 사인했으니 유효하다" 주장 반박</strong> — 강행규정(제20조) 위반 약정은 사인 여부와 무관하게 무효 정황.</li>\n<li><strong>"실제 회사 손해가 발생했다" 주장 반박</strong> — 실손해 입증·구체적 산정 자료 부재 시 추정만으로 공제 어려운 영역. 입증책임은 사용자.</li>\n<li><strong>"교육비 환수 명목이라 가능하다" 주장 일부 한계</strong> — 의무근무 위반 시 교육비 환수 약정은 일부 유효 사례가 있으나, 정액 위약금 형태는 무효 영역.</li>\n<li><strong>임금 전액지급 위반 별도 신고</strong> — 본인 동의 없는 공제는 그 자체로 근로기준법 제43조 위반. 노동청 진정 + 형사 처벌 트랙 결합 가능.</li>\n</ul>\n<p><strong style="color:#1e3a5f">🏛️ 무료 상담·구제 기관</strong></p>\n<ul>\n<li><strong>대한법률구조공단 132</strong> — 위약예정·임금공제 무료 상담.</li>\n<li><strong>고용노동부 노동포털 (labor.moel.go.kr)</strong> — 임금체불 + 전액지급 위반 진정.</li>\n<li><strong>한국공인노무사회 02-6293-1500</strong> — 사안 검토 노무사 자문.</li>\n</ul>',
      },
    ],
    cases: [
      {
        title: '판례 — 임금 공제와 전액지급 원칙',
        summary:
          '대법원 2001다25184(대법원, 2001.10.23 선고)에서 법원은 근로기준법의 임금 전액지급 원칙에 따라 사용자가 근로자에 대한 채권을 가지고 일방적으로 임금채권을 상계하는 것은 원칙적으로 금지된다고 판시했습니다. 다만 근로자의 자유로운 의사에 따른 동의가 있다고 인정할 합리적인 이유가 객관적으로 존재하는 경우에는 예외적으로 허용될 수 있으나, 그 동의가 자유로운 의사에 기한 것인지는 엄격하고 신중하게 판단해야 한다고 보았습니다. 위약금·손해배상 명목으로 임금에서 일방적으로 금액을 공제하는 관행도 이러한 기준으로 그 효력을 검토해볼 수 있습니다.',
        takeaway: '임금에서 위약금·손해배상 명목으로 일방 공제하는 것은 원칙적으로 금지됨. 자유의사에 따른 동의가 없다면 무효를 다퉈 환수를 검토해볼 수 있으니 급여명세서·공제 통보 자료를 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
        ...
        answer:
          '<strong>연수비·교육비 실비 환수 약정 자체는 일부 유효 사례가 있습니다.</strong> 다만 실제 연수비 지출액을 초과하는 \'정액 위약금\' 부분, 또는 의무근무 기간이 지나치게 긴 경우는 무효 정황 영역.',
      },
      {

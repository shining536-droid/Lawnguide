...
export const spokesBatch76DivorceInheritTraffic: SpokePage[] = [
  // ─── 1 divorce-late-life-homemaker-contribution-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '혼전 재산계약 효력', href: '/guide/divorce/divorce-prenup-property-validity' },
  ...
  // ─── 5 inheritance-renunciation-next-rank-debt-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '기여분 상속재산 분할 다툼', href: '/guide/inheritance/inheritance-contributory-portion-dispute-track' },
    ],
  },

...
export const spokesBatch48WageUnemp: SpokePage[] = [
    ...
    faq: [
      {
        ...
        answer:
          '<strong>비과세 한도 내(식대 월 20만 원 등)는 4대보험·세금 산정에서 제외되지만, 임금성 자체는 인정됩니다.</strong> 즉 폐지 시 임금체불로 청구 가능하면서도 보험료엔 영향이 없을 수 있어요.',
      },
      {
  ...
  // ─── 5. unemployment / pregnancy-resignation-eligibility ───
  {
    ...
    intro:
      '<p>"임신 사실을 알리자 \'업무가 힘들 텐데 그만두는 게 어떻겠냐\'는 권유를 매일 받고 있어요. 사직서를 써야 하나요? 실업급여는 받을 수 있나요?" 임신을 이유로 한 권고사직·해고 권유는 남녀고용평등법 위반 소지가 큽니다. 또한 이런 상황에서의 자진퇴사는 정당이직으로 인정받을 가능성이 있어 실업급여 수급자격이 검토될 수 있습니다(고용보험법 시행규칙 [별표2]). 사직서 제출 전에 반드시 절차를 확인하세요.</p>',
    sections: [
      {

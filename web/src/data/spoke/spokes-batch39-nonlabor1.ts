...
export const spokesBatch39Nonlabor1: SpokePage[] = [
  // ─── 1. divorce / domestic-violence-evidence-collection ───
  {
    ...
    internalLinks: [
      ...
      { label: '협의이혼 숙려기간 면제', href: '/guide/divorce/divorce-cooling-period-domestic-violence-waiver-track' },
  ...
  // ─── 5. divorce / mediation-failure-next-step ───
  {
    ...
    internalLinks: [
      ...
      { label: '자녀없는 부부 재산분할 전업주부', href: '/guide/divorce/divorce-childless-property-division-housewife-track' },
      { label: '자녀 양육권 전략', href: '/guide/divorce/divorce-child-custody-father-strategy' },
  ...
  // ─── 6. traffic-accident / truck-compensation-special ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 약관 설명의무 위반 구제', href: '/guide/traffic-accident/traffic-accident-insurance-explanation-duty' },
  ...
  // ─── 9. traffic-accident / seatbelt-nonuse-fault ───
  {
    ...
    internalLinks: [
      ...
      { label: '교통사고 추가 치료 합의 미루기', href: '/guide/traffic-accident/traffic-delay-settlement-additional-treatment' },
  ...
  // ─── 14. fraud / fake-ecommerce-site-response ───
  {
    ...
    internalLinks: [
      { label: '위장 쇼핑몰 사기 환불', href: '/guide/fraud/fraud-fake-online-shopping-mall' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '피해구제 신청', href: '/guide/fraud/fraud-voice-phishing-relief-law-application' },

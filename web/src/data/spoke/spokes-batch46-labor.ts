...
export const spokesBatch46Labor: SpokePage[] = [
  ...
  // ─── 3. dismissal / meeting-recording-fired ───
  {
    ...
    internalLinks: [
      ...
      { label: '직장 내 괴롭힘 신고 보복해고', href: '/guide/dismissal/dismissal-bullying-report-retaliation' },
  ...
  // ─── 4. dismissal / coworker-feud-pretext ───
  {
    ...
    internalLinks: [
      ...
      { label: '경고장 누적 해고 효력', href: '/guide/dismissal/dismissal-warning-letter-cumulative-validity' },
      { label: '부당해고 구제신청 절차', href: '/guide/dismissal/dismissal-relief-procedure-comprehensive' },
    ],
  },
  ...
  // ─── 5. dismissal / pregnancy-period-protect ───
  {
    ...
    internalLinks: [
      { label: '해고근로자 종합 가이드', href: '/guide/dismissal' },
      { label: '출산휴가 육아휴직 복귀 직후 해고', href: '/guide/dismissal/dismissal-maternity-leave-return-immediate-fired' },
      { label: '휴직 종료 복직거부 보직박탈', href: '/guide/dismissal/dismissal-leave-return-position-deprived' },
      { label: '수습 직무 부적격 해고 다툼', href: '/guide/dismissal/dismissal-probation-skill-deficient-relief' },
      { label: '부당해고 구제신청 절차', href: '/guide/dismissal/dismissal-relief-procedure-comprehensive' },
    ],
  },
  ...
  // ─── 6. wage / team-leader-overtime-strip ───
  {
    ...
    internalLinks: [
      ...
      { label: '격일제 야간 휴일 가산수당 청구', href: '/guide/wage/wage-alternate-day-shift-overtime-night-holiday-claim' },
  ...
  // ─── 7. wage / bonus-vesting-departure ───
  {
    ...
    cta: { text: '임금체불 대응 순서, AI로 바로 정리하기', link: '/chat?domain=wage' },
    internalLinks: [
      { label: '정기상여금 통상임금 산입 청구', href: '/guide/wage/wage-regular-bonus-ordinary-wage-claim' },
      { label: '임금 종합 가이드', href: '/guide/wage' },
      { label: '월급 밀림 노동청 신고 절차 방법', href: '/guide/wage/delayed-salary-labor-office-report' },
      { label: '퇴직급여 종합 가이드', href: '/guide/retirement' },
      { label: '투표일 출근 강요 유급 휴가', href: '/guide/wage/election-day-vacation-attendance' },
    ],
  },
  ...
  // ─── 8. wage / pogual-equity-pretext ───
  {
    ...
    internalLinks: [
      { label: '임금 종합 가이드', href: '/guide/wage' },
      { label: '포괄임금제 야간·휴일근로 차액', href: '/guide/wage/wage-comprehensive-night-holiday-overtime-shortfall' },
      { label: '연장근로 사전승인 없음 사후 청구', href: '/guide/wage/wage-overtime-no-prior-approval-tacit-acceptance-claim-track' },
      { label: '월급 밀림 노동청 신고 절차 방법', href: '/guide/wage/delayed-salary-labor-office-report' },
  ...
  // ─── 12. retirement / trial-period-included ───
  {
    ...
    internalLinks: [
      ...
      { label: '1년 미만 퇴직금', href: '/guide/retirement/retirement-under-one-year-eligibility-track' },
      { label: '임금 종합 가이드', href: '/guide/wage' },
      { label: '퇴직급여 종합 가이드', href: '/guide/retirement' },
    ],
  },

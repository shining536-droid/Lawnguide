...
export const spokesBatch46Labor: SpokePage[] = [
  ...
  // ─── 6. wage / team-leader-overtime-strip ───
  {
    ...
    intro:
      '<p>"팀장이 되니까 그날부터 야근수당이 안 들어와요. \'관리자라 안 준다\'고 합니다"라는 상담이 늘고 있습니다. 직책이 팀장이라고 해서 무조건 관리감독자(근기법 제63조)인 것은 아니며, 실질적 권한·근무 형태가 핵심 판단 기준입니다. 명목상 팀장이라도 일반 근로자와 다르지 않다면 연장·야간·휴일수당 미지급은 임금체불로 청구할 수 있습니다. 임금채권 시효 3년이 가장 큰 변수입니다.</p>',
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          '<strong>일부만 충족하면 관리감독자성이 부정될 가능성이 큽니다.</strong> 채용·해고·예산 등 경영 권한이 폭넓게 있어야 인정됩니다.',
      },
      {
  ...
  // ─── 7. wage / bonus-vesting-departure ───
  {
    ...
    intro:
      '<p>"3월 말 퇴사했더니 4월 지급 예정이던 상반기 상여금을 못 받았어요. 재직조건 때문이래요"라는 사연이 적지 않습니다. 재직조건부 상여금이라도 정기·일률·고정성을 갖춘 임금이라면 사후 임의로 미지급할 수 없는 것이 원칙으로 검토되며, 재직조건 자체가 무조건 효력을 갖는 것은 아닙니다. 근로 제공 시점·산정 기간·지급 시점을 분리해 보면 청구 가능성이 보입니다.</p>',
    sections: [
      {

...
export const spokesBatch87DefameDivorceInheritTraffic: SpokePage[] = [
  // ─── 1. divorce-domestic-violence-ground-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '가정폭력 이혼 보호명령 동시 진행', href: '/guide/divorce/divorce-domestic-violence-protection-order-parallel' },
  ...
  // ─── 2. divorce-retirement-pay-division-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '국민연금 분할 이혼', href: '/guide/divorce/divorce-national-pension-division-track' },
  ...
  // ─── 3. divorce-spouse-gambling-debt-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '채무초과 재산분할 판단', href: '/guide/divorce/divorce-debt-exceeds-asset-division-track' },
  ...
  // ─── 6. defamation-openchat-rumor-track ───
  {
    ...
    internalLinks: [
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '학부모 단톡방 허위사실 명예훼손 신고', href: '/guide/defamation/defamation-parent-group-chat-false-fact-report-track' },
  ...
  // ─── 7. defamation-workplace-rumor-track ───
  {
    ...
    internalLinks: [
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '학원 강사 단톡 험담 모욕', href: '/guide/defamation/defamation-tutor-parent-groupchat-insult-victim' },
  ...
  // ─── 10. traffic-accident-motorcycle-lanechange-track ───
  {
    ...
    internalLinks: [
      { label: '보행자 무단횡단 과실비율 판단', href: '/guide/traffic-accident/traffic-accident-pedestrian-jaywalk-fault-ratio-track' },
      { label: '이륜차 진로변경 과실비율', href: '/guide/traffic-accident/traffic-accident-motorcycle-lane-change-fault-track' },

...
export const spokesBatch44Nonlabor1: SpokePage[] = [
  ...
  // ─── 5. fraud / partial-repayment-settlement-reduction ───
  {
    ...
    internalLinks: [
      ...
      { label: '중고거래 사기 합의 수락 기준', href: '/guide/fraud/fraud-secondhand-settlement-accept-criteria' },
      { label: '사기 누범 가중처벌 실형', href: '/guide/fraud/fraud-recidivist-sentencing-risk' },
    ],
  },
  ...
  // ─── 6. traffic-accident / commute-work-injury-double-claim ───
  {
    ...
    internalLinks: [
      { label: '출퇴근 교통사고 산재 자동차보험 공제 잔여 손해', href: '/guide/traffic-accident/traffic-accident-commute-workers-comp-auto-insurance-deduction-track' },
  ...
  // ─── 7. traffic-accident / child-carpool-driver-liability ───
  {
    ...
    internalLinks: [
      { label: '산재 vs 자동차보험 중복 청구', href: '/guide/traffic-accident/traffic-accident-workers-comp-vs-auto-insurance' },
      { label: '교통사고 종합 가이드', href: '/guide/traffic-accident' },
  ...
  // ─── 14. divorce / pet-visitation-agreement-template ───
  {
    ...
    internalLinks: [
      ...
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
      { label: '이혼 당사자 사망 재산분할 상속인 청구 절차', href: '/guide/divorce/divorce-ex-spouse-death-property-division-heir-claim-track' },
    ],
  },
];

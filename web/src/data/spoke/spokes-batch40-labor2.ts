...
export const spokesBatch40Labor2: SpokePage[] = [
  ...
  // ─── 2. dismissal / relocation-refused-then-fired ───
  {
    ...
    internalLinks: [
      ...
      { label: '군 복무 후 복직 거부 부당해고 구제', href: '/guide/dismissal/dismissal-military-return-reinstatement-denied' },
    ],
  },
  ...
  // ─── 5. divorce / mediation-refused-trial-procedure ───
  {
    ...
    cases: [
      {
        title: '판례 — 혼인파탄 중대 사유 판단 기준',
        summary:
          '대법원 2009므2413(대법원, 2009.12.24 선고)에서 법원은 민법 제840조 제6호의 \'혼인을 계속하기 어려운 중대한 사유\'란 부부공동생활 관계가 회복할 수 없을 정도로 파탄되어 혼인 계속을 강제하는 것이 한쪽 배우자에게 참을 수 없는 고통이 되는 경우를 말한다고 판시했습니다. 이를 판단할 때에는 혼인 계속 의사, 파탄 원인과 책임, 혼인 기간, 자녀 유무 등 제반 사정을 두루 고려해야 한다고 보았습니다. 협의이혼이 거부된 경우에도 이러한 중대한 사유가 인정될 여지가 있는지 정리해 재판상 이혼을 검토해볼 수 있습니다.',
        takeaway:
          '협의이혼이 무산돼도 파탄 사유가 인정되면 재판상 이혼을 검토할 수 있음. 파탄 경위·책임을 뒷받침할 자료를 정리해두는 것이 좋습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      { label: '이혼 후 양육비 미지급 강제집행 감치명령 절차', href: '/guide/divorce/divorce-post-divorce-child-support-non-payment-full-procedure' },
      { label: '이혼 종합 가이드', href: '/guide/divorce' },
      { label: '이혼 조정 실패 재판 이혼', href: '/guide/divorce/divorce-mediation-failure-next-step' },
  ...
  // ─── 6. divorce / teenager-custody-own-choice ───
  {
    ...
    internalLinks: [
      ...
      { label: '재혼 양육자 변경 심판', href: '/guide/divorce/divorce-remarriage-environment-change-custodian-change-petition-track' },
  ...
  // ─── 7. child-support / overdue-salary-seizure-procedure ───
  {
    ...
    internalLinks: [
      ...
      { label: '양육비 종합 가이드', href: '/guide/child-support' },
  ...
  // ─── 8. child-support / ex-remarriage-reduction-possible ───
  {
    ...
    internalLinks: [
      { label: '양육비 종합 가이드', href: '/guide/child-support' },
      { label: '친양자 파양 친생부모 양육비', href: '/guide/child-support/child-support-step-parent-adoption-cancel-pre-existing-track' },
      { label: '양육비 산정 기준표', href: '/guide/child-support/child-support-calculation-table' },
  ...
  // ─── 9. traffic-accident / electric-scooter-collision-response ───
  {
    ...
    internalLinks: [
      ...
      { label: '교통사고 보험금 청구 필요 서류', href: '/guide/traffic-accident/insurance-claim-required-docs' },
      { label: '자전거 운전자 무보험 본인 부담 일상생활배상', href: '/guide/traffic-accident/traffic-accident-bicycle-rider-no-insurance-self-pay-track' },
    ],
  },
  ...
  // ─── 10. traffic-accident / hit-run-culprit-identification ───
  {
    ...
    internalLinks: [
      ...
      { label: '뺑소니 사고 피해자 대응 방법', href: '/guide/traffic-accident/hit-and-run-victim-response' },
      { label: '에어백 미작동 제조사 책임', href: '/guide/traffic-accident/traffic-accident-airbag-non-deploy-defect-claim-track' },

...
// 18. 이 페이지는 [사업주가 폐업하거나 파산한 상황에서 밀린 임금을 받으려는 근로자]의 [폐업 후에도 임금을 받을 수 있는 방법을 모르는 상황]에서 [재단채권 청구 절차와 대지급금 제도 안내]를 돕는 페이지다.
...
export const spokesBatch26_15to19: SpokePage[] = [
    ...
    faq: [
      {
        ...
        answer:
          '<strong>가능한 한 항목이 분리 표시될 필요는 없지만, 전체 지급액에 주휴수당이 포함되어 최저임금 이상으로 지급되고 있어야 합니다.</strong> 주휴수당이 따로 표시되지 않고 기본급에 합산됐다면 실제 지급 시간급을 계산해서 최저임금 이상인지 확인하세요.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      ...
      {
        question: '노동조합이 취업규칙 변경에 동의했으면 조합원은 원칙적으로 따라야 하나요?',
        answer:
  ...
  // ───────────────────────────────────────────
  {
    ...
    perspective: 'victim',
    meta: {
      title: '폐업 사업주 임금체불 재단채권·대지급금 청구 4단계 | 로앤가이드',
      description:
        '사업주가 파산하거나 폐업해서 임금을 못 받고 있다면 재단채권 청구와 대지급금 제도를 지금 확인하세요.',
    },
    intro:
      '<p>월급이 석 달째 밀리고 있는데 사장님이 "법원에 파산 신청했다"고 합니다. 이미 파산을 했으니 돈을 받을 방법이 없는 건지, 아니면 다른 방법이 있는 건지 막막합니다. 파산 절차가 시작됐다고 해서 밀린 임금이 사라지는 것이 아닙니다. 근로자의 임금·퇴직금은 파산 절차에서 재단채권으로 보호되며, 대지급금 제도를 통해 국가가 대신 지급하는 방법도 있습니다.</p>',
    sections: [
      {
        title: '파산 후 임금·퇴직금은 재단채권으로 최우선 보호된다',
        content:
          '<p><strong style="color:#1e3a5f">근로자의 임금·퇴직금은 채무자 회생 및 파산에 관한 법률(채무자회생법)에 따라 재단채권으로 인정될 수 있습니다.</strong></p>\n<p>대법원 2013다64908 사건(대법원, 2014.11.20 선고)에서 법원은 파산선고 전에 생긴 근로자의 임금·퇴직금 및 재해보상금에 대해 파산관재인이 파산선고 후 변제할 의무의 이행을 지체함으로써 생긴 지연손해금 채권도 채무자회생법 제473조 제4호 소정의 재단채권에 해당한다고 판시했습니다. 즉, 파산 이후에 발생한 지연이자도 재단채권으로 최우선 변제를 받을 수 있습니다.</p>\n<ul>\n<li><strong>재단채권</strong> — 파산 재단에서 다른 채권자보다 먼저 변제받는 채권입니다. 파산채권(일반 채권)보다 우선합니다</li>\n<li><strong>임금·퇴직금</strong> — 파산 전 3개월분 임금, 3년분 퇴직금, 재해보상금이 재단채권에 해당할 소지가 있습니다</li>\n<li><strong>지연이자도 포함</strong> — 파산 후 파산관재인이 지급을 지체해서 발생한 지연손해금도 재단채권으로 보호됩니다</li>\n</ul>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">핵심: 사업주가 파산해도 근로자 임금은 다른 채권보다 먼저 받습니다. 포기하지 마세요.</blockquote>',
      },
      {
        title: '재단채권 청구와 대지급금 제도 활용 4단계',
        content:
          '<p><strong style="color:#1e3a5f">파산·폐업 사업주로부터 밀린 임금을 받는 방법은 두 가지가 있습니다: 파산 재단에서 받거나, 국가(대지급금)가 대신 지급받는 방법입니다.</strong></p>\n<ol>\n<li><strong>체불 임금 확인</strong> — 고용노동청에 임금체불 확인서를 발급받습니다. 대지급금 신청과 재단채권 신고 모두 이 확인서가 필요합니다</li>\n<li><strong>파산 법원에 재단채권 신고</strong> — 사업주 파산 절차가 진행 중이라면 파산관재인에게 재단채권 신고를 합니다. 법원 공고를 통해 신고 기간을 확인하세요</li>\n<li><strong>대지급금 신청</strong> — 파산선고 또는 폐업 확인 후 근로복지공단에 대지급금을 신청합니다. 퇴직일로부터 2년 이내에 신청해야 합니다</li>\n<li><strong>대지급금 수령</strong> — 일반 대지급금은 최종 3개월 임금 + 3년분 퇴직금을 기준으로 지급되며, 상한액이 있습니다</li>\n</ol>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>💬 AI 법률 상담으로 빠르게 확인하세요</strong></p>\n<p style="margin:0;font-size:0.95em">변호사 상담 전, AI가 파산·폐업 사업주 임금 청구 방법을 분석해드립니다.</p>\n<a href="/chat?domain=wage" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '대지급금 신청 요건과 지급 금액',
        content:
          '<p><strong style="color:#1e3a5f">대지급금 제도는 사업주의 도산으로 임금을 받지 못한 근로자를 국가가 보호하는 제도입니다.</strong></p>\n<p>근로자퇴직급여보장법 및 임금채권보장법에 따라 근로복지공단이 대지급금을 지급합니다.</p>\n<ul>\n<li><strong>신청 요건</strong> — 사업주가 파산 선고, 회생 절차 개시, 또는 도산 사실 인정(소규모 사업장 폐업)이 있어야 합니다</li>\n<li><strong>지급 범위</strong> — 최종 3개월 임금, 최종 3년간 퇴직금, 최종 3개월 휴업수당</li>\n<li><strong>지급 상한</strong> — 월 최대 700만 원(2026년 기준) 내에서 지급합니다</li>\n<li><strong>신청 기한</strong> — 퇴직일로부터 2년, 도산 등 사실 인정일로부터 1년 이내에 신청해야 합니다</li>\n</ul>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">주의: 대지급금은 전액 지급이 아닌 상한액 이내의 지급이므로, 초과분은 파산 재단 채권 배당으로 별도 청구해야 합니다.</blockquote>',
      },
    ],
    cases: [
      {
    ...
    faq: [
      {
        question: '사업주가 파산이 아닌 단순 폐업을 한 경우에도 대지급금을 받을 수 있나요?',
        answer:
          '<strong>사업주가 법원의 파산 선고 없이 폐업한 경우에도 "도산 사실 인정" 절차를 통해 대지급금을 받을 수 있습니다.</strong> 근로복지공단이 소규모 사업장(상시 근로자 300명 이하)의 도산 사실을 인정하면 대지급금 지급이 가능합니다.',
      },
      {
        question: '대지급금 신청 기한을 놓쳤는데 다른 방법이 있나요?',
        answer:
          '<strong>대지급금 신청 기한(퇴직일로부터 2년)이 지났다면 민사소송으로 청구해야 합니다.</strong> 임금채권 소멸시효(3년) 이내라면 파산 재단 채권 배당 절차나 민사 소액소송을 활용하세요.',
      },
      {
      ...
      {
        question: '파산 절차 중인데 재직하고 있어도 대지급금을 받을 수 있나요?',
        answer:
          '<strong>대지급금은 퇴직(또는 이직) 후에 신청할 수 있습니다.</strong> 재직 중이라면 파산 법원에 재단채권을 신고하고, 퇴직 후 대지급금 절차를 별도로 진행하세요.',
      },
      {
  ...
  // ───────────────────────────────────────────
  {
    ...
    faq: [
      {
        question: '포괄임금제 계약서에 사인했으면 원칙적으로 수당을 못 받나요?',
        answer:

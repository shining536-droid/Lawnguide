...
export const spokesBatch27Unemployment_6to10: SpokePage[] = [
  ...
  {
    domain: 'unemployment',
    slug: 'unemployment-part-time-income-limit',
    keyword: '실업급여 수급 중 알바 소득 한도',
    questionKeyword: '실업급여 받으면서 알바하면 급여가 깎이나요?',
    ctaKeyword: '실업급여 알바 소득 한도 상담',
    type: '수치기한형',
    perspective: 'victim',
    meta: {
      title: '실업급여 수급 중 알바 소득 한도와 감액 기준 5가지 | 로앤가이드',
      description:
        '실업급여 받으면서 알바를 하면 급여가 감액되거나 중단될 수 있습니다. 월 60시간·3개월 기준과 소득 한도를 지금 확인하세요.',
    },
    intro:
      '<p>실업급여를 받고 있는데 생활비가 빠듯합니다. 알바라도 하고 싶은데 실업급여가 끊기면 어떡하나 걱정입니다. 일정 조건 내에서는 알바를 하면서 실업급여를 동시에 받을 수 있습니다. 소득 한도와 감액 기준을 확인해보세요.</p>',
    timelineSteps: [
      '1단계: 취업 유형 확인 (일용·단기·자영)',
      '2단계: 근로시간·기간 한도 확인',
      '3단계: 소득 신고 방법 확인',
      '4단계: 감액 여부 계산',
    ],
    sections: [
      {
        title: '알바해도 실업급여를 유지할 수 있는 조건',
        content:
          '<p><strong style="color:#1e3a5f">월 60시간 미만, 3개월 미만의 취업활동은 실업급여를 유지하면서 가능합니다.</strong></p>\n<ul>\n<li><strong>월 근로시간 60시간 미만</strong> — 주당 15시간 미만에 해당합니다.</li>\n<li><strong>계속 고용기간 3개월 미만</strong> — 동일 사업주 아래에서 3개월 이상 근무하면 취업으로 간주되어 실업급여가 중단됩니다.</li>\n<li><strong>소득 신고 필수</strong> — 알바 소득이 발생하면 실업인정일에 반드시 신고해야 합니다. 미신고 시 부정수급에 해당합니다.</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 월 60시간 이상이거나 3개월 이상 근무하면 "취업"으로 간주되어 실업급여가 중단됩니다.</blockquote>',
      },
      {
        title: '소득에 따른 감액 기준',
        content:
          '<p><strong style="color:#1e3a5f">알바 소득이 발생하면 실업급여가 감액될 수 있습니다.</strong></p>\n<p>감액 계산 방식:</p>\n<ul>\n<li>1일 알바 소득 + 1일 구직급여액이 퇴직 전 1일 평균임금을 초과하면, 초과분만큼 구직급여가 감액됩니다.</li>\n<li>다만 구직급여 하한액(최저구직급여일액)보다 적어지지는 않습니다.</li>\n</ul>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>알바 소득에 따른 감액 금액, AI가 계산합니다</strong></p>\n<p style="margin:0;font-size:0.95em">알바 시급과 근로시간을 입력하면 실업급여 감액 여부를 무료로 확인하세요.</p>\n<a href="/chat?domain=unemployment" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '신고하지 않으면 부정수급',
        content:
          '<p><strong style="color:#1e3a5f">알바 소득을 신고하지 않으면 구직급여 반환 + 추가징수 2배까지 부과됩니다.</strong></p>\n<ul>\n<li><strong>반환명령</strong> — 부정수급한 금액 전액을 반환해야 합니다.</li>\n<li><strong>추가징수</strong> — 부정수급액의 최대 2배를 추가로 징수당합니다.</li>\n<li><strong>수급자격 상실</strong> — 남은 수급기간의 급여도 모두 중단됩니다.</li>\n</ul>',
      },
      {
        title: '알바 유형별 주의사항',
        content:
          '<p><strong style="color:#1e3a5f">알바 유형에 따라 신고 방법이 달라집니다.</strong></p>\n<ul>\n<li><strong>일용직 알바</strong> — 근로일수와 소득을 실업인정일에 신고합니다. 일한 날은 구직급여가 지급되지 않습니다.</li>\n<li><strong>프리랜서·용역</strong> — 소득이 발생한 기간과 금액을 신고합니다.</li>\n<li><strong>자영업 준비</strong> — 사업자등록을 하면 취업으로 간주됩니다. 다만 자영업 준비 활동은 구직활동으로 인정받을 수 있습니다.</li>\n</ul>',
      },
    ],
    cases: [
      {
        title: '판례 — 해외 체류 중 부정수급 적발 사례',
        summary:
    ...
    faq: [
      {
        question: '하루만 알바해도 신고해야 하나요?',
        answer: '<p>네, 1일이라도 소득이 발생하면 실업인정일에 신고해야 합니다. 일한 날의 구직급여는 지급되지 않지만, 나머지 날의 급여는 정상 지급됩니다.</p>',
      },
      {
        question: '배달 알바도 근로시간에 포함되나요?',
        answer: '<p>네, 배달 앱 등 플랫폼 노동도 근로시간에 포함됩니다. 월 60시간 미만을 유지해야 합니다.</p>',
      },
      {
        question: '알바 소득이 적으면 감액 없이 전액 받을 수 있나요?',
        answer: '<p>1일 알바 소득 + 1일 구직급여가 퇴직 전 1일 평균임금 이하이면 감액 없이 전액 받을 수 있습니다.</p>',
      },
      {
        question: '가족 가게를 돕는 것도 신고해야 하나요?',
        answer: '<p>무급이라도 주 15시간 이상 종사하면 취업활동으로 간주될 수 있습니다. 고용센터 상담사에게 미리 확인하세요.</p>',
      },
    ],
    cta: { text: '알바 소득에 따른 실업급여 감액 계산 AI로 확인하기', link: '/chat?domain=unemployment' },
    internalLinks: [
      { label: '홈', href: '/' },

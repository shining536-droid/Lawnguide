...
export const spokesBatch47Misc: SpokePage[] = [
  ...
  // ─── 2. rehabilitation / 자영업 변동소득 변제계획 ───
  {
    ...
    internalLinks: [
      ...
      { label: '자영업 폐업 파산 절차 특례', href: '/guide/bankruptcy/bankruptcy-self-employed-closing' },
    ],
  },
  ...
  // ─── 5. stalking / 헤어진 연인 온라인 스토킹 대응 ───
  {
    ...
    internalLinks: [
      ...
      { label: '헤어진 연인 온라인 스토킹 증거', href: '/guide/stalking/stalking-ex-lover-online-evidence-collect' },

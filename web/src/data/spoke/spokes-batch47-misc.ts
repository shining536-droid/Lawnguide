    ...
    cases: [
      {
        ...
        takeaway: '파산 절차 중 재산 처분·협의가 필요할 때는 반드시 파산관재인의 동의 또는 법원 허가를 확인해야 합니다.',
      },
    ],
    faq: [
      {
  ...
  // ─── 4. industrial-accident / 통근재해 우회로 인정 ───
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<strong>가능합니다.</strong> 2017년 이후 산재법 개정으로 대중교통 외 자가용 통근 중 사고도 통근재해로 인정됩니다. 음주운전 등 본인의 중과실은 인정 범위에서 제외될 수 있습니다.',
      },
      {

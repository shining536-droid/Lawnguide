...
export const spokesBatch86Labor: SpokePage[] = [
  // ─── 1. dismissal-sick-leave-return-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '근무능력 부족 통상해고', href: '/guide/dismissal/dismissal-low-performance-track' },
      { label: '해고 서면통지 요건', href: '/guide/dismissal/dismissal-written-notice-requirement' },
      { label: '질병·휴직 해고 다툼', href: '/guide/dismissal/dismissal-sickness-leave-track' },
  ...
  // ─── 2. dismissal-foreign-worker-visa-track ───
  {
    ...
    internalLinks: [
      { label: '부당해고 구제 절차', href: '/guide/dismissal/unfair-dismissal-relief-procedure' },
      { label: '외국인 근로자 해고 다툼', href: '/guide/dismissal/dismissal-foreign-worker-track' },
      { label: '균등대우·차별 금지', href: '/guide/dismissal/dismissal-equal-treatment-track' },
      { label: '해고 서면통지 요건', href: '/guide/dismissal/dismissal-written-notice-requirement' },
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
    ],
  },
  ...
  // ─── 3. dismissal-absence-tardiness-misconduct-track ───
  {
    ...
    internalLinks: [
      { label: '부당해고 구제 절차', href: '/guide/dismissal/unfair-dismissal-relief-procedure' },
      { label: '근태불량 징계해고 다툼', href: '/guide/dismissal/dismissal-attendance-misconduct-track' },
  ...
  // ─── 4. wage-on-call-standby-hours-track ───
  {
    ...
    internalLinks: [
      { label: '대기시간 근로시간 다툼', href: '/guide/wage/wage-standby-hours-track' },
      { label: '격일제 소정근로·최저임금', href: '/guide/wage/wage-alternate-day-minimum-wage-track' },
      { label: '연장근로수당 청구', href: '/guide/wage/wage-overtime-allowance-claim' },
  ...
  // ─── 5. wage-comprehensive-overtime-track ───
  {
    ...
    cta: { text: '임금체불 대응 순서, AI로 바로 정리하기', link: '/chat?domain=wage' },
    internalLinks: [
      { label: '포괄임금 최저임금 다툼', href: '/guide/wage/wage-comprehensive-minimum-wage-track' },
      { label: '연장근로수당 청구', href: '/guide/wage/wage-overtime-allowance-claim' },
      { label: '비교대상 시급 산정', href: '/guide/wage/wage-comparison-hourly-rate-track' },
      { label: '통상임금 산정 기준', href: '/guide/wage/wage-ordinary-wage-calculation-standard' },
      { label: '임금체불 진정 절차', href: '/guide/wage/unpaid-wage-report-procedure-timeline' },
    ],
  },
  ...
  // ─── 6. unemployment-wage-arrears-resignation-track ───
  {
    ...
    internalLinks: [
      { label: '임금체불 자진퇴사 수급', href: '/guide/unemployment/wage-arrears-resignation-track' },
      { label: '정당한 이직 사유 정리', href: '/guide/unemployment/justifiable-separation-reason-track' },
      { label: '실업급여 신청 절차', href: '/guide/unemployment/benefit-application-procedure' },
      { label: '부정수급 반환·추가징수', href: '/guide/unemployment/illegal-receipt-recovery-track' },
  ...
  // ─── 7. unemployment-business-closure-separation-track ───
  {
    ...
    cta: { text: '실업급여 받을 수 있는지 AI로 점검하기', link: '/chat?domain=unemployment' },
    internalLinks: [
      { label: '폐업·권고사직 수급자격', href: '/guide/unemployment/closure-recommended-resignation-track' },
      { label: '비자발적 이직 사유 정리', href: '/guide/unemployment/involuntary-separation-reason-track' },
      { label: '실업급여 신청 절차', href: '/guide/unemployment/benefit-application-procedure' },
      { label: '구직급여일액·평균임금', href: '/guide/unemployment/benefit-amount-average-wage-track' },
      { label: '피보험단위기간 확인', href: '/guide/unemployment/insured-period-check-track' },
    ],
  },
  ...
  // ─── 8. retirement-continuous-service-rehire-track ───
  {
    ...
    internalLinks: [
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
      { label: '계속근로기간 통산 다툼', href: '/guide/retirement/retirement-continuous-service-track' },
      { label: '시용·수습 근속 다툼', href: '/guide/retirement/retirement-probation-service-track' },
  ...
  // ─── 9. retirement-dc-db-pension-arrears-track ───
  {
    ...
    internalLinks: [
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
      { label: '퇴직연금 부담금 미납 다툼', href: '/guide/retirement/retirement-pension-arrears-track' },
      { label: '퇴직금 분할 약정 효력', href: '/guide/retirement/retirement-division-agreement-track' },
      { label: '퇴직금 재산정 차액', href: '/guide/retirement/retirement-recalculation-difference' },
      { label: '퇴직금 체불 진정', href: '/guide/retirement/retirement-pay-unpaid-report-track' },
    ],
  },
  ...
  // ─── 10. industrial-accident-musculoskeletal-disorder-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '근골격계 질환 산재 다툼', href: '/guide/industrial-accident/industrial-accident-musculoskeletal-track' },
      { label: '업무상 질병 인과관계', href: '/guide/industrial-accident/industrial-accident-disease-causation-track' },
      { label: '여러 사업장 업무 통산', href: '/guide/industrial-accident/industrial-accident-multiple-workplace-track' },

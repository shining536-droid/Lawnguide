...
export const spokesBatch65DivorceInheritance: SpokePage[] = [
  // ─── 1. divorce-cooling-period-domestic-violence-waiver-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '가정폭력 이혼 보호명령', href: '/guide/divorce/divorce-domestic-violence-protection-track' },
  ...
  // ─── 6. inheritance-overseas-asset-double-taxation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '상속재산 분할심판', href: '/guide/inheritance/inheritance-division-disagreement-court-judgment' },

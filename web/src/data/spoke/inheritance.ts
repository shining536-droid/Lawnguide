...
export const inheritancePages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '비교형',
    meta: {
      title: '상속 분쟁 조정 vs 소송 비교 | 로앤가이드',
      description:
        '상속 분쟁 발생 시 가사조정과 소송의 소요기간, 비용, 강제력, 관계 영향을 비교하고 내 상황에 맞는 해결 방법을 정리했습니다.',
    },
    intro:
  ...
  },
  {
    ...
    type: '절차타임라인형',
    meta: {
      title: '상속 포기 신청 절차와 기한 | 로앤가이드',
      description:
        '민법 제1019조에 따른 상속 포기 3개월 기한과 가정법원 신고 절차를 단계별로 안내합니다. 기한 도과 시 특별한정승인 등 대응 방법까지 정리했습니다.',
    },
    intro:

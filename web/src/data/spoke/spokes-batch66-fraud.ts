...
export const spokesBatch66Fraud: SpokePage[] = [
  // ─── 1. fraud-bitcoin-mining-machine-fake-rental-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '가상자산 거래소 허위 상장 투자 유인 기망 사기', href: '/guide/fraud/fraud-crypto-exchange-fake-listing-lure-track' },
  ...
  // ─── 2. fraud-auction-shill-bidding-fake-bidder-track ───
  {
    ...
    internalLinks: [
      { label: '사기죄 고소 절차 총정리', href: '/guide/fraud/fraud-complaint-procedure-comprehensive' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '반려동물 분양 허위매물 사기', href: '/guide/fraud/fraud-pet-adoption-false-listing-track' },
  ...
  // ─── 3. fraud-airbnb-fake-listing-deposit-track ───
  {
    ...
    internalLinks: [
      { label: '사기죄 고소 절차 총정리', href: '/guide/fraud/fraud-complaint-procedure-comprehensive' },
      { label: '가짜 온라인 쇼핑몰 물품 미배송 기망 사기', href: '/guide/fraud/fraud-fake-online-shopping-mall-nondelivery-track' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
  ...
  // ─── 4. fraud-art-investment-fractional-ownership-track ───
  {
    ...
    internalLinks: [
      { label: '사기죄 고소 절차 총정리', href: '/guide/fraud/fraud-complaint-procedure-comprehensive' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '가짜 코인거래소 출금정지 사기', href: '/guide/fraud/fraud-crypto-exchange-fake-withdrawal-block-track' },
  ...
  // ─── 5. fraud-prepaid-card-discount-bulk-resale-track ───
  {
    ...
    internalLinks: [
      { label: '사기죄 고소 절차 총정리', href: '/guide/fraud/fraud-complaint-procedure-comprehensive' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '가짜 온라인 스토어 결제 환불', href: '/guide/fraud/fraud-online-shopping-fake-store-recovery' },

...
export const spokesBatch81Labor: SpokePage[] = [
  // ─── 1. dismissal-pregnant-employee-maternity-protection-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '임신 출산 불이익 해고', href: '/guide/dismissal/dismissal-pregnancy-maternity-disadvantage-track' },
      { label: '육아휴직 복귀 불이익 해고', href: '/guide/dismissal/dismissal-parental-leave-return-track' },
  ...
  // ─── 3. dismissal-transfer-order-refusal-disciplinary-discharge-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '근무능력 부진 대기발령 해고', href: '/guide/dismissal/dismissal-standby-then-low-performance-discharge-track' },
  ...
  // ─── 6. unemployment-pregnancy-childbirth-extended-period-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '실업급여 수급 중 임신 출산 연장', href: '/guide/unemployment/unemployment-pregnancy-benefit-extension' },
  ...
  // ─── 7. unemployment-illness-medical-treatment-extended-period-track ───
  {
    ...
    internalLinks: [
      { label: '실업급여 수급기간 연장 가능한 4가지 경우', href: '/guide/unemployment/benefit-period-extension-cases' },
      { label: '실업급여 질병 재발 연장', href: '/guide/unemployment/unemployment-recurring-illness-extension-treatment-track' },

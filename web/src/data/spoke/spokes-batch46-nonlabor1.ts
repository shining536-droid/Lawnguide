...
export const spokesBatch46Nonlabor1: SpokePage[] = [
  // ─── 1. fraud / mlm-investment-recovery ───
  {
    ...
    internalLinks: [
      ...
      { label: '학원 교재비·시험비 선납 폐원 잠적 사기', href: '/guide/fraud/fraud-academy-textbook-prepay-closure-vanish-track' },
  ...
  // ─── 2. fraud / bitcoin-cold-wallet-scam ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '모르고 사기에 가담했을 때 대응법', href: '/guide/fraud/fraud-accomplice-unknowing-defense' },
  ...
  // ─── 3. fraud / fake-online-shopping-mall ───
  {
    ...
    internalLinks: [
      ...
      { label: '가족 통신사 명의도용 단말기 할부', href: '/guide/fraud/fraud-family-mobile-line-identity-theft-installment-track' },
  ...
  // ─── 4. fraud / personal-loan-flight-pursuit ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: 'NFT 디지털자산 투자 사기', href: '/guide/fraud/fraud-nft-digital-asset-investment-track' },
      { label: '소액소송 소장 양식과 작성 예시', href: '/guide/small-claims/small-claims-complaint-template' },
  ...
  // ─── 5. fraud / romance-marriage-promise-recovery ───
  {
    ...
    cta: { text: '사기 고소 전 준비자료, AI로 체크하기', link: '/chat?domain=fraud' },
    internalLinks: [
      { label: '연애빙자 사기 증거 수집 고소', href: '/guide/fraud/fraud-dating-romance-scam-evidence' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '사기 혐의 방어 전략 총정리', href: '/guide/fraud/fraud-accused-defense-strategy-guide' },
  ...
  // ─── 6. traffic-accident / driveway-collision-fault ───
  {
    ...
    cases: [
      {
        ...
        summary:
          '대전지방법원 2023노1855 사건(대전지방법원, 2024.10.10 선고)에서 법원은 지하주차장에서 진출하던 차량이 가속하며 광장을 가로질러 사고를 낸 경우 운전자의 안전운전 의무 위반이 인정된다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요합니다. 진출입로에서는 일시정지·서행·시야 확인 의무가 무겁게 적용되는 만큼, 유사 상황이라면 이런 기준을 검토해볼 수 있습니다.',
        takeaway:
    ...
    internalLinks: [
      { label: '자전거도로 충돌 과실비율 판단', href: '/guide/traffic-accident/traffic-accident-bicycle-lane-collision-fault-ratio-track' },
      ...
      { label: '무인주차장 사고 책임', href: '/guide/traffic-accident/traffic-accident-unmanned-parking-lot-liability-track' },
    ],
  },
  ...
  // ─── 7. traffic-accident / night-cycling-collision-fault ───
  {
    ...
    cases: [
      {
        ...
        summary:
          '울산지방법원 2019고단1124 판결(울산지방법원, 2019.08.14 선고)에서 법원은 자전거도로에서 자전거를 운전하는 자의 주의의무를 인정하면서, 동시에 차량 운전자의 자전거에 대한 안전 확인 의무도 별도로 부담한다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요합니다. 야간 사고는 양측 의무를 모두 따져 비율을 산정해야 하는 만큼, 유사 상황이라면 이런 기준을 검토해볼 수 있습니다.',
        takeaway:
    ...
    cta: { text: '교통사고 합의 전 체크리스트, AI로 정리하기', link: '/chat?domain=traffic-accident' },
    internalLinks: [
      { label: '자전거 차도 주행 사고 과실비율 판단', href: '/guide/traffic-accident/traffic-accident-bicycle-roadway-car-fault-ratio-track' },
      { label: '동승자 자기과실 후유증 추가 청구', href: '/guide/traffic-accident/traffic-accident-passenger-self-fault-aftereffect-claim' },
      { label: '무보험차 정부보장사업 청구', href: '/guide/traffic-accident/traffic-uninsured-defendant-government-guarantee' },
      { label: '무보험차상해 정부보장사업 한도 결합', href: '/guide/traffic-accident/traffic-accident-uninsured-self-injury-coverage-government-fund-limit' },
  ...
  // ─── 8. traffic-accident / passenger-window-injury ───
  {
    ...
    cta: { text: '교통사고 합의 전 체크리스트, AI로 정리하기', link: '/chat?domain=traffic-accident' },
    internalLinks: [
      { label: '버스 택시 급정거 승객 부상 손해배상 청구', href: '/guide/traffic-accident/traffic-accident-bus-sudden-stop-passenger-claim' },
      { label: '무보험차상해 정부보장사업 한도 결합', href: '/guide/traffic-accident/traffic-accident-uninsured-self-injury-coverage-government-fund-limit' },
      { label: '동승자 안전벨트 미착용 손해배상 감액 다툼 면책', href: '/guide/traffic-accident/traffic-accident-passenger-seatbelt-nonuse-reduction-defense-track' },
      { label: '교통사고 후유증 추가 치료비 청구 방법', href: '/guide/traffic-accident/traffic-accident-aftereffect-treatment-claim' },
      { label: '차량 시세하락 손해배상', href: '/guide/traffic-accident/traffic-accident-diminished-value-claim-procedure' },
    ],
  },
  ...
  // ─── 9. traffic-accident / school-bus-injury-claim ───
  {
    ...
    cta: { text: '교통사고 합의 전 체크리스트, AI로 정리하기', link: '/chat?domain=traffic-accident' },
    internalLinks: [
      { label: '통학버스 어린이 하차 직후 사고', href: '/guide/traffic-accident/traffic-accident-kindergarten-school-bus-child-alighting-injury-track' },
      { label: '카풀 운전자 자녀 부상 배상책임', href: '/guide/traffic-accident/traffic-accident-child-carpool-driver-liability' },
      { label: '교통사고 치료 중 사망 책임보험금 산정', href: '/guide/traffic-accident/traffic-accident-victim-died-during-treatment-liability-insurance-track' },
      { label: '운전 중 의식 소실 사고', href: '/guide/traffic-accident/traffic-accident-driver-sudden-loss-consciousness-track' },
      { label: '자전거 사고 보상 청구', href: '/guide/traffic-accident/traffic-accident-bicycle-compensation' },
    ],
  },
  ...
  // ─── 10. traffic-accident / pedestrian-distracted-walk-fault ───
  {
    ...
    internalLinks: [
      ...
      { label: '재활치료 과실 부상', href: '/guide/traffic-accident/traffic-accident-rehab-therapy-negligence-injury-track' },
      { label: '자율주행 보조시스템 사고 책임', href: '/guide/traffic-accident/traffic-accident-autonomous-mode-liability' },
      { label: '블랙박스 변조 의심', href: '/guide/traffic-accident/traffic-accident-dashcam-altered-evidence-track' },
      { label: '어린이보호구역 사고 가중처벌 민식이법 방어', href: '/guide/traffic-accident/traffic-accident-school-zone-protected-area-aggravated-accused-track' },
    ],
  },
];

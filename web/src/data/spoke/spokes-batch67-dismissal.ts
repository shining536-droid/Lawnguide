...
export const spokesBatch67Dismissal: SpokePage[] = [
  ...
  // ─── 2. dismissal-annual-leave-coerced-use-absent-fire-track ───
  {
    ...
    cases: [
      {
        ...
        summary:
          '서울행정법원 2006구합45852(서울행정법원, 2007.07.26 선고)에서는 연차휴가는 근로자에 대해 매년 일정 일수의 휴가를 유급으로 보장하고자 하는 제도이고, 사용자의 귀책 등으로 근로자가 출근하지 못한 기간에 대하여 출근율을 계산함에 있어 근로자에게 불리하게 고려할 수 없으며, 그 기간 동안의 처리를 정당한 연차 신청으로 인정하지 않고 결근을 이유로 한 해고는 부당하다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요합니다.',
    ...
    internalLinks: [
      ...
      { label: '대표 바뀐 후 해고', href: '/guide/dismissal/dismissal-ceo-change-unfair-dismissal' },
    ],
  },

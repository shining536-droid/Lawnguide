...
export const spokesBatch30RetirementWage: SpokePage[] = [
  // ── 퇴직금 1. IRP 의무이전 절차와 예외 ──
  {
    ...
    perspective: 'victim',
    meta: {
      title: '퇴직금 IRP 이전 의무, 면제되는 경우는? | 로앤가이드',
      description:
        '만 55세 이상·1년 미만 근속·일부 지급 등 IRP 이전 면제 사례를 확인해보세요. 적용 기준과 예외를 함께 정리했습니다.',
    },
    intro:
      '<p>퇴직금 IRP 의무 이전은 만 55세 미만이고 1년 이상 근속한 일반 퇴직자에게 적용되는 영역이에요. 만 55세 이상이거나 1년 미만 근속, 일부 지급 사례는 예외라 본인이 어떤 분류인지 먼저 확인해야 합니다. 근로자퇴직급여보장법 제17조 기준으로 적용·면제 사례를 정리합니다.</p>',
    sections: [
      {

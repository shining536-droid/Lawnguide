...
export const spokesBatch44Nonlabor2: SpokePage[] = [
  // ─── 1. inheritance / life-insurance-beneficiary-separate ───
  {
    ...
    internalLinks: [
      ...
      { label: '상속세 신고기한 초과 가산세', href: '/guide/inheritance/inheritance-tax-deadline-penalty' },
    ...
    cases: [
      {
        ...
        summary:
          '수원고등법원 2024누14742 사건(수원고등법원, 2025.08.22 선고)에서 법원은 해외재산 상속 시 평가 기준일·환율 기준을 정확히 적용해야 하고, 납세자가 임의로 유리한 시점을 택할 수 없다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요합니다. 기준에 어긋난 과소신고는 가산세 부과 사유가 될 수 있는 만큼, 유사 상황이라면 이런 기준을 검토해볼 수 있습니다.',
        takeaway:
  ...
  // ─── 4. inheritance / digital-assets-platform-access ───
  {
    ...
    internalLinks: [
      ...
      { label: '상속재산 분할협의 무효', href: '/guide/inheritance/inheritance-division-agreement-void-track' },
      { label: '입양자 상속 분쟁 법정상속분', href: '/guide/inheritance/inheritance-adopted-child-legal-share' },
    ],
  },
  ...
  // ─── 6. defamation / deepfake-victim-takedown-procedure ───
  {
    ...
    internalLinks: [
      ...
      { label: '아파트 입주민 앱 허위 글 명예훼손 신고', href: '/guide/defamation/defamation-apartment-resident-app-false-post-report-track' },
  ...
  // ─── 8. jeonse / auction-small-deposit-priority-repay ───
  {
    ...
    internalLinks: [
      ...
      { label: '전세보증금 반환 소송 전 준비 서류', href: '/guide/jeonse/deposit-lawsuit-docs' },
    ],
  },
  ...
  // ─── 9. jeonse / refund-overdue-interest-claim ───
  {
    ...
    internalLinks: [
      ...
      { label: '임차권등기명령 신청 절차와 비용', href: '/guide/jeonse/lease-registration-order-process' },
      { label: '전세보증금 반환 내용증명 작성법', href: '/guide/jeonse/deposit-return-notice-template' },
  ...
  // ─── 11. rehabilitation / co-borrower-spouse-impact ───
  {
    ...
    internalLinks: [
      ...
      { label: '개인회생 연대보증 채무 포함', href: '/guide/rehabilitation/rehabilitation-cosigner-joint-debt-include' },
  ...
  // ─── 12. bankruptcy / prior-gift-clawback-defense ───
  {
    ...
    internalLinks: [
      { label: '파산 면책 요건 절차 총정리', href: '/guide/bankruptcy/bankruptcy-discharge-requirements-comprehensive' },

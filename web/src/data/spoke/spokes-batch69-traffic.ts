...
export const spokesBatch69Traffic: SpokePage[] = [
  // ─── 1. traffic-accident-rear-end-chain-emergency-brake-fault-distribution-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '음주 보행자 사고 과실비율', href: '/guide/traffic-accident/traffic-accident-drunk-pedestrian-fault' },
  ...
  // ─── 2. traffic-accident-roundabout-entry-exit-yield-violation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '음주뺑소니 단순뺑소니 형량 차이 사고후미조치', href: '/guide/traffic-accident/traffic-accident-dui-hitandrun-vs-simple-hitandrun-sentence-track' },
  ...
  // ─── 3. traffic-accident-mountain-road-fallen-rock-state-liability-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '음주운전 가해 혼합 과실', href: '/guide/traffic-accident/traffic-accident-dui-offender-victim-mixed-fault' },
  ...
  // ─── 4. traffic-accident-electric-scooter-sidewalk-pedestrian-collision-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '음주운전 동승자 책임', href: '/guide/traffic-accident/traffic-accident-dui-passenger-liability-track' },

...
export const spokesBatch21_8to14: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    keyword: '퇴직금 중간정산 요건 6가지와 신청 절차',
    questionKeyword: '퇴직금 중간정산을 받을 수 있는 요건과 절차는 무엇인가요?',
    ctaKeyword: '퇴직금 중간정산 요건',
    type: '상황형',
    perspective: '일반',
    meta: {
      title: '퇴직금 중간정산 요건 6가지와 신청 절차 | 로앤가이드',
      description: '재직 중 퇴직금을 미리 받을 수 있는지 궁금하다면 중간정산 요건 6가지를 지금 확인하세요.',
    },
    intro:
      '<p>갑자기 목돈이 필요해졌습니다. 전세금을 올려야 하는데 대출이 안 되고, 퇴직금을 미리 받을 수 있다는 이야기를 들었습니다. 퇴직금 중간정산은 아무 때나 할 수 있는 것이 아니라 법에서 정한 요건을 충족해야 합니다. 요건을 모르고 신청하면 거부당할 수 있으니 미리 확인하세요.</p>',
    sections: [
      {
        title: '퇴직금 중간정산이란? — 기본 개념',
        content:
          '<p><strong style="color:#1e3a5f">근로자퇴직급여 보장법 제8조 제2항에 따라 근로자가 일정한 사유에 해당하면 재직 중에 퇴직금을 미리 정산받을 수 있습니다</strong></p>\n<p>중간정산의 핵심:</p>\n<ul>\n<li><strong>과거 근로기간 대상</strong> — 정산 시점까지의 계속근로기간에 대한 퇴직금만 정산 가능합니다. 미래 기간에 대한 사전 정산은 불가합니다</li>\n<li><strong>계속근로기간 리셋</strong> — 중간정산 후 퇴직금 산정을 위한 근속기간은 정산 시점부터 새로 시작됩니다</li>\n<li><strong>근로자 요구 필수</strong> — 반드시 근로자가 요구해야 하며, 사용자가 일방적으로 실시할 수 없습니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 근로자 요구 + 법정 사유 충족 → 과거 기간에 대한 퇴직금 미리 정산</blockquote>',
      },
      {
        title: '중간정산 가능한 6가지 법정 사유',
        content:
          '<p><strong style="color:#1e3a5f">근로자퇴직급여 보장법 시행령 제3조에서 정한 사유에 해당해야 중간정산이 가능합니다</strong></p>\n<ul>\n<li><strong>1. 무주택자의 주택 구입</strong> — 본인 명의 주택이 없는 상태에서 주택을 구입하는 경우</li>\n<li><strong>2. 전세금 또는 보증금 부담</strong> — 무주택자가 주거 목적으로 전세금·보증금을 부담하는 경우 (본인 명의 임대차 계약에 한함)</li>\n<li><strong>3. 6개월 이상 요양</strong> — 본인, 배우자, 부양가족이 6개월 이상 요양이 필요한 질병·부상에 해당하는 경우</li>\n<li><strong>4. 파산 선고</strong> — 최근 5년 이내에 근로자가 채무자 회생 및 파산에 관한 법률에 따라 파산 선고를 받은 경우</li>\n<li><strong>5. 개인회생 인가</strong> — 최근 5년 이내에 개인회생절차개시 결정을 받은 경우</li>\n<li><strong>6. 임금피크제 적용</strong> — 임금이 줄어드는 임금피크제에 적용된 경우</li>\n</ul>\n<div style="margin-top:16px;padding:14px 18px;background:linear-gradient(135deg,#fff8e1,#fff3cd);border-left:4px solid #f9a825;border-radius:8px">\n<strong style="color:#e65100">지금 바로 확인하세요</strong><br/>\n<a href="/diagnosis/retirement" style="color:#1565c0;font-weight:600">중간정산 요건 충족 여부 무료 진단받기 &rarr;</a>\n</div>',
      },
      {
        title: '중간정산 신청 절차와 필요 서류',
        content:
          '<p><strong style="color:#1e3a5f">사유를 증빙하는 서류를 구비하여 회사 인사부서에 중간정산 신청서를 제출합니다</strong></p>\n<ul>\n<li><strong>주택 구입</strong> — 매매계약서, 등기부등본, 무주택 확인서(주민등록등본)</li>\n<li><strong>전세금 부담</strong> — 임대차계약서, 주민등록등본, 전입세대열람내역서</li>\n<li><strong>6개월 이상 요양</strong> — 진단서(6개월 이상 치료 필요 소견 포함), 가족관계증명서</li>\n<li><strong>파산/회생</strong> — 법원 파산선고 결정문 또는 개인회생 인가결정문</li>\n</ul>\n<p>회사에 별도의 중간정산 신청 양식이 있는 경우가 많으므로 <strong>인사부서에 먼저 양식 존재 여부를 확인</strong>하세요. 없다면 자유 양식으로 사유·금액·증빙서류를 기재하여 제출합니다.</p>',
      },
      {
        title: '중간정산 시 주의할 3가지',
        content:
          '<p><strong style="color:#1e3a5f">중간정산은 당장 목돈을 마련할 수 있지만, 향후 퇴직금이 줄어드는 구조적 단점이 있습니다</strong></p>\n<ul>\n<li><strong>퇴직금 감소</strong> — 중간정산 후 근속기간이 리셋되므로 최종 퇴직 시 받는 퇴직금이 줄어듭니다. 임금이 올라갈수록 손실이 커집니다</li>\n<li><strong>세금 이중 과세</strong> — 중간정산 시 퇴직소득세가 부과되고, 최종 퇴직 시에도 별도로 과세됩니다. 합산 시 세금이 더 많아질 수 있습니다</li>\n<li><strong>사용자 거부 가능</strong> — 사용자에게 중간정산 의무는 없습니다("지급할 수 있다"로 규정). 법정 사유에 해당하더라도 사용자가 거부할 수 있으므로 사전 협의가 중요합니다</li>\n</ul>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">주의: 근속기간 리셋 + 세금 이중 과세 + 사용자 거부 가능</blockquote>',
      },
    ],
    cases: [
      {
        title: '퇴직금 중간정산 합의의 유효성 — 대법원 판단',
        summary:
          '대법원 2012다41045 사건(퇴직금)에서 법원은 퇴직금 중간정산 합의가 반드시 근로자가 먼저 적극적으로 요구한 경우에만 유효한 것은 아니며, 개별 근로자의 자유로운 의사에 따라 이루어진 것이면 중간정산은 유효하다고 판시했습니다.',
        takeaway:
          '중간정산 합의는 근로자의 자유의사가 핵심입니다. 회사가 일방적으로 실시한 경우에는 무효가 될 수 있으므로, 반드시 서면으로 본인의 의사를 명확히 남겨두세요.',
      },
    ],
    faq: [
      {
        question: '전세 연장(갱신) 시에도 중간정산이 가능한가요?',
        answer: '<strong>무주택자가 전세금 부담을 위해 신청하는 것이므로, 동일 주택의 전세 연장(보증금 증액)도 중간정산 사유에 해당합니다.</strong> 갱신 계약서와 보증금 증액 내역을 증빙으로 제출하세요.',
      },
      {
        question: '배우자가 주택을 소유하고 있으면 중간정산이 안 되나요?',
        answer: '주택 구입·전세 사유의 경우 <strong>"무주택자" 요건은 근로자 본인 명의 기준</strong>입니다. 다만 시행령에서 세대주 기준으로 판단하도록 규정하고 있어, 배우자 소유 주택이 있으면 인정되지 않을 수 있습니다.',
      },
      {
        question: '중간정산을 여러 번 받을 수 있나요?',
        answer: '<strong>법정 사유에 해당할 때마다 신청 가능</strong>합니다. 다만 각 사유마다 증빙서류를 제출해야 하며, 사용자가 매번 승인해야 합니다.',
      },
      {
        question: '확정기여형(DC형) 퇴직연금도 중간정산이 되나요?',
        answer: 'DC형 퇴직연금의 경우 <strong>중도인출이 가능하며, 법정 사유는 동일</strong>합니다. 퇴직연금 운용기관에 중도인출 신청서와 증빙서류를 제출하세요.',
      },
    ],
    cta: {
      text: '퇴직금 중간정산 요건 무료 진단받기',
      link: '/diagnosis/retirement',
    },
    internalLinks: [
      { label: '퇴직금 가이드', href: '/guide/retirement' },

...
export const spokesBatch62Traffic: SpokePage[] = [
  // ─── 1. traffic-accident-bicycle-night-light-collision-track ───
  {
    ...
    internalLinks: [
      { label: '자전거 보행자 과실비율', href: '/guide/traffic-accident/traffic-accident-bicycle-pedestrian-fault-table' },
  ...
  // ─── 2. traffic-accident-truck-falling-cargo-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 교통사고 피해자의 자동차보험 진료수가',
        summary:
          '대법원 2019다279962(대법원, 2020.12.10 선고)에서 법원은 자동차보험진료수가 청구와 관련해, 건강보험심사평가원이 업무 편의를 위해 일방적으로 만든 공고 규정만으로는 진료를 실시한 의료기관이나 보험회사의 권리·의무가 제한된다고 볼 수 없다고 판단했습니다. 교통사고 치료비의 보험 처리는 법령과 계약이 정한 기준에 따라야 한다는 취지입니다. 적재물 추락으로 인한 추돌처럼 여러 차량·당사자가 얽힌 사고에서도 손해와 치료비의 청구 경로를 정확히 확인해두는 것이 좋습니다.',
        takeaway: '적재물 추락에 따른 추돌은 가해 트럭 특정과 손해·치료비 청구 경로 확인이 관건인 영역이라, 가해 차량을 특정하기 어려운 경우 정부보장사업 등 대체 경로까지 함께 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    cta: { text: '교통사고 합의 전 체크리스트, AI로 정리하기', link: '/chat?domain=traffic-accident' },
    internalLinks: [
      { label: '뺑소니 가해자 신원확인', href: '/guide/traffic-accident/traffic-accident-hit-run-culprit-identification' },
      { label: '무보험차 피해 정부보장사업', href: '/guide/traffic-accident/traffic-accident-uninsured-victim-government-fund' },
      { label: '고속도로 다중추돌 과실비율', href: '/guide/traffic-accident/traffic-accident-highway-multi-collision' },
  ...
  // ─── 3. traffic-accident-dui-passenger-liability-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 사고 후 동승자 관련 도주 판단',
        summary:
          '대법원 2007도1738(대법원, 2007.10.11 선고)에서 법원은 사고 운전자가 경찰관에게 동승자를 운전자라고 진술하거나 허위신고를 하게 했더라도, 사고 직후 피해자가 병원으로 후송될 때까지 현장을 벗어나지 않고 자신의 차량이 가해차량임을 밝힌 뒤 동승자와 함께 조사를 받기 위해 경찰 지구대로 동행했다면 특정범죄가중처벌법상 \'도주\'로 보기 어렵다고 판단했습니다. 도주 여부는 구호조치 이행과 현장 이탈 정황을 종합해 판단한다는 취지입니다. 음주운전 차량에 동승한 상황이라면 동승자의 역할과 사고 직후 대응이 이후 책임 판단에 영향을 줄 수 있으므로, 사고 경위와 진술 내용을 정확히 정리해두는 것이 좋습니다.',
        takeaway: '음주운전 동승은 음주 인식·권유 정도와 사고 후 대응에 따라 책임이 달라질 수 있는 영역이라, 동승 경위와 대리운전 권유 여부 등을 구체적으로 정리해두는 방향을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '음주운전 동승자 책임 분배', href: '/guide/traffic-accident/traffic-accident-drunk-driver-companion-passenger-liability-track' },
      { label: '스쿨존 어린이 보호구역 사고 12대 중과실', href: '/guide/traffic-accident/traffic-accident-school-zone-child-12-negligence-track' },
      { label: '음주운전 동승자 자기보험', href: '/guide/traffic-accident/traffic-accident-drunk-passenger-self-insurance' },
  ...
  // ─── 4. traffic-accident-alley-reverse-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 도로 표지와 사고 유형 판단',
        summary:
          '대법원 2015도3107(대법원, 2015.11.12 선고)에서 법원은 교차로 진입 직전에 백색실선이 설치돼 있더라도 진로변경을 금지하는 안전표지가 개별적으로 설치돼 있지 않다면, 그 지점에서 진로를 바꾸다 낸 사고를 교통사고처리특례법상 \'통행금지 안전표지 지시 위반\'으로 볼 수 없다고 판단했습니다. 사고가 어떤 위반에 해당하는지는 표지의 종류와 설치 형태를 구체적으로 따져야 한다는 취지입니다. 골목·주차장에서의 후진 사고처럼 저속·근접 상황의 사고도 도로 표지와 진행 경위에 따라 과실 평가가 달라질 수 있으므로, CCTV·블랙박스로 정확한 경위를 확보해두는 것이 좋습니다.',
        takeaway: '후진 사고도 상대 차량의 과속·역주행 등 사정이 확인되면 과실비율이 조정될 수 있는 영역이라, CCTV·블랙박스 영상을 확보해 경위를 다투는 방향을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    cta: { text: '교통사고 합의 전 체크리스트, AI로 정리하기', link: '/chat?domain=traffic-accident' },
    internalLinks: [
      { label: '주차장 후진 사고 과실', href: '/guide/traffic-accident/traffic-accident-parking-lot-backing' },
      ...
      { label: '신호위반 사고 과실비율 협상', href: '/guide/traffic-accident/traffic-accident-signal-violation-fault-negotiation' },
      { label: '블랙박스 데이터 복구 사고 입증', href: '/guide/traffic-accident/traffic-accident-dashcam-data-recovery-insurance-dispute' },
    ],
  },
  ...
  // ─── 5. traffic-accident-ice-single-vehicle-insurance-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 교통사고와 공공주체의 배상책임',
        summary:
          '대법원 2023다205968(대법원, 2023.06.29 선고)에서 법원은 주한미군 소속 차량이 일으킨 교통사고와 관련해, SOFA 협정과 그 시행 민사특별법에 따라 국가배상법이 적용되는 경우의 배상책임 구조를 밝혔습니다. 교통사고로 인한 손해에 대해 공공주체의 배상책임이 국가배상법 체계 안에서 판단될 수 있다는 취지입니다. 빙판길 단독 사고에서도 다리·터널 등 결빙 구간의 관리 부실이 문제 된다면 도로 관리주체를 상대로 한 배상책임(영조물 책임)을 함께 살펴볼 수 있으므로, 기상·제설 기록을 확보해두는 것이 좋습니다.',
        takeaway: '빙판 단독 사고는 자차·자기신체사고 보험과 함께 도로 관리주체의 영조물 책임까지 검토해볼 수 있는 영역이라, 사고 구간의 기상·제설 기록을 확보하는 방향을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {

...
export const spokesBatch83FraudSexCrime: SpokePage[] = [
  ...
  // ─── 2. fraud-romance-dating-app-investment-lure-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보이스피싱 송금 환급 절차', href: '/guide/fraud/fraud-phishing-transfer-refund-procedure' },
      { label: '로맨스 스캠 해외 송금 후 환급', href: '/guide/fraud/fraud-romance-scam-overseas-money-transfer' },
    ],
  },
  ...
  // ─── 3. fraud-fake-rental-listing-deposit-upfront-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '보이스피싱 송금 환급 절차', href: '/guide/fraud/fraud-phishing-transfer-refund-procedure' },
      { label: '지인 금전거래 담보 설명 사기 고의 무고 방어', href: '/guide/fraud/fraud-acquaintance-loan-collateral-misrepresentation-falsely-accused-defense' },
  ...
  // ─── 5. fraud-unlisted-stock-pre-ipo-lure-track ───
  {
    ...
    internalLinks: [
      { label: '거래 분쟁의 사기 고소 둔갑', href: '/guide/fraud/fraud-business-dispute-criminal-complaint-false-accused-defense' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '의료기기 건강식품 허위판매 사기', href: '/guide/fraud/fraud-medical-illegal-product-sale' },
      { label: '보이스피싱 송금 환급 절차', href: '/guide/fraud/fraud-phishing-transfer-refund-procedure' },
  ...
  // ─── 7. sex-crime-taxi-passenger-driver-contact-track ───
  {
    ...
    internalLinks: [
      { label: '클럽 댄스플로어 기습 추행 신고', href: '/guide/sex-crime/sex-crime-club-dancefloor-grope-report-track' },
      { label: '성범죄 디지털 증거 보존기한 정리', href: '/guide/sex-crime/sex-crime-digital-evidence-timeline' },
      { label: '소개팅 동의 추행 무고', href: '/guide/sex-crime/sex-crime-blind-date-consent-falsely-accused-defense' },
      { label: '의료시술 마취 중 성폭력', href: '/guide/sex-crime/sex-crime-medical-procedure-anesthesia-victim-track' },
      { label: '소개팅 강제추행 무고', href: '/guide/sex-crime/sex-crime-blind-date-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 8. sex-crime-crowded-subway-groping-track ───
  {
    ...
    cta: { text: '성범죄 피해 대응 순서, AI로 정리하기', link: '/chat?domain=sex-crime' },
    internalLinks: [
      { label: '만원 버스 혼잡 틈탄 추행 신고', href: '/guide/sex-crime/sex-crime-crowded-bus-rush-hour-touch-report-track' },
      { label: '성범죄 디지털 증거 보존기한 정리', href: '/guide/sex-crime/sex-crime-digital-evidence-timeline' },
      { label: '출장 숙소 동료 추행 위력', href: '/guide/sex-crime/sex-crime-business-trip-lodging-coworker-track' },
      { label: '요양시설 노인 성폭력 피해', href: '/guide/sex-crime/sex-crime-elder-care-facility-victim-track' },
      { label: '출장 숙소 강제추행 무고', href: '/guide/sex-crime/sex-crime-business-trip-lodging-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 9. sex-crime-business-trip-lodging-coworker-track ───
  {
    ...
    cta: { text: '성범죄 피해 대응 순서, AI로 정리하기', link: '/chat?domain=sex-crime' },
    internalLinks: [
      { label: '회식 자리 강요 신체접촉 추행 신고', href: '/guide/sex-crime/sex-crime-company-dinner-forced-seating-touch-report-track' },
  ...
  // ─── 10. sex-crime-massage-shop-customer-falsely-accused-defense ───
  {
    ...
    cta: { text: '성범죄 피해 대응 순서, AI로 정리하기', link: '/chat?domain=sex-crime' },
    internalLinks: [
      { label: '성범죄 무고 대응 방법', href: '/guide/sex-crime/sex-crime-false-accusation-defense' },
      ...
      { label: '성범죄 합의 vs 불합의 양형 비교', href: '/guide/sex-crime/sex-crime-settlement-vs-no-settlement' },
    ],
  },
];

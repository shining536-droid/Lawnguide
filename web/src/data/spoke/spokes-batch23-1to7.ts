...
export const spokesBatch23_1to7: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    keyword: '매매계약 해제 계약금 반환 청구 방법',
    questionKeyword: '매매계약 해제하면 계약금 돌려받을 수 있나요?',
    ctaKeyword: '매매계약 해제 계약금 반환 상담',
    type: '절차타임라인형',
    perspective: '피해자',
    meta: {
      title: '매매계약 해제 계약금 반환 4단계 청구 절차 | 로앤가이드',
      description:
        '매매계약이 깨져서 계약금을 돌려받고 싶은데 어떻게 해야 할지 막막하다면 해제 사유별 4단계 반환 청구 절차를 지금 확인하세요',
    },
    intro:
      '<p>잔금일이 코앞인데 매도인이 갑자기 "집값이 올랐으니 더 받겠다"며 계약 이행을 거부합니다. 이미 계약금 3,000만 원을 송금한 상태라 억울하고 당황스럽습니다. 계약금을 그냥 날리는 건지, 아니면 배액배상을 받을 수 있는지, 소송까지 가야 하는지 판단이 서지 않습니다. 해제 사유와 이행착수 여부에 따라 대응 방법이 달라지므로 지금 당장 절차를 파악해야 합니다.</p>',
    timelineSteps: [
      '1단계: 해제 사유·이행착수 여부 확인',
      '2단계: 내용증명으로 해제 의사 통지',
      '3단계: 계약금 반환 또는 배액배상 요구',
      '4단계: 민사소송 또는 조정 신청',
    ],
    sections: [
      {
        title: '민법 제565조: 계약금 해제의 한계와 이행착수 판단',
        content:
          '<p><strong style="color:#1e3a5f">매도인은 계약금의 배액을 상환해야만 적법하게 해제할 수 있으며, 상대방이 이행에 착수한 후에는 계약금 해제 자체가 불가능합니다.</strong></p>\n<p>민법 제565조 제1항은 매수인이 계약금을 교부한 경우 상대방이 이행에 착수할 때까지 매수인은 계약금을 포기하고, 매도인은 계약금의 배액을 상환하여 계약을 해제할 수 있다고 규정합니다. 핵심은 <strong>"이행착수 전"</strong>이라는 조건입니다.</p>\n<ul>\n<li><strong>이행착수 인정 사례</strong> — 매수인의 중도금 지급, 잔금 이행 제공, 매도인의 소유권이전 서류 준비 및 근저당 말소 완료 등</li>\n<li><strong>이행착수 불인정 사례</strong> — 잔금일 전 단순 은행 대출 준비, 이삿짐 예약만 한 경우 등</li>\n<li><strong>배액배상 미이행 파기</strong> — 매도인이 배액배상 없이 이행을 거부하면 이는 민법 제390조 채무불이행(이행거절)에 해당하며 실손해 전액 배상 청구가 가능합니다</li>\n</ul>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">핵심: 중도금 지급 이후라면 매도인의 계약금 해제 불가 → 계약금 반환 + 실손해 배상 동시 청구 가능</blockquote>',
      },
      {
        title: '2단계: 내용증명 작성과 해제 통지 방법',
        content:
          '<p><strong style="color:#1e3a5f">계약 해제 의사는 반드시 내용증명 우편으로 통지해야 추후 분쟁에서 증거력을 확보할 수 있습니다.</strong></p>\n<p>내용증명에는 ①계약 일자·부동산 표시, ②상대방의 위반 행위 구체적 기술, ③해제 의사 명시, ④계약금 반환(또는 배액배상) 요구 금액과 기한, ⑤미이행 시 소송 예고를 포함해야 합니다. 해제 통지 후 상대방이 7~14일 이내에 응하지 않으면 소송 또는 조정을 준비합니다.</p>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>💬 AI 법률 상담으로 빠르게 확인하세요</strong></p>\n<p style="margin:0;font-size:0.95em">변호사 상담 전, AI가 계약금 반환 가능성과 내용증명 작성 방향을 분석해드립니다.</p>\n<a href="/chat?domain=real-estate-sale" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '3~4단계: 반환 청구와 소송 전략',
        content:
          '<p><strong style="color:#1e3a5f">계약금 반환 청구는 협의, 내용증명, 지급명령, 민사소송 순서로 단계적으로 진행합니다.</strong></p>\n<ul>\n<li><strong>협의 단계</strong> — 내용증명 발송 후 상대방이 반환에 응하면 합의서를 작성하고 지급받습니다</li>\n<li><strong>지급명령</strong> — 금액이 확정되어 있고 다툼 여지가 적다면 소장보다 저렴한 지급명령으로 신청할 수 있습니다. 인지대가 소액 소송의 약 50% 수준입니다</li>\n<li><strong>민사소송</strong> — 배액배상, 채무불이행 손해배상 등 다툼이 있다면 민사소송을 제기합니다. 가압류와 병행하면 강제집행 실효성이 높아집니다</li>\n<li><strong>소멸시효</strong> — 계약금 반환청구권의 소멸시효는 <strong>10년</strong>(민법 제162조 제1항)이지만, 내용증명 발송 후 최대한 빨리 청구하는 것이 유리합니다</li>\n</ul>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">전략: 배액배상 청구 vs. 채무불이행 손해배상 청구 중 더 유리한 금액을 계산해 선택하세요</blockquote>',
      },
    ],
    cases: [
      {
        title: '판례 — 매매 후 소유권 이전 시 전세금 반환의무와 해제 관련 대법원 판결',
        summary:
          '대법원 2024다312566 사건(대법원, 2025.04.15 선고)에서 법원은 전세권이 성립한 후 전세목적물의 소유권이 이전된 경우 새 소유자도 전세금 반환의무를 부담하며, 공유자 1인이 지분을 처분하면서 사해행위가 되면 일반채권자들의 공동담보에 제공되지 않은 우선변제권 있는 임차보증금 상당액은 취소 범위에서 제외해야 한다고 판시했습니다.',
        takeaway:
          '매매계약 해제 후 계약금 반환 청구 시, 매도인의 재산에 선순위 임차보증금이나 전세권이 있는 경우 실제 회수 가능한 금액을 먼저 파악하고 가압류 전략을 세우는 것이 중요합니다.',
      },
    ],
    faq: [
      {
        question: '계약금 일부만 지급한 경우도 배액배상을 받을 수 있나요?',
        answer:
          '<strong>지급한 금액을 기준으로 배액배상이 계산됩니다.</strong> 계약서에 계약금이 3,000만 원으로 기재되어 있어도 실제로 500만 원만 지급했다면, 매도인은 500만 원의 배액인 1,000만 원을 상환해야 합니다. 나머지 2,500만 원은 미지급 계약금 채무에 해당합니다.',
      },
      {
        question: '매도인이 잠적하거나 연락이 안 되면 어떻게 하나요?',
        answer:
          '<strong>공시송달 방식으로 내용증명을 발송하거나 법원에 소장을 제출하면 됩니다.</strong> 매도인의 주민등록상 주소지로 내용증명을 발송하고 반송되면, 법원에 소를 제기하여 공시송달 방법으로 진행할 수 있습니다. 동시에 매도인 명의 부동산에 가압류 신청을 검토하세요.',
      },
      {
        question: '중개사가 개입한 계약에서 중개사에게도 책임을 물을 수 있나요?',
        answer:
          '<strong>중개사가 계약 위험을 설명하지 않았다면 공인중개사법에 따라 손해배상 책임을 물을 수 있습니다.</strong> 중개사는 계약 당사자의 이행 능력, 권리관계 등을 확인하고 설명할 의무가 있습니다. 이를 위반한 경우 계약금 손해의 일부 또는 전부를 청구할 수 있습니다.',
      },
      {
        question: '해제 후 이사 비용, 대출 수수료 등 부대비용도 청구할 수 있나요?',
        answer:
          '<strong>매도인의 채무불이행이 인정되면 계약금 외에도 실제 손해를 배상받을 수 있습니다.</strong> 이사 비용, 대출 수수료, 이자 비용 등 인과관계가 인정되는 손해를 청구할 수 있습니다. 영수증과 지출 내역을 꼼꼼히 보관해두세요.',
      },
      {
        question: '계약금 해제와 채무불이행 손해배상 중 어떤 것이 더 유리한가요?',
        answer:
          '<strong>시세 상승폭이 크다면 채무불이행 손해배상이, 상승폭이 작다면 배액배상이 유리할 수 있습니다.</strong> 예를 들어 계약금 5,000만 원, 시세 차액 3억 원이라면 채무불이행 손해배상(3억 원)이 배액배상(1억 원)보다 유리합니다. 변호사와 상담하여 청구 전략을 수립하세요.',
      },
    ],
    cta: {
      text: '매매계약 해제 계약금 반환 가능성, AI가 분석해드립니다',
      link: '/chat?domain=real-estate-sale',
    },
    internalLinks: [
      { label: '부동산 매매 계약서 필수 특약 사항', href: '/guide/real-estate-sale/sale-contract-essential-clauses' },
      { label: '매매 목적물 하자 발견 시 손해배상 청구', href: '/guide/real-estate-sale/defect-damage-claim' },
  ...
  // ───────────────────────────────────────────
  {
    ...
    questionKeyword: '부동산 매매계약서에 어떤 특약을 넣어야 하나요?',
    ctaKeyword: '매매계약서 특약 작성 상담',
    type: '체크리스트형',
    perspective: '피해자',
    meta: {
      title: '부동산 매매계약서 필수 특약 7가지 체크리스트 | 로앤가이드',
      description:
        '계약서 서명 전에 어떤 특약을 넣어야 안전한지 고민된다면 분쟁 예방을 위한 필수 특약 7가지 체크리스트를 지금 확인하세요',
    },
    intro:
      '<p>공인중개사가 "기본 계약서면 충분하다"고 하지만 뭔가 찜찜합니다. 잔금일 전에 근저당이 말소될지, 하자가 있으면 누가 책임지는지, 이사 날짜가 어긋나면 어떻게 하는지 계약서에 명시하지 않으면 나중에 분쟁이 생겨도 근거가 없습니다. 서명 전에 반드시 넣어야 할 특약 사항을 미리 점검하는 것이 수천만 원 손해를 막는 가장 확실한 방법입니다.</p>',
    sections: [
      {
        title: '특약 1~3: 잔금·등기 관련 핵심 특약',
        content:
          '<p><strong style="color:#1e3a5f">잔금일과 소유권이전등기, 근저당 말소에 관한 특약은 매매계약에서 가장 중요한 3가지입니다.</strong></p>\n<ul>\n<li><strong>특약 1 — 잔금일까지 근저당권·압류 완전 말소</strong>: "잔금 지급 전까지 본 부동산에 설정된 모든 근저당권, 압류, 가압류를 말소하기로 한다. 미이행 시 매수인은 계약을 해제하고 계약금의 배액을 청구할 수 있다"</li>\n<li><strong>특약 2 — 소유권이전등기 동시 이행</strong>: "잔금 지급과 동시에 소유권이전등기에 필요한 서류(인감증명서, 등기권리증, 주민등록초본)를 교부하기로 한다"</li>\n<li><strong>특약 3 — 명의 신탁·이중 매매 방지</strong>: "매도인은 본 부동산을 제3자에게 담보로 제공하거나 이중으로 매도하지 않기로 한다. 위반 시 손해배상 책임을 진다"</li>\n</ul>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">체크: 잔금일 당일 법원 등기소 또는 법무사 동행 여부도 특약으로 명시하면 더 안전합니다</blockquote>',
      },
      {
        title: '특약 4~5: 하자 및 현황 고지 특약',
        content:
          '<p><strong style="color:#1e3a5f">하자와 현황 고지에 관한 특약은 입주 후 분쟁을 예방하는 데 필수적입니다.</strong></p>\n<ul>\n<li><strong>특약 4 — 하자 현황 고지 의무</strong>: "매도인은 본 부동산의 누수, 균열, 시설물 고장 등 알려진 하자를 계약 전 고지하기로 한다. 계약 후 숨겨진 하자가 발견될 경우 민법 제580조에 따른 하자담보책임을 진다"</li>\n<li><strong>특약 5 — 도배·장판·시설 상태 명시</strong>: "본 부동산은 현 상태(as-is)로 인도하되, 이 계약서에 첨부된 사진 및 현황 체크리스트 기준의 상태를 유지하기로 한다. 계약 후 시설물 임의 철거 및 변경은 금지한다"</li>\n</ul>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>💬 AI 법률 상담으로 빠르게 확인하세요</strong></p>\n<p style="margin:0;font-size:0.95em">변호사 상담 전, AI가 내 계약서의 빠진 특약 항목을 점검해드립니다.</p>\n<a href="/chat?domain=real-estate-sale" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '특약 6~7: 인도·위약 관련 특약',
        content:
          '<p><strong style="color:#1e3a5f">인도 날짜와 위약금 조항은 계약서에서 자주 빠지는 특약이지만 분쟁 발생 시 핵심 근거가 됩니다.</strong></p>\n<ul>\n<li><strong>특약 6 — 인도 날짜와 이사 연기 위약금</strong>: "매도인은 잔금 수령일로부터 ○○일 이내에 부동산을 완전히 인도하기로 한다. 기한 내 인도하지 못할 경우 매수인에게 1일당 잔금의 0.1%에 해당하는 지연손해금을 지급한다"</li>\n<li><strong>특약 7 — 계약 해제 위약금과 배액배상 상한</strong>: "본 계약의 계약금은 위약금의 성질을 가지며, 당사자 일방의 귀책 사유로 계약이 해제되는 경우 귀책 당사자는 계약금에 해당하는 금액을 손해배상으로 지급한다. 단, 양 당사자 합의 시 계약금 외 추가 손해배상을 청구할 수 있다"</li>\n</ul>\n<p>특약은 <strong>구체적으로 기재할수록</strong> 분쟁 예방 효과가 높습니다. "잔금 전 근저당 말소"처럼 모호한 표현보다 "20XX년 X월 X일까지 말소등기 완료"처럼 날짜를 명시하는 것이 좋습니다.</p>\n<blockquote style="border-left:4px solid #ddd;padding:8px 12px;color:#555">최종 체크: 계약서 서명 전 등기부등본을 다시 한번 열람하고 특약 내용과 일치하는지 확인하세요</blockquote>',
      },
    ],
    cases: [
      {
        title: '판례 — 공동주택 하자 판정과 특약 관련 행정소송',
        summary:
          '서울행정법원 2024구합53482 사건에서 법원은 공동주택 신축 시공사가 장애인 편의시설(경사로)을 설치하지 않은 것을 국토교통부 하자심사·분쟁조정위원회가 하자로 판정한 처분이 정당하다고 판시했습니다. 장애인 등 편의증진 보장에 관한 법률상 편의시설 설치 기준을 지키지 않은 것은 법적 의미의 하자에 해당한다는 점을 확인한 사례입니다.',
        takeaway:
          '신규 분양 아파트나 공동주택 매매 시 편의시설 설치 여부, 법정 기준 충족 여부를 계약서 특약에 명시하거나 확인 후 계약해야 합니다. 이를 소홀히 하면 입주 후 하자 분쟁이 발생할 수 있습니다.',
      },
    ],
    faq: [
      {
        question: '중개사가 작성한 기본 계약서에 특약을 추가하면 효력이 있나요?',
        answer:
          '<strong>특약은 기본 계약서 내용보다 우선 적용됩니다.</strong> 계약서 본문과 특약이 충돌하면 특약이 우선합니다. 특약은 당사자 쌍방이 서명·날인해야 효력이 있으므로 반드시 양 당사자 확인란이 포함된 특약 양식을 사용하세요.',
      },
      {
        question: '구두로 약속한 내용도 특약으로 인정되나요?',
        answer:
          '<strong>구두 약속은 입증이 어려워 분쟁 시 효력을 인정받기 어렵습니다.</strong> 카카오톡·문자 등 문자로 남긴 합의는 증거가 될 수 있지만, 계약서 특약에 직접 기재하는 것이 가장 확실합니다. 구두 합의가 있다면 반드시 특약 추가를 요구하세요.',
      },
      {
        question: '매도인이 특약 추가를 거부하면 어떻게 해야 하나요?',
        answer:
          '<strong>특약 거부 자체가 리스크 신호입니다.</strong> 정당한 이유 없이 근저당 말소 특약이나 하자 고지 특약을 거부한다면 뭔가 숨기는 것이 있을 수 있습니다. 이 경우 계약 체결을 재고하거나 반드시 전문가 자문을 받으세요.',
      },
      {
        question: '계약서에 "현 상태 인수" 조항이 있으면 하자 책임을 물을 수 없나요?',
        answer:
          '<strong>알지 못한 하자는 "현 상태 인수" 조항으로도 면책되지 않습니다.</strong> 대법원 판례에 따르면 매도인이 알면서 고지하지 않은 하자는 특약으로도 면책이 안 됩니다. 다만 매수인이 계약 전 충분히 확인할 수 있었던 하자는 청구가 제한될 수 있습니다.',
      },
      {
        question: '특약에 "중도금 지급 후 해제 불가"라고 적어도 법적으로 유효한가요?',
        answer:
          '<strong>유효하지만 이행착수 후에는 어차피 계약금 해제가 불가하므로 큰 의미는 없습니다.</strong> 다만 이 특약이 있으면 해제 조건 해석에서 유리한 입장이 될 수 있습니다. 더 중요한 것은 "이행착수의 기준 시점"을 특약에 명시하는 것입니다.',
      },
    ],
    cta: {
      text: '내 계약서 특약 항목, AI가 빠짐없이 점검해드립니다',
      link: '/chat?domain=real-estate-sale',
    },
    internalLinks: [

    ...
    cases: [
      {
        ...
        takeaway:
          '분양권이나 소유권이전등기청구권을 전매(재양도)하는 경우 매도인의 승낙서를 가능한 한 받아야 합니다. 단순히 양도 통지만 한 경우 제3자에게 대항력이 없어 소유권 취득이 어렵게 될 수 있습니다.',
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          '<strong>네, 등기부등본에 나타나지 않는 위험 요소가 있습니다.</strong> 유치권은 등기 없이도 성립하며, 법정지상권도 등기 없이 발생할 수 있습니다. 건물이 있는 토지를 매수할 때는 건물 소유자와 토지 소유자가 동일인인지 가능한 한 확인하세요.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<strong>등기부가 깨끗해도 사기 위험은 있습니다.</strong> 타인 명의 서류를 도용하거나, 위조 신분증을 사용하는 부동산 사기가 있습니다. 중요한 계약은 가능한 한 법무사나 변호사를 동행하여 소유자 본인 확인과 등기 절차를 동시에 처리하는 것이 가장 안전합니다.',
      },
    ],
    cta: {

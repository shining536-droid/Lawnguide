...
export const spokesBatch89FraudSexCrime: SpokePage[] = [
  ...
  // ─── 7. sex-crime-study-cafe-close-contact-track ───
  {
    ...
    internalLinks: [
      { label: '헬스장 PT 자세 교정 빙자 추행 신고', href: '/guide/sex-crime/sex-crime-gym-pt-posture-correction-touch-report-track' },
      ...
      { label: '축제 인파 접촉 오해 추행 무고 방어', href: '/guide/sex-crime/sex-crime-festival-crowd-contact-misunderstanding-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 8. sex-crime-hospital-ward-inpatient-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '축제 인파 기습추행', href: '/guide/sex-crime/sex-crime-festival-crowd-grope-track' },
    ],
  },
  ...
  // ─── 9. sex-crime-rental-studio-hidden-camera-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '축제 인파 강제추행', href: '/guide/sex-crime/sex-crime-festival-crowd-track' },
    ],
  },
  ...
  // ─── 10. sex-crime-mt-group-trip-intoxicated-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '탈의실 몰래카메라 촬영', href: '/guide/sex-crime/sex-crime-fitting-room-hidden-cam-track' },
      { label: '매장 탈의실 불법촬영', href: '/guide/sex-crime/sex-crime-fitting-room-hidden-camera-track' },

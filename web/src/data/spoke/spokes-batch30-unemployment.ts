...
export const spokesBatch30Unemployment: SpokePage[] = [
  ...
  // ── 3. 65세 이상 고용보험 수급 예외 사항 ──
  {
    ...
    perspective: 'victim',
    meta: {
      title: '만 65세 이상 실업급여, 가능한 경우 정리 | 로앤가이드',
      description:
        '만 65세 이전부터 계속 근무한 경우는 수급 가능한 사례가 있어요. 가입 시점·예외 적용 조건을 사례별로 확인해보세요.',
    },
    intro:
      '<p>만 65세 이상은 원칙적으로 실업급여 가입 대상에서 제외되지만, 만 65세 이전부터 같은 사업장에서 계속 근무해온 사례라면 수급 가능 영역이에요. 가입 시점·근무 단절 여부·이직 사유에 따라 적용이 갈리고, 고용센터 1350에서 본인 사례 분류 확인 후 신청 절차가 시작됩니다. 고용보험법 제10조 기준입니다.</p>',
    sections: [
      {

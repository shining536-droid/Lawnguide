...
export const spokesBatch30Unemployment: SpokePage[] = [
  // ── 1. 사업장 원거리 이전 퇴사 실업급여 ──
  {
    ...
    sections: [
      {
        ...
        content:
          '<p><strong style="color:#1e3a5f">고용보험법 시행규칙 별표2에 따라 사업장 이전으로 통근이 곤란해진 경우는 비자발적 이직으로 인정됩니다.</strong></p>\n<p>구체적으로 사업장의 이전으로 인해 출퇴근에 왕복 3시간 이상이 소요되는 경우, 근로자가 퇴사하더라도 정당한 이직 사유에 해당합니다. 고용센터에서는 실제 통근 시간과 교통수단의 이용 가능성을 종합적으로 판단합니다.</p>\n<ol>\n<li><strong>왕복 통근시간 3시간 이상</strong> — 대중교통 기준으로 출퇴근에 왕복 3시간 이상 소요되면 통근 곤란으로 인정됩니다. 자가용이 아닌 대중교통 기준이 원칙입니다.</li>\n<li><strong>교통수단 변경 불가</strong> — 이전된 사업장까지 대중교통이 없거나 첫차·막차 시간이 근무시간과 맞지 않는 경우도 포함됩니다.</li>\n<li><strong>사업주의 대안 미제공</strong> — 사업주가 통근버스, 기숙사, 이전비 지원 등 합리적 대안을 제시하지 않은 경우 정당성이 더 강해집니다.</li>\n</ol>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 사업장 이전 후 왕복 3시간 이상 통근이 필요하면, 자진퇴사라도 실업급여 수급이 가능합니다. 통근 경로와 소요시간을 반드시 캡처해두세요.</blockquote>',
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>네, 사업장 폐쇄는 권고사직·정리해고와 유사하게 처리되어 별도 증빙 없이도 비자발적 이직으로 인정됩니다. 사업장 이전은 통근 곤란을 증명해야 합니다.</p>',
      },
    ],
    ...
    cases: [
      {
        ...
        takeaway:
          '성희롱 피해로 정신적 고통이 크더라도 실업인정(구직활동 신고)은 반드시 본인이 직접 해야 합니다. 대리 신고는 부정수급으로 처벌받을 수 있으니, 온라인 신고를 활용하세요.',
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          '<p>네, 성적 농담이나 외모 품평도 반복되면 직장 내 성희롱에 해당합니다. 물리적 접촉이 아니더라도 정당한 이직 사유로 인정됩니다.</p>',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>대화 당사자가 직접 녹음한 것은 증거로 인정됩니다. 다만 제3자의 대화를 몰래 녹음하면 통신비밀보호법 위반이 될 수 있으니, 본인이 참여한 대화만 녹음하세요.</p>',
      },
      {
  ...
  // ── 4. 훈련연장급여 수급 조건과 신청 방법 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>고용센터의 승인을 받으면 훈련과정 변경이 가능합니다. 단, 무단으로 과정을 바꾸면 훈련연장급여가 중단될 수 있으니 반드시 사전에 협의하세요.</p>',
      },
      {
  ...
  // ── 7. 예술인·특수고용 실업급여 수급 조건 ──
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>일반 근로자와 동일하게 입사지원, 면접 참석, 직업훈련 수강 등이 구직활동으로 인정됩니다. 예술인은 오디션 참석, 공모전 응모 등도 인정될 수 있습니다.</p>',
      },
    ],
  ...
  // ── 8. 구직활동 인정 유형 총정리 ──
  {
    ...
    intro:
      '<p>실업급여를 받기 시작했는데, 2주마다 구직활동을 증명해야 한다고 합니다. 입사지원만 구직활동인 줄 알았는데, 실제로는 다양한 활동이 인정됩니다. 어떤 활동이 인정되는지 미리 알아두면 실업인정에 어려움 없이 구직급여를 받을 수 있습니다.</p>',
    sections: [
      {
        title: '구직활동 인정 유형 7가지',
        content:
          '<p><strong style="color:#1e3a5f">고용보험법 시행규칙에 따라 다음 7가지 유형의 구직활동이 실업인정 시 인정됩니다.</strong></p>\n<ol>\n<li><strong>구인업체 입사지원</strong> — 채용 공고에 이력서를 제출하고 지원한 활동입니다. 온라인(잡코리아, 사람인 등)과 오프라인 모두 인정됩니다.</li>\n<li><strong>채용면접 참석</strong> — 서류 통과 후 면접에 참석한 경우입니다. 전화·화상 면접도 인정됩니다.</li>\n<li><strong>직업훈련 수강</strong> — 국비지원 직업훈련, 내일배움카드 훈련 등을 수강하는 경우입니다.</li>\n<li><strong>고용센터 상담</strong> — 고용센터에서 취업상담을 받은 경우입니다. 온라인 상담도 포함됩니다.</li>\n<li><strong>취업특강·세미나 참석</strong> — 고용센터나 공공기관이 주관하는 취업 특강, 이력서 작성 교육 등에 참석한 경우입니다.</li>\n<li><strong>자격증 시험 응시</strong> — 취업에 도움이 되는 자격증 시험에 응시한 경우입니다. 시험 접수만으로는 부족하고, 실제 응시해야 합니다.</li>\n<li><strong>창업 준비활동</strong> — 소상공인지원센터 상담, 사업계획서 작성, 창업교육 수강 등이 해당됩니다.</li>\n</ol>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 입사지원만이 구직활동이 아닙니다. 직업훈련, 자격증 시험, 창업 준비까지 다양한 활동이 인정됩니다.</blockquote>',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '<p>네, 워크넷이나 민간 채용사이트(잡코리아, 사람인 등)에서의 입사지원은 구직활동으로 인정됩니다. 지원 이력 화면을 캡처해두세요.</p>',
      },
      {
        question: '같은 날 여러 회사에 지원하면 각각 인정되나요?',
        answer:
          '<p>네, 같은 날이라도 서로 다른 회사에 지원했다면 각각 별도의 구직활동으로 인정됩니다. 2회 이상 활동이 필요할 때 유용합니다.</p>',
      },
      {
    ...
    cases: [
      {
        ...
        takeaway:
          '취업 사실을 신고하지 않고 구직급여를 받은 경우 반환명령은 적법합니다. 소액이라도 반드시 신고해야 하며, 반환 명령을 받았다면 산정 오류 여부를 확인한 후 이의신청 여부를 결정하세요.',
      },
    ],
    faq: [
      {
        ...
        answer:
          '<p>네, 1일이라도 취업하면 실업인정 시 반드시 신고해야 합니다. 미신고 시 부정수급으로 처리될 수 있습니다.</p>',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          '<p>실업급여 신청은 국내 관할 고용센터에서 해야 합니다. 해외에서는 신청할 수 없으므로 귀국 후 신청하세요. 수급기간(12개월) 이내인지 반드시 확인하세요.</p>',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>이직일 이전 18개월 범위 내의 피보험기간만 인정됩니다. 5년 전 국내 근무 기간은 범위를 벗어나므로 합산이 어렵습니다.</p>',
      },
      {
        question: '해외 체류 중 한국 실업급여를 온라인으로 신청할 수 있나요?',
        answer:
          '<p>실업급여 최초 신청은 고용센터 방문이 원칙입니다. 해외에서 온라인만으로 신청하는 것은 불가하며, 대리 신청도 부정수급에 해당하므로 반드시 귀국 후 직접 방문하세요.</p>',
      },
    ],

...
export const trafficAccidentPages: SpokePage[] = [
  ...
  },
  {
    ...
    type: '체크리스트형',
    meta: {
      title: '교통사고로 다쳤어요. 보상금 얼마 받나요? 5가지 청구 | 로앤가이드',
      description:
    ...
    faq: [
      {
        question: '교통사고 보상금은 어떤 항목으로 청구할 수 있나요?',
        answer:

...
export const spokesBatch22_1to7: SpokePage[] = [
  ...
  // ───────────────────────────────────────────
  {
    ...
    cases: [
      {
        title: '판례 — 회식 중 재해도 업무상 재해가 될 수 있는지',
        summary:
          '대법원 2013두25276 사건(대법원, 2015.11.12 선고)에서 법원은 사업주가 지배·관리하는 회식에서 근로자가 주량을 초과해 음주한 것이 주된 원인이 되어 부상·질병 등이 발생한 경우, 업무와 과음, 재해 사이에 상당인과관계가 있는지를 따져 업무상 재해에 해당하는지 판단해야 한다고 판시했습니다.',
        takeaway:
          '휴업급여는 업무상 재해로 요양하며 일하지 못한 기간에 지급되므로, 회식 등 업무 관련 자리에서 다친 경우에도 사업주의 지배·관리 여부와 인과관계 자료를 정리해 업무상 재해 인정을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {

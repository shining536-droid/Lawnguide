...
export const spokesBatch29Unemployment1: SpokePage[] = [
  // ── 1. 임금체불 퇴사 실업급여 ──
  {
    ...
    sections: [
      {
        ...
        content:
          '<p><strong style="color:#1e3a5f">고용보험법 시행규칙 별표2에 따라 임금체불은 비자발적 이직으로 인정됩니다.</strong></p>\n<p>구체적으로 사업주가 근로조건을 위반한 경우에 해당하며, 임금의 30% 이상을 체불하거나 2개월 이상 연속 체불한 경우가 대표적입니다.</p>\n<ol>\n<li><strong>임금의 30% 이상 체불</strong> — 정해진 급여일에 임금의 70% 미만만 지급받은 경우입니다. 잔여분을 다음 달에 주겠다는 약속만으로는 해결되지 않습니다.</li>\n<li><strong>2개월 이상 연속 체불</strong> — 2개월 이상 계속하여 임금이 지급되지 않은 경우입니다. 일부만 지급한 경우도 체불에 해당합니다.</li>\n<li><strong>퇴직금 미지급 약속</strong> — 퇴직금을 지급하지 않겠다고 사업주가 명시적으로 말한 경우도 포함됩니다.</li>\n</ol>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 임금체불 2개월 이상이면 자진퇴사도 정당한 이직으로 인정됩니다. 급여명세서와 계좌이체 내역을 반드시 보관하세요.</blockquote>',
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<p>반드시 그럴 필요는 없지만, 퇴사 전 진정을 해두면 체불 사실 증명이 쉬워집니다. 퇴사 후에도 진정은 가능하므로 상황에 따라 결정하세요.</p>',
      },
    ],
    ...
    faq: [
      {
        ...
        answer:
          '<p>구두 통보만으로도 계약 만료 사실은 인정됩니다. 다만 증거를 위해 사업주에게 문자나 이메일로 확인 요청을 보내고, 그 답변을 보관해두세요.</p>',
      },
      {
      ...
      },
      {
        ...
        answer:
          '<p>프리랜서 소득이 발생하면 실업인정 시 반드시 신고해야 합니다. 월 소득이 일정 금액을 초과하면 해당 기간의 구직급여가 감액되거나 중단될 수 있습니다.</p>',
      },
    ],
  ...
  {
    domain: 'unemployment',
    slug: 'unemployment-harassment-quit',
    keyword: '직장 내 괴롭힘 퇴사 실업급여',
    questionKeyword: '직장 내 괴롭힘으로 퇴사하면 실업급여를 받을 수 있나요?',
    ctaKeyword: '직장 괴롭힘 퇴사 실업급여 상담',
    type: '자격확인형',
    perspective: 'victim',
    meta: {
      title: '직장 내 괴롭힘 퇴사 실업급여 인정 조건 3가지 | 로앤가이드',
      description:
        '상사의 괴롭힘이나 성희롱으로 더 이상 출근하기 어렵다면, 자진퇴사도 실업급여를 받을 수 있는 조건을 지금 확인하세요.',
    },
    intro:
      '<p>매일 상사에게 소리를 듣고, 업무에서 배제되고, 회식 자리에서 모욕을 당합니다. 더 이상 버틸 수 없어 퇴사를 결심했지만 자진퇴사면 실업급여를 못 받을까 걱정됩니다. 근로기준법 제76조의2에 따른 직장 내 괴롭힘이 인정되면 정당한 이직 사유로 실업급여를 받을 수 있습니다.</p>',
    sections: [
      {
        title: '직장 내 괴롭힘이 정당한 이직 사유인 기준',
        content:
          '<p><strong style="color:#1e3a5f">고용보험법 시행규칙 별표2에 따라 직장 내 괴롭힘·성희롱은 정당한 이직 사유입니다.</strong></p>\n<p>2019년 7월 직장 내 괴롭힘 금지법 시행 이후, 괴롭힘으로 인한 퇴사는 명확한 비자발적 이직 사유가 되었습니다.</p>\n<ol>\n<li><strong>직장 내 괴롭힘(근로기준법 제76조의2)</strong> — 지위·관계의 우위를 이용하여 업무상 적정범위를 넘어 신체적·정신적 고통을 주는 행위입니다.</li>\n<li><strong>직장 내 성희롱(남녀고용평등법)</strong> — 성적 언동으로 근로환경을 악화시키는 행위입니다.</li>\n<li><strong>사업주의 조치 미이행</strong> — 괴롭힘을 신고했는데 사업주가 적절한 조치를 취하지 않은 경우도 포함됩니다.</li>\n</ol>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 괴롭힘 신고 후 회사가 조치를 안 하거나, 오히려 신고자에게 불이익을 준 경우는 더욱 강력한 이직 사유가 됩니다.</blockquote>',
      },
      {
        title: '괴롭힘 증거 수집 방법',
        content:
          '<p><strong style="color:#1e3a5f">퇴사 전에 반드시 증거를 확보해야 합니다.</strong></p>\n<ul>\n<li><strong>녹음</strong> — 괴롭힘 발언을 녹음하세요. 대화 당사자가 녹음하는 것은 합법입니다.</li>\n<li><strong>문자·메신저 캡처</strong> — 모욕적 메시지, 업무 배제 지시 등을 스크린샷으로 저장하세요.</li>\n<li><strong>일지 작성</strong> — 날짜, 시간, 장소, 내용, 목격자를 기록한 괴롭힘 일지를 작성하세요.</li>\n<li><strong>진단서</strong> — 괴롭힘으로 인해 우울증, 불안장애 등이 발생했다면 정신건강의학과 진단서를 받으세요.</li>\n<li><strong>사내 신고 기록</strong> — 회사 인사팀이나 노사협의회에 신고한 기록이 있다면 보관하세요.</li>\n</ul>\n<div style="margin:24px 0;padding:20px;background:linear-gradient(135deg,#fef9e7,#fdf2d5);border-left:5px solid #f4c430;border-radius:8px">\n<p style="margin:0 0 8px;font-size:1.05em"><strong>직장 내 괴롭힘 퇴사 후 실업급여 가능성, AI가 즉시 판단합니다</strong></p>\n<p style="margin:0;font-size:0.95em">괴롭힘 유형과 증거 보유 현황을 입력하면 수급 자격을 무료로 확인하세요.</p>\n<a href="/chat?domain=unemployment" style="display:inline-block;margin-top:12px;padding:10px 24px;background:#f4c430;color:#1a1a1a;border-radius:6px;text-decoration:none;font-weight:bold">무료 AI 상담 시작 →</a>\n</div>',
      },
      {
        title: '괴롭힘 퇴사 실업급여 신청 절차',
        content:
          '<p><strong style="color:#1e3a5f">퇴사 전 사내 신고를 먼저 하는 것이 유리합니다.</strong></p>\n<ol>\n<li><strong>사내 괴롭힘 신고</strong> — 회사 인사팀 또는 대표에게 괴롭힘 사실을 공식 신고합니다. 회사의 대응 여부가 이직 사유 판단에 중요합니다.</li>\n<li><strong>고용노동부 신고(선택)</strong> — 회사가 조치를 취하지 않으면 고용노동부에 직장 내 괴롭힘 신고를 할 수 있습니다.</li>\n<li><strong>퇴사 및 이직확인서 확인</strong> — 이직확인서의 이직 사유를 반드시 확인하세요.</li>\n<li><strong>고용센터 수급자격 인정신청</strong> — 괴롭힘 증빙서류를 첨부하여 신청합니다.</li>\n</ol>',
      },
    ],
    cases: [
      {
        title: '판례 — 고용보험법상 실질적 근로관계 보호',
        summary:
          '대법원 2012두22904 사건(대법원, 2013.02.28 선고)에서 법원은 고용보험 적용 대상의 판단 기준에 대해, 실질적인 근로관계의 존재 여부를 기준으로 판단해야 한다고 판시했습니다.',
        takeaway:
          '직장 내 괴롭힘으로 퇴사할 때 실질적으로 근로가 불가능한 환경이었는지가 핵심입니다. 형식적인 사직서보다 실질적 퇴사 사유를 증명하는 것이 중요합니다.',
      },
    ],
    faq: [
      {
        question: '괴롭힘 증거가 녹음밖에 없어도 실업급여를 받을 수 있나요?',
        answer:
          '<p>녹음만으로도 강력한 증거가 됩니다. 괴롭힘 발언이 담긴 녹음 파일과 함께 괴롭힘 일지를 제출하면 고용센터에서 종합적으로 판단합니다.</p>',
      },
      {
        question: '사내 신고 없이 바로 퇴사해도 실업급여를 받을 수 있나요?',
        answer:
          '<p>사내 신고가 없어도 실업급여 신청 자체는 가능합니다. 다만 사내 신고 기록이 있으면 "회사가 조치를 취하지 않아 퇴사할 수밖에 없었다"는 점을 더 쉽게 증명할 수 있습니다.</p>',
      },
      {
        question: '상사가 아닌 동료의 괴롭힘도 정당한 이직 사유인가요?',
        answer:
          '<p>동료 간 괴롭힘도 직장 내 괴롭힘에 해당합니다. 지위가 아닌 관계의 우위(다수 vs 소수, 선임 vs 후임 등)를 이용한 괴롭힘도 인정됩니다.</p>',
      },
      {
        question: '괴롭힘으로 우울증이 생겼는데 산재도 신청할 수 있나요?',
        answer:
          '<p>직장 내 괴롭힘으로 인한 정신질환은 업무상 질병으로 산재 인정이 가능합니다. 실업급여와 산재보험은 별개 제도이므로 동시에 청구할 수 있습니다.</p>',
      },
    ],
    ...
    internalLinks: [
      { label: '실업급여 수급 요건', href: '/guide/unemployment/unemployment-benefit-requirements' },
      { label: '자발적 퇴사 실업급여', href: '/guide/unemployment/unemployment-voluntary-quit-benefits' },
      { label: '직장 내 괴롭힘 대응', href: '/guide/dismissal/dismissal-workplace-bullying' },
      { label: '이직확인서 분쟁', href: '/guide/unemployment/unemployment-separation-confirmation-dispute' },
      { label: '산재 신청 절차', href: '/guide/industrial-accident1/industrial-accident-employer-safety-obligation' },
    ],
  },
    ...
    cases: [
      {
        ...
        takeaway:
          '건강 사유로 퇴사한 후에도 회복 의지와 구직 의사가 있다면 실업급여 수급 자격이 인정됩니다. 치료 중이라도 수급자격 인정신청은 빠르게 하세요.',
      },
    ],
    faq: [
      {
        ...
        answer:
          '<p>네, 정신건강의학과 진단서에 "근로가 어렵다"는 소견이 있으면 정당한 이직 사유로 인정됩니다. 정신질환도 신체 질환과 동일하게 취급됩니다.</p>',
      },
      {
  ...
  // ── 5. 가족돌봄 퇴사 실업급여 ──
  {
    ...
    intro:
      '<p>어머니가 갑자기 쓰러지셔서 수술을 받으셨습니다. 간병할 사람이 없어 회사를 그만둬야 하는데, 자진퇴사면 실업급여를 못 받을까 걱정됩니다. 가족의 질병·부상으로 인한 간병이 필요하여 퇴사한 경우도 정당한 이직 사유로 인정됩니다.</p>',
    sections: [
      {

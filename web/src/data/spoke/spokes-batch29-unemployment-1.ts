    ...
    cases: [
      {
        ...
        summary:
          '서울행정법원 2007구합1972(서울행정법원, 2008.06.25 선고)에서는 회사가 임직원에게 지급한 경영성과금이 근로기준법상 임금에 해당하여 고용보험료 산정 기준인 임금총액에 포함되어야 한다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하니, 본인 사건에 적용할 때는 개별 검토를 해볼 수 있습니다.',
        takeaway:
    ...
    cases: [
      {
        ...
        summary:
          '광주지방법원 2007구합3176(광주지방법원, 2007.12.13 선고)에서는 고용보험법상 적용 제외 요건의 해석은 엄격해야 하며, 청원경찰에 대한 고용보험 적용 여부를 판단할 때 실질적인 근로관계를 기준으로 해야 한다고 판단한 사례가 있습니다. 다만 하급심 판단으로 확정 여부는 별도 확인이 필요하니, 본인 상황에 맞는지 검토해볼 수 있습니다.',
        takeaway:

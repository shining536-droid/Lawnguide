...
export const spokesBatch64Dismissal: SpokePage[] = [
  ...
  // ─── 3. dismissal-subsidiary-spinoff-fired-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '부당해고 증거 수집 방법', href: '/guide/dismissal/dismissal-unfair-evidence-collection' },
      { label: '해고근로자 종합 가이드', href: '/guide/dismissal' },
      { label: '위탁계약 근로자성 해고', href: '/guide/dismissal/dismissal-commission-contract-worker-status-track' },
    ],
  },
  ...
  // ─── 4. dismissal-union-join-evaluation-low-fire-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 노조 활동 관련 해고와 재량권 일탈',
        summary:
          '대법원 2008두22211(대법원, 2009.04.09 선고)에서 법원은 항공사 객실승무원들이 단독노조 설립을 추진하며 모금한 후원금의 관리·사용을 둘러싸고 생긴 분쟁을 이유로 회사가 노조 설립추진위원회 핵심 임원들을 해고한 사안에서, 사회통념상 고용관계를 계속할 수 없을 정도로 근로자에게 책임이 있다고 보기 어렵다며 그 해고가 재량권의 범위를 벗어난 것이라고 판시했습니다.',
        takeaway: '노조 가입·활동 직후 낮은 평가와 해고가 이어졌다면, 해고 사유가 고용관계를 끝낼 만큼 중대한지, 노조 활동과의 시간적 근접성은 없는지 등을 정리해 부당해고·부당노동행위 여부를 점검해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    cases: [
      {
        ...
        takeaway: '산재 요양으로 휴업한 기간과 그 후 30일 사이의 해고는 원칙적으로 제한되므로, 요양·휴업의 필요성을 입증할 진단서와 요양 기록을 정리해 복직 거부·해고의 정당성을 점검해볼 수 있습니다.',
      },
    ],
    faq: [
      {

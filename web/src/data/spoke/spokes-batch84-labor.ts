...
export const spokesBatch84Labor: SpokePage[] = [
  // ─── 1. dismissal-probation-final-hiring-refusal-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '저성과 PIP 해고 부당성', href: '/guide/dismissal/dismissal-pip-low-performance-defense' },
  ...
  // ─── 3. dismissal-fixed-term-renewal-expectation-track ───
  {
    ...
    internalLinks: [
      { label: '부당해고 구제 절차', href: '/guide/dismissal/unfair-dismissal-relief-procedure' },
      { label: '계약직 재계약 거부 부당해고', href: '/guide/dismissal/dismissal-fixed-term-non-renewal-remedy' },
      { label: '기간제 갱신기대권 갱신거절 해고', href: '/guide/dismissal/dismissal-fixedterm-renewal-refusal-track' },
  ...
  // ─── 4. wage-unused-annual-leave-pay-track ───
  {
    ...
    internalLinks: [
      { label: '연차휴가 미사용수당 미지급 임금 청구 판단', href: '/guide/wage/wage-annual-leave-allowance-unpaid-claim-track' },
      ...
      { label: '교대근무수당 통상임금 산입', href: '/guide/wage/wage-shift-allowance-ordinary-wage-inclusion-track' },
  ...
  // ─── 5. wage-intermediate-exploitation-subcontract-track ───
  {
    ...
    cta: { text: '임금체불 대응 순서, AI로 바로 정리하기', link: '/chat?domain=wage' },
    internalLinks: [
      { label: '프리랜서 임금체불 근로자성 인정', href: '/guide/wage/wage-freelancer-worker-status-claim' },
  ...
  // ─── 7. unemployment-illness-injury-separation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '단시간 두 사업장 보수일수 합산', href: '/guide/unemployment/unemployment-part-time-multi-employer-insured-day-aggregation-track' },
    ],
  },
  ...
  // ─── 8. retirement-repeated-fixed-term-continuous-service-track ───
  {
    ...
    internalLinks: [
      ...
      { label: 'DC형 퇴직연금 부담금 미납', href: '/guide/retirement/retirement-dc-pension-unpaid-contribution-track' },
  ...
  // ─── 9. retirement-average-wage-bonus-inclusion-track ───
  {
    ...
    internalLinks: [
      { label: '퇴직금 계산', href: '/guide/retirement/retirement-pay-calculation' },
      { label: '정기상여금 평균임금 산입 퇴직금 재산정 판단', href: '/guide/retirement/retirement-pay-regular-bonus-average-wage-inclusion-recalc-track' },
      { label: '상여금 평균임금 산입 퇴직금', href: '/guide/retirement/retirement-bonus-average-wage-track' },
      { label: '퇴직급여 종합 가이드', href: '/guide/retirement' },
  ...
  // ─── 10. industrial-accident-commute-recognition-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '과로 뇌심혈관 질병 업무상 재해 요양급여 절차', href: '/guide/industrial-accident/industrial-accident-overwork-cerebral-cardiac-disease-track' },
      { label: '과로 뇌심혈관 산재 인정', href: '/guide/industrial-accident/industrial-accident-overwork-cardio-cerebral-track' },

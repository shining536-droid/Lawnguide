...
export const spokesBatch67Traffic: SpokePage[] = [
  // ─── 1. traffic-accident-electric-wheelchair-pedestrian-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '신호등 없는 횡단보도 사고 과실', href: '/guide/traffic-accident/traffic-accident-crosswalk-pedestrian-fault-track' },
  ...
  // ─── 2. traffic-accident-airbag-non-deploy-defect-claim-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '횡단보도 보행자 사고 과실', href: '/guide/traffic-accident/traffic-accident-crosswalk-pedestrian-track' },
  ...
  // ─── 3. traffic-accident-fog-multi-vehicle-fault-distribution-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '횡단보도 신호 보행 중 차량 사고 과실비율', href: '/guide/traffic-accident/traffic-accident-crosswalk-signal-pedestrian-track' },
      { label: '자기차량보험 자기부담금 대위', href: '/guide/traffic-accident/traffic-accident-self-insured-claim' },
    ],
  },
  ...
  // ─── 4. traffic-accident-tow-truck-cargo-loading-collision-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '자전거 충돌 중상 책임', href: '/guide/traffic-accident/traffic-accident-cyclist-severe-injury-liability' },
  ...
  // ─── 5. traffic-accident-cargo-tarp-failure-debris-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보험 청구', href: '/guide/traffic-accident/traffic-accident-insurance-claim-comprehensive' },
      { label: '교통사고 지연 통증 진단서', href: '/guide/traffic-accident/traffic-accident-delayed-pain-medical-record' },

...
export const spokesBatch17_16to20: SpokePage[] = [
  {
    ...
    intro: '경매로 아파트를 낙찰받았는데, 기존 세입자가 나가지 않겠다고 합니다. 보증금을 돌려받아야 한다며 버티고 있고, 명도를 요구하면 오히려 자신에게 대항력이 있다고 주장합니다. 이사 계획은 틀어지고 잔금 납부 기한은 다가오는데 어떻게 해야 할지 막막합니다. 세입자가 있는 경매 물건을 낙찰받았을 때 반드시 확인해야 할 사항과 대처 절차를 정리했습니다.',
    sections: [
      {
        title: '첫째, 세입자의 대항력 유무를 먼저 확인하세요',
        content:
          '<p><strong style="color:#1e3a5f">대항력이 있는 세입자와 없는 세입자는 대처법이 완전히 다릅니다</strong></p>\n<p>세입자가 <strong>전입신고 + 확정일자</strong>를 갖추고, 그 날짜가 근저당권 설정일보다 <strong>앞서면</strong> 대항력이 인정됩니다. 대항력이 있는 세입자는 매수인에게 보증금 반환을 요구할 수 있고, 보증금을 돌려받기 전까지 퇴거를 거부할 수 있습니다.</p>\n<p>반대로 전입신고일이 근저당 설정일보다 <strong>늦으면</strong> 대항력이 없습니다. 이 경우 세입자는 배당 절차에서 보증금을 받고, 매수인에게는 퇴거 의무가 있습니다. 등기부등본과 배당표를 대조해서 세입자의 <strong>전입일·확정일자·근저당 설정일</strong>을 반드시 확인하세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">체크: 전입신고일 vs 근저당 설정일 비교 → 대항력 유무 판단</blockquote>',
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '대항력 있는 세입자가 배당에서 보증금을 받지 못했다면 <strong>매수인이 보증금 반환 의무</strong>를 승계합니다. 이 금액은 낙찰가에서 사실상 차감해야 하므로, 입찰 전에 반드시 계산에 포함해야 합니다.',
      },
      {
  ...
  {
    domain: 'child-sex-crime',
    slug: 'victim-report-required-documents',
    keyword: '아동성범죄 피해 신고 준비서류',
    questionKeyword: '아동성범죄 피해 신고할 때 어떤 서류를 준비해야 하나요?',
    ctaKeyword: '아동성범죄 신고 서류 준비',
    type: '준비서류형',
    perspective: 'victim',
    meta: {
      title: '아동성범죄 피해 신고 시 필요한 서류 7가지 | 로앤가이드',
      description: '아이가 성범죄 피해를 입었는데 경찰 신고 시 어떤 서류를 가져가야 하는지 모르겠나요? 신고 전 준비해야 할 서류 7가지를 지금 확인하세요.',
    },
    intro: '아이가 성범죄 피해를 당한 사실을 알게 되었습니다. 당장 경찰에 신고하고 싶지만 어떤 자료를 가져가야 하는지, 아이의 진술은 어떻게 준비해야 하는지 모르겠습니다. 서류가 미비하면 수사가 지연될까 걱정이 됩니다. 아동성범죄 피해 신고 시 반드시 준비해야 할 서류와 증거를 정리했습니다.',
    sections: [
      {
        title: '첫째, 피해 아동의 진술을 기록으로 남기세요',
        content:
          '<p><strong style="color:#1e3a5f">아이의 첫 진술이 수사에서 가장 중요한 증거입니다</strong></p>\n<p>아이가 피해 사실을 말했을 때, <strong>언제·어디서·누가·무엇을</strong> 했는지를 최대한 구체적으로 <strong>메모</strong>하세요. 아이의 말을 그대로 옮겨 적는 것이 중요하며, 부모가 유도하거나 해석을 덧붙이면 안 됩니다.</p>\n<p>가능하다면 아이의 진술을 <strong>녹음 또는 영상으로 기록</strong>해두세요. 다만 반복 질문은 아이에게 2차 피해를 줄 수 있으므로, 한 번만 차분하게 들어보세요. 경찰 조사에서는 <strong>영상녹화 조사(해바라기센터)</strong>를 요청할 수 있습니다.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">핵심: 아이의 말 그대로 메모 + 녹음 | 유도 질문 금지 | 반복 질문 자제</blockquote>',
      },
      {
        title: '둘째, 의료 진단서와 상담 기록을 확보하세요',
        content:
          '<p><strong style="color:#1e3a5f">신체적 피해가 있다면 48시간 이내 진단서를 발급받으세요</strong></p>\n<p>성범죄 피해의 경우 <strong>해바라기센터(전국 39곳)</strong>에서 무료로 의료 진단과 증거 채취를 받을 수 있습니다. 해바라기센터에서 발급받은 <strong>진단서, 소견서, 증거 채취 기록</strong>은 수사에서 핵심 증거로 활용됩니다.</p>\n<p>아이가 심리적 충격을 받은 경우, <strong>정신건강의학과 소견서</strong>도 함께 준비하세요. 심리 상담 기록은 피해 사실의 <strong>일관성을 뒷받침하는 간접 증거</strong>로 사용됩니다. 해바라기센터 연락처는 <strong>1899-3075</strong>입니다.</p>\n<p style="margin-top:12px;padding:10px 14px;background:linear-gradient(135deg,#fff8e1,#fff3cd);border-radius:8px;font-size:0.95em"><strong style="color:#d4a017">💬 지금 내 상황에 맞는 대응 전략 확인하기</strong> → <a href="/diagnosis/child-sex-crime" style="color:#1e3a5f;font-weight:bold">무료 진단 시작</a></p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">해바라기센터 1899-3075 | 무료 의료 진단 + 증거 채취 + 상담</blockquote>',
      },
      {
        title: '셋째, 가해자 관련 정보와 증거를 정리하세요',
        content:
          '<p><strong style="color:#1e3a5f">가해자의 신원과 접촉 증거를 최대한 확보하세요</strong></p>\n<p>가해자의 <strong>이름, 연락처, 주소, 직업, 아이와의 관계</strong>를 정리하세요. 가해자가 아이에게 보낸 <strong>메시지(카카오톡, 문자)</strong>가 있다면 스크린샷을 캡처하고, 원본 데이터가 삭제되지 않도록 기기를 보존하세요.</p>\n<p>CCTV 영상이 있을 수 있는 장소(학원, 놀이터, 건물 출입구)를 확인하세요. CCTV는 통상 <strong>30일 이내</strong>에 삭제되므로 빠르게 경찰에 보존 요청을 해야 합니다. 목격자가 있다면 <strong>이름과 연락처</strong>를 메모해두세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">가해자 정보 + 메시지 캡처 + CCTV 보존 요청(30일 내) + 목격자 연락처</blockquote>',
      },
      {
        title: '넷째, 신고 시 지참할 서류 목록을 확인하세요',
        content:
          '<p><strong style="color:#1e3a5f">아래 7가지 서류를 준비하면 신고 절차가 빠르게 진행됩니다</strong></p>\n<p>①<strong>보호자 신분증</strong>, ②<strong>아동 기본증명서(주민센터 발급)</strong>, ③<strong>가해자 관련 정보 메모</strong>, ④<strong>의료 진단서·소견서</strong>, ⑤<strong>아이의 진술 메모·녹음</strong>, ⑥<strong>메시지 캡처·사진 등 증거자료</strong>, ⑦<strong>해바라기센터 상담 확인서(해당 시)</strong>를 지참하세요.</p>\n<p>서류가 완벽하지 않아도 <strong>먼저 신고하는 것이 중요합니다</strong>. 신고 접수 후에도 추가 증거를 제출할 수 있으며, 수사기관에서 필요한 자료를 안내해줍니다. 신고는 가까운 <strong>경찰서 여성청소년수사팀</strong> 또는 <strong>112</strong>로 하세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">7가지: 신분증, 기본증명서, 가해자 정보, 진단서, 진술 기록, 증거자료, 상담 확인서</blockquote>',
      },
      {
        title: '다섯째, 피해 아동 지원 제도를 활용하세요',
        content:
          '<p><strong style="color:#1e3a5f">수사 단계부터 무료 법률 지원과 심리 치료를 받을 수 있습니다</strong></p>\n<p>아동·청소년 성범죄 피해자는 수사 단계부터 <strong>국선변호사</strong>를 무료로 선임할 수 있습니다(아동·청소년의 성보호에 관한 법률 제30조). 국선변호사는 경찰·검찰 조사에 동석하여 아이의 <strong>2차 피해를 방지</strong>합니다.</p>\n<p>또한 <strong>범죄피해자 지원센터(1577-1295)</strong>에서 의료비, 심리 치료비, 생계 지원 등을 받을 수 있습니다. 해바라기센터에서도 <strong>장기 심리 상담</strong>을 무료로 제공하므로, 신고 후에도 아이의 심리 회복을 위해 꾸준히 활용하세요.</p>\n<blockquote style="margin-top:8px;padding:8px 12px;background:#f7f7f7;border-radius:6px;font-size:0.9em;color:#555">지원: 국선변호사 무료 선임 + 범죄피해자 지원센터 1577-1295 + 해바라기센터 상담</blockquote>',
      },
    ],
    cases: [
      {
        title: '아동 성착취물 소지 증거 수집의 적법성 — 대법원 2023도3626',
        summary:
          '대법원 2023도3626 사건(2024.12.24)에서 법원은 디지털 성범죄 수사에서 혐의사실과 같거나 근접한 시기에 행해진 동종 유형의 전자정보에 대해 구체적·개별적 연관관계가 인정된다면 압수수색 대상이 될 수 있다고 판시했습니다.',
        takeaway:
          '가해자의 기기에 남아 있는 전자정보는 수사의 핵심 증거입니다. 메시지, 사진 등 디지털 증거가 삭제되기 전에 빠르게 신고하세요.',
      },
    ],
    faq: [
      {
        question: '서류가 다 준비되지 않아도 신고할 수 있나요?',
        answer:
          '<strong>네, 서류 없이도 신고할 수 있습니다.</strong> 신고 접수 후에도 추가 서류를 제출할 수 있으며, 증거 수집은 수사기관이 진행합니다. 빠른 신고가 가장 중요합니다.',
      },
      {
        question: '해바라기센터는 어디에 있나요?',
        answer:
          '전국 <strong>39곳</strong>에 설치되어 있으며, <strong>1899-3075</strong>으로 전화하면 가장 가까운 센터를 안내받을 수 있습니다. 24시간 상담이 가능합니다.',
      },
      {
        question: '아이가 경찰 조사를 받아야 하나요?',
        answer:
          '아동 피해자는 <strong>영상녹화 조사</strong>를 통해 1회만 진술하면 됩니다. 해바라기센터에서 전문 조사관이 아동 친화적 환경에서 조사를 진행하며, <strong>국선변호사가 동석</strong>할 수 있습니다.',
      },
      {
        question: '가해자가 가족인 경우에도 신고해야 하나요?',
        answer:
          '<strong>가족이 가해자여도 반드시 신고해야 합니다.</strong> 친족 성범죄는 가중 처벌 대상이며, 신고 즉시 아동보호전문기관이 피해 아동의 <strong>격리 보호 조치</strong>를 진행합니다.',
      },
      {
        question: '신고 후 아이의 학교에 알려지나요?',
        answer:
          '피해 아동의 인적사항은 <strong>비공개가 원칙</strong>입니다. 아동·청소년의 성보호에 관한 법률 제31조에 따라 피해자의 신원이 드러나는 정보를 공개하는 것은 금지되어 있습니다.',
      },
    ],
    cta: {
      text: '💬 지금 내 상황에 맞는 대응 전략 확인하기',
    ...
    internalLinks: [
      { label: '아동성범죄 진단', href: '/diagnosis/child-sex-crime' },
      { label: '아동성범죄 의무신고 절차', href: '/spoke/child-sex-crime/mandatory-reporting-procedure' },
      { label: '아동성범죄 신고 안 하면 처벌', href: '/spoke/child-sex-crime/penalty-for-not-reporting' },
      { label: '성범죄 피해자 국선변호사 제도', href: '/guide/sex-crime/sexual-assault-procedure-trial' },
      { label: '디지털 성범죄 증거 보존법', href: '/guide/digital-sex-crime/deepfake-pornography-report-removal' },
    ],
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '학교폭력의 성립 여부는 <strong>가해자의 의도가 아닌 피해자가 느끼는 고통</strong>을 기준으로 판단합니다. 가해 학생이 장난이라고 주장해도 피해 학생이 실제로 고통을 받았다면 학교폭력에 해당합니다.',
      },
      {
  ...
  },
  {
    ...
    intro: '학교에서 전화가 왔습니다. 아이가 학교폭력 가해자로 지목되었고, 곧 학폭위가 열릴 예정이라고 합니다. 아이는 억울하다고 하고, 상대측 부모는 이미 증거를 정리하고 있습니다. 학폭위까지 시간이 얼마 없는데 무엇부터 해야 할지 모르겠습니다. 학폭위가 열리기 전 72시간 안에 부모가 반드시 해야 할 초기 대응을 정리했습니다.',
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          '학폭위 심의에 <strong>변호사가 보호자와 함께 출석하여 조언</strong>하는 것은 가능합니다. 다만 변호사가 보호자를 대리하여 단독으로 출석하는 것은 인정되지 않으므로, 보호자가 반드시 직접 참석해야 합니다.',
      },
      {

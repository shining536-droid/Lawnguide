...
export const spokesBatch67DefameJeonseStalking: SpokePage[] = [
  ...
  // ─── 2. defamation-chatbot-ai-generated-content-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '온라인 허위사실 삭제 가처분', href: '/guide/defamation/defamation-online-false-deletion-injunction' },
  ...
  // ─── 3. defamation-broadcast-press-victim-secondary-leak-track ───
  {
    ...
    internalLinks: [
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '언론 인터뷰 명예훼손 무고', href: '/guide/defamation/defamation-press-interview-falsely-accused-defense' },
      { label: '온라인 게시글 삭제 요청 절차', href: '/guide/defamation/defamation-online-post-deletion-request-procedure' },
      { label: '학교 카더라 인터넷 게시 정정·삭제', href: '/guide/defamation/defamation-school-rumor-online-takedown' },
  ...
  // ─── 4. jeonse-deposit-return-delay-monthly-interest-claim-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '임차권등기 후 추가 임대 후순위', href: '/guide/jeonse/jeonse-rental-registration-after-additional-tenant-junior-risk' },
      { label: '보증금 지연 반환 지연이자', href: '/guide/jeonse/jeonse-deposit-delay-interest-claim' },
  ...
  // ─── 6. stalking-online-game-voice-chat-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '스토킹처벌법 경범죄 분기', href: '/guide/stalking/stalking-act-vs-minor-offense-restraining-bifurcation' },
    ],
  },
  ...
  // ─── 7. stalking-rental-property-landlord-resident-track ───
  {
    ...
    internalLinks: [
      { label: '스토킹 종합 가이드', href: '/guide/stalking' },
      { label: '스토킹 잠정조치 긴급응급조치 신청', href: '/guide/stalking/stalking-emergency-protection-order-apply' },
      { label: '연예인 팬 개인정보 추적', href: '/guide/stalking/stalking-celebrity-fan-private-info-tracking-track' },
      { label: '주택임대차 종합 가이드', href: '/guide/jeonse' },
      { label: '스토킹 고소 취하하면 처벌은 어떻게 되나요', href: '/guide/stalking/stalking-complaint-withdrawal-effect' },
    ],
  },
];

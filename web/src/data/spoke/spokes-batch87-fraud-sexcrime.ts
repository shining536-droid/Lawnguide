...
export const spokesBatch87FraudSexCrime: SpokePage[] = [
  // ─── 1. fraud-romance-military-impersonation-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '로맨스스캠 송금 사기', href: '/guide/fraud/fraud-romance-scam-remittance-track' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '부동산 계약금 이중계약 사기 고의 무고 방어', href: '/guide/fraud/fraud-realestate-down-payment-double-contract-falsely-accused-defense' },
  ...
  // ─── 2. fraud-used-car-lease-takeover-track ───
  {
    ...
    internalLinks: [
      { label: '거래 분쟁의 사기 고소 둔갑', href: '/guide/fraud/fraud-business-dispute-criminal-complaint-false-accused-defense' },
      { label: '중고차 사고이력 은폐 판매 기망 사기', href: '/guide/fraud/fraud-used-car-accident-history-concealment-sale-track' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
  ...
  // ─── 5. fraud-membership-refund-refusal-track ───
  {
    ...
    internalLinks: [
      { label: '거래 분쟁의 사기 고소 둔갑', href: '/guide/fraud/fraud-business-dispute-criminal-complaint-false-accused-defense' },
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '헬스장 폐업 회원권 환불', href: '/guide/fraud/fraud-gym-closure-membership-refund' },
      { label: '동업 사업자금 편취 사기 무고 방어', href: '/guide/fraud/fraud-joint-business-seed-money-falsely-accused-defense' },
      { label: '보이스피싱 송금 환급 절차', href: '/guide/fraud/fraud-phishing-transfer-refund-procedure' },
    ],
  },
  ...
  // ─── 6. fraud-borrowed-name-account-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      { label: '사기/재산범죄 종합 가이드', href: '/guide/fraud' },
      { label: '멤버십 포인트 현금화 미지급 기망 사기', href: '/guide/fraud/fraud-membership-point-cash-exchange-nonpayment-track' },
      ...
      { label: '사업 투자금 명목 차용금 변제불능 사기 무고', href: '/guide/fraud/fraud-business-investment-pretext-borrowing-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 7. sex-crime-taxi-passenger-contact-track ───
  {
    ...
    internalLinks: [
      { label: '축제 인파 밀집 틈탄 추행 신고', href: '/guide/sex-crime/sex-crime-festival-dense-crowd-touch-report-track' },
      { label: '촬영물 이용 협박', href: '/guide/sex-crime/sex-crime-filming-blackmail-threat-track' },
  ...
  // ─── 8. sex-crime-lodging-hidden-cam-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '성범죄 디지털 증거 보존기한 정리', href: '/guide/sex-crime/sex-crime-digital-evidence-timeline' },
      { label: '의료시술 마취 중 성폭력', href: '/guide/sex-crime/sex-crime-medical-procedure-anesthesia-victim-track' },
      { label: '만원 지하철 추행 기습추행 가해자 특정', href: '/guide/sex-crime/sex-crime-crowded-subway-groping-track' },
    ],
  },
  ...
  // ─── 9. sex-crime-synthetic-photo-sns-spread-track ───
  {
    ...
    cta: { text: '성범죄 피해 대응 순서, AI로 정리하기', link: '/chat?domain=sex-crime' },
    internalLinks: [
      { label: '딥페이크 합성 영상물', href: '/guide/sex-crime/sex-crime-deepfake-synthetic-video-track' },
      ...
      { label: '데이팅앱 만남 강제추행 무고', href: '/guide/sex-crime/sex-crime-dating-app-meetup-falsely-accused-defense' },
    ],
  },
  ...
  // ─── 10. sex-crime-blackout-drunk-falsely-accused-defense ───
  {
    ...
    internalLinks: [
      ...
      { label: '연인관계 성범죄 무고 대응법', href: '/guide/sex-crime/sex-crime-dating-relationship-accusation' },
      { label: '운전연수 신체접촉 추행 혐의', href: '/guide/sex-crime/sex-crime-driving-lesson-touch-defense-track' },

...
export const spokesBatch62DefameJeonseStalking: SpokePage[] = [
  // ─── 1. defamation-academy-parent-groupchat-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 명예훼손의 사실 적시 판단 기준',
        summary:
          '대법원 2020도15642(대법원, 2022.05.13 선고)에서 법원은 명예훼손이 성립하려면 사실의 적시가 있어야 하고 그 사실은 사회적 가치나 평가가 침해될 수 있을 정도로 구체성을 띠어야 하며, 가치판단이나 평가를 담은 의견 표현은 ‘사실의 적시’에 해당하지 않는다고 판시했습니다. 단톡방에서 오간 험담도 구체적 사실을 담았는지 단순한 평가에 그치는지에 따라 성립 여부가 달라질 수 있습니다. 따라서 문제된 글이 증명 가능한 구체적 사실인지부터 정리해볼 수 있습니다.',
        takeaway: '단톡방 발언이 구체적 사실인지 의견 표현인지부터 구분해 명예훼손 성립 여부를 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '회사 단톡 비판 명예훼손 고소', href: '/guide/defamation/defamation-company-groupchat-criticism-accused' },
      ...
      { label: '아파트 입주민 카페 게시글 명예훼손 공익성', href: '/guide/defamation/defamation-apartment-resident-online-cafe-post-track' },
    ],
  },
  ...
  // ─── 2. defamation-company-anonymous-board-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 공공의 이익 판단과 위법성 조각',
        summary:
          '대법원 2004도3912(대법원, 2004.10.15 선고)에서 법원은 형법 제310조의 ‘오로지 공공의 이익에 관한 때’란 적시된 사실이 객관적으로 공공의 이익에 관한 것이고 행위자도 주관적으로 공익을 위하여 적시한 경우를 뜻한다고 하면서, 해당 사안에서는 공공의 이익을 위한 것으로 볼 수 없어 명예훼손의 위법성이 조각되지 않는다고 판시했습니다. 회사 익명게시판에 올린 험담도 사적 감정이 주된 동기라면 공익 목적이 부정될 수 있습니다. 따라서 글의 작성 동기와 공익성을 함께 정리해볼 수 있습니다.',
        takeaway: '익명 게시글이라도 사적 감정이 주된 동기면 공익 면책이 어려우니 작성 동기부터 점검해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '인터넷 카페 폭로글 명예훼손', href: '/guide/defamation/defamation-online-cafe-post-track' },
      { label: '명예훼손 손해배상 금액 기준과 판례', href: '/guide/defamation/defamation-damages-amount-standard' },
      { label: '블라인드 익명 직장인 앱 허위 글 명예훼손 신고', href: '/guide/defamation/defamation-blind-anonymous-workplace-app-false-post-report-track' },
    ],
  },
  ...
  // ─── 3. defamation-secondhand-trade-review-track ───
  {
    ...
    cases: [
      {
        ...
        takeaway: '실제 거래 경험에 기반한 후기인지, 허위 사실이 섞였는지에 따라 비방 목적 인정 여부가 갈릴 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      { label: '명예훼손/모욕 종합 가이드', href: '/guide/defamation' },
      { label: '병원 항의 업무방해 명예훼손', href: '/guide/defamation/defamation-hospital-protest-business-interference-track' },
  ...
  // ─── 4. jeonse-renewal-rent-increase-cap-overrun-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 상한 초과 임대료 약정의 효력',
        summary:
          '대법원 2013다42236(대법원, 2016.11.18 선고)에서 법원은 공공건설임대주택의 임대사업자가 임차인의 동의 절차를 거치지 않고 일방적으로 제시한 임대보증금·임대료 전환 조건으로 체결한 임대차계약은 무효이고, 민법 제138조에 따라 표준임대보증금과 표준임대료를 조건으로 하는 계약으로 전환되어 유효하게 존속한다고 판시했습니다. 법정 기준을 벗어난 임대료 약정 부분은 그대로 효력을 인정받기 어렵다는 취지입니다. 갱신 시 5% 상한을 넘긴 인상분이 있다면 그 초과 부분의 효력과 반환 가능성을 검토해볼 수 있습니다.',
        takeaway: '법정 기준을 초과한 임대료 약정은 효력이 제한될 수 있으니, 5% 상한 초과 지급분의 반환 청구를 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
  ...
  // ─── 5. jeonse-landlord-abroad-emigrate-track ───
  {
    ...
    cases: [
      {
        ...
        takeaway: '임대인이 해외에 있어도 국내 주택 소유관계를 확인해 양수인 상대 보증금 반환·임차권등기를 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: 'HUG 보증 가입 거부 대응', href: '/guide/jeonse/jeonse-hug-guarantee-denial-rejection-response-track' },
  ...
  // ─── 6. stalking-coworker-quit-force-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 전자감독 장치 무력화 행위의 처벌',
        summary:
          '대법원 2016도17719(대법원, 2017.03.15 선고)에서 법원은 위치추적 전자장치의 효용을 해하는 행위에는 장치를 직접 손상하는 행위뿐 아니라 부착자가 재택 감독장치가 설치된 자신의 주거를 벗어나 그 효용이 정상적으로 발휘될 수 없게 하는 행위도 포함되며, 고의로 그렇게 한 경우 처벌 대상이 된다고 판시했습니다. 스토킹처벌법상 잠정조치나 전자감독이 내려진 가해자가 이를 회피·무력화하면 별도로 문제될 수 있다는 점을 참고할 수 있습니다. 따라서 접근·연락이 이어질 경우 잠정조치 위반 정황을 구체적으로 기록해두는 것을 검토해볼 수 있습니다.',
        takeaway: '가해자에게 잠정조치·전자감독이 내려졌다면 위반·회피 정황을 구체적으로 기록해두는 것을 검토해볼 수 있습니다.',
      },
    ],
    faq: [
      {
    ...
    internalLinks: [
      ...
      { label: '사용자 귀책 휴업수당 평균임금 70', href: '/guide/wage/wage-workplace-shutdown-60percent-allowance-track' },
    ],
  },
  ...
  // ─── 7. stalking-multiple-anonymous-account-track ───
  {
    ...
    cases: [
      {
        title: '판례 — 전자장치 효용을 해하는 행위의 범위',
        summary:
          '대법원 2012도5862(대법원, 2012.08.17 선고)에서 법원은 위치추적 전자장치의 효용을 해하는 행위에는 장치 자체의 기능을 직접 해치는 행위뿐 아니라 전자장치의 효용이 정상적으로 발휘될 수 없도록 하는 행위가 포함되고, 부작위라도 고의로 그 효용을 발휘될 수 없게 한 경우 처벌 대상이 된다고 판시했습니다. 스토킹 가해자에 대한 전자감독·잠정조치가 내려진 경우 이를 회피하는 행위도 별도로 평가될 수 있다는 점을 참고할 수 있습니다. 익명 다수 계정으로 접근이 반복된다면 각 계정의 접근 시각과 내용을 통합해 기록해두는 것을 검토해볼 수 있습니다.',
        takeaway: '다수 계정으로 접근이 반복되면 계정별 접근 기록을 통합해두고, 잠정조치 위반 정황도 함께 정리해볼 수 있습니다.',
      },
    ],
    faq: [
      {

...
export const spokesBatch90AssaultDuiJeonseFraud: SpokePage[] = [
  // ─── 1. assault-highway-road-rage-stop-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '보복운전·도로 폭행 대응', href: '/guide/assault/assault-road-rage-response' },
  ...
  // ─── 2. assault-neighbor-noise-hallway-track ───
  {
    ...
    internalLinks: [
      { label: '폭행·상해 고소 절차', href: '/guide/assault/assault-injury-complaint-procedure' },
      { label: '폭행·모욕 병합 대응', href: '/guide/assault/assault-insult-combined-response' },
      { label: '이웃·층간소음 분쟁 폭행', href: '/guide/assault/assault-neighbor-conflict-response' },
      { label: 'CCTV·녹취 영상 확보', href: '/guide/assault/assault-cctv-evidence-secure' },
      { label: '범죄피해자 지원 제도', href: '/guide/assault/assault-victim-support-system' },
    ],
  },
  ...
  // ─── 3. assault-delivery-rider-dispute-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '업무 중 폭행·손해배상', href: '/guide/assault/assault-work-injury-compensation' },
      { label: '헬멧캠·CCTV 영상 확보', href: '/guide/assault/assault-cctv-evidence-secure' },
      { label: '범죄피해자 지원 제도', href: '/guide/assault/assault-victim-support-system' },
    ],
  },
  ...
  // ─── 4. assault-sports-game-tackle-injury-track ───
  {
    ...
    internalLinks: [
      { label: '폭행·상해 고소 절차', href: '/guide/assault/assault-injury-complaint-procedure' },
      { label: '정당행위·사회상규 기준', href: '/guide/assault/assault-justifiable-act-standard' },
      { label: '운동·레저 부상 손해배상', href: '/guide/assault/assault-sports-injury-compensation' },
      { label: 'CCTV·경기 영상 확보', href: '/guide/assault/assault-cctv-evidence-secure' },
      { label: '범죄피해자 지원 제도', href: '/guide/assault/assault-victim-support-system' },
    ],
  },
  ...
  // ─── 5. dui-personal-mobility-pm-track ───
  {
    ...
    internalLinks: [
      { label: '운전 당시 혈중알코올농도 증명', href: '/guide/dui/dui-driving-time-bac-proof' },
      { label: '개인형이동장치 음주 적용법조', href: '/guide/dui/dui-personal-mobility-law' },
  ...
  // ─── 6. dui-private-parking-lot-track ───
  {
    ...
    internalLinks: [
      { label: '위드마크 공식·혈중알코올농도 추정', href: '/guide/dui/dui-widmark-bac-estimation' },
      { label: '음주 측정 절차·정확성', href: '/guide/dui/dui-breath-test-procedure' },
      { label: '운전 당시 혈중알코올농도 증명', href: '/guide/dui/dui-driving-time-bac-proof' },
      { label: '음주운전 양형·감경', href: '/guide/dui/dui-sentencing-mitigation-factors' },
      { label: '음주운전 행정심판 절차', href: '/guide/dui/dui-administrative-appeal-procedure' },
  ...
  // ─── 8. jeonse-fraud-multifamily-prior-tenant-deposit-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '가장 임차인·대항력 다툼', href: '/guide/jeonse-fraud/jeonse-fraud-fake-tenant-dispute' },
  ...
  // ─── 9. jeonse-fraud-trust-registered-property-track ───
  {
    ...
    internalLinks: [
      ...
      { label: '공동저당·경매대가 산정', href: '/guide/jeonse-fraud/jeonse-fraud-joint-mortgage-distribution' },
      { label: '다세대·다가구 선순위 보증금', href: '/guide/jeonse-fraud/jeonse-fraud-multi-household-priority' },
      { label: '경매 배당요구 절차', href: '/guide/jeonse-fraud/jeonse-fraud-auction-distribution-claim' },
      { label: '보증금반환소송', href: '/guide/jeonse-fraud/jeonse-fraud-deposit-return-lawsuit' },
    ],
  },
  ...
  // ─── 10. jeonse-fraud-fake-agent-impersonation-track ───
  {
    ...
    cta: { text: '전세사기 피해 대응 순서, AI로 정리하기', link: '/chat?domain=jeonse-fraud' },
    internalLinks: [
      { label: '중개사 주의의무·설명 범위', href: '/guide/jeonse-fraud/jeonse-fraud-broker-duty-scope' },
      { label: '채무인수·청구 상대방', href: '/guide/jeonse-fraud/jeonse-fraud-debt-assumption-party' },
      { label: '매매로 임대인 변경 시 보증금', href: '/guide/jeonse-fraud/jeonse-fraud-landlord-change-deposit' },
      { label: '중개사 설명의무·배상책임', href: '/guide/jeonse-fraud/jeonse-fraud-broker-duty-liability' },
      { label: '보증금반환소송', href: '/guide/jeonse-fraud/jeonse-fraud-deposit-return-lawsuit' },
    ],
  },
